...
class MarginPageTransformerTest :
    ...
    fun testMargin() {
        ...
        // when
        listOf({
            selectOrientation(ORIENTATION_HORIZONTAL)
            marginPx = selectPageTransformer(LABEL_NONE)
        }, {
            selectOrientation(ORIENTATION_HORIZONTAL)
            marginPx = selectPageTransformer(LABEL_50_PX)
        }, {
            selectOrientation(ORIENTATION_VERTICAL)
            marginPx = selectPageTransformer(LABEL_50_PX)
        }, {
            selectOrientation(ORIENTATION_VERTICAL)
            marginPx = selectPageTransformer(LABEL_50_PX)
