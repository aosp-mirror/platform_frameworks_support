...
abstract class BaseCardActivity : FragmentActivity() {
    ...
    private val translateX get() = orientationTracker.orientation == ORIENTATION_VERTICAL &&
            translateCheckBox.isChecked
    private val translateY get() = orientationTracker.orientation == ORIENTATION_HORIZONTAL &&
            translateCheckBox.isChecked
    ...
    public override fun onCreate(savedInstanceState: Bundle?) {
        ...
        orientationTracker = OrientationTracker(viewPager, findViewById(R.id.orientation_spinner))
