...
import androidx.viewpager2.PageTransformAdapter;
...
public class ViewPager2 extends ViewGroup {
    ...
    private @Nullable PageTransformAdapter mPageTransformAdapter;
    ...
    private PageTransformAdapter getPageTransformAdapter() {
        if (mPageTransformAdapter == null) {
            mPageTransformAdapter = new PageTransformAdapter(mLayoutManager);
            getScrollEventAdapter().setPageTransformAdapter(mPageTransformAdapter);
        }
        return mPageTransformAdapter;
    }
    ...
    public void setPageTransformer(@Nullable PageTransformer transformer) {
        ...
        getPageTransformAdapter().setPageTransformer(transformer);
    }
