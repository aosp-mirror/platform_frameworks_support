...
public class ViewPager2 extends ViewGroup {
    ...
    private boolean mUserScrollable = true;
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        ss.mUserScrollable = mUserScrollable;
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        ...
        mUserScrollable = ss.mUserScrollable;
    ...
    /**
     * Enable or disable user initiated scrolling. This includes touch input (swipe gestures) and
     * accessibility input. Disabling keyboard input is not yet supported. When user initiated
     * scrolling is disabled, programmatic scrolls through {@link #setCurrentItem(int, boolean)}
     ...
     *        initiated scrolling
     */
    public void setUserScrollable(boolean enabled) {
        mUserScrollable = enabled;
    }
     ...
     */
    public boolean isUserScrollable() {
        return mUserScrollable;
    }
    ...
    private class RecyclerViewImpl extends RecyclerView {
        ...
        public boolean onTouchEvent(MotionEvent event) {
            return isUserScrollable() && super.onTouchEvent(event);
        }

        @Override
        public boolean onInterceptTouchEvent(MotionEvent ev) {
            return isUserScrollable() && super.onInterceptTouchEvent(ev);
        }
    }
