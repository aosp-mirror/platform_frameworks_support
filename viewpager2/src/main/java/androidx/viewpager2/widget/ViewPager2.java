...
public final class ViewPager2 extends ViewGroup {
    ...
    private FakeDragComponent mFakeDragger;
    ...
    private void initialize(Context context, AttributeSet attrs) {
        ...
        // Create FakeDragComponent before attaching PagerSnapHelper, same reason as above
        mFakeDragger = new FakeDragComponent(this, mScrollEventAdapter, mRecyclerView);
