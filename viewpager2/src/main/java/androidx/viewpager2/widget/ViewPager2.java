...
public final class ViewPager2 extends ViewGroup {
     ...
     *
     * <p>If your pages are view hierarchies not contained in a {@link
     * androidx.fragment.app.Fragment Fragment}, implement {@link RecyclerView.Adapter} as usual. If
     * your pages are {@code Fragments}, implement {@link
     * androidx.viewpager2.adapter.FragmentStateAdapter FragmentStateAdapter}</p>
     *
     ...
     * getLayoutTransition().setAnimateParentHierarchy(false)} on the ViewGroup with {@code
     * animateLayoutChanges} after you inflated the xml layout, like this:</p>
     *
     * <pre>
