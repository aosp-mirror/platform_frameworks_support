...
public abstract class FragmentStateAdapter extends
    ...
    class FragmentMaxLifecycleEnforcer {
        ...
        void register(@NonNull RecyclerView recyclerView) {
            ...
            mPageChangeCallback = new ViewPager2.OnPageChangeCallback() {
                ...
                public void onPageScrollStateChanged(int state) {
                    updateFragmentMaxLifecycle(viewPager, false);
                }
            ...
            mDataObserver = new DataSetChangeObserver() {
                ...
                public void onChanged() {
                    updateFragmentMaxLifecycle(viewPager, true);
                }
            };
        ...
        void updateFragmentMaxLifecycle(@NonNull ViewPager2 viewPager, boolean dataSetChanged) {
            if (shouldDelayFragmentTransactions()) {
