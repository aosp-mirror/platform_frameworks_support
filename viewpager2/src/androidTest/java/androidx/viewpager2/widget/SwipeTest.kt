...
import androidx.viewpager2.widget.swipe.PageManipulator
...
class SwipeTest(private val testConfig: TestConfig) : BaseTest() {
    private val pageManipulator = PageManipulator()
            ...
            setUpTest(orientation).apply {
                ...
                pageSequence.forEachIndexed { currentStep, targetPage ->
                    ...
                    if (modifiedPageValue != null) {
                        ...
                        runOnUiThread {
                            pageManipulator.setText(
                                    pageManipulator.findView(activity), modifiedPageValue)
                        }
                    }
