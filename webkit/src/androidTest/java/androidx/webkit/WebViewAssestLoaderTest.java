...
public class WebViewAssestLoaderTest {
    private final static String TAG = "WebViewAssetLoaderTest";
    ...
    private static class MockProtocolHandler extends WebViewAssestLoader.AndroidProtocolHandler {
    ...
    public void testCustomPathHandler() {
        WebViewAssestLoader assetLoader = new WebViewAssestLoader(new MockProtocolHandler());
        final String contents = RandomString.next(2000);
        final String encoding = "utf-8";

        WebViewAssestLoader.PathHandler pathHandler = new WebViewAssestLoader.PathHandler() {
            @Override
        ...
        assetLoader.register(uri, pathHandler);
    ...
    public void testHostAssets() {
        ...
        WebViewAssestLoader.AssetHostingDetails details =
    ...
    public static class TestActivity extends Activity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            mAssetLoader = new WebViewAssestLoader(this);
    ...
    public void integrationTest_testAssetHosting() throws Exception {
        ...
        InstrumentationRegistry.getInstrumentation().runOnMainSync(new Runnable() {
            @Override
            public void run() {
                WebViewAssestLoader.AssetHostingDetails hostingDetails =
        ...
        Assert.assertEquals("WebViewAssestLoaderTest", title.get());
    }
