...
public class WebUriMatcherTest {
    ...
    public void testFullHttpUriMatching() {
        ...
        Assert.assertEquals("Failed to match http path with #id", pathMatch,
                    matcher.match(Uri.parse("http://androidplatform.net/some/path#asd")));
        ...
        Assert.assertNull("Matched https path",
                    matcher.match(Uri.parse("https://androidplatform.net/some/path")));
        Assert.assertNull("Mathced http path without a separating slash",
                    matcher.match(Uri.parse("http://androidplatform.net/somepath")));
        Assert.assertNull("Matched http .../some/path with .../some/paththing",
                    matcher.match(Uri.parse("http://androidplatform.net/some/paththing")));
        Assert.assertNull("Mathced http with an empty path",
                    matcher.match(Uri.parse("http://androidplatform.net/")));
        Assert.assertNull("Mathced http with a different prefix",
    ...
    public void testFullHttpsUriMatching() {
        ...
        Assert.assertEquals("Failed to match https path with #id", pathMatch,
                    matcher.match(Uri.parse("https://androidplatform.net/some/path#asd")));
        ...
        Assert.assertNull("Matched http path",
                    matcher.match(Uri.parse("http://androidplatform.net/some/path")));
        Assert.assertNull("Mathced https path without a separating slash",
                    matcher.match(Uri.parse("https://androidplatform.net/somepath")));
        Assert.assertNull("Matched https .../some/path with .../some/paththing",
                    matcher.match(Uri.parse("https://androidplatform.net/some/paththing")));
        Assert.assertNull("Mathced https with an empty path",
                    matcher.match(Uri.parse("https://androidplatform.net/")));
        Assert.assertNull("Mathced https with a different prefix",
    ...
    public void testManyUriMatchers() {
        ...
        Assert.assertNull("Matched a non registered path prefix .../some/path_1",
