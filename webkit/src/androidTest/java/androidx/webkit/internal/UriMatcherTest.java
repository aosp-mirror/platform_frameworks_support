...
public class UriMatcherTest {
    private final Object mNullObject = new Object();

    @Test
    @SmallTest
    public void testFullHttpUrlMatching() {
        Object pathMatch = new Object();
        UriMatcher<Object> matcher = new UriMatcher<>(nullObject);
        ...
        Assert.assertEquals(nullObject, matcher.match(Uri.parse("http:")));
        Assert.assertEquals(nullObject, matcher.match(Uri.parse("https:")));
    }
