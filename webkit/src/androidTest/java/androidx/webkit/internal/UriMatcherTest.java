...
public class UriMatcherTest {
    ...
    public void testFullHttpUrlMatching() {
        ...
        final Object rootMatch = new Object();
        UriMatcher<Object> matcher = new UriMatcher<>(rootMatch);
        ...
        Assert.assertEquals(rootMatch, matcher.match(Uri.parse("http:")));
        Assert.assertEquals(rootMatch, matcher.match(Uri.parse("https:")));
    }
