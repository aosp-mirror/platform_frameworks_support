...
public class HttpUriMatcherTest {
    ...
    public void testFullHttpUrlMatching() {
        ...
        HttpUriMatcher<Object> matcher = new HttpUriMatcher<>();
        ...
        Assert.assertNull(matcher.match(Uri.parse("http:")));
        Assert.assertNull(matcher.match(Uri.parse("https:")));
    }
