...
public final class WebkitUtils {
    ...
    /**
     * Converts a {@link Throwable} to a {@link RuntimeException}. This can be used to convert a
     * checked exception to an unchecked exception, for the case when it doesn't make sense for the
     * caller to try to handle this exception.
     *
     * <p>Does nothing if {@code t} is already a {@link RuntimeException}.
     *
