...
public class TracingControllerCompatTest {
    private TracingControllerCompat mTracingController;
    ...
    public void setUp() {
        ...
        mTracingController = TracingControllerCompat.getInstance();
    ...
    public void testTracingControllerCallbacksOnUI() throws Throwable {
        ...
        runTracingTestWithCallbacksOnUI(tracingReceiver, mSingleThreadExecutor);
    ...
    public void testIsSingleton() {
        Assert.assertSame(TracingControllerCompat.getInstance(),
                TracingControllerCompat.getInstance());
    }

    private void testInvalidCategoriesPattern(List<String> categories) {
        try {
            mTracingController.start(TracingConfig.CATEGORIES_NONE, categories,
    ...
    private void runTracingTestWithCallbacks(TracingReceiver tracingReceiver, Executor executor) {
        ...
        Assert.assertFalse(mTracingController.isTracing());
        mTracingController.start(TracingConfig.CATEGORIES_WEB_DEVELOPER,
                new ArrayList<String>(), TracingConfig.RECORD_CONTINUOUSLY);
        Assert.assertTrue(mTracingController.isTracing());
    ...
    @UiThread
    private void runTracingTestWithCallbacksOnUI(TracingReceiver tracingReceiver,
            Executor executor) {
        runTracingTestWithCallbacks(tracingReceiver, executor);
    }
