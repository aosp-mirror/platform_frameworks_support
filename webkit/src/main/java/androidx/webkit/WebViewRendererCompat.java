...
/**
 * WebViewRendererCompat provides an opaque handle to a WebView renderer.
 */
public abstract class WebViewRendererCompat {
    /**
     * Cause this renderer to terminate.
     *
     * <p>Calling this on an already terminated renderer will have no effect.
     *
     ...
     *
     * @return {@code true} if it was possible to terminate this renderer.
     *         If the renderer has already terminated, or has not yet been started, then {@code
     *         false} is returned.
     */
