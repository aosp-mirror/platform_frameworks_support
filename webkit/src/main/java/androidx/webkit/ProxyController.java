...
public class ProxyController {
    ...
    public static class ProxyRules {
        ...
        /**
         * ProxyRules builder. Use {@link ProxyRulesBuilder#addProxyRule(String)} or
         * {@link ProxyRulesBuilder#addProxyRule(String, String)} to add proxy rules. Note that if
         * you don't add any proxy rules, all connections will be made directly. Use
         * {@link ProxyRulesBuilder#addBypassRule(String)} to add bypass rules. Use
         * {@link ProxyRulesBuilder#build()} to build this into a {@link ProxyRules} object.
         */
        public static class ProxyRulesBuilder {
             ...
             */
            public ProxyRulesBuilder addProxyRule(@NonNull String proxyUrl) {
                return addProxyRuleInternal(proxyUrl, "");
            }

            /**
             * This does everything that {@link ProxyRulesBuilder#addProxyRule(String)} does,
             * but only applies to URLs using {@code schemeFilter}. Scheme filter must be one of
             * {@link ProxyController#HTTP} or {@link ProxyController#HTTPS}.
             *
             * @param proxyUrl Proxy URL
            ...
            public ProxyRulesBuilder addProxyRule(@NonNull String proxyUrl,
                ...
                return addProxyRuleInternal(proxyUrl, schemeFilter);
            }

            /*package*/ ProxyRulesBuilder addProxyRuleInternal(String proxyUrl,
                    String schemeFilter) {
                if (proxyUrl == null) {
