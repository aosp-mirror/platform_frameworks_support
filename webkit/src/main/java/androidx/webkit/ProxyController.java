...
public abstract class ProxyController {
     ...
     * in the same thread this method was called from.
     *
     * @param listener Optional listener called when the proxy setting change has been applied
     */
    ...
    private static ProxyControllerBoundaryInterface getProxyController() {
        return WebViewGlueCommunicator.getFactory().getProxyController();
    }
}
