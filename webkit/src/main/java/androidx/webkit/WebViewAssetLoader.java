...
/**
 * Helper class to enable accessing application's static assets and resources under an http(s)://
 * URL to be used within {@link android.webkit.WebView} class.
 ...
 * refer to {@link https://developer.android.com/guide/topics/resources/providing-resources}.
 *
 * <p class='note'>
...
public class WebViewAssetLoader {
     ...
     * {@code "http://<domain>/<prefix-path>/"}, if the default values are used then it will be:
