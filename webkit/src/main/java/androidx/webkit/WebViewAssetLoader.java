...
public final class WebViewAssetLoader {
    ...
    public abstract static class PathHandler {
         ...
         * @return {@link WebResourceResponse} for the requested URLor {@code null} if can't handle
         *                                     this url.
         */
        @Nullable
    ...
    public static final class AssetsPathHandler extends PathHandler {
         ...
         *
         * @param url the URL to be handled.
         * @return {@link WebResourceResponse} for the requested file, the {@link InputStream} will
         *                                     be null if file is not found.
         */
        @Override
        @Nullable
