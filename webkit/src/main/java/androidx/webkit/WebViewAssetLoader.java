...
public class WebViewAssetLoader {
     ...
     * Will use a default domain on the form of: apkassets.androidplatform.net
     ...
     * <code>http(s)://apkassets.androidplatform.net/res/{resource_type}/{resource_name}</code>.
     */
    @NonNull
    ...
    @NonNull
    private static Uri createUriPrefix(String domain, String virtualPath) {
