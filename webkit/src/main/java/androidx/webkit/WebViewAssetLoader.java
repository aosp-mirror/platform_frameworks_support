...
public class WebViewAssetLoader {
    ...
    public static class AssetsPathHandler extends PathHandler {
    ...
    public static class ResourcesPathHandler extends PathHandler {
        private AssetHelper mAssetHelper;
    ...
    public static final class Builder {
         ...
         */
        @NonNull
        public Builder onDomain(@NonNull String domain, boolean allowHttp) {
            mDomain = domain;
     ...
     */
    @Nullable
    public WebResourceResponse shouldInterceptRequestImpl(@NonNull Uri url) {
