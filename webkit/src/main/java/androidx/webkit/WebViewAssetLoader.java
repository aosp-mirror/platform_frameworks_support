...
public class WebViewAssetLoader {
     ...
     *
     * <p class='note'>
     * HTTPS is always enabled. Consider setting {@code enableHttp} to {@code false} if it isn't
     * needed and accessing your resources over HTTPS for security.
     * <p>
     ...
     * {@code appassets.androidplatform.net} should be used instead.
     * HTTPS is always enabled as well. Consider setting {@code enableHttp} to {@code false} if it
     * isn't needed and accessing your resources over HTTPS for security.
     * <p>
     * The virtual assets path should have a leading and trailing slash
     * (for instance {@code "/assets/www/"}).
     *
     ...
     *
     * <p class='note'>
     * Both HTTP and HTTPS is enabled.
     */
    @NonNull
