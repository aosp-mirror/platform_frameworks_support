...
public class WebViewAssetLoader {
    ...
    public static final class Builder {
        ...
        /**
         * using the HTTP scheme in addition to HTTPS.
        ...
        @VisibleForTesting
        @NonNull
        /*package*/ WebViewAssetLoader buildForTest(final @NonNull AssetHelper assetHelper) {
            PathHandler assetHandler = new AssetsPathHandler(mAssetsUri.getAuthority(),
                                                mAssetsUri.getPath(), mAllowHttp, assetHelper);
        ...
        @VisibleForTesting
        @NonNull
        /*package*/ WebViewAssetLoader buildForTest(@NonNull final PathHandler assetHandler,
