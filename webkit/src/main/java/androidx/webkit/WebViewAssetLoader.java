...
public class WebViewAssetLoader {
    ...
    public static final class Builder {
         ...
         *
         * @param subdirectory internal storage subdirectory to be exposed under this directory.
        ...
        public Builder setInternalStorageHostingPath(@NonNull String subdirectory,
            ...
            if (subdirectory.isEmpty() || subdirectory.charAt(0) != '/') {
                throw new IllegalArgumentException(
                        "subdirectory should start with a slash '/'.");
            }
            if (!subdirectory.endsWith("/")) {
                throw new IllegalArgumentException(
                        "subdirectory should end with a slash '/'.");
            }
