...
public class WebViewAssetLoader {
    ...
    /*package*/ abstract static class PathHandler {
         ...
         * @param httpsEnabled whether to enable hosting using the https scheme.
         */
        PathHandler(@NonNull final String authority, @NonNull final String path,
                                boolean httpEnabled, boolean httpsEnabled) {
            this.mMimeType = null;
            this.mEncoding = null;
            this.mAuthority = authority;
            this.mPath = path;
            this.mHttpEnabled = httpEnabled;
            this.mHttpsEnabled = httpsEnabled;
        }
        ...
        /**
         * Match happens when:
         *      - URI's scheme is "http" and http is enabled or scheme is
         *        "https" and https is enabled.
        ...
        public boolean match(@NonNull Uri uri) {
            if (!(mHttpEnabled && uri.getScheme().equals(HTTP_SCHEME))
                    && !(mHttpsEnabled && uri.getScheme().equals(HTTPS_SCHEME))) {
                return false;
            }
    ...
    public AssetHostingDetails hostAssets(@NonNull String assetPath) {
        return hostAssets(KNOWN_UNUSED_AUTHORITY, assetPath, "/assets", true, true);
    }
    ...
    public AssetHostingDetails hostAssets(@NonNull final String assetPath,
                                        ...
                                        boolean enableHttps) {
        return hostAssets(KNOWN_UNUSED_AUTHORITY, assetPath, virtualAssetPath, enableHttp,
                enableHttps);
    }
    ...
    public AssetHostingDetails hostResources() {
        return hostResources(KNOWN_UNUSED_AUTHORITY, "/res", true, true);
    }
    ...
    public AssetHostingDetails hostResources(@NonNull final String virtualResourcesPath,
                                             boolean enableHttp, boolean enableHttps) {
        return hostResources(KNOWN_UNUSED_AUTHORITY, virtualResourcesPath, enableHttp, enableHttps);
    }
