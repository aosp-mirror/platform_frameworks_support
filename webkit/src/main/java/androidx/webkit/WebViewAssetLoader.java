...
public class WebViewAssetLoader {
    ...
    /*package*/ abstract static class PathHandler {
        ...
        @Nullable String mEncoding;
        @Nullable String mCharset;
        @Nullable int mStatusCode;
        @Nullable String mReasonPhrase;
        @Nullable Map<String, String> mResponseHeaders;
    ...
    public WebResourceResponse shouldInterceptRequest(WebResourceRequest request) {
        ...
        synchronized (mUriMatcher) {
            handler = mUriMatcher.match(request.getUrl());
        }
        if (handler == null) {
            return null;
        }
    ...
    public AssetHostingDetails hostAssets(@NonNull final String domain,
        ...
        PathHandler handler = new PathHandler() {
            ...
            public InputStream handle(Uri url) {
                ...
                this.mMimeType = URLConnection.guessContentTypeFromName(assetUri.getPath());
                if (stream == null) {
                    this.mStatusCode = 404;
                    this.mReasonPhrase = "Not Found";
                } else {
    ...
    public AssetHostingDetails hostResources(@NonNull final String domain,
        ...
        PathHandler handler = new PathHandler() {
            ...
            public InputStream handle(Uri url) {
                ...
                this.mMimeType = URLConnection.guessContentTypeFromName(resourceUri.getPath());
                if (stream == null) {
                    this.mStatusCode = 404;
                    this.mReasonPhrase = "Not Found";
                } else {
