...
public class WebViewAssetLoader {
    ...
    private abstract static class LazyInputStream extends InputStream {
        ...
        LazyInputStream(PathHandler handler) {
    ...
    private static class LegacyLazyInputStream extends LazyInputStream {
        ...
        LegacyLazyInputStream(PathHandler handler, Uri uri) {
            super(handler);
            this.mUri = uri;
        }
    ...
    private static class LollipopLazyInputStream extends LazyInputStream {
        ...
        LollipopLazyInputStream(PathHandler handler, WebResourceRequest request) {
            super(handler);
        ...
        @Override
        protected InputStream handle() {
            return mHandler.handle(mRequest);
        }
    }
}
