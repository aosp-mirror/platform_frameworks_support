 ...
 * {@code android.platform.net}. This domain will be used by default unless the user specified
 * a different domain. A subdomain {@code appassets} is used to even make sure no such collisons
 * would happen.
 *
 * <p>
 * <b>A typical usage would be like:</b>
...
public class WebViewAssetLoader {
    ...
    /*package*/ abstract static class PathHandler {
         ...
         * Match happens when:
         * <ul>
         *      <li>Scheme is "https" OR the scheme is "http" and http is enabled.</li>
     ...
     * {@link WebResourceResponse} with a {@code null} stream will be returned. If the URL doesn't
     * match any registered URL, it returns {@code null} and fails back to network.
     * <p>
     * This method should be invoked from within
     * {@link android.webkit.WebViewClient#shouldInterceptRequest(android.webkit.WebView, android.webkit.WebResourceRequest)}.
     *
     * @param request the {@link WebResourceRequest} to process.
     * @return {@link WebResourceResponse} if the request URL had a matching registered url,
     *         {@code null} otherwise.
     */
    @RequiresApi(21)
    @Nullable
     ...
     * @return a response if the request URL had a matching registered url, {@code null} otherwise.
     */
    @Nullable
