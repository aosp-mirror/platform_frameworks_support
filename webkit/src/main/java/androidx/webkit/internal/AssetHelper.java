...
public class AssetHelper {
    ...
    public static final class FileNotInMountedDirectoryException extends Exception {
        public FileNotInMountedDirectoryException(String msg) {
            super(msg);
        }
    }
     ...
     * @param uri The file to be loaded.
    ...
    public static InputStream openFile(@NonNull File directory, @NonNull String suffixPath)
            throws FileNotInMountedDirectoryException {
        try {
            File file = new File(directory, suffixPath);
            if (!isCanonicalChildOf(directory, file)) {
                throw new FileNotInMountedDirectoryException("the requested file: " + file.getPath()
                        + "isn't a child of the mounted data directory: "
            ...
            Log.e(TAG, "error opening the requested file " + suffixPath);
            return null;
        }
    }
