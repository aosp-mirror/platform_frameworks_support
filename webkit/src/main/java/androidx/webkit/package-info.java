 ...
 *
 * <p>Inside your app's build.gradle file, include these lines in dependencies:
 * <pre>dependencies {
 *   ...
 ...
 *
 * <p>Old code:
 * <pre>if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O_MR1) {
 *   WebView.startSafeBrowsing(appContext, callback);
 * }</pre>
 *
 * <p>New code:
 * <pre>if (WebViewFeature.isFeatureSupported(WebViewFeature.START_SAFE_BROWSING)) {
 ...
 *
 * <p>New code:
 * <pre>if (WebViewFeature.isFeatureSupported(WebViewFeature.VISUAL_STATE_CALLBACK)) {
