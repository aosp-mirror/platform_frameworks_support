...
public class ProxyConfig {
     ...
     * <p>
     * <strong>Note</strong> that if you don't add any proxy rules, all connections will be made
    ...
    public static class Builder {
         ...
         * {@code [scheme://]host[:port]}. Scheme is optional, must be one of {@code HTTP} or
         * {@code HTTPS} and defaults to {@code HTTP}; host is one of an IPv6 literal with brackets,
         * an IPv4 literal or one or more labels separated by a period; port number is optional and
         * defaults to {@code 80} for {@code HTTP}, {@code 443} for {@code HTTPS} and {@code 1080}
         * for <a href="https://tools.ietf.org/html/rfc1928">SOCKS</a>.
         * <p>
