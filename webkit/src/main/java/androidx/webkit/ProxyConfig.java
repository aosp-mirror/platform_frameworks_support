...
public class ProxyConfig {
    ...
    public static class Builder {
         ...
         */
        @NonNull
        public Builder bypassLocalNetworkRequests() {
            return addBypassRule(BYPASS_RULE_LOCAL);
        }

        /**
         * Localhost and local addresses will no longer be bypassed and instead use these proxy
         * settings.
         */
        @NonNull
        public Builder proxyLoopbackRequests() {
