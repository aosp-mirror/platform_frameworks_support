...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent,
    ...
    private static final int[] FILL_VIEWPORT_ATTRS = {android.R.attr.fillViewport};
    ...
    public NestedScrollView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        a = context.obtainStyledAttributes(attrs, CLIP_TO_PADDING_ATTRS, defStyleAttr, 0);
        setClipToPadding(a.getBoolean(0, true));
        a.recycle();

        a = context.obtainStyledAttributes(attrs, FILL_VIEWPORT_ATTRS, defStyleAttr, 0);
