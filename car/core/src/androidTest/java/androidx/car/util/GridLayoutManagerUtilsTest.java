...
public final class GridLayoutManagerUtilsTest {
    ...
    public void testGetLastViewOnSameRow_singleItem() {
        ...
        assertTrue(first == GridLayoutManagerUtils.getLastViewOnSameRow(first, recyclerView));
    }
    ...
    public void testGetLastViewOnSameRow() {
        ...
        for (int i = 0; i < SPAN_COUNT; i++) {
            ...
            assertTrue(last == GridLayoutManagerUtils.getLastViewOnSameRow(current, recyclerView));
        }
    }
