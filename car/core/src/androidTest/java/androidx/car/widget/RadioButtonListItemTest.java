...
public class RadioButtonListItemTest {
    ...
    @Test
    public void testSetPrimaryActionIcon_textStartMarginForEmptyIcon() {
        RadioButtonListItem item = new RadioButtonListItem(mActivity);
    ...
    @Test
    public void testSetPrimaryActionIcon_textStartMarginForNoIcon() {
        RadioButtonListItem item = new RadioButtonListItem(mActivity);
    ...
    @Test
    public void testSetPrimaryActionIcon_textStartMarginForSmallIcon() {
        RadioButtonListItem item = new RadioButtonListItem(mActivity);
    ...
    @Test
    public void testSetPrimaryActionIcon_textStartMarginForMediumIcon() {
        RadioButtonListItem item = new RadioButtonListItem(mActivity);
        item.setPrimaryActionIcon(android.R.drawable.sym_def_app_icon,
    ...
    @Test
    public void testSetPrimaryActionIcon_textStartMarginForLargeIcon() {
        RadioButtonListItem item = new RadioButtonListItem(mActivity);
        item.setPrimaryActionIcon(android.R.drawable.sym_def_app_icon,
    ...
    @Test
    public void testSetShowDivider_noDivider() {
