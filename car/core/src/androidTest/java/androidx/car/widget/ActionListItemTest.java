...
public class ActionListItemTest {
    ...
    public void testItemWithOnlyTitleIsSingleLine() {
        ...
        double singleLineHeight = ApplicationProvider.getApplicationContext().getResources().getDimension(
    ...
    public void testSmallAndMediumPrimaryIconStartMargin() {
        ...
        int expected = ApplicationProvider.getApplicationContext().getResources().getDimensionPixelSize(
    ...
    public void testSmallPrimaryIconTopMarginRemainsTheSameRegardlessOfTextLength() {
        final String longText = ApplicationProvider.getApplicationContext().getResources().getString(
                R.string.over_uxr_text_length_limit);
