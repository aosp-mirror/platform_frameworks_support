...
public class CarToolbarTest {
     ...
     *
     * @param horizontalMargins The sum of horizontal margins value to match to.
     * @return A {@link Matcher} for verification.
     */
    @NonNull
    public static Matcher<View> withHorizontalMargins(int horizontalMargins) {
        return new TypeSafeMatcher<View>() {
            @Override
            public boolean matchesSafely(View view) {
                ViewGroup.MarginLayoutParams params =
                        (ViewGroup.MarginLayoutParams) view.getLayoutParams();
                return horizontalMargins == params.leftMargin + params.rightMargin;
            }

            @Override
            public void describeTo(Description description) {
                description.appendText("has horizontal margins: " + horizontalMargins);
            }
        };
    }
}
