...
public class CarToolbarTest {
    ...
    @Test
    public void testConstructor_doNotThrowError() {
    ...
    public void testMinimumHeight_fixedHeight() throws Throwable {
        ...
        assertThat(mToolbar.getHeight(), is(equalTo(minHeight)));
    }
    ...
    @Test
    public void testSetTitleTextAppearance_doNotThrowError() throws Throwable {
    ...
    @Test
    public void testSetNavigationIcon_doNotThrowError() throws Throwable {
