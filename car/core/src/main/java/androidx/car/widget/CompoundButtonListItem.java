...
public abstract class CompoundButtonListItem<VH extends CompoundButtonListItem.ViewHolder> extends
    ...
    public CompoundButtonListItem(@NonNull Context context) {
        ...
        mForegroundDrawable = res.getDrawable(R.drawable.car_card_ripple_background, null);
        markDirty();
    }
     ...
     */
    @Override
    public void onBind(VH viewHolder) {
    ...
    /**
     * Sets a {@link Drawable} to be the foreground for the list item view.
     *
    ...
    /**
     * Sets the state of {@code CompoundButton}.
     *
     ...
     * value is used by {@link #setTextStartMargin()} to determine start margins for the
    ...
    private void setForeground() {
        mBinders.add(vh -> vh.getContainerLayout().setForeground(mForegroundDrawable));
    }
