...
public class CarTabBarView extends ViewGroup {
    ...
    private static final int POSITION_TAG = R.id.car_tab_position;
    ...
    /**
     * Returns the position of the tab that is currently selected. This value will not necessarily
     * match the value passed to {@link #setSelectedTab(int)}. It will always match the
     * last-selected tab, as determined by user interaction.
     *
