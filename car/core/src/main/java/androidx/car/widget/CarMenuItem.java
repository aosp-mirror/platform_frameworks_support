...
public class CarMenuItem {
     ...
     *
     * <p>Items are unchecked by default, this has no effect if isCheckable is {@code false}.
     *
    ...
    public static final class Builder {
         ...
         *
         * <p>Passing an invalid resource Id (i.e. 0 or less) will throw an exception.
         *
        ...
        public Builder setStyle(@StyleRes int styleResId) {
            if (styleResId < 1) {
                throw new IllegalArgumentException("Invalid style resource Id");
            }
