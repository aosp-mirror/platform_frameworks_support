 ...
 * </ul>
 *
 * {@code RadioButtonListItem} binds data to {@link ViewHolder} based on components selected.
 *
...
public class RadioButtonListItem extends ListItem<RadioButtonListItem.ViewHolder> {
     ...
     */
    public void setPrimaryActionIcon(@DrawableRes int iconResId, int size) {
    ...
    protected void resolveDirtyState() {
        ...
        mBinders.add(vh -> {
            vh.getContainerLayout().setOnClickListener(mOnClickListener);
        });
    }
    ...
    private void setRadioButton() {
        mBinders.add(vh -> {
            ...
            vh.getRadioButton().setChecked(mChecked);
            vh.getRadioButton().setOnCheckedChangeListener(mRadioButtonOnCheckedChangeListener);
    ...
    private void setPrimaryIconLayout() {
        ...
        mBinders.add(vh -> {
            ...
            // Icon is always vertically centered since we retrict text to one line.
