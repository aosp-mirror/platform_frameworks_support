...
public class PagedListView extends FrameLayout {
     ...
     *
     * <p>When set to {@code true}, the scroll bar will only be visible if the number of items
     ...
     *
     * <p>If {@code true}, the scroll bar will only be visible if the number of items requires
