...
public final class ActionListItem extends ListItem<ActionListItem.ViewHolder> {
     ...
     */
    public void setActions(@NonNull String action1Text, boolean showAction1Divider,
            @NonNull View.OnClickListener action1OnClickListener,
            @NonNull String action2Text, boolean showAction2Divider,
            @NonNull View.OnClickListener action2OnClickListener) {
