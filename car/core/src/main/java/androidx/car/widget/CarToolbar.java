...
public class CarToolbar extends ViewGroup {
     ...
     *
     * @deprecated Use {@link #setOverflowMenuShown(boolean)} with argument {@code true} to show
     * overflow menu.
     */
    @Deprecated
    public void showOverflowMenu() {
        setOverflowMenuShown(true);
    }

    /**
     * Hides the overflow menu.
     *
     * @deprecated Use {@link #setOverflowMenuShown(boolean)} with argument {@code false} to hide
     * overflow menu.
     */
    @Deprecated
    public void hideOverflowMenu() {
        setOverflowMenuShown(false);
    }
