...
public class CarToolbar extends ViewGroup {
    ...
    public CarToolbar(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        try {
            ...
            setLogoSize(a.getResourceId(R.styleable.CarToolbar_logoSize,
                    R.dimen.car_application_icon_size));
    ...
    /**
     * Set a new dimension size for the logo.
     *
     * @param resId Resource Id for the logo dimension size.
     *
     * @attr ref R.styleable#CarToolbar_logoSize
     */
    public void setLogoSize(@DimenRes int resId) {
        mLogoSize = getContext().getResources().getDimensionPixelSize(resId);
        requestLayout();
    }
