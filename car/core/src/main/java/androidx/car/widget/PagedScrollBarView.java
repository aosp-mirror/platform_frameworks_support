...
public class PagedScrollBarView extends ViewGroup {
    ...
    public interface PaginationListener {
         ...
         *
         * <p>AlphaJump buckets only support characters from the en language. Characters from other
         * languages will not be recognized and bucketed. AlphaJump overlay is still displayed if
