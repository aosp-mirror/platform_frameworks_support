...
public class GridLayoutManagerUtils {
    ...
    public static boolean isOnLastRow(View view, RecyclerView parent) {
        ...
        int lastChildIndex = parent.getAdapter().getItemCount() - 1;
        int currentChildIndex = parent.getChildAdapterPosition(view);
        ...
        int spanSum = getSpanIndex(view) + spanSizeLookup.getSpanSize(currentChildIndex);
        ...
        while (spanSum < spanCount) {
            ...
            spanSum += spanSizeLookup.getSpanSize(currentChildIndex);
        }
