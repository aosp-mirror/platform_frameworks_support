...
public class ListItemAdapter extends
    ...
    /**
     * Defaults {@link ListBackgroundStyle} to {@code BACKGROUND_STYLE_NONE}.
     */
     ...
     * }</pre>
     *
     * <p>The function will receive a view as {@link ListItem.ViewHolder#itemView}. This view
     * uses a background defined by {@link ListBackgroundStyle}.
     *
