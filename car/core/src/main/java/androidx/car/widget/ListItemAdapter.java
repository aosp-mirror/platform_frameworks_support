...
public class ListItemAdapter extends
    ...
    static final int LIST_ITEM_TYPE_ACTION_BUTTONS = 4;
    ...
    public ListItemAdapter(Context context, ListItemProvider itemProvider,
        ...
        registerListItemViewTypeInternal(LIST_ITEM_TYPE_ACTION_BUTTONS,
                R.layout.car_list_item_action_content, ActionButtonListItem::createViewHolder);
