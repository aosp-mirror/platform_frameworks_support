...
public class ListItemAdapter extends
    ...
    public static final class BackgroundStyle {
         ...
         *
         * @deprecated Use Use {@link #BACKGROUND_STYLE_SOLID} instead.
         */
        @Deprecated
         ...
         *
         * @deprecated Use Use {@link #BACKGROUND_STYLE_NONE} instead.
         */
        @Deprecated
         ...
         *
         * @deprecated Use Use {@link #BACKGROUND_STYLE_CARD} instead.
         */
        @Deprecated
         ...
         *
         * @deprecated Use Use {@link #BACKGROUND_STYLE_PANEL} instead.
         */
        @Deprecated
