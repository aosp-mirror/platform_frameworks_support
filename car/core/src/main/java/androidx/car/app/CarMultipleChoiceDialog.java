...
public final class CarMultipleChoiceDialog extends Dialog {
    private static final String TAG = "CarMultipleChoiceDialog";
    ...
    CarMultipleChoiceDialog(Context context, Builder builder) {
        ...
        mCheckedItems = builder.mCheckedItems;
    ...
    private CheckBoxListItem createItem(Item selectionItem, int position) {
        ...
        item.addViewBinder(vh -> {
            vh.getCompoundButton().setChecked(mCheckedItems[position]);
    ...
    public interface OnMultiChoiceClickListener {
         ...
         */
        void onClick(DialogInterface dialog, boolean[] checkedItems);
    }
    ...
    public static final class Builder {
         ...
         *                     no items are checked. If non null it must be exactly the same length
         *                     as list of items.
         * @return This {@code Builder} object to allow for chaining of calls.
         */
        @NonNull
        public Builder setItems(@NonNull List<Item> items, @Nullable boolean[] checkedItems) {
            if (items.size() == 0) {
                throw new IllegalArgumentException("Provided list of items cannot be empty.");
            }

            if (checkedItems != null && checkedItems.length != items.size()) {
                throw new IllegalArgumentException(
                        "Checked items array length does not match length of list of items.");
            }

            mItems = items;
            mCheckedItems = checkedItems != null ? checkedItems : new boolean[items.size()];
            return this;
        }
         ...
         *
         * <p>If {@link #setItems(List, boolean[])} is never called, then calling this method
         * will throw
         * an exception.
         *
        ...
        public Dialog create() {
            ...
            if (mItems == null || mItems.size() == 0) {
                throw new IllegalStateException(
                        "CarMultipleChoiceDialog cannot be created with a non-empty list.");
            }
