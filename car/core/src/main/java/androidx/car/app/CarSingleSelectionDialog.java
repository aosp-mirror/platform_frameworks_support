...
public class CarSingleSelectionDialog extends Dialog {
    ...
    @Nullable
    private final OnSelectionConfirmationListener mOnSelectionConfirmationListener;
    ...
    CarSingleSelectionDialog(Context context, Builder builder) {
        ...
        mOnSelectionConfirmationListener = builder.mOnSelectionConfirmationListener;
    ...
    private void initializeButtons() {
        ...
        if (!TextUtils.isEmpty(mPositiveButtonText)) {
            ...
            positiveButtonView.setOnClickListener(v -> {
                if (mOnSelectionConfirmationListener != null) {
                    mOnSelectionConfirmationListener.onSelectionConfirmation(mSelectedItem);
                }
                dismiss();
            });
        } else {
    ...
    public interface OnSelectionConfirmationListener {
        /**
    ...
    public static final class Builder {
        ...
        int mSelectedItem;
        OnSelectionConfirmationListener mOnSelectionConfirmationListener;
         ...
         * @param onSelectionConfirmationListener The listener that will be notified of a selection.
         * @return This Builder object to allow for chaining of calls to set methods.
         */
        public Builder setPositiveButton(@StringRes int textId,
                @NonNull OnSelectionConfirmationListener onSelectionConfirmationListener) {
            mPositiveButtonText = mContext.getText(textId);
            mOnSelectionConfirmationListener = onSelectionConfirmationListener;
            return this;
        }
        ...
        public CarSingleSelectionDialog create() {
            ...
            if (mPositiveButtonText == null) {
                throw new IllegalStateException(
                        "CarSingleSelectionDialog cannot be created without a positive button.");
            }
