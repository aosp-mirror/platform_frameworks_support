 ...
 */
public final class CarSingleSelectionDialog extends Dialog {
     ...
     */
    private void initializeWithItems(List<SelectionItem> items) {
     ...
     *
     * @param {@link SelectionItem} to display as a {@code RadioButtonListItem}.
     * @param position The position of the item in the list.
     */
    private RadioButtonListItem createItem(SelectionItem selectionItem, int position) {
    ...
    public static class SelectionItem {
        ...
        /**
         * Creates a SelectionItem.
         *
         * @param title The title of the item. This value must be non-empty.
         */
        public SelectionItem(@NonNull CharSequence title) {
         ...
         */
        public SelectionItem(@NonNull CharSequence title, @Nullable CharSequence body) {
    ...
    public static final class Builder {
         ...
         */
        @NonNull
        public Builder setItems(@NonNull List<SelectionItem> items,
        ...
        public CarSingleSelectionDialog create() {
            ...
            if (mSelectedItem < 0 || mSelectedItem >= mItems.size()) {
                throw new IllegalStateException(
                        "CarSingleSelectionDialog cannot be created with an invalid initial "
                                + "selected item.");
            }
