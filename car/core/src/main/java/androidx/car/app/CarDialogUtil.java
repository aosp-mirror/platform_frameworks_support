...
class CarDialogUtil {
     ...
     */
    static void setUpDialogList(@NonNull Dialog dialog, @NonNull PagedListView mList,
            @NonNull PagedScrollBarView mScrollBarView) {
        mList.getRecyclerView().addOnScrollListener(new RecyclerView.OnScrollListener() {
            @Override
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                super.onScrolled(recyclerView, dx, dy);
                updateDialogListScrollbar(dialog, mList, mScrollBarView);
            }
        });

        setUpDialogListPagination(mList, mScrollBarView);
    ...
    private static void setUpDialogListPagination(@NonNull PagedListView mList,
            @NonNull PagedScrollBarView mScrollBarView) {
     ...
     */
    private static void updateDialogListScrollbar(@NonNull Dialog dialog,
            @NonNull PagedListView mList, @NonNull PagedScrollBarView mScrollBarView) {
