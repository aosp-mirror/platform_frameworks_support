 ...
 * title, body text, a fixed list of items and and up to three buttons -- a positive, neutral and
 * negative button.
 *
...
public class CarSelectionDialog extends Dialog {
    ...
    CarSelectionDialog(Context context, Builder builder) {
        ...
        mCheckedItem = builder.mCheckedItem;
    ...
    public static final class Builder {
         ...
         * @param checkedItem     Specifies which item is checked. If -1 no
         *                        items are checked.
         * @param onClickListener The listener that will be notified of a click.
         * @return This {@code Builder} object to allow for chaining of calls.
         */
        @NonNull
        public Builder setSingleChoiceItems(@NonNull DialogSelectionItem[] items, int checkedItem,
         ...
         *
         * <p>If
         * {@link #setSingleChoiceItems(DialogSelectionItem[], int,
