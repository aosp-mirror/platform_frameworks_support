 ...
 * title, body text, a fixed list of items and up to three buttons -- a positive and negative
 * button.
 *
...
public class CarSelectionDialog extends Dialog {
    ...
    /** Used to listen for {@link CarSelectionDialog} selection events. */
    ...
    public static final class Builder {
         ...
         */
        @NonNull
        public Builder setItems(@NonNull DialogSelectionItem[] items, int selectedItem,
         ...
         *
         * <p>If
         * {@link #setItems(DialogSelectionItem[], int, OnSelectionListener)} is never called,
