...
public final class Lane implements VersionedParcelable {
     ...
     * Creates a new lane.
     *
     * @param highlightedDirection Direction the driver could take on this lane in order to stay in
     *                             the navigation route, or null if the driver shouldn't be using
     *                             this lane.
     */
    public Lane(@Nullable LaneDirection highlightedDirection) {
     ...
     * @see #getDirections()
     */
    public Lane addDirection(@NonNull LaneDirection direction) {
