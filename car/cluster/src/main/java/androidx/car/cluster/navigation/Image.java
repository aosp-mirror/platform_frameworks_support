 ...
 * <ul>
 * <li><b>Sizing:</b> All images will have default dimension which define their aspect ratio.
 ...
 * They can optionally also resize it to exactly match the size constraints. Consumers should not
 * assume that the received image will match the requested size. Instead, they should assume that
 * the image might require additional sizing.
 * <li><b>Content:</b> Image content must fit exactly in its bounding box, without margins.
 ...
 * <li><b>Color:</b> Images can be either "tintable" or not. A "tintable" image is such that all the
 ...
 * image once downloaded and use this image reference as key.
 * </ul>
 */
@VersionedParcelize
public class Image {
