...
public final class Step implements VersionedParcelable {
     ...
     * executed.
     */
    public Step setManeuver(@NonNull Maneuver maneuver) {
        mManeuver = maneuver;
        return this;
    }
     ...
     */
    public Step setDistance(@NonNull Distance distance) {
        mDistance = distance;
        return this;
    }
     ...
     * be executed, or {@link Distance#NOT_SET} if distance to this step is unknown.
     */
    @Nullable
    ...
    /**
     * Returns the maneuver to be performed on this step, or {@link Maneuver#NOT_SET} if this step
     * doesn't involve a maneuver.
     */
    @Nullable
    public Maneuver getManeuver() {
        return Common.nonNullOrDefault(mManeuver, Maneuver.NOT_SET);
    }
    ...
    /**
     * Returns a list of cues to help the user navigate this step. As many cues as possible should
     * be displayed, starting from the first item in the list.
     */
    @NonNull
