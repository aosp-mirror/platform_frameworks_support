 ...
 * like bearing, speed and so on.
  */
@VersionedParcelize
public class LatLng implements VersionedParcelable {
    @ParcelField(1)
    double mLatitude;
    @ParcelField(2)
    double mLongitude;
    ...
    /**
     * Constructs a new {@link LatLng} from the given {@link Location}.
     */
    @NonNull
    ...
    /**
     * Builder for creating {@link LatLng}.
     */
    public static final class Builder {
        ...
        /**
         * Returns a {@link LatLng} built with the provided information.
         */
        @NonNull
        public LatLng build() {
