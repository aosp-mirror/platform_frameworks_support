...
public final class ProducerStatus implements VersionedParcelable {
    ...
    public enum Code {
        /**
         * Status is unknown to the consumer. Consumers must assume the status is NOT normal.
         * If available, the description should be shown to the user. Otherwise, a generic
         * representation of this status should be used instead.
         */
        UNKNOWN,
        /**
    ...
    @ParcelField(1)
    EnumWrapper<Code> mCode = EnumWrapper.of(Code.UNKNOWN);
    @ParcelField(2)
    String mDescription = "";
    ...
    /**
     * Code representing the status. In the later case, the consumer should assume the service is in
     * an abnormal state.
     */
    @NonNull
    public Code getCode() {
        return mCode.getValue(Code.UNKNOWN);
    }
