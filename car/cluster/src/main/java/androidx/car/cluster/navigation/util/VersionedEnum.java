...
public class VersionedEnum<T extends Enum<T>> implements VersionedParcelable {
    ...
    @SafeVarargs
    private VersionedEnum(@Nullable T value, @NonNull T ... fallbacks) {
        if (value != null) {
     ...
     */
    @SafeVarargs @NonNull
    public static <T extends Enum<T>> VersionedEnum<T> of(@Nullable T value,
            @NonNull T ... fallbacks) {
     ...
     */
    @SafeVarargs @NonNull
    public static <T extends Enum<T>> VersionedEnum<T> ofNonNull(@NonNull T value,
            @NonNull T ... fallbacks) {
