...
public final class Distance implements VersionedParcelable {
    ...
    int mDisplayE3;
    @ParcelField(3)
    EnumWrapper<Unit> mDisplayUnit = EnumWrapper.of(Unit.UNKNOWN);
     ...
     * unknown. This field would mirror the distance unit displayed by the producer in its own UI.
     */
    public @NonNull Unit getDisplayUnit() {
