...
public final class Distance implements VersionedParcelable {
    /**
     * Value used in case a distance was not set.
     */
    public static Distance NOT_SET = new Distance();
    ...
    public enum Unit {
        /**
         * Display distance was not provided by the producer, or the unit is unknown to the
         * consumer, in which case, the distance shouldn't be displayed.
         */
        NOT_SET,
        METERS,
        KILOMETERS,
     ...
     * would mirror the distance unit displayed by the producer in its own UI.
     */
    @NonNull
    public Unit getDisplayUnit() {
        return EnumWrapper.getValue(mDisplayUnit, Unit.NOT_SET);
    }
