...
public class RichTextElement implements VersionedParcelable {
     ...
     */
    @RestrictTo(LIBRARY_GROUP)
    public RichTextElement(@NonNull String text, @Nullable Image image) {
    ...
    public static class Builder {
        ...
        /**
         * Sets the textual representation of this element. If no other graphic element is provided
         ...
         * @return this object for chaining
         */
        public Builder setImage(@Nullable Image image) {
        ...
        /**
         * Returns a {@link RichTextElement} built with the provided information.
         */
        public RichTextElement build() {
            Preconditions.checkNotNull(mText, "A textual representation of this "
                    + "element must be provided.");
            return new RichTextElement(mText, mImage);
        }
    }
