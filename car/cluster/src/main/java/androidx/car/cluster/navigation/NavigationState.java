...
public final class NavigationState implements VersionedParcelable {
     ...
     */
    public NavigationState setSegment(@NonNull Segment segment) {
    ...
    /**
     * Returns the current segment being driven.
     */
    @NonNull
    public Segment getSegment() {
        return Common.nonNullOrDefault(mSegment, Segment.NOT_SET);
    }
