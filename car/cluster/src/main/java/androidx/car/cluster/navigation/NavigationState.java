...
public final class NavigationState implements VersionedParcelable {
    ...
    @ParcelField(2)
    EnumWrapper<NavigationMode> mMode = EnumWrapper.of();
    @ParcelField(3)
     ...
     */
    public NavigationState(@NonNull ProducerStatus status) {
        mStatus = status;
    }
     ...
     * @see #getSteps()
     */
    public NavigationState addStep(@NonNull Step step) {
     ...
     * @see #getDestinations()
     */
    public NavigationState addDestination(@NonNull Destination destination) {
