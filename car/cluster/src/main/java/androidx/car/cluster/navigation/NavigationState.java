...
public final class NavigationState implements VersionedParcelable {
    ...
    /**
     * Creates a {@link NavigationState} builder
     */
    public static Builder newBuilder() {
        return new NavigationState().new Builder();
    }
     ...
     * many steps in advance will be provided. This list should not be modified.
     */
    @NonNull
     ...
     * furthest. This list should not be modified.
     */
    @NonNull
