...
public final class Destination implements VersionedParcelable {
    /**
     * Value used in case an ETA was not set.
     */
    public static final ZonedDateTime ETA_NOT_SET = ZonedDateTime.ofInstant(
            Instant.ofEpochSecond(0), ZoneId.of("Z"));

    /**
     * Value used in case a location ws not set.
     */
    public static final Location LOCATION_NOT_SET = new Location("");
     ...
     * unknown.
     */
    public Destination setDistance(@NonNull Distance distance) {
        mDistance = distance;
        return this;
    }

    /**
     * Sets the estimated time of arrival to this destination, or ETA_NOT_SET if estimated time of
     * arrival is unknown.
     *
     * @see #getEta()
     */
    public Destination setEta(@NonNull ZonedDateTime eta) {
        mEta = new Time(Preconditions.checkNotNull(eta));
        return this;
    }
    ...
    /**
     * Returns the distance from the current position to this destination, or
     * {@link Distance#NOT_SET} if distance was not provided or is unknown.
     */
    @NonNull
    public Distance getDistance() {
        return Common.nonNullOrDefault(mDistance, Distance.NOT_SET);
    }

    /**
     * Returns the estimated time of arrival to this destination, or {@link #ETA_NOT_SET} was not
     * provided or is unknown.
     */
    @NonNull
    public ZonedDateTime getEta() {
        return Common.nonNullOrDefault(mEta.getTime(), ETA_NOT_SET);
    }

    /**
     * Returns the geo-location of this destination, or {@link #LOCATION_NOT_SET} was not provided
     * or is unknown.
     */
    @NonNull
    public Location getLocation() {
        return Common.nonNullOrDefault(mLocation, LOCATION_NOT_SET);
    }
