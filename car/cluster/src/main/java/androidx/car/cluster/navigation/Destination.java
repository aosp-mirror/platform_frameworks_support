...
public final class Destination implements VersionedParcelable {
    ...
    /**
     * Sets the estimated time of arrival to destination
     *
     * @see #getEta()
     */
    ...
    /**
     * Name of the destination (formatted for the current user's locale), or empty if destination
     * name is unknown.
     */
    @NonNull
    ...
    /**
     * Destination address (formatted for the current user's locale), or empty if there is no
     * address associated with this destination.
     */
    @NonNull
    ...
    /**
     * Distance from the current position to this destination, or null if distance is unknown.
     */
    @Nullable
    ...
    /**
     * Estimated time of arrival to this destination, or null if estimated time of arrival is
     * unknown.
     */
    @Nullable
    public Time getEta() {
    ...
    /**
     * Geo-location of this destination, or null if location is unknown.
     */
    @Nullable
