...
public final class Destination implements VersionedParcelable {
    ...
    /**
     * Level of delay over the estimated time of arrival under usual driving conditions
     */
    public enum Delay {
        /** Delay information is not available */
        DELAY_UNKNOWN,
        /** Much higher delay than usual */
        DELAY_HIGH,
        /** Moderately higher delay than usual */
        DELAY_MEDIUM,
        /** No to little delay over usual */
        DELAY_LOW,
    }
    ...
    public Delay getDelay() {
        return EnumWrapper.getValue(mDelay, Delay.DELAY_UNKNOWN);
    }
