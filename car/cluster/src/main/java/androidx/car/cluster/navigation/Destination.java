...
public final class Destination implements VersionedParcelable {
    ...
    /**
     * Returns the distance from the current position to this destination, or null if distance is
     * unknown.
     */
    @Nullable
    ...
    /**
     * Returns the estimated time of arrival to this destination, or null if estimated time of
     * arrival is unknown.
     */
    @Nullable
    public Time getEta() {
    ...
    /**
     * Returns the geo-location of this destination, or null if location is unknown.
     */
    @Nullable
