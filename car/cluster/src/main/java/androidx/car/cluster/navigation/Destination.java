...
public final class Destination implements VersionedParcelable {
    ...
    public static final class Builder {
        ...
        /**
         * Sets the estimated time of arrival to this destination, as a formatted String
         *
         * @return this object for chaining
         */
        @NonNull
        public Builder setFormattedEta(@NonNull String formattedEta) {
