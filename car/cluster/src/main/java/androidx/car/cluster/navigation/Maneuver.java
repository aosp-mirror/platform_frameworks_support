...
public final class Maneuver implements VersionedParcelable {
    ...
    private Maneuver(@NonNull Type type, @NonNull Type ... fallbackTypes) {
        mType = EnumWrapper.of(type, fallbackTypes);
    }

    /**
     * Creates a {@link Maneuver} builder, based on the provided data.
     *
     ...
     */
    public static Builder newBuilder(@NonNull Type type, @NonNull Type ... fallbackTypes) {
        return new Maneuver(type, fallbackTypes).new Builder();
    }
    ...
    public class Builder {
        /**
         * Builders should be created using {@link #newBuilder(Type, Type...)}
         */
        private Builder() {}
