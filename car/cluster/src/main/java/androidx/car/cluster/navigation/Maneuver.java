...
public final class Maneuver implements VersionedParcelable {
     ...
     *                             order. Only relevant if {@link #mType} is
     ...
     *                      main type is {@link Type#OFF_RAMP_NORMAL_LEFT}, and a fallback type
     *                      could be {@link Type#TURN_NORMAL_LEFT}.
     */
    public Maneuver(@Nullable Type type, int roundaboutExitNumber,
            @NonNull Type ... fallbackTypes) {
        mType = VersionedEnum.of(type, fallbackTypes);
     ...
     * roundabout, and increasing in circulation order. Only relevant if {@link #mType} is
