...
public class LaneDirection implements VersionedParcelable {
    ...
    @ParcelField(1)
    VersionedEnum<Shape> mShape = VersionedEnum.of();
    @ParcelField(2)
    VersionedEnum<Side> mSide = VersionedEnum.of();
    ...
    public LaneDirection(@NonNull Shape shape, @NonNull Side side) {
        mShape = VersionedEnum.ofNonNull(shape);
        mSide = VersionedEnum.ofNonNull(side);
    }
