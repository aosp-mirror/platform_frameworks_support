...
public class LaneDirection implements VersionedParcelable {
    ...
    public enum Shape {
        /**
         * The type is unknown to the consumer.
         */
        UNKNOWN,
        /**
    ...
    @ParcelField(1)
    EnumWrapper<Shape> mShape = EnumWrapper.of(Shape.UNKNOWN);
    @ParcelField(2)
    EnumWrapper<Side> mSide = EnumWrapper.of(Side.UNKNOWN);
    ...
    public @NonNull Shape getShape() {
        return mShape.getValue(Shape.UNKNOWN);
    }
    ...
    public @NonNull Side getSide() {
        return mSide.getValue(Side.UNKNOWN);
    }
    ...
    public String toString() {
        return String.format("{shape: %s, side: %s}", mShape, mSide);
    }
}
