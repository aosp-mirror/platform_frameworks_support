...
public class RichTextTest {
    ...
    public void equality() {
        ...
        assertNotEquals(expected, new RichText.Builder().setText(TEST_TEXT).build());
    ...
    public void immutability() {
        assertImmutable(new RichText.Builder().setText(TEST_TEXT).build().getElements());
    ...
    /**
     * Test that text must be set.
     */
    @Test(expected = NullPointerException.class)
    public void builder_textMustBeSet() {
        new RichText.Builder().build();
    }
