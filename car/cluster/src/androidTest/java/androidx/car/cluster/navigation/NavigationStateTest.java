...
public class NavigationStateTest {
    ...
    private NavigationState createEmptyState() {
        return NavigationState.newBuilder().build();
    }
    ...
    private NavigationState createSampleState() {
        return NavigationState
                ...
                .addStep(Step.newBuilder()
                        .setManeuver(Maneuver.newBuilder(Maneuver.Type.DEPART).build())
                        .setDistance(new Distance(10, 10000, Distance.Unit.METERS))
                        .build())
                .addStep(Step.newBuilder()
                        .setManeuver(Maneuver.newBuilder(Maneuver.Type.ROUNDABOUT_EXIT)
                                .setRoundaboutExitNumber(2)
                                .build())
                        .setDistance(new Distance(15, 15000, Distance.Unit.METERS))
                        .build())
                .addDestination(Destination.newBuilder("Home")
