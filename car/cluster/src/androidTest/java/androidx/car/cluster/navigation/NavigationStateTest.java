...
public class NavigationStateTest {
    ...
    /**
     * Tests that non-nullable methods (those that return enums, String or List) always return a
     * non-null value even if the value transmitted over the wire is null.
     */
    @Test
