...
public class DestinationTest {
    ...
    private static final Destination.Delay TEST_DELAY = Destination.Delay.LOW;
    ...
    public void nullability_defaultConstructor() {
        ...
        assertEquals(Destination.Delay.UNKNOWN, destination.getDelay());
    }
    ...
    public void equality() {
        ...
        assertNotEquals(expected, new Destination.Builder().build());
    }
