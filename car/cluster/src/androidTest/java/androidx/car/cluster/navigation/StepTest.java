...
import static androidx.car.cluster.navigation.utils.Assert.assertThrows;
...
public class StepTest {
    ...
    public void equality() {
        ...
        assertNotEquals(expected, new Step.Builder()
                ...
                .setLanesImage(ImageTest.createSampleImage())
                .build());
        assertNotEquals(expected, new Step.Builder()
    ...
    public void builder_lanesMetadataAndImageMustBeBothProvided() {
        ...
        assertThrows(IllegalArgumentException.class, () ->
                new Step.Builder().setLanesImage(ImageTest.createSampleImage()).build());
    }
