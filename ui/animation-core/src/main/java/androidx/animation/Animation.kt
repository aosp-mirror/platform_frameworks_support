 ...
 */
class ExponentialDecay(frictionMultiplier: Float = 1f) : DecayAnimation {
 ...
 * internalVelocity, and target value for target based animations. This wrapper is purely for the
 ...
 * value, end value, start internalVelocity, and interpolator are cached in this wrapper. So once
 ...
 * the same throughout the animation: start value/internalVelocity.
 */
