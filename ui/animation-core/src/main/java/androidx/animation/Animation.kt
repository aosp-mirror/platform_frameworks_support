...
internal class ExponentialDecay : TargetlessAnimation<Float> {
    ...
    override fun isFinished(playTime: Long,
        ...
        return getVelocity(playTime, start, startVelocity, ::lerp) < 0.1f
    }
 ...
 * and velocity, and target value for target based animations. This wrapper is purely for the
 ...
 * start value, end value, start velocity, interpolator is cached in this wrapper. So once the
 ...
 * well as the animations values that stay the same throughout the animation: start value/velocity,
 * and the animation.
 */
