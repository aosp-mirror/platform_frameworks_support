...
internal class TextInputServiceAndroid(val view: View) : TextInputService {
    ...
    private fun fillEditorInfo(
        ...
        when (imeAction) {
            ImeAction.Unspecified -> outInfo.imeOptions = EditorInfo.IME_ACTION_UNSPECIFIED
            ImeAction.NoAction -> outInfo.imeOptions = EditorInfo.IME_ACTION_NONE
            ImeAction.Go -> outInfo.imeOptions = EditorInfo.IME_ACTION_GO
            ImeAction.Next -> outInfo.imeOptions = EditorInfo.IME_ACTION_NEXT
            ImeAction.Previous -> outInfo.imeOptions = EditorInfo.IME_ACTION_PREVIOUS
            ImeAction.Search -> outInfo.imeOptions = EditorInfo.IME_ACTION_SEARCH
            ImeAction.Send -> outInfo.imeOptions = EditorInfo.IME_ACTION_SEND
            ImeAction.Done -> outInfo.imeOptions = EditorInfo.IME_ACTION_DONE
