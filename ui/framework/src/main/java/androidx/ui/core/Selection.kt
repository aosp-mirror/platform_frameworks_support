...
data class Selection(
    ...
    init {
        startCurrent = PxPosition(startOffset.left.px + ((startOffset.right - startOffset.left) / 4).px,
        startOffset.top.px + ((startOffset.bottom - startOffset.top)/4).px)
        endCurrent = PxPosition(endOffset.left.px + ((endOffset.right - endOffset.left) / 4).px,
            endOffset.top.px + ((endOffset.bottom - endOffset.top)/4).px)
        startOrigin = PxPosition(startOffset.left.px, startOffset.top.px + ((startOffset.bottom - startOffset.top)/2).px)
        endOrigin = PxPosition(endOffset.left.px, endOffset.top.px + ((endOffset.bottom - endOffset.top)/2).px)
    }
}
...
internal class SelectionManager : SelectionRegistrar {
    ...
    val startHandleDragObserver = object : DragObserver {
        ...
        override fun onDrag(dragDistance: PxPosition): PxPosition {
            ...
            Log.e("SelectionDrag", "\n\ndragDistance = ("+dragDistance.x.value.toString()+" ," + dragDistance.y.value.toString()+")")
            Log.e("SelectionDrag","startOffset = (top = " + selection!!.startOffset.top.toString() + ", bottom = " + selection!!.startOffset.bottom.toString() + ", left = "+selection!!.startOffset.left.toString()+", right = "+selection!!.startOffset.right.toString()+")")
            Log.e("SelectionDrag","endOffset = (top = " + selection!!.endOffset.top.toString() + ", bottom = " + selection!!.endOffset.bottom.toString() + ", left = "+selection!!.endOffset.left.toString()+", right = "+selection!!.endOffset.right.toString()+")")
            Log.e("SelectionDrag", "startCenter = (" + startOrigin.x.value.toString() +", " + startOrigin.y.value.toString()+")")
            Log.e("SelectionDrag", "endCenter = (" + endCurrent.x.value.toString() +", " + endCurrent.y.value.toString()+")")
            Log.e("SelectionDrag", "dragStartDist = (" + dragStartDist.x.value.toString()+", "+ dragStartDist.y.value.toString()+")")
            Log.e("SelectionDrag", "oldStartCenter = (" + oldStartOrigin.x.value.toString() +", " + oldStartOrigin.y.value.toString()+")")
            ...
            Log.e("SelectionDrag", "updated dragStartDist = (" + dragStartDist.x.value.toString()+", "+ dragStartDist.y.value.toString()+")")
            Log.e("SelectionDrag", "updated oldStartCenter = (" + oldStartOrigin.x.value.toString() +", " + oldStartOrigin.y.value.toString()+")")

            dragStartDist += dragDistance
            Log.e("SelectionDrag", "dragged dragStartDist = (" + dragStartDist.x.value.toString()+", "+ dragStartDist.y.value.toString()+")")
    ...
    val endHandleDragObserver = object : DragObserver {
        ...
        override fun onDrag(dragDistance: PxPosition): PxPosition {
            ...
            Log.e("SelectionDrag","startOffset = (top = " + selection!!.startOffset.top.toString() + ", bottom = " + selection!!.startOffset.bottom.toString() + ", left = "+selection!!.startOffset.left.toString()+", right = "+selection!!.startOffset.right.toString()+")")
            Log.e("SelectionDrag","endOffset = (top = " + selection!!.endOffset.top.toString() + ", bottom = " + selection!!.endOffset.bottom.toString() + ", left = "+selection!!.endOffset.left.toString()+", right = "+selection!!.endOffset.right.toString()+")")
            Log.e("SelectionDrag", "startCenter = (" + startCurrent.x.value.toString() +", " + startCurrent.y.value.toString()+")")
            Log.e("SelectionDrag", "endCenter = (" + endOrigin.x.value.toString() +", " + endOrigin.y.value.toString()+")")
            Log.e("SelectionDrag", "dragEndDist = (" + dragEndDist.x.value.toString()+", "+ dragEndDist.y.value.toString()+")")
            Log.e("SelectionDrag", "oldEndCenter = (" + oldEndOrigin.x.value.toString() +", " + oldEndOrigin.y.value.toString()+")")
            ...
            Log.e("SelectionDrag", "updated dragEndDist = (" + dragEndDist.x.value.toString()+", "+ dragEndDist.y.value.toString()+")")
            Log.e("SelectionDrag", "updated oldEndCenter = (" + oldEndOrigin.x.value.toString() +", " + oldEndOrigin.y.value.toString()+")")

            dragEndDist += dragDistance
            Log.e("SelectionDrag", "dragged dragEndDist = (" + dragEndDist.x.value.toString()+", "+ dragEndDist.y.value.toString()+")")
...
fun SelectionContainer(
    ...
    SelectionRegistrarAmbient.Provider(value = manager) {
        ...
        val startHandle = @Composable {
            DragGestureDetector(canDrag={ true }, dragObserver=manager.startHandleDragObserver) {
        ...
        Layout(childrenArray=arrayOf(content, startHandle, endHandle), layoutBlock = {
