...
internal class SelectionManager : SelectionRegistrar {
    ...
    val startHandleDragObserver = object : DragObserver {
        ...
        override fun onDrag(dragDistance: PxPosition): PxPosition {
            ...
            val currentStart = dragBeginPosition + dragTotalDistance
            val currentEnd = containerLayoutCoordinates!!.childToLocal(
    ...
    val endHandleDragObserver = object : DragObserver {
        ...
        override fun onDrag(dragDistance: PxPosition): PxPosition {
            ...
            val currentStart = containerLayoutCoordinates!!.childToLocal(
                selection?.startLayoutCoordinates!!,
                getCoordinatesForCharacter(selection!!.startOffset)
            )
            val currentEnd = dragBeginPosition + dragTotalDistance
