...
internal fun getTextSelection(
    ...
    var textSelectionStart = getSelectionBorder(
        textPainter,
        layoutCoordinates,
        lastTextPosition,
        box,
    ...
    var startLayoutCoordinates = getSelectionBorder(
        textPainter,
        layoutCoordinates,
        lastTextPosition,
        box,
    ...
    var textSelectionEnd = getSelectionBorder(
        textPainter,
        layoutCoordinates,
        lastTextPosition,
        box,
    ...
    var endLayoutCoordinates = getSelectionBorder(
        textPainter,
        layoutCoordinates,
        lastTextPosition,
        box,
 ...
 * selection.
 */
internal fun getSelectionBorder(
    textPainter: TextPainter,
    layoutCoordinates: LayoutCoordinates?,
    lastTextPosition: Int, box: Rect,
    position: PxPosition,
    isStart: Boolean
