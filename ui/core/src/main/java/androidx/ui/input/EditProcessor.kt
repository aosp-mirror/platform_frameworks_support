...
class EditProcessor {
    ...
    // The editor state we passed it back to the user of this class.
    ...
    /**
     * Must be called whenever new editor state has arrived.
     *
     * This method updates the internal editing buffer with the given editor state.
     * This method may tell the IME about the selection offset changed or extracted text changed.
     */
    ...
    /**
     * Must be called whenever new edit operations are arrived from IMEs.
     *
     * This method update internal editing buffer with the given edit operations and returns the
