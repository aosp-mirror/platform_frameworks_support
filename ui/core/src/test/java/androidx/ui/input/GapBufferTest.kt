...
class GapBufferTest {
    ...
    @Test
    fun insertTest_intoExistingText() {
    ...
    fun deleteTest() {
        ...
        // Delete two chars with two instructions
        assertEquals("C", PartialGapBuffer("").apply {
            replace(0, 0, "ABC")
            replace(0, 1, "")
            replace(0, 1, "")
    ...
    @Test
    fun deleteTest_fromExistingText() {
    ...
    fun replaceTest() {
        ...
        // Replace two chars with single char
        ...
        // Replace three chars with single char
        assertEquals("X", PartialGapBuffer("").apply {
            replace(0, 0, "ABC")
            replace(0, 3, "X")
        }.toString())

        // Replace single char with two chars
        ...
        // Replace two chars with two chars
    ...
    @Test
    fun replaceTest_fromExistingText() {
