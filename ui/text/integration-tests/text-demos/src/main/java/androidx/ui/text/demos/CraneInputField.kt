...
val KEYBOARD_TYPES = listOf(
    Pair(KeyboardType.KEYBOARD_TYPE_TEXT, "Text"),
    Pair(KeyboardType.KEYBOARD_TYPE_ASCII, "ASCII"),
    Pair(KeyboardType.KEYBOARD_TYPE_NUMBER, "Number"),
    Pair(KeyboardType.KEYBOARD_TYPE_EMAIL, "Email"),
    Pair(KeyboardType.KEYBOARD_TYPE_PHONE, "Phone")
)
...
@Composable
fun EditLine(initText: String, keyboardType: KeyboardType = KeyboardType.KEYBOARD_TYPE_TEXT) {
