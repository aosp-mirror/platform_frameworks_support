...
fun TextDemoComposableTextSpan() {
    CraneWrapper {
        Text {
            Span(text = "This is a ", style = TextStyle(fontSize = 95f)) {
                Span(text = "composable ", style = TextStyle(fontStyle = FontStyle.italic))
                val textPieces = listOf(
                    Pair("T", Color(0xFF4285F4.toInt())),
                    Pair("e", Color(0xFFDB4437.toInt())),
                    Pair("x", Color(0xFFF4B400.toInt())),
                    Pair("t", Color(0xFF4285F4.toInt())),
                    Pair("S", Color(0xFF0F9D58.toInt())),
                    Pair("p", Color(0xFFDB4437.toInt())),
                    Pair("a", Color(0xFFF4B400.toInt())),
                    Pair("n", Color(0xFF4285F4.toInt()))
                )
                for (textPiece in textPieces) {
                    Span(text = textPiece.first, style = TextStyle(color = textPiece.second))
                }
            }
        }
    }
