...
class ParagraphAndroidTest {
    ...
    fun textStyle_setColorOnWholeText() {
        ...
        val paragraph = simpleParagraph(
            text = text,
            textStyles = listOf(MarkUp(textStyle, 0, text.length))
        )
    ...
    fun textStyle_setColorOnPartOfText() {
        ...
        val paragraph = simpleParagraph(
            text = text,
            textStyles = listOf(MarkUp(textStyle, 0, "abc".length))
        )
        paragraph.layout(100.0f)
    ...
    fun textStyle_setTextIndent_firstCharIsLineFeed() {
        ...
        val paragraph = simpleParagraph(
            text = text,
            textStyles = listOf(
                MarkUp(textStyle, "abc".length, "abc\nd".length)
            )
        )
        // width is not important
        paragraph.layout(100.0f)
    ...
    fun textStyle_setTextIndent_coverMultiParagraph() {
        ...
        val paragraph = simpleParagraph(
            text = text,
            textStyles = listOf(
                MarkUp(textStyle, "ab".length, "abc\nd".length)
            )
        )
        // width is not important
        paragraph.layout(100.0f)
    ...
    fun textStyle_setShadow() {
        ...
        val paragraph = simpleParagraph(
            text = text,
            textStyles = listOf(
                MarkUp(textStyle, start = 0, end = text.length)
            )
        )
        // width is not important
        paragraph.layout(100.0f)
    ...
    fun textStyle_setShadowTwice_lastOnTop() {
        ...
        val paragraph = simpleParagraph(
            ...
            textStyles = listOf(
                MarkUp(textStyle, start = 0, end = text.length),
                MarkUp(textStyleOverwrite, start = 0, end = "abc".length)
            )
        )
        // width is not important
        paragraph.layout(100.0f)
