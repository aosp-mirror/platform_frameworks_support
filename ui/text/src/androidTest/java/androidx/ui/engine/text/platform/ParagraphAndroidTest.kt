...
class ParagraphAndroidTest {
    ...
    fun textStyle_setColorOnWholeText() {
        ...
        val paragraph = simpleParagraph(
            text = text,
            textStyles = listOf(AnnotatedString.TextStyleRecord(textStyle, 0, text.length))
        )
    ...
    fun textStyle_setColorOnPartOfText() {
        ...
        val paragraph = simpleParagraph(
            text = text,
            textStyles = listOf(AnnotatedString.TextStyleRecord(textStyle, 0, "abc".length))
        )
        paragraph.layout(100.0f)
    ...
    fun textStyle_setTextIndent_onWholeParagraph() {
        ...
        val paragraph = simpleParagraph(
            text = text,
            textStyles = listOf(
                AnnotatedString.TextStyleRecord(textStyle, 0, "abc".length)
            )
        )
        // width is not important
        paragraph.layout(100.0f)
    ...
    fun textStyle_setTextIndent_onPartParagraph() {
        ...
        val paragraph = simpleParagraph(
            text = text,
            textStyles = listOf(
                AnnotatedString.TextStyleRecord(textStyle, 0, 1)
            )
        )
        // width is not important
        paragraph.layout(100.0f)
    ...
    fun textStyle_setTextIndent_lastCharIsLineFeed() {
        ...
        val paragraph = simpleParagraph(
            text = text,
            textStyles = listOf(
                AnnotatedString.TextStyleRecord(textStyle, 0, "abc\n".length)
            )
        )
        // width is not important
        paragraph.layout(100.0f)
    ...
    fun textStyle_setTextIndent_firstCharIsLineFeed() {
        ...
        val paragraph = simpleParagraph(
            text = text,
            textStyles = listOf(
                AnnotatedString.TextStyleRecord(textStyle, "abc".length, "abc\nd".length)
            )
        )
        // width is not important
        paragraph.layout(100.0f)
    ...
    fun textStyle_setTextIndent_coverMultiParagraph() {
        ...
        val paragraph = simpleParagraph(
            text = text,
            textStyles = listOf(
                AnnotatedString.TextStyleRecord(textStyle, "ab".length, "abc\nd".length)
            )
        )
        // width is not important
        paragraph.layout(100.0f)
    ...
    fun textStyle_setShadow() {
        ...
        val paragraph = simpleParagraph(
            text = text,
            textStyles = listOf(
                AnnotatedString.TextStyleRecord(textStyle, start = 0, end = text.length)
            )
        )
        // width is not important
        paragraph.layout(100.0f)
    ...
    fun textStyle_setShadowTwice_lastOnTop() {
        ...
        val paragraph = simpleParagraph(
            ...
            textStyles = listOf(
                AnnotatedString.TextStyleRecord(textStyle, start = 0, end = text.length),
                AnnotatedString.TextStyleRecord(textStyleOverwrite, start = 0, end = "abc".length)
            )
        )
        // width is not important
        paragraph.layout(100.0f)
    ...
    private fun simpleParagraph(
        text: String = "",
        textStyles: List<AnnotatedString.TextStyleRecord> = listOf(),
