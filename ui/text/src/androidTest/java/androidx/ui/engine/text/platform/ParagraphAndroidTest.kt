...
class ParagraphAndroidTest {
    ...
    fun draw_with_newline_and_line_break_default_values() {
        ...
        for (text in arrayOf("abc\ndef", "\u05D0\u05D1\u05D2\n\u05D3\u05D4\u05D5")) {
            ...
            // 2 chars width
            paragraphAndroid.layout(width = 2 * fontSize.value())
    ...
    fun testAnnotatedString_setFontSizeOnWholeText() {
        val text = "abcde"
        val fontSize = 20.sp
        val paragraphWidth = text.length * fontSize.value()
    ...
    fun testAnnotatedString_setFontSizeTwice_lastOneOverwrite() {
        ...
        val paragraphWidth = text.length * fontSizeOverwrite.value()
        val textStyle = TextStyle(fontSize = fontSize)
    ...
    fun testEllipsis_withMaxLineEqualsNull_doesNotEllipsis() {
        val text = "abc"
        val fontSize = 20.sp
        val paragraphWidth = (text.length - 1) * fontSize.value()
        val paragraph = simpleParagraph(
            text = text,
            textStyle = TextStyle(
                fontFamily = fontFamily,
    ...
    fun testEllipsis_withMaxLinesLessThanTextLines_doesEllipsis() {
        ...
        val paragraphWidth = (text.length - 1.5f) * fontSize.value()
        val paragraph = simpleParagraph(
            text = text,
            ellipsis = true,
            maxLines = 1,
    ...
    fun testEllipsis_withMaxLinesMoreThanTextLines_doesNotEllipsis() {
        ...
        val fontSize = 100.sp
        val paragraphWidth = (text.length - 1) * fontSize.value()
        val maxLines = ceil(text.length * fontSize.value() / paragraphWidth).toInt()
        val paragraph = simpleParagraph(
            text = text,
            ellipsis = true,
            maxLines = maxLines,
    ...
    fun testTextStyle_fontSize_appliedOnTextPaint() {
        ...
        assertThat(paragraph.textPaint.textSize, equalTo(fontSize.value()))
    }
    ...
    fun testTextStyle_fontSizeScale_appliedOnTextPaint() {
        ...
        assertThat(paragraph.textPaint.textSize, equalTo(fontSize.value() * fontSizeScale))
    }
