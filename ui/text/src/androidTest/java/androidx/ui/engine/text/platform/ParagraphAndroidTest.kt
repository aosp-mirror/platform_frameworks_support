...
//    @Test
//    fun testTextStyle_shadow_appliedOnTextPaint() {
//        val color = Color(0x12345678)
//        val offset = Offset(dx = 10f, dy = 20f);
//        val blurRadius = 5.px;
//        val paragraph = simpleParagraph(
//            text = "",
//            textStyle = TextStyle(
...
//        paragraph.layout(0f)
//
//        assertThat(paragraph.textPaint.shadowLayerColor, equalTo(color.toArgb()))
//        assertThat(paragraph.textPaint.shadowLayerDx, equalTo(offset.dx))
//        assertThat(paragraph.textPaint.shadowLayerDy, equalTo(offset.dy))
//        assertThat(paragraph.textPaint.shadowLayerRadius, equalTo(blurRadius.value))
//    }
