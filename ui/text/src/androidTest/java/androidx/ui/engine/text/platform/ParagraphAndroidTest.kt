...
class ParagraphAndroidTest {
    ...
    fun textStyle_setShadow() {
        ...
        val paragraph = simpleParagraph(
            text = text,
            textStyles = listOf(
                Span(textStyle, start = 0, end = text.length)
            )
        )
        // width is not important
        paragraph.layout(100.0f)
    ...
    fun textStyle_setShadowTwice_lastOnTop() {
        ...
        val paragraph = simpleParagraph(
            ...
            textStyles = listOf(
                Span(textStyle, start = 0, end = text.length),
                Span(textStyleOverwrite, start = 0, end = "abc".length)
            )
        )
        // width is not important
        paragraph.layout(100.0f)
    ...
    fun textStyle_fontFamily_addsTypefaceSpanWithCorrectTypeface() {
        ...
        val paragraph = simpleParagraph(
            text = text,
            textStyles = listOf(
                Span(textStyle, expectedStart, expectedEnd)
            )
        )
        paragraph.layout(100.0f)
