...
class ParagraphIntegrationTest {
    ...
    fun textStyle_setFontSizeOnWholeText() {
        ...
        val paragraph = simpleParagraph(
            text = text,
            textStyleItems = listOf(AnnotatedString.Item(textStyle, 0, text.length))
        )
    ...
    fun textStyle_setFontSizeOnPartOfText() {
        ...
        val paragraph = simpleParagraph(
            text = text,
            textStyleItems = listOf(AnnotatedString.Item(textStyle, 0, "abc".length)),
            fontSize = fontSize
        )
        paragraph.layout(ParagraphConstraints(width = paragraphWidth))
        val paragraphImpl = paragraph.paragraphImpl
    ...
    fun textStyle_setWordSpacingOnPartText() {
        ...
        val paragraph = simpleParagraph(
            text = text,
            textStyleItems = listOf(AnnotatedString.Item(textStyle, 0, "a b".length)),
            fontSize = fontSize
        )
        paragraph.layout(ParagraphConstraints(width = paragraphWidth))
        val paragraphImpl = paragraph.paragraphImpl
    ...
    private fun simpleParagraph(
        ...
        textStyleItems: List<AnnotatedString.Item<TextStyle>> = listOf(),
