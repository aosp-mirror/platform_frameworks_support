...
class ParagraphIntegrationTest {
    ...
    fun textStyle_setFontSizeOnWholeText() {
        ...
        val paragraph = simpleParagraph(
            text = text,
            textStyleRecords = listOf(AnnotatedString.TextStyleRecord(textStyle, 0, text.length))
        )
    ...
    fun textStyle_setFontSizeOnPartOfText() {
        ...
        val paragraph = simpleParagraph(
            text = text,
            textStyleRecords = listOf(AnnotatedString.TextStyleRecord(textStyle, 0, "abc".length)),
            fontSize = fontSize
        )
        paragraph.layout(ParagraphConstraints(width = paragraphWidth))
        val paragraphImpl = paragraph.paragraphImpl
    ...
    fun textStyle_seFontSizeTwice_lastOneOverwrite() {
        ...
        val paragraph = simpleParagraph(
            text = text,
            textStyleRecords = listOf(
                AnnotatedString.TextStyleRecord(textStyle, 0, text.length),
                AnnotatedString.TextStyleRecord(textStyleOverwrite, 0, "abc".length)
            )
        )
        paragraph.layout(ParagraphConstraints(width = paragraphWidth))
        val paragraphImpl = paragraph.paragraphImpl
    ...
    fun textStyle_fontSizeScaleNested() {
        ...
        val paragraph = simpleParagraph(
            ...
            textStyleRecords = listOf(
                AnnotatedString.TextStyleRecord(textStyle, 0, text.length),
                AnnotatedString.TextStyleRecord(textStyleNested, 0, text.length)
            ),
            fontSize = fontSize
        )
        paragraph.layout(ParagraphConstraints(width = Float.MAX_VALUE))
    ...
    fun textStyle_fontSizeScaleWithFontSizeFirst() {
        ...
        val paragraph = simpleParagraph(
            text = text,
            textStyleRecords = listOf(
                AnnotatedString.TextStyleRecord(fontSizeStyle, 0, text.length),
                AnnotatedString.TextStyleRecord(fontSizeScaleStyle, 0, text.length)
            ),
    ...
    fun textStyle_fontSizeScaleWithFontSizeNested() {
        ...
        val paragraph = simpleParagraph(
            text = text,
            textStyleRecords = listOf(
                AnnotatedString.TextStyleRecord(fontSizeScaleStyle1, 0, text.length),
                AnnotatedString.TextStyleRecord(fontSizeStyle, 0, text.length),
                AnnotatedString.TextStyleRecord(fontSizeScaleStyle2, 0, text.length)
            ),
            fontSize = paragraphFontSize
        )
        paragraph.layout(ParagraphConstraints(width = Float.MAX_VALUE))
    ...
    fun textStyle_setWordSpacingOnPartText() {
        ...
        val paragraph = simpleParagraph(
            text = text,
            textStyleRecords = listOf(AnnotatedString.TextStyleRecord(textStyle, 0, "a b".length)),
            fontSize = fontSize
        )
        paragraph.layout(ParagraphConstraints(width = paragraphWidth))
        val paragraphImpl = paragraph.paragraphImpl
    ...
    fun textStyle_setWordSpacingTwice_lastOneOverwrite() {
        ...
        val paragraph = simpleParagraph(
            ...
            textStyleRecords = listOf(
                AnnotatedString.TextStyleRecord(textStyle, 0, text.length),
                AnnotatedString.TextStyleRecord(textStyleOverwrite, 0, "a b".length)
            ),
            fontSize = fontSize
        )
        paragraph.layout(ParagraphConstraints(width = paragraphWidth))
    ...
    fun textStyle_textIndent_onSingleLine() {
        ...
        val paragraph = simpleParagraph(
            text = text,
            textStyleRecords = listOf(
                AnnotatedString.TextStyleRecord(
                    style = textStyle,
                    start = 0,
                    end = text.length
                )
    ...
    fun textStyle_fontFamily_changesMeasurement() {
        ...
        val paragraph = simpleParagraph(
            text = text,
            textStyleRecords = listOf(
                AnnotatedString.TextStyleRecord(textStyle, "a".length, text.length)
            ),
            fontSize = fontSize,
    ...
    fun textStyle_fontFeature_turnOffKern() {
        ...
        val paragraph = simpleParagraph(
            text = text,
            textStyleRecords = listOf(
                AnnotatedString.TextStyleRecord(textStyle, 0, "aA".length)
            ),
            fontSize = fontSize,
    ...
    private fun simpleParagraph(
        ...
        textStyleRecords: List<AnnotatedString.TextStyleRecord> = listOf(),
        fontFamily: FontFamily = fontFamilyMeasureFont
    ): Paragraph {
        return Paragraph(
            text = text,
            textStyleRecords = textStyleRecords,
            paragraphStyle = ParagraphStyle(
                textAlign = textAlign,
