...
class ParagraphIntegrationTest {
    ...
    fun textStyle_setFontSizeOnWholeText() {
        ...
        val paragraph = simpleParagraph(
            text = text,
            textStyles = listOf(Span(textStyle, 0, text.length))
        )
    ...
    fun textStyle_setFontSizeOnPartOfText() {
        ...
        val paragraph = simpleParagraph(
            text = text,
            textStyles = listOf(Span(textStyle, 0, "abc".length)),
            fontSize = fontSize
        )
        paragraph.layout(ParagraphConstraints(width = paragraphWidth))
        val paragraphImpl = paragraph.paragraphImpl
    ...
    fun textStyle_seFontSizeTwice_lastOneOverwrite() {
        ...
        val paragraph = simpleParagraph(
            text = text,
            textStyles = listOf(
                Span(textStyle, 0, text.length),
                Span(textStyleOverwrite, 0, "abc".length)
            )
        )
        paragraph.layout(ParagraphConstraints(width = paragraphWidth))
        val paragraphImpl = paragraph.paragraphImpl
    ...
    fun textStyle_fontSizeScaleNested() {
        ...
        val paragraph = simpleParagraph(
            ...
            textStyles = listOf(
                Span(textStyle, 0, text.length),
                Span(textStyleNested, 0, text.length)
            ),
            fontSize = fontSize
        )
        paragraph.layout(ParagraphConstraints(width = Float.MAX_VALUE))
    ...
    fun textStyle_fontSizeScaleWithFontSizeFirst() {
        ...
        val paragraph = simpleParagraph(
            text = text,
            textStyles = listOf(
                Span(fontSizeStyle, 0, text.length),
                Span(fontSizeScaleStyle, 0, text.length)
            ),
    ...
    fun textStyle_fontSizeScaleWithFontSizeNested() {
        ...
        val paragraph = simpleParagraph(
            text = text,
            textStyles = listOf(
                Span(fontSizeScaleStyle1, 0, text.length),
                Span(fontSizeStyle, 0, text.length),
                Span(fontSizeScaleStyle2, 0, text.length)
            ),
            fontSize = paragraphFontSize
        )
        paragraph.layout(ParagraphConstraints(width = Float.MAX_VALUE))
    ...
    fun textStyle_setWordSpacingOnPartText() {
        ...
        val paragraph = simpleParagraph(
            text = text,
            textStyles = listOf(Span(textStyle, 0, "a b".length)),
            fontSize = fontSize
        )
        paragraph.layout(ParagraphConstraints(width = paragraphWidth))
        val paragraphImpl = paragraph.paragraphImpl
    ...
    fun textStyle_setWordSpacingTwice_lastOneOverwrite() {
        ...
        val paragraph = simpleParagraph(
            ...
            textStyles = listOf(
                Span(textStyle, 0, text.length),
                Span(textStyleOverwrite, 0, "a b".length)
            ),
            fontSize = fontSize
        )
        paragraph.layout(ParagraphConstraints(width = paragraphWidth))
    ...
    fun textStyle_fontFamily_changesMeasurement() {
        ...
        val paragraph = simpleParagraph(
            text = text,
            textStyles = listOf(
                Span(textStyle, "a".length, text.length)
            ),
            fontSize = fontSize,
