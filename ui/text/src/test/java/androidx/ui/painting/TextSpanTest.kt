...
//    }
    ...
    fun `toAnnotatedString with includeRootStyle default value`() {
        ...
        assertThat(annotatedString.textStyleItems.size).isEqualTo(1)
        assertThat(annotatedString.textStyleItems[0].style).isEqualTo(textStyle)
        assertThat(annotatedString.textStyleItems[0].start).isEqualTo(0)
        assertThat(annotatedString.textStyleItems[0].end).isEqualTo(text.length)
    }
    ...
    fun `toAnnotatedString with includeRootStyle false`() {
        ...
        assertThat(annotatedString.textStyleItems.size).isEqualTo(0)
    }
    ...
    fun `toAnnotatedString with nested TextSpan with TextStyle`() {
        ...
        assertThat(annotatedString.text).isEqualTo(text1 + text2)
        assertThat(annotatedString.textStyleItems.size).isEqualTo(2)

        assertThat(annotatedString.textStyleItems[0].style).isEqualTo(textStyle1)
        assertThat(annotatedString.textStyleItems[0].start).isEqualTo(0)
        assertThat(annotatedString.textStyleItems[0].end).isEqualTo((text1 + text2).length)

        assertThat(annotatedString.textStyleItems[1].style).isEqualTo(textStyle2)
        assertThat(annotatedString.textStyleItems[1].start).isEqualTo(text1.length)
        assertThat(annotatedString.textStyleItems[1].end).isEqualTo((text1 + text2).length)
    }
    ...
    fun `toAnnotatedString with complex nested TextSpan`() {
        /*
          ...
          AnnotatedString(
            ...
            textStyleItems = listOf(Root[0, 17], Leaf1[0, 6], Inner[6, 17], leaf2[6, 12], leaf3[12, 17])
          )
         */
        ...
        assertThat(annotatedString.textStyleItems.size).isEqualTo(5)

        assertThat(annotatedString.textStyleItems[0].style).isEqualTo(textStyleRoot)
        assertThat(annotatedString.textStyleItems[0].start).isEqualTo(0)
        assertThat(annotatedString.textStyleItems[0].end)
            .isEqualTo((text1 + text2 + text3).length)

        assertThat(annotatedString.textStyleItems[1].style).isEqualTo(textStyleLeaf1)
        assertThat(annotatedString.textStyleItems[1].start).isEqualTo(0)
        assertThat(annotatedString.textStyleItems[1].end).isEqualTo(text1.length)

        assertThat(annotatedString.textStyleItems[2].style).isEqualTo(textStyleInner)
        assertThat(annotatedString.textStyleItems[2].start).isEqualTo(text1.length)
        assertThat(annotatedString.textStyleItems[2].end)
            .isEqualTo((text1 + text2 + text3).length)

        assertThat(annotatedString.textStyleItems[3].style).isEqualTo(textStyleLeaf2)
        assertThat(annotatedString.textStyleItems[3].start).isEqualTo(text1.length)
        assertThat(annotatedString.textStyleItems[3].end).isEqualTo((text1 + text2).length)

        assertThat(annotatedString.textStyleItems[4].style).isEqualTo(textStyleLeaf3)
        assertThat(annotatedString.textStyleItems[4].start).isEqualTo((text1 + text2).length)
        assertThat(annotatedString.textStyleItems[4].end)
            .isEqualTo((text1 + text2 + text3).length)
    }
}
