...
//    }
    ...
    fun `toAnnotatedString with includeRootStyle default value`() {
        ...
        assertThat(annotatedString.markUps.size).isEqualTo(1)
        assertThat(annotatedString.markUps[0].style).isEqualTo(textStyle)
        assertThat(annotatedString.markUps[0].start).isEqualTo(0)
        assertThat(annotatedString.markUps[0].end).isEqualTo(text.length)
    }
    ...
    fun `toAnnotatedString with includeRootStyle false`() {
        ...
        assertThat(annotatedString.markUps.size).isEqualTo(0)
    }
    ...
    fun `toAnnotatedString with nested TextSpan with TextStyle`() {
        ...
        assertThat(annotatedString.text).isEqualTo(text1 + text2)
        assertThat(annotatedString.markUps.size).isEqualTo(2)

        assertThat(annotatedString.markUps[0].style).isEqualTo(textStyle1)
        assertThat(annotatedString.markUps[0].start).isEqualTo(0)
        assertThat(annotatedString.markUps[0].end).isEqualTo((text1 + text2).length)

        assertThat(annotatedString.markUps[1].style).isEqualTo(textStyle2)
        assertThat(annotatedString.markUps[1].start).isEqualTo(text1.length)
        assertThat(annotatedString.markUps[1].end).isEqualTo((text1 + text2).length)
    }
    ...
    fun `toAnnotatedString with complex nested TextSpan`() {
        /*
          ...
          AnnotatedString(
            ...
            markUps = listOf(Root[0, 17], Leaf1[0, 6], Inner[6, 17], leaf2[6, 12], leaf3[12, 17])
          )
         */
        ...
        assertThat(annotatedString.markUps.size).isEqualTo(5)

        assertThat(annotatedString.markUps[0].style).isEqualTo(textStyleRoot)
        assertThat(annotatedString.markUps[0].start).isEqualTo(0)
        assertThat(annotatedString.markUps[0].end).isEqualTo((text1 + text2 + text3).length)

        assertThat(annotatedString.markUps[1].style).isEqualTo(textStyleLeaf1)
        assertThat(annotatedString.markUps[1].start).isEqualTo(0)
        assertThat(annotatedString.markUps[1].end).isEqualTo(text1.length)

        assertThat(annotatedString.markUps[2].style).isEqualTo(textStyleInner)
        assertThat(annotatedString.markUps[2].start).isEqualTo(text1.length)
        assertThat(annotatedString.markUps[2].end).isEqualTo((text1 + text2 + text3).length)

        assertThat(annotatedString.markUps[3].style).isEqualTo(textStyleLeaf2)
        assertThat(annotatedString.markUps[3].start).isEqualTo(text1.length)
        assertThat(annotatedString.markUps[3].end).isEqualTo((text1 + text2).length)

        assertThat(annotatedString.markUps[4].style).isEqualTo(textStyleLeaf3)
        assertThat(annotatedString.markUps[4].start).isEqualTo((text1 + text2).length)
        assertThat(annotatedString.markUps[4].end).isEqualTo((text1 + text2 + text3).length)
    }
}
