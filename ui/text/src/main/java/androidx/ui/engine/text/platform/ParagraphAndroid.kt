...
internal class ParagraphAndroid constructor(
    ...
    val textStyleItems: List<AnnotatedString.Item<TextStyle>>,
    ...
    fun layout(width: Float) {
        ...
        val charSequence = applyTextStyle(text, textStyleItems)
    ...
    private fun applyTextStyle(
        text: String,
        textStyleItems: List<AnnotatedString.Item<TextStyle>>
    ): CharSequence {
        if (textStyleItems.isEmpty()) return text
        val spannableString = SpannableString(text)
        for (textStyleRecord in textStyleItems) {
