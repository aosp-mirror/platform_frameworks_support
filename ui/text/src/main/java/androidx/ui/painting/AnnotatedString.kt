...
data class AnnotatedString(
    val text: String,
    val textStyleRecords: List<TextStyleRecord> = listOf()
) {
    /**
     * The text style information attached on the text.
     *
     * @param style The text style being applied on this part of [AnnotatedString].
