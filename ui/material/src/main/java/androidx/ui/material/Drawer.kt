...
import androidx.ui.foundation.gestures.AnchorsAnimationAdjustment
import androidx.ui.foundation.gestures.AnimatedDraggable
import androidx.ui.foundation.gestures.AxisProjection
    ...
    Container(expanded = true) {
        WithConstraints { pxConstraints ->
            ...
            AnimatedDraggable(
                ...
                minValue = minValue,
                maxValue = maxValue,
                axisProjection = AxisProjection.X,
                animationAdjustment = AnchorsAnimationAdjustment(
    ...
    Container(expanded = true) {
        WithConstraints { pxConstraints ->
            ...
            AnimatedDraggable(
                ...
                minValue = minValue,
                maxValue = maxValue,
                axisProjection = AxisProjection.Y,
                animationAdjustment = AnchorsAnimationAdjustment(anchors, AnimationBuilder),
                onAnimationFinished = { finalValue, cancelled ->
                    if (!cancelled) {
                        onStateChange(
