...
fun TopAppBar(
    ...
    TopAppBar(
        ...
        titleTextLabel = { TopAppBarTitleTextLabel(title) },
 ...
 * styling [androidx.ui.material.MaterialTypography.h6] will be used.
 ...
 * @see [TopAppBar]
 *
 * @param title An optional title String to display
 */
@Composable
