...
fun Shape(family: ShapeFamily, corner: Corner = SharpCorner, border: Border? = null): ShapeModel =
    ShapeModel(family, corner, corner, corner, corner, border)

fun RoundedShape(corner: Corner, border: Border? = null): ShapeModel =
    Shape(ShapeFamily.Rounded, corner, border)

fun CutShape(corner: Corner, border: Border? = null): ShapeModel =
    Shape(ShapeFamily.Cut, corner, border)

val CircularShape: ShapeModel = Shape(ShapeFamily.Rounded, Corner(50))

val RectShape: ShapeModel = Shape(ShapeFamily.Rounded, Corner(0.dp))
