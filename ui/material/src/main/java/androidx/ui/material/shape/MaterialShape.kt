...
/**
 * [MaterialShape] with [ShapeFamily.Rounded] corners.
 *
 * @param cornerSizes the sizes of all four corners
 * @param border an optional border to draw on top of the shape.
 */
fun RoundedMaterialShape(cornerSizes: CornerSizes, border: Border? = null) =
    MaterialShape(ShapeFamily.Rounded, cornerSizes, border)

/**
 * [MaterialShape] with [ShapeFamily.Cut] corners.
 *
 * @param cornerSizes the sizes of all four corners
 * @param border an optional border to draw on top of the shape.
 */
fun CutMaterialShape(cornerSizes: CornerSizes, border: Border? = null) =
    MaterialShape(ShapeFamily.Cut, cornerSizes, border)
