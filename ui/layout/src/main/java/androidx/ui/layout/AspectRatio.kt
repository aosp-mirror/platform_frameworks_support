...
/**
 * Layout widget that attempts to size itself and its optional child to match a specified aspect
 * ratio. The widget will try to match one of the incoming constraints, in the following order:
 * maxWidth, maxHeight, minWidth, minHeight. The size in the other dimension will then be computed
