 ...
 */
data class ReplaceEdit(var range: TextRange, var text: String) : EditOperation(OpType.REPLACE)
 ...
 */
data class SetSelectionEdit(var range: TextRange) : EditOperation(OpType.SET_SELECTION)
 ...
 */
data class SetCompositionEdit(var range: TextRange?) : EditOperation(OpType.SET_COMPOSITION)
