...
class SemanticsComponentNode(
    ...
    // TODO(ryanmentley): initialize properly, temporary hack for bug minimization
//    var properties: (SemanticsPropertyReceiver.() -> Unit) by InvalidatingProperty(properties!!)
