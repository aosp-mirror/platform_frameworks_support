...
import androidx.ui.animation.AnimatedScroll
...
class FancyScrolling : Activity() {
    ...
    fun FancyScrollingExample() {
        Column {
            ...
            val animScroll = +memo { AnimatedScroll(0f) }
            ...
            DragGestureDetector(canDrag = { true }, dragObserver = object : DragObserver {
                ...
                override fun onStop(velocity: PxPosition) {
                    ...
                    val adjustTarget: ((Float) -> Float) = { target ->
                    ...
                    animScroll.fling(velocity.x.value, adjustTarget,
                        targetAnimation = PhysicsBuilder(dampingRatio = 2.0f, stiffness = 100f)
                    )
                }
            }) {
                val children = @Composable {
                    ...
                    Draw { canvas, parentSize ->
                        ...
                        drawItems(canvas, scroll, width, parentSize.height.value, paint.value)
                    }
                }
