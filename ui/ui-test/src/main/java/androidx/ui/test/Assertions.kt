 ...
 *
 * Throws [AssertionError] if the component is not checked.
 */
fun SemanticsNodeInteraction.assertIsChecked(): SemanticsNodeInteraction {
    verify({ "Component is toggled off, expected it to be toggled on" }) {
        it.getOrElse(FoundationSemanticsProperties.ToggleState) {
 ...
 *
 * Throws [AssertionError] if the component is checked.
 */
 ...
 *
 * Throws [AssertionError] if the component is not selected.
 */
 ...
 *
 * Throws [AssertionError] if the component is selected.
 */
