...
abstract class Recomposer {
    ...
    companion object {
        ...
        /**
         * Get current thread's Recomposer
         *
         * @return Recomposer for caller's thread
         */
        ...
        /**
         * Schedule recompose to happen some time in the future for [Composer]
         *
         * @param composer composer to be recomposed
         */
        fun scheduleRecompose(composer: Composer<*>) =
            current().scheduleRecompose(composer)
