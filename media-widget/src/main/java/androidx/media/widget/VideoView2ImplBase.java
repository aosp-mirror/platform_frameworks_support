...
class VideoView2ImplBase implements VideoView2Impl, VideoViewInterface.SurfaceListener {
    ...
    private final SessionPlayerCallback mSessionPlayerCallback = new SessionPlayerCallback();
    ...
    private class SessionPlayerCallback extends SessionPlayer2.PlayerCallback {
        @Override
