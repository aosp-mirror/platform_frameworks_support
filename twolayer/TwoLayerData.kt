...
class NetworkItemDataSource1 : PageKeyedDataSource<NetworkKey, NetworkItem>() {
    override fun loadInitial(
        params: LoadInitialParams<NetworkKey>,
        callback: LoadInitialCallback<NetworkKey, NetworkItem>
    ) {
        val page: Page = fetchPage()
        callback.onResult(page.data, page.prev, page.next)
    }
    ...
    override fun loadAfter(
        ...
        val page: Page = fetchPage(key = params.key)
        callback.onResult(page.data, page.next)
    }
}
class NetworkItemDataSource2 : PageKeyedDataSource<NetworkKey, NetworkItem>() {
    override fun loadInitial(
        params: LoadInitialParams<NetworkKey>,
        callback: LoadInitialCallback<NetworkKey, NetworkItem>
    ) {
    ...
    override fun loadAfter(
        ...
        try {
            ...
            if (t is RetryableException) {
                callback.onRetryableError(t)
            }
        }
    }
}
