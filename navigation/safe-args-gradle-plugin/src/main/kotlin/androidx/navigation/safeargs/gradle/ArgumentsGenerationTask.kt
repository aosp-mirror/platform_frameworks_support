...
open class ArgumentsGenerationTask : DefaultTask() {
    ...
    var applicationId: String? = null // null on AGP 3.30 and above

    @get:Input
    var useAndroidX: Boolean = false

    @get:Input
    var isKotlinProject: Boolean = false
     ...
     * The availability from which the app id string is retrieved on is based on the Android Gradle
     * Plugin version of the project.
     */
    @Input
