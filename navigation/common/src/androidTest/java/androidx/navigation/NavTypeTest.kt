...
class NavTypeTest {
    ...
    companion object {
        ...
        private val serializable = Bitmap.Config.ALPHA_8
        private val serializables = arrayOf(Bitmap.Config.ALPHA_8)
        private val parcelableNavType = NavType.ObjectType(ActivityInfo::class.java)
        private val parcelableArrayNavType =
            NavType.ObjectArrayType(Array<ActivityInfo>::class.java)
        private val serializableNavType = NavType.ObjectType(Bitmap.Config::class.java)
        private val serializableArrayNavType =
            NavType.ObjectArrayType(Array<Bitmap.Config>::class.java)
    }
