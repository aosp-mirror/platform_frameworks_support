...
public abstract class NavType<T> {
    ...
    public static final NavType<Object> UnspecifiedType = new NavType<Object>(true) {
        @Override
    ...
    public static final class ObjectType<D> extends NavType<D> {
        ...
        public ObjectType(Class<D> type) {
            super(true);
            if (!Parcelable.class.isAssignableFrom(type) && !Serializable.class.isAssignableFrom(
                    type)) {
