...
public class NavDestination {
    ...
    /**
     * Checks the given deep link, and determines whether matches a Uri pattern added to the
     * destination by a call to {@link #addDeepLink(String)} . It returns <code>true</code> if the
     * deep link is a valid match, and <code>false</code> otherwise.
     *
     * <p>
