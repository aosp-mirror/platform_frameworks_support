...
public class NavOptions {
    ...
    private final NavigatorExtras mNavigatorExtras;
    ...
    /**
     * The {@link NavigatorExtras} attached to the NavOptions via
     * {@link #withNavigatorExtras}.
     */
    @Nullable
    public NavigatorExtras getNavigatorExtras() {
        return mNavigatorExtras;
    }

    /**
     * Create a copy of these NavOptions with the specified {@link NavigatorExtras} attached.
     *
     * @param navigatorExtras extras to pass onto the {@link Navigator}
     * @return a copy of these NavOptions with the specified NavigatorExtras attached
     */
    @NonNull
    public NavOptions withNavigatorExtras(@NonNull NavigatorExtras navigatorExtras) {
