 ...
 *
 * <p>A NavArgument has a type and optionally a default value, that are used to read/write
...
public final class NavArgument {
     ...
     * Use {@link #isHasDefaultValue()} to distinguish between `null` and absence of a value.
