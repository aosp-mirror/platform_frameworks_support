...
import androidx.dynamicanimation.animation.flingAnimationOfProperty
import androidx.dynamicanimation.animation.springAnimationOfProperty
...
class DynamicAnimationTest {
    ...
    @Test fun testCreateFlingAnimation() {
        val flingAnimation = flingAnimationOfProperty(view::setAlpha, view::getAlpha)
    ...
    @Test fun testCreateSpringAnimation() {
        val springAnimationWithoutFinalPosition =
            springAnimationOfProperty(view::setScaleX, view::getScaleX)
        ...
        val springAnimationWithFinalPosition =
            springAnimationOfProperty(view::setScaleX, view::getScaleX, 100f)
    ...
    @Test fun testSpringForce() {
        val springAnimationWithoutFinalPosition = springAnimationOfProperty(
        ...
        val springAnimationWithFinalPosition = springAnimationOfProperty(
