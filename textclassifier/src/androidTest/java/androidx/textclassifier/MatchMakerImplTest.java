...
public final class MatchMakerImplTest {
    ...
    public void getUrlActions() throws Exception {
        final List<RemoteActionCompat> actions = mMatchMaker.getActions(
                TextClassifier.TYPE_URL, "www.android.com");
    ...
    public void getEmailActions() throws Exception {
        final List<RemoteActionCompat> actions = mMatchMaker.getActions(
                TextClassifier.TYPE_EMAIL, "email@android.com");
    ...
    public void getPhoneActions() throws Exception {
        final List<RemoteActionCompat> actions = mMatchMaker.getActions(
                TextClassifier.TYPE_PHONE, "(987) 654-3210");
    ...
    public void unsupportedEntityType() throws Exception {
        final List<RemoteActionCompat> actions = mMatchMaker.getActions(
                TextClassifier.TYPE_ADDRESS, "1 Android way");
    ...
    public void noMatchingApp() throws Exception {
        ...
        final List<RemoteActionCompat> actions = matchMaker.getActions(
                TextClassifier.TYPE_URL, "www.android.com");
