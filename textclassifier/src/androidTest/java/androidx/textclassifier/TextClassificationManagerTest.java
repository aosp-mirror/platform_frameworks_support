...
public class TextClassificationManagerTest {
    ...
    public void testGetTextClassifier_default_postO() throws Exception {
        TextClassifier textClassifier = mTextClassificationManager.getTextClassifier(mContext);
    ...
    public void testGetTextClassifier_custom_preO() throws Exception {
        mTextClassificationManager.setTextClassifier(mContext, new DummyTextClassifier());
        TextClassifier textClassifier =
                mTextClassificationManager.getTextClassifier(mContext);
