...
public final class TextLinkSpanTest {
    ...
    public void setUp() {
        ...
        mReceiver = new BlockingReceiver(mContext, UUID.randomUUID().toString());
        final PendingIntent intent = mReceiver.registerForPendingIntent();
    ...
    public void onClick_unsupportedWidget() throws Exception {
        ...
        mReceiver.assertNoPendingIntent(300);
    }
    ...
    public void onClick_noActions() throws Exception {
        final TextLinkSpan span = new TextLinkSpan(mTextLink);
        final TextView textView = createTextViewWithSpan(span);
        final TextLinks textLinks = new TextLinks.Builder(ENTITY)
                .addLink(mTextLink)
                .build();
        textLinks.setClassifierFactory(new TextClassifierFactory() {
            @Override
