...
public class ExtrasUtilsTest {
    ...
    public void testGetTopLanguage() {
        ...
        Truth.assertThat(ExtrasUtils.getTopLanguage(intent).getLanguage()).isEqualTo("ja");
    }

    @Test
    public void testGetTopLanguage_nullLanguageBundle() {
        Truth.assertThat(ExtrasUtils.getTopLanguage(new Intent())).isNull();
    }

    @Test
    public void testGetTopLanguage_null() {
        Truth.assertThat(ExtrasUtils.getTopLanguage(null)).isNull();
    }
}
