...
public abstract class TextClassifier {
     ...
     * {@link android.widget.TextView}. @hide */
    @RestrictTo(RestrictTo.Scope.LIBRARY)
    static final String WIDGET_TYPE_TEXTVIEW = "textview";
    /** The widget involved in the text classification session is a standard
     * {@link android.widget.EditText}. @hide */
    @RestrictTo(RestrictTo.Scope.LIBRARY)
    ...
    /** The widget involved in the text classification session is a standard
     * {@link android.webkit.WebView}. @hide */
    @RestrictTo(RestrictTo.Scope.LIBRARY)
    ...
    /** The widget involved in the text classification session is a custom text widget. @hide */
    @RestrictTo(RestrictTo.Scope.LIBRARY)
