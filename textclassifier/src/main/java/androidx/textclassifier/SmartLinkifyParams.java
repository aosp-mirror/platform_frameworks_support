...
public final class SmartLinkifyParams {
    ...
    private final Map<Pattern, EntityRecognizer> mPatternsMap;
    ...
    SmartLinkifyParams(
            ...
            Map<Pattern, EntityRecognizer> patternsMap,
     ...
     */
    @RestrictTo(RestrictTo.Scope.LIBRARY)
    Map<Pattern, EntityRecognizer> getPatternsMap() {
        return mPatternsMap;
    }
    ...
    public static final class Builder {
        ...
        private MatchMaker mMatchMaker = MatchMaker.EMPTY;
        private final Map<Pattern, EntityRecognizer> mPatternsMap = new ArrayMap<>();
        private final SimpleEntityRecognizer mSimpleEntityRecognizer = new SimpleEntityRecognizer();
         ...
         *
         * <p>This is a shorthand for {@link #addPattern(Pattern, EntityRecognizer)}.
         *
        ...
        public Builder addPattern(
            ...
            mSimpleEntityRecognizer.put(pattern, entityType);
            mPatternsMap.put(pattern, mSimpleEntityRecognizer);
            return this;
        }

        /**
         * Maps a regex pattern to an entity type recognizer.
         * This indicates that recognizer should be used to return the entity type for sections of
         * the text that match the specified pattern.
         *
         * @param pattern the regex pattern
         * @param recognizer the entity type recognizer
         *
         * @return this builder
         */
        @NonNull
        public Builder addPattern(
                @NonNull Pattern pattern, @NonNull EntityRecognizer recognizer) {
            mPatternsMap.put(
                    Preconditions.checkNotNull(pattern), Preconditions.checkNotNull(recognizer));
            return this;
        }
        ...
        public Builder setMatchMaker(@Nullable MatchMaker matchMaker) {
            mMatchMaker = matchMaker == null ? MatchMaker.EMPTY : matchMaker;
            return this;
        }
        ...
        private static final class SimpleEntityRecognizer implements EntityRecognizer {

            private final Map<Pattern, String> mPatternType = new ArrayMap<>();

            SimpleEntityRecognizer() {}

            @Override
            @Nullable
            public String getEntityType(Pattern pattern, CharSequence s, int start, int end) {
                return mPatternType.get(pattern);
            }

            void put(Pattern pattern, @EntityType String entityType) {
                mPatternType.put(pattern, entityType);
            }
        }
