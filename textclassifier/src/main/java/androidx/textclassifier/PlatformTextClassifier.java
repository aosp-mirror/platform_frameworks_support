...
/**
 * An implementation of a platform TextClasifier, by wrapping an androidx textclassifier.
 *
 * @hide
 */
@RestrictTo(RestrictTo.Scope.LIBRARY)
@RequiresApi(api = Build.VERSION_CODES.P)
class PlatformTextClassifier implements TextClassifier {
    private androidx.textclassifier.TextClassifier mTextClassifier;

    PlatformTextClassifier(@NonNull androidx.textclassifier.TextClassifier textClassifier) {
    ...
    public TextClassification classifyText(TextClassification.Request request) {
        ...
        return (TextClassification) mTextClassifier.classifyText(androidxRequest).toPlatform();
    }
