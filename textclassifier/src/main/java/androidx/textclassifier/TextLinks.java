...
public final class TextLinks {
     ...
     * {@link #onClassify(TextView, TextClassification)}.
     */
    public static class TextLinkSpan extends ClickableSpan {
            ...
            sWorkerExecutor.execute(new Runnable() {
                ...
                public void run() {
                    ...
                    sMainThreadExecutor.execute(new Runnable() {
                        @Override
                        public void run() {
                            onClassify(textView, textClassification);
                        }
                    });
                }
            });
         ...
         * the best action is started directly otherwise.
         * Apps can change this behaviour by overriding this function, like starting the action
         * directly without showing a floating toolbar.
         *
