...
public final class TextLinks {
    ...
    public static final class TextLink {
        ...
        // The classifier factory used to generate this TextLinks. Not parcelled.
        @Nullable private TextClassifierFactory mClassifierFactory;
            ...
            if (widget instanceof TextView) {
                ...
                if (text instanceof Spannable) {
                    final TextClassificationContext tcc = new TextClassificationContext.Builder(
                            widget.getContext().getPackageName(),
                    ...
                    if (mTextLink != null && mTextLink.mClassifierFactory != null) {
                        classifier = mTextLink.mClassifierFactory.create(tcc);
                    } else {
                        classifier = TextClassificationManager.of(widget.getContext())
                                .createTextClassifier(tcc);
                    }
                    final LocaleListCompat locales;
                    if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.N) {
                        locales = LocaleListCompat.wrap(textView.getTextLocales());
                    } else {
                        locales = LocaleListCompat.create(textView.getTextLocale());
                    }
                    // TODO: Truncate the text.
                    final Spannable spannable = (Spannable) text;
                    final int start = spannable.getSpanStart(this);
                    final int end = spannable.getSpanEnd(this);
                    final Calendar referenceTime = mTextLink != null
                            ? mTextLink.mReferenceTime : null;
