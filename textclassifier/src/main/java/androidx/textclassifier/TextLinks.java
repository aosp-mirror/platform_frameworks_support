...
public final class TextLinks {
    ...
    public static class TextLinkSpanData {
        @NonNull
        final TextLink mTextLink;
        @NonNull
        final TextClassifier mTextClassifier;
        @Nullable
        final Calendar mReferenceTime;
    ...
    public static class TextLinkSpan extends ClickableSpan {
        ...
        public void onClick(View widget) {
            ...
            final TextClassification.Request request =
                    new TextClassification.Request.Builder(text, start, end)
                            .setReferenceTime(mTextLinkSpanData.mReferenceTime)
                            .setDefaultLocales(getLocales(textView))
                            .build();
            final TextClassifier classifier = mTextLinkSpanData.mTextClassifier;
        ...
        public final TextLink getTextLink() {
            return mTextLinkSpanData.mTextLink;
        }
    }
