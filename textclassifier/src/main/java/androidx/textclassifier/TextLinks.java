...
public final class TextLinks {
    ...
    public interface SpanFactory {
        ...
        AbstractTextLinkSpan createSpan(@NonNull TextLinkSpanData textLinkSpanData);
    }
     ...
     * <p>
     * You can implement the {@link #onClick(View)} function to change the on click behavior of
     * the span.
     */
    public abstract static class AbstractTextLinkSpan extends ClickableSpan {
        private TextLinkSpanData mTextLinkSpanData;

        public AbstractTextLinkSpan(@NonNull TextLinkSpanData textLinkSpanData) {
    ...
    /**
     * The default implementation of {@link #AbstractTextLinkSpan}.
     * <p>
     ...
     */
    public static class TextLinkSpan extends AbstractTextLinkSpan {
         ...
         * this span. Once text classifier has the result, this callback will be invoked.
         * <p>
         * You can change the way how the suggested actions are presented to user by overriding
         * this function.
         *
