...
public final class ToolbarController {
    ...
    private static void dismissImmediately(FloatingToolbar toolbar) {
        toolbar.hide();
        toolbar.dismiss();
    }
    ...
    private static final class ActionModeCallback extends ActionMode.Callback2 {
        ...
        public boolean onPrepareActionMode(ActionMode actionMode, Menu menu) {
            ...
            return mOriginalCallback.onPrepareActionMode(actionMode, menu);
        }
        ...
        public boolean onActionItemClicked(ActionMode actionMode, MenuItem menuItem) {
            ...
            return mOriginalCallback.onActionItemClicked(actionMode, menuItem);
        }
