...
public final class ToolbarController {
    ...
    private static void setHighlight(
        ...
        final CharSequence text = textView.getText();
        if (text instanceof Spannable) {
            Selection.setSelection((Spannable) text, start, start);
    ...
    private static void setListeners(TextView textView, final FloatingToolbar toolbar) {
        ...
        final ActionModeCallback selectionCallback =
                new ActionModeCallback(toolbar, textView.getCustomSelectionActionModeCallback());
        final ActionModeCallback insertionCallback =
                new ActionModeCallback(toolbar, textView.getCustomInsertionActionModeCallback());
    ...
    private static final class ActionModeCallback extends ActionMode.Callback2 {
        ...
        private final FloatingToolbar mToolbar;
        @Nullable private final ActionMode.Callback mOriginalCallback;

        ActionModeCallback(
                FloatingToolbar toolbar, @Nullable ActionMode.Callback originalCallback) {
            mToolbar = Preconditions.checkNotNull(toolbar);
        ...
        public boolean onCreateActionMode(ActionMode actionMode, Menu menu) {
            ...
            if (actionMode.getType() == ActionMode.TYPE_FLOATING) {
                ...
                // TODO: "Paste after copy" feature for EditText will force the link toolbar to be
                // dismissed. Decide whether this is acceptable UX or whether we should prefer the
                // link toolbar in this situations.
            }
