...
public interface CallbackReceiver<T> {
     ...
     * chain of 3 calls, starting with createRemoteCallback() and ending with
     * either {@link #toPendingIntent(Context)} or {@link #toRemoteCallback(Context)}.
     *
     * <pre>
     ...
     * </pre>
     *
     * The middle call can be any method within the class that is tagged with
     * {@link RemoteCallable}.
     *
     * <pre>
     *     \@RemoteCallable
     *     public MyClass callMyMethod(String argStr, int argInt, double argDouble) {
     *         ...
     *         return this;
     *     }
     * </pre>
     */
    T createRemoteCallback();

    /**
     * Creates a PendingIntent when a RemoteCallback is being triggered, should only
     ...
     * be used in the context on {@link #createRemoteCallback()}.
     */
    RemoteCallback toRemoteCallback(Context context);
}
