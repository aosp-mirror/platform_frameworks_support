...
public class ExternalInputTest {
    ...
    public void testArg() throws Exception {
        run(new RemoteInputReceiver().createRemoteCallback().setMethod(0 /* unused */, 4), 3);
    ...
    public void testArgString() throws Exception {
        run(new RemoteInputReceiver().createRemoteCallback().setMethodString(0/* unused */, 4), 3);
        assertEquals(3, sArg1);
        assertEquals(4, sArg2);
    }

    private void run(RemoteInputReceiver callback, int extraValue)
        ...
        callback.toPendingIntent(mContext).send(mContext, 0, intent);
    ...
    public static class RemoteInputReceiver extends
        ...
        @RemoteCallable
        public RemoteInputReceiver setMethod(@ExternalInput(EXTRA_ARG) int arg1, int arg2) {
            sArg1 = arg1;
            sArg2 = arg2;
        ...
        @RemoteCallable
        public RemoteInputReceiver setMethodString(@ExternalInput("extra_arg") int arg1, int arg2) {
            sArg1 = arg1;
            sArg2 = arg2;
            if (sLatch != null) sLatch.countDown();
            return this;
