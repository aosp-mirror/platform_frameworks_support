...
public class AdvertisingIdProviderUtilsTest {
    ...
    private static final Correspondence<AdvertisingIdProviderInfo, AdvertisingIdProviderInfo>
            ...
            AdvertisingIdProviderUtilsTest::isProviderInfoEqual, "is equivalent to");
    ...
    public void getAllAdIdProviders_withOpenIntent() throws Exception {
        ...
        assertThat(AdvertisingIdProviderUtils.getAllAdIdProviders(mContext))
                ...
                .containsExactly(
                        AdvertisingIdProviderInfo.builder()
                                .setPackageName(mContext.getPackageName())
                                .setSettingsUiIntent(new Intent(OPEN_SETTINGS_ACTION)
    ...
    private static boolean isProviderInfoEqual(
        ...
        return actual.getPackageName().equals(expected.getPackageName())
                && (actual.getSettingsUiIntent() == null ? expected.getSettingsUiIntent() == null
                : actual.getSettingsUiIntent().filterEquals(expected.getSettingsUiIntent()))
