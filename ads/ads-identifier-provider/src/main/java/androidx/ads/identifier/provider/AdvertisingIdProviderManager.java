 ...
 * <li>Register the Advertising Id settings UI with the intent filter {@link #OPEN_SETTINGS_ACTION}.
 * </ol>
 */
public class AdvertisingIdProviderManager {
     ...
     * intent action.
     * <p>Use {@link PackageManager#MATCH_SYSTEM_ONLY} to reduce the returned activities number on
     * api-level >= N. But even non system-level activities are returned, it will not and should
     * not be used by outer methods.
     */
