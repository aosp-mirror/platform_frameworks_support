...
/**
 * An AdvertisingIdProviderManager will be used by an advertising ID provider to register the
...
public class AdvertisingIdProviderManager {
    ...
    /**
     * Retrieves a list of all the Ad ID providers' information on this device, including self and
     * other providers which is based on the AndroidX Ads ID provider library.
     */
    @NonNull
