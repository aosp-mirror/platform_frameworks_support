...
public class AdvertisingIdProviderUtils {
    ...
    private static final String ADVERTISING_ID_SETTINGS =
            "androidx.ads.identifier.provider.SETTINGS";

    /**
     * Retrieves a list of other providers' information.
     */
    public static List<AdvertisingIdProviderInfo> getOtherProviders(Context context) {
        Intent serviceIntent = new Intent(ADVERTISING_ID_SERVICE);
        ...
        for (ResolveInfo resolveInfo : resolveInfos) {
            ...
            if (activityName != null) {
                builder.setSettingsIntent(
                        new Intent(ADVERTISING_ID_SETTINGS)
    ...
    private static Map<String, String> getActivityMap(PackageManager packageManager) {
        Intent settingsIntent = new Intent(ADVERTISING_ID_SETTINGS);
