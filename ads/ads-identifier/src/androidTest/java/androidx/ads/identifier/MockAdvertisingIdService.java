...
public class MockAdvertisingIdService extends Service {
    ...
    private MockAdvertisingIdServiceStubImpl mAdvertisingIdServiceStubImpl;

    @Override
    public void onCreate() {
        mAdvertisingIdServiceStubImpl = new MockAdvertisingIdServiceStubImpl();
    }

    @Nullable
    @Override
    public IBinder onBind(Intent intent) {
        return mAdvertisingIdServiceStubImpl;
    }

    private static class MockAdvertisingIdServiceStubImpl extends IAdvertisingIdService.Stub {
        @Override
