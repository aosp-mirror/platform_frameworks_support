...
import static androidx.ads.identifier.AdvertisingIdClient.ADVERTISING_ID_SERVICE;
...
public class AdvertisingIdClientTest {
    ...
    public void setUp() {
        ...
        resolveInfo.serviceInfo.name = MOCK_SERVICE_NAME;
        resolveInfo.serviceInfo.packageName = MOCK_SERVICE_PACKAGE_NAME;
        ...
        mockQueryIntentServices(Lists.newArrayList(resolveInfo));
    }

    @After
    public void tearDown() {
        Intent intent = new Intent(ADVERTISING_ID_SERVICE);
    ...
    private void mockQueryIntentServices(List<ResolveInfo> resolveInfos) {
        when(mMockPackageManager.queryIntentServices(argThat(new ArgumentMatcher<Intent>() {
            ...
            public boolean matches(Intent intent) {
                return intent != null && ADVERTISING_ID_SERVICE.equals(intent.getAction());
            }
    ...
    private static class MockAdvertisingIdClient extends AdvertisingIdClient {
        ...
        public static AdvertisingIdInfo getAdvertisingIdInfo(Context context)
            ...
            final MockAdvertisingIdClient client = new MockAdvertisingIdClient(context);
            try {
