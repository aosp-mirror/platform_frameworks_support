...
public class AdvertisingIdClient {
    ...
    private static Pair<IAdvertisingIdService, Intent> getServiceWithIntent(Context context)
        ...
        synchronized (sLock) {
            if (sHoldingConnectionClient == null) {
                sHoldingConnectionClient =
                        new HoldingConnectionClient(context, () -> getIntent(context),
                                IAdvertisingIdService.Stub::asInterface);
            }
    ...
    private static AdvertisingIdInfo getAdvertisingIdInfo(
        ...
        try {
            ...
            throw new AdvertisingIdNotAvailableException(e);
        }
    }
    ...
    protected void finalize() throws Throwable {
        synchronized (sLock) {
            if (sHoldingConnectionClient != null) {
                sHoldingConnectionClient.finish();
            }
        }
        super.finalize();
    }
