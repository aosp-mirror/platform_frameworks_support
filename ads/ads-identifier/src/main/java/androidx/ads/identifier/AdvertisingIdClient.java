...
import static androidx.ads.identifier.AdvertisingIdUtils.getAdvertisingIdProviderServices;
...
public class AdvertisingIdClient {
    ...
    private ComponentName getProviderComponentName(Context context)
            throws AdvertisingIdNotAvailableException {
        PackageManager packageManager = context.getPackageManager();
        List<ResolveInfo> resolveInfos = getAdvertisingIdProviderServices(packageManager);
    ...
    public static boolean isAdvertisingIdProviderAvailable(@NonNull Context context) {
        List<ResolveInfo> resolveInfos =
                getAdvertisingIdProviderServices(context.getPackageManager());
