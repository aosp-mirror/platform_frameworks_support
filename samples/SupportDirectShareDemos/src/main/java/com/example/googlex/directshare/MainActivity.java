...
import androidx.core.content.pm.XmlShareTargetParser;
        ...
        public void onClick(View view) {
            switch (view.getId()) {
                ...
                case R.id.parse_share_targets:
                    ArrayList<ShareTargetCompat> targets = XmlShareTargetParser.parseShareTargets(getApplicationContext());
                    System.out.println("METT: parsed " + targets.size() + " ShareTargets from manifest");
                    for (ShareTargetCompat target : targets) {
                        System.out.println("METT: " + target.toString());
                    }
                    break;
            }
        }
