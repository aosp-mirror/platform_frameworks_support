 ...
 */
public class RemoteCallbackProvider extends AppWidgetProviderWithCallbacks {
    @Override
    ...
    public RemoteViews createRemoteViews(Context context, int[] ids, int value) {
        ...
        remoteViews.setOnClickPendingIntent(R.id.sub,
                createRemoteCallback(context, "setValue", ids, value - 1).toPendingIntent());
        remoteViews.setOnClickPendingIntent(R.id.add,
                createRemoteCallback(context, "setValue", ids, value + 1).toPendingIntent());
        remoteViews.setOnClickPendingIntent(R.id.reset,
                createRemoteCallback(context, "setValue", ids, 0).toPendingIntent());
     ...
     */
    @RemoteCallable
    public void setValue(Context context, int[] ids, int value) {
