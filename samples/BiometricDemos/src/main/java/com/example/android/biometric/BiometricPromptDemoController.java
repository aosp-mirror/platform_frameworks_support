 ...
 */
class BiometricPromptDemoController {
    ...
    private final Button mCreateKeysButton;
    ...
    private final CheckBox mConfirmationRequiredCheckbox;
    private final CheckBox mDeviceCredentialAllowedCheckbox;
    ...
    BiometricPromptDemoController(
        ...
        this(createKeysButton, authenticateButton, canAuthenticateButton,
                useCryptoCheckbox, confirmationRequiredCheckbox,
                deviceCredentialAllowedCheckbox, radioGroup);
        mActivity = activity;
    }

    private BiometricPromptDemoController(
            final Button createKeysButton,
            final Button authenticateButton,
            final Button canAuthenticateButton,
            CheckBox useCryptoCheckbox,
            CheckBox confirmationRequiredCheckbox,
            CheckBox deviceCredentialAllowedCheckbox,
