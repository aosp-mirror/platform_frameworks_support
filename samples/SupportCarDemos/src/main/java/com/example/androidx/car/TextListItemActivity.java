...
import androidx.car.widget.ActionButtonListItem;
...
public class TextListItemActivity extends Activity {
    ...
    private static class SampleProvider extends ListItemProvider {
        ...
        SampleProvider(Context context) {
            ...
            TextListItem item;
            ActionButtonListItem actionItem;
            ...
            actionItem = new ActionButtonListItem(mContext);
            ...
            actionItem = new ActionButtonListItem(mContext);
            actionItem.setPrimaryActionEmptyIcon();
            actionItem.setTitle("double line with empty primary icon."
                    + mContext.getString(R.string.long_text));
            actionItem.setBody("one line text as primary", true);
            actionItem.setActions("Screen Size", false, v -> {
            ...
            actionItem = new ActionButtonListItem(mContext);
            actionItem.setTitle("double line with no primary action and one divider");
            actionItem.setBody("one line text as primary", true);
            actionItem.setActions("Screen Size", false, v -> {
                Context c = v.getContext();
                Point size = new Point();
