...
public class CarSingleChoiceDialogDemoActivity extends FragmentActivity {
    ...
    private void createAndShowDialog() {
        CarSingleChoiceDialog test = new CarSingleChoiceDialog.Builder(this)
    ...
    private List<CarSingleChoiceDialog.SelectionItem> createSelectionItems() {
        List<CarSingleChoiceDialog.SelectionItem> items = new ArrayList<>();

        CarSingleChoiceDialog.SelectionItem item;

        for (int i = 0; i < 5; i++) {
            item = new CarSingleChoiceDialog.SelectionItem(
