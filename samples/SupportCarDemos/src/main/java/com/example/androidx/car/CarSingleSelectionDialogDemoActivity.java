...
public class CarSingleSelectionDialogDemoActivity extends FragmentActivity {
        ...
        CarSingleSelectionDialog test = new CarSingleSelectionDialog.Builder(this)
                ...
                .setPositiveButton("Okay",
                        (dialog, position) -> Toast.makeText(
                                CarSingleSelectionDialogDemoActivity.this,
    ...
    private List<CarSingleSelectionDialog.SelectionItem> createSelectionItems() {
        List<CarSingleSelectionDialog.SelectionItem> items = new ArrayList<>();

        CarSingleSelectionDialog.SelectionItem item;

        for (int i = 0; i < 5; i++) {
            item = new CarSingleSelectionDialog.SelectionItem(
