...
public class SliceProviderCompat {
    ...
    public static final String TAG = "SliceProviderCompat";
    ...
    public SliceProviderCompat(SliceProvider provider, CompatPermissionManager permissionManager,
        ...
        Set<String> files = allFiles.getStringSet(SliceProviderUtils.ALL_FILES, Collections.<String>emptySet());
    ...
    public Bundle call(String method, String arg, Bundle extras) {
        if (method.equals(METHOD_SLICE)) {
            ...
            Bundle b = new Bundle();
            b.putInt(SliceProviderUtils.EXTRA_RESULT, mPermissionManager.checkSlicePermission(uri, pid, uid));
            return b;
    ...
    public static Slice bindSlice(Context context, Uri uri,
        ...
        SliceProviderUtils.ProviderHolder holder = SliceProviderUtils.acquireClient(context.getContentResolver(), uri);
    ...
    public static void pinSlice(Context context, Uri uri,
        ...
        try {
            ...
            SliceProviderUtils.addSpecs(extras, supportedSpecs);
            holder.mProvider.call(METHOD_PIN, SliceProviderUtils.ARG_SUPPORTS_VERSIONED_PARCELABLE, extras);
        } catch (RemoteException e) {
    ...
    public static void unpinSlice(Context context, Uri uri,
        ...
        if (SliceProviderUtils.getPinnedSlices(context).contains(uri)) {
            ...
            try {
                ...
                extras.putString(SliceProviderUtils.EXTRA_PKG, context.getPackageName());
                SliceProviderUtils.addSpecs(extras, supportedSpecs);
                holder.mProvider.call(METHOD_UNPIN, SliceProviderUtils.ARG_SUPPORTS_VERSIONED_PARCELABLE, extras);
            } catch (RemoteException e) {
    ...
    public static Uri mapIntentToUri(Context context, Intent intent) {
        ...
        Uri uri = new Uri.Builder().scheme(ContentResolver.SCHEME_CONTENT)
                .authority(authority).build();
        try (SliceProviderUtils.ProviderHolder holder = SliceProviderUtils.acquireClient(resolver, uri)) {
            if (holder.mProvider == null) {
                throw new IllegalArgumentException("Unknown URI " + uri);
            }
            Bundle extras = new Bundle();
