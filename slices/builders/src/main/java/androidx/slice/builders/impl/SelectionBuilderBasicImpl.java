...
public class SelectionBuilderBasicImpl extends SelectionBuilderImpl {
    ...
    /**
     * Creates a basic selection slice that calls the provided intent with no option.
     *
     * The app providing the slice is expected to implement a selection interface.
     *
