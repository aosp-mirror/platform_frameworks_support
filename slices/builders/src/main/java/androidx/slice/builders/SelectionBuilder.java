...
public class SelectionBuilder {
     ...
     * @return this SelectionBuilder
     */
    public SelectionBuilder setPrimaryAction(@NonNull PendingIntent primaryAction) {
     ...
     *
     * The intent will include an extra with the key
     * {@link androidx.slice.core.SliceHints#EXTRA_SELECTION} and a {@link String} value containing
     ...
     *
     * It is expected, but not required, that the icon will have selected and unselected states,
     * such that the app presenting the slice can indicate which item is selected.
     *
