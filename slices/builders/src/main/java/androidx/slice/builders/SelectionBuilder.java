...
public class SelectionBuilder {
    private List<Pair<String, String>> mOptions;
     ...
     */
    public SelectionBuilder addOption(String optionKey, String optionText) {
    ...
    /**
     * Sets the icon to be displayed next to options if they are displayed as a list with radio
     * buttons.
     *
