...
import static androidx.slice.core.SliceHints.SUBTYPE_SELECTION_SELECTED_OPTION_KEY;
...
public class SelectionBuilderV1Impl extends SelectionBuilderImpl {
    ...
    public void apply(SelectionBuilder selectionBuilder, Slice.Builder sliceBuilder) {
        ...
        if (selectionBuilder.getSelectedOption() != null) {
            sliceBuilder.addText(selectionBuilder.getSelectedOption(),
                    SUBTYPE_SELECTION_SELECTED_OPTION_KEY);
        }
