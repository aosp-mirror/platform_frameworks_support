...
public class LocationBasedViewTracker implements Runnable, View.OnLayoutChangeListener {
    ...
    private static boolean trackInputFocused(ViewGroup parent) {
    ...
    private static boolean trackA11yFocus(ViewGroup parent) {
    ...
    /**
     * Tries to preserve the input and accessibility focus after the next content change
     * @hide
     */
    @RestrictTo(RestrictTo.Scope.LIBRARY)
    public static void  trackInputAndA11yFocus(ViewGroup parent) {
        boolean inputFocus = trackInputFocused(parent);
        boolean a11yFocus = trackA11yFocus(parent);
        if (inputFocus || a11yFocus) {
