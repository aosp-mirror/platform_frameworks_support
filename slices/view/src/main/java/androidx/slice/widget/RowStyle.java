...
public class RowStyle {
    private int mIconFrameEndPadding;
    private int mContentStartPadding;
    private int mContentEndPadding;
    private int mWidgetFrameStartPadding;
    private int mWidgetFrameEndPadding;
    ...
    public RowStyle(Context context, int resId) {
        ...
        try {
            mIconFrameEndPadding = (int) a.getDimension(
                    R.styleable.RowStyle_iconFrameEndPadding, -1);
            mContentStartPadding = (int) a.getDimension(
                    R.styleable.RowStyle_contentStartPadding, -1);
            mContentEndPadding = (int) a.getDimension(R.styleable.RowStyle_contentEndPadding, -1);
            mWidgetFrameStartPadding = (int) a.getDimension(
                    R.styleable.RowStyle_widgetFrameStartPadding, -1);
            mWidgetFrameEndPadding = (int) a.getDimension(
                    R.styleable.RowStyle_widgetFrameEndPadding, -1);
    ...
    public int getIconFrameEndPadding() {
        return mIconFrameEndPadding;
    }
    ...
    public int getWidgetFrameStartPadding() {
        return mWidgetFrameStartPadding;
    }

    public int getWidgetFrameEndPadding() {
        return mWidgetFrameEndPadding;
    }
