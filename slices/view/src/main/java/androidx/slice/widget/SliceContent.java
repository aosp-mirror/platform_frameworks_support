...
import static android.app.slice.Slice.*;
import static android.app.slice.Slice.HINT_TITLE;
import static android.app.slice.SliceItem.*;
import static android.app.slice.SliceItem.FORMAT_IMAGE;
import static androidx.slice.core.SliceHints.*;
...
public class SliceContent {
    ...
    public SliceContent(Slice slice) {
        ...
        // Built from a slice implies it's not a item but top level and these don't matter.
        mRowIndex = -1;
    }
     ...
     */
    public int getHeight(SliceStyle style, @SliceView.SliceMode SliceViewPolicy policy) {
        return 0;
    }
