...
public final class SliceLiveData {
    ...
    /**
     * Version of {@link LiveData<Slice>} that provides controls over how
    ...
    public static class CachedSliceLiveData extends LiveData<Slice> {
        ...
        /**
         * Generally the InputStream will only be parsed asynchronously once the
         * LiveData goes into the active state. Calling this method will ensure
         * the stream read into a slice synchronously and will release the reference
         * to the input stream.
         * <p>
         * Calling parseStream() multiple times will have no effect.
         */
