...
class ContiguousPagedListTest(private val placeholdersEnabled: Boolean) {
    ...
    private inner class TestSource(val listData: List<Item> = ITEMS)
        ...
        override fun dispatchLoadInitial(
            ...
            if (data != null) {
                ...
                receiver.onPageError(PageResult.INIT, ERROR)
            }
        }
        ...
        override fun dispatchLoadAfter(
            ...
            mainThreadExecutor.execute {
                if (data != null) {
                    ...
                    receiver.onPageError(PageResult.APPEND, ERROR)
                }
            }
        }
        ...
        override fun dispatchLoadBefore(
            ...
            mainThreadExecutor.execute {
                if (data != null) {
                    ...
                    receiver.onPageError(PageResult.PREPEND, ERROR)
                }
            }
        }
    ...
    companion object {
        ...
        private val ERROR = DataSource.Error(Exception(), true)
        private val RETRYABLE_ERROR = PagedList.LoadState.fromError(ERROR)
    }
}
