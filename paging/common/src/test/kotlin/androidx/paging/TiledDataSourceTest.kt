...
class TiledDataSourceTest {
    fun TiledDataSource<String>.loadInitial(
        ...
        val params = PositionalDataSource.LoadInitialParams(startPosition, count, pageSize, true)
        return loadInitial(params).get().data
    }

    @Test
    fun loadInitialEmpty() {
        class EmptyDataSource : TiledDataSource<String>() {
            override fun countItems() = 0

            override fun loadRange(startPosition: Int, count: Int) = emptyList<String>()
        }
