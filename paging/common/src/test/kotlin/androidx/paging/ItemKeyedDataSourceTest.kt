...
class ItemKeyedDataSourceTest {
    ...
    @Test
    fun loadInitialCallbackListTooBig() = assertFailsWithCause<IllegalArgumentException> {
        performLoadInitial {
    ...
    @Test
    fun loadInitialCallbackPositionTooLarge() = assertFailsWithCause<IllegalArgumentException> {
        performLoadInitial {
            // LoadInitialCallback can't accept pos + list > totalCount
    ...
    @Test
    fun loadInitialCallbackPositionNegative() = assertFailsWithCause<IllegalArgumentException> {
        performLoadInitial {
