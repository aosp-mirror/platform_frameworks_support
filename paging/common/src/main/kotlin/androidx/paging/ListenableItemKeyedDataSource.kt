...
abstract class ListenableItemKeyedDataSource<Key : Any, Value : Any> :
    ...
    public override fun load(params: Params<Key>): ListenableFuture<out BaseResult<Value>> {
    ...
    public abstract override fun getKey(item: Value): Key?
    ...
    /**
     * Type produced by [.loadBefore] and
     * [.loadAfter] to represent a page of loaded data.
     *
     * @param <V> The type of the data loaded.
    </V> */
    open class Result<V>(data: List<V>) : DataSource.BaseResult<V>(data, null, null, 0, 0, 0, false)
}
