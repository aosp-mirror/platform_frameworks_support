...
open abstract class ListenablePositionalDataSource<T> :
    DataSource<Int, T>(KeyType.POSITIONAL) {

    internal override fun load(params: Params<Int>): ListenableFuture<out BaseResult<T>> {
    ...
    internal override fun getKey(item: T): Int? {
        return null
    }
