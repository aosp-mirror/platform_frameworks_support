 ...
 */
abstract class ListenablePageKeyedDataSource<Key, Value> :
     ...
     *                             page size.
     */
    open class LoadParams<Key>(@JvmField val key: Key, @JvmField val requestedLoadSize: Int)
     ...
     */
    @Suppress("RedundantVisibilityModifier") // Metalava doesn't inherit visibility properly.
    internal override fun supportsPageDropping() = false
