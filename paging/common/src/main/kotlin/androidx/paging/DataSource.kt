...
internal constructor(private val type: KeyType) {
    ...
    internal fun supportsPageDropping() = true
    ...
    */
    ...
    open class BaseResult<Value> protected constructor(
        ...
        companion object {
            internal fun <T> empty() = BaseResult(emptyList<Any>(), null, null, 0, 0, 0, true)
