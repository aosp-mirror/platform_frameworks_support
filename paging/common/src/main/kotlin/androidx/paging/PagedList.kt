...
abstract class PagedList<T> : AbstractList<T> {
    ...
    internal var boundaryCallbackBeginDeferred = false
    /* synthetic access */
    @Suppress("MemberVisibilityCanBePrivate")
    internal var boundaryCallbackEndDeferred = false
    ...
    /* synthetic access */
    @Suppress("MemberVisibilityCanBePrivate")
    internal val listeners: ArrayList<WeakReference<LoadStateListener>>
    ...
    open fun loadAround(index: Int) {
        ...
        lowestIndexAccessed = Math.min(lowestIndexAccessed, index)
        highestIndexAccessed = Math.max(highestIndexAccessed, index)
    ...
    internal /* synthetic access */ fun tryDispatchBoundaryCallbacks(post: Boolean) {
        ...
        val dispatchEnd =
            boundaryCallbackEndDeferred && highestIndexAccessed >= size - 1 - config.prefetchDistance
