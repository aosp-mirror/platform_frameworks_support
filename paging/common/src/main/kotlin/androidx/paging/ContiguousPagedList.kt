...
open class ContiguousPagedList<K, V>(
    ...
    override fun retry() {
        ...
        if (refreshRetryCallback != null && pager.mLoadStateManager.refresh == LoadState.RETRYABLE_ERROR) {
    ...
    init {
        ...
        shouldTrim =
            mDataSource.supportsPageDropping() && config.maxSize != Config.MAX_SIZE_UNBOUNDED
    ...
    override fun loadAroundInternal(index: Int) {
        val prependItems = getPrependItemsRequested(
            getConfig().prefetchDistance, index,
