...
abstract class PageKeyedDataSource<Key : Any, Value> : ListenablePageKeyedDataSource<Key, Value>() {
    /**
    ...
    abstract class LoadInitialCallback<Key : Any, Value> {
        /**
    ...
    ): PageKeyedDataSource<Key, ToValue> = mapByPage(createListFunction(function))
}
