...
abstract class PageKeyedDataSource<Key : Any, Value : Any> :
    ...
    /**
     * Callback for PageKeyedDataSource [.loadBefore] and [.loadAfter] to return data.
     *
     * A callback can be called only once, and will throw if called again.
     *
     * It is always valid for a DataSource loading method that takes a callback to stash the
    ...
    abstract class LoadCallback<Key : Any, Value : Any> {
         ...
         * Called to pass loaded data from a DataSource.
         *
         * Call this method from your PageKeyedDataSource's [.loadBefore] and [.loadAfter] methods
         * to return data.
         *
         * It is always valid to pass a different amount of data than what is requested. Pass an
         * empty list if there is no more data to load.
