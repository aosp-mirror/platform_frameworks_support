...
public abstract class PageKeyedDataSource<Key, Value>
    ...
    @Override
    ListenableFuture<InitialResult<Key, Value>> loadInitial(
    ...
    @Override
    ListenableFuture<Result<Key, Value>> loadBefore(final @NonNull LoadParams<Key> params) {
    ...
    @Override
    ListenableFuture<Result<Key, Value>> loadAfter(final @NonNull LoadParams<Key> params) {
        final ResolvableFuture<Result<Key, Value>> future = ResolvableFuture.create();
        getExecutor().execute(new Runnable() {
            @Override
            public void run() {
    ...
    @NonNull
    @Override
    public <ToValue> PageKeyedDataSource<Key, ToValue> mapByPage(
