                ...
                LoadInitialCallback<T> callback = new LoadInitialCallback<T>() {
                    ...
                    public void onResult(@NonNull List<T> data, int position, int totalCount) {
                        if (isInvalid()) {
                            ...
                            setFuture(params, new InitialResult<>(data, position, totalCount));
                        }
                    }
                    ...
                    public void onResult(@NonNull List<T> data, int position) {
                        if (isInvalid()) {
                            ...
                            setFuture(params, new InitialResult<>(data, position));
                        }
                    }

                    private void setFuture(@NonNull LoadInitialParams params,
