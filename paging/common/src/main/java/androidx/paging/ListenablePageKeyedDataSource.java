...
public abstract class ListenablePageKeyedDataSource<Key, Value> extends DataSource<Key, Value> {
    ...
    /**
     * Type produced by {@link #loadInitial(PageKeyedDataSource.LoadInitialParams)} to represent
    ...
    /**
     * Type produced by {@link #loadBefore(PageKeyedDataSource.LoadParams)} and
     * {@link #loadAfter(PageKeyedDataSource.LoadParams)} to represent a page of loaded data.
     *
     * @param <Key> Type of key used to identify pages.
     * @param <Value> Type of items being loaded by the DataSource.
     */
