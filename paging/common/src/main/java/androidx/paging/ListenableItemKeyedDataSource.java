 ...
 * {@code N - 1} to load item {@code N}. This is common, for example, in sorted database queries
 * where attributes of the item such just before the next query define how to execute it.
 *
...
public abstract class ListenableItemKeyedDataSource<Key, Value> extends DataSource<Key, Value> {
     ...
     * to the {@link InitialResult} constructor if possible, as this enables PagedLists presenting
