...
public abstract class ListenablePositionalDataSource<T> extends DataSource<Integer, T> {
     ...
     */
    @NonNull
    public abstract ListenableFuture<RangeResult<T>> loadRange(
    ...
    /**
     * Type produced by {@link #loadInitial(PositionalDataSource.LoadInitialParams)} to represent
    ...
    /**
     * Type produced by {@link #loadRange(PositionalDataSource.LoadRangeParams)} to represent a page
     * of loaded data.
     *
     * @param <V> The type of the data loaded.
     */
