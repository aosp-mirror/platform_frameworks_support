...
public abstract class PagedList<T> extends AbstractList<T> {
    ...
    public static final class LoadState {
         ...
         */
        @NonNull
        public static final LoadState IDLE = new LoadState("Idle");

        /**
         * Loading is in progress.
         */
        @NonNull
        public static final LoadState LOADING = new LoadState("Loading");

        /**
         * PagedList is done loading, no more to load.
         */
        static final LoadState DONE = new LoadState("Done");
