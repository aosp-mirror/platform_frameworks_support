...
public abstract class ListenableItemKeyedSource<K, V> extends ListenableSource<K, V> {
    ...
    @Override
    final ListenableFuture<? extends BaseResult<V>> load(@NonNull Params<K> params) {
    ...
    abstract ListenableFuture<InitialResult<V>> loadInitial(
            @NonNull ItemKeyedDataSource.LoadInitialParams<K> params);
    abstract ListenableFuture<Result<V>> loadBefore(
            @NonNull ItemKeyedDataSource.LoadParams<K> params);
