...
// TODO: avoid passing the coroutine context by taking two lambdas
/*
suspend fun <T> SuspendingPositionalDataSource2() {
    val context = coroutineContext
    object : SuspendingPositionalDataSource<T>(context) {

    }
}
*/

abstract class SuspendingPositionalDataSource<T>(coroutineContext: CoroutineContext) : ListenablePositionalDataSource<T>() {
