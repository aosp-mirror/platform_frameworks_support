...
internal abstract class RxPositionalDataSource<T> : ListenablePositionalDataSource<T>() {
    /**
    ...
    override fun loadRange(params: LoadRangeParams) =
        RxDataSourceUtil.singleToListenableFuture(onLoadRange(params), executor, scheduler)
