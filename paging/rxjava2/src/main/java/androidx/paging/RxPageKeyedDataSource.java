...
abstract class RxPageKeyedDataSource<Key, Value> extends PageKeyedDataSource<Key, Value> {
     ...
     * {@link PageKeyedDataSource#loadInitial(ListenablePageKeyedDataSource.LoadInitialParams)}.
     *
    ...
    /**
     * Rx-extension of the parent method:
     * {@link PageKeyedDataSource#loadBefore(ListenablePageKeyedDataSource.LoadParams)}.
     *
    ...
    /**
     * Rx-extension of the parent method:
     * {@link PageKeyedDataSource#loadAfter(ListenablePageKeyedDataSource.LoadParams)}.
     *
     * @param params Parameters for load, including page key and load size.
     * @return {@link Single} that receives the loaded data.
     */
