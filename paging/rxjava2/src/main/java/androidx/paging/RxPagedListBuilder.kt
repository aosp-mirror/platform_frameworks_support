...
class RxPagedListBuilder<Key : Any, Value : Any>(
     ...
     *
     * @param scheduler [Scheduler] used to fetch from DataSources, generally a background thread pool
    ...
    internal class PagingObservableOnSubscribe<Key : Any, Value : Any>(
    ...
    ) : ObservableOnSubscribe<PagedList<Value>>, Cancellable, Runnable {
        ...
        private fun createPagedList(): PagedList<Value> {
            ...
            do {
                ...
                newDataSource.addInvalidatedCallback(onInvalidatedCallback)
