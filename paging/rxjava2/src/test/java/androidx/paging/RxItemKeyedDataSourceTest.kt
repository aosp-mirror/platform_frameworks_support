...
class RxItemKeyedDataSourceTest {
    ...
    fun loadInitial_empty() {
        ...
        assertEquals(actual, InitialResult<Int>(List(0) { it }, 0, 0))
    }
    ...
    fun loadInitial_simple() {
        ...
        assertEquals(actual, InitialResult<Int>((0..2).toList(), 0, 3))
    }
    ...
    fun loadAfter_empty() {
        ...
        assertEquals(actual, Result<Int>(List(0) { it }))
    }
    ...
    fun loadAfter_simple() {
        ...
        assertEquals(actual, Result<Int>((0..2).toList()))
    }
    ...
    fun loadBefore_simple() {
        ...
        assertEquals(actual, Result<Int>((-3..-1).toList()))
    }
