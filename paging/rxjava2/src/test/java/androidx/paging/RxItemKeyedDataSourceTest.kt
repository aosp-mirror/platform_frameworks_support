...
class RxItemKeyedDataSourceTest {
    ...
    private lateinit var errorDataSource: RxItemKeyedDataSource<Int, Int>
    ...
    fun setUp() {
        ...
        errorDataSource = object : RxItemKeyedDataSource<Int, Int>() {
            ...
            override fun loadInitial(
                params: LoadInitialParams<Int>
            ): Single<LoadInitialResponse<Int>> = Single.error(NotImplementedError())

            override fun loadBefore(
                params: LoadParams<Int>
            ): Single<List<Int>> = Single.error(NotImplementedError())
