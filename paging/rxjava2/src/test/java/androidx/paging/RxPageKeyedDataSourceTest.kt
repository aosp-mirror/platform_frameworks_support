...
class RxPageKeyedDataSourceTest {
    ...
    fun loadAfter_empty() {
        ...
        assertEquals(actual, ListenablePageKeyedDataSource.Result<Int, Int>(List(0) { it }, 0))
    }
    ...
    fun loadAfter_simple() {
        ...
        assertEquals(actual, ListenablePageKeyedDataSource.Result<Int, Int>((0..2).toList(), 3))
    }
    ...
    fun loadBefore_simple() {
        ...
        assertEquals(actual, ListenablePageKeyedDataSource.Result<Int, Int>((-3..-1).toList(), 3))
    }
