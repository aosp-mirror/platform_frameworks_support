...
class RxPageKeyedDataSourceTest {
    private lateinit var trivialDataSource: RxPageKeyedDataSource<Int, Int>
    private lateinit var perpetuallyLoadingDataSource: RxPageKeyedDataSource<Int, Int>
    private lateinit var errorDataSource: RxPageKeyedDataSource<Int, Int>
