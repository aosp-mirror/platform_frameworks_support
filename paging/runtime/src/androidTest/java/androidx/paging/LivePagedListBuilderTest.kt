...
class LivePagedListBuilderTest {
    ...
    fun failedLoad() {
        ...
        initPagedList.addWeakLoadStateChangedCallback(loadStateChangedCallback)
        ...
        initPagedList.removeWeakLoadStateChangedCallback(loadStateChangedCallback)
        pagedListHolder[0]!!.addWeakLoadStateChangedCallback(loadStateChangedCallback)
        assertEquals(
            listOf(
                LoadState(REFRESH, LOADING, null),
                LoadState(REFRESH, RETRYABLE_ERROR, RETRYABLE_EXCEPTION),
