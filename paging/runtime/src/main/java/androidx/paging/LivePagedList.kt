...
internal class LivePagedList<Key, Value>(
    initialKey: Key?,
    ...
    private val listenableFuture: ListenableFuture<PagedList<Value>>
        get() {
    ...
    fun invalidate(force: Boolean) {
        ...
        currentFuture = listenableFuture
        Futures.addCallback(currentFuture!!, this, notifyExecutor)
    }
}
