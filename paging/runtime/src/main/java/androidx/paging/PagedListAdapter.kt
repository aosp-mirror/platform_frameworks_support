...
abstract class PagedListAdapter<T : Any, VH : RecyclerView.ViewHolder> : RecyclerView.Adapter<VH> {
    ...
    protected constructor(diffCallback: DiffUtil.ItemCallback<T>) {
        ...
        differ.addLoadStateChangedListener(loadStateListener)
    }
     ...
     */
    open fun addLoadStateChangedCallback(callback: LoadStateListener) {
     ...
     */
    open fun removeLoadStateChangedCallback(callback: LoadStateListener) {
