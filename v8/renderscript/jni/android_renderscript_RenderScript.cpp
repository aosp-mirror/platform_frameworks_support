...
static void
nAllocation1DElementData(JNIEnv *_env, jobject _this, jlong con, jlong alloc, jint xoff,
                         jint lod, jint compIdx, jbyteArray data, jint sizeBytes)
{
    jint len = _env->GetArrayLength(data);
    LOG_API("nAllocation1DElementData, con(%p), alloc(%p), xoff(%i), comp(%i), len(%i), "
...
{"rsnAllocation1DElementData",       "(JJIII[BI)V",                           (void*)nAllocation1DElementData },
