...
public class ScriptIntrinsicConvolve3x3 extends ScriptIntrinsic {
    ...
    public static ScriptIntrinsicConvolve3x3 create(RenderScript rs, Element e) {
        ...
        if (true || rs.isUseNative() && android.os.Build.VERSION.SDK_INT < 21) {
            ...
            mUseIncSupp = true;
            id = rs.nIncScriptIntrinsicCreate(1, e.getID(rs));
            android.util.Log.v("Inc RS Test", "Creatie Intrinsic Completed");
        } else {
            id = rs.nScriptIntrinsicCreate(1, e.getID(rs));
        }
    ...
    public void setInput(Allocation ain) {
        mInput = ain;
        //setVar(1, ain);
        android.util.Log.v("Inc RS Test", "Seting aIn");
        setVar(1, ain);
        android.util.Log.v("Inc RS Test", "Seting aIn Completed");
    }
