...
public class RenderScript {
    ...
    native void rsnAllocation1DElementData(long con,long id, int xoff, int mip, int compIdx, byte[] d, int sizeBytes);
    synchronized void nAllocation1DElementData(long id, int xoff, int mip, int compIdx, byte[] d, int sizeBytes) {
        validate();
        rsnAllocation1DElementData(mContext, id, xoff, mip, compIdx, d, sizeBytes);
    }
