...
public class RenderScript {
    ...
    native void rsnAllocationData1D(long con, long id, int off, int mip, int count, Object d, int sizeBytes, int dt,
                                    int mSize, boolean usePadding, byte[] buffer);
    synchronized void nAllocationData1D(long id, int off, int mip, int count, Object d, int sizeBytes, Element.DataType dt,
                                        int mSize, boolean usePadding, byte[] buffer) {
        validate();
        rsnAllocationData1D(mContext, id, off, mip, count, d, sizeBytes, dt.mID, mSize, usePadding, buffer);
    }
    ...
    */
    ...
    synchronized void nAllocationData2D(long id, int xoff, int yoff, int mip, int face,
                                        ...
                                        int mSize, boolean usePadding, byte[] buffer) {
        validate();
        rsnAllocationData2D(mContext, id, xoff, yoff, mip, face, w, h, d, sizeBytes, dt.mID, mSize, usePadding, buffer);
    }
    ...
    synchronized void nAllocationData3D(long id, int xoff, int yoff, int zoff, int mip,
        ...
        rsnAllocationData3D(mContext, id, xoff, yoff, zoff, mip, w, h, depth, d, sizeBytes,
                            dt.mID, mSize, usePadding, buffer);
    }

    native void rsnAllocationRead(long con, long id, Object d, int dt, int mSize, boolean usePadding, byte[] buffer);
    synchronized void nAllocationRead(long id, Object d, Element.DataType dt, int mSize, boolean usePadding, byte[] buffer) {
        validate();
        rsnAllocationRead(mContext, id, d, dt.mID, mSize, usePadding, buffer);
    }

    native void rsnAllocationRead1D(long con, long id, int off, int mip, int count, Object d,
                                    int sizeBytes, int dt, int mSize, boolean usePadding, byte[] buffer);
    synchronized void nAllocationRead1D(long id, int off, int mip, int count, Object d,
                                        int sizeBytes, Element.DataType dt, int mSize, boolean usePadding, byte[] buffer) {
        validate();
        rsnAllocationRead1D(mContext, id, off, mip, count, d, sizeBytes, dt.mID, mSize, usePadding, buffer);
    }
    ...
    */
    ...
    synchronized void nAllocationRead2D(long id, int xoff, int yoff, int mip, int face,
                                        ...
                                        int mSize, boolean usePadding, byte[] buffer) {
        validate();
        rsnAllocationRead2D(mContext, id, xoff, yoff, mip, face, w, h, d, sizeBytes, dt.mID, mSize, usePadding, buffer);
    }
    ...
    synchronized void nAllocationRead3D(long id, int xoff, int yoff, int zoff, int mip,
                                        ...
                                        int mSize, boolean usePadding, byte[] buffer) {
        validate();
        rsnAllocationRead3D(mContext, id, xoff, yoff, zoff, mip, w, h, depth, d, sizeBytes, dt.mID, mSize, usePadding, buffer);
    }
    */
