...
public final class BenchmarkState {
    ...
    private long mStartTimeNs = 0; // System.nanoTime() at beginning of warmup.
    private long mLastTimeNs = 0; // System.nanoTime() at beginning of last warmup iteration.
    ...
    private void beginWarmup() {
        mStartTimeNs = mLastTimeNs = System.nanoTime();
        mIteration = 0;
        mState = WARMUP;
    }
    ...
    public boolean keepRunning() {
        switch (mState) {
            ...
            case WARMUP:
                ...
                final long lastDuration = time - mLastTimeNs;
                mLastTimeNs = time;
