...
class BenchmarkState internal constructor() {
    ...
    internal companion object {
         ...
         * @param nanos Summary number for benchmark result, in nanoseconds
         ...
         * @param repeatIterations Number of iterations in between each measurement
         */
        @Suppress("unused")
        @JvmStatic
        fun reportData(
            ...
            val bundle = Bundle()
            bundle.putIdeSummaryLine(testName, nanos)
            InstrumentationRegistry.getInstrumentation().sendStatus(Activity.RESULT_OK, bundle)
