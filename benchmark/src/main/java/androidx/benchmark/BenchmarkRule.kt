...
class BenchmarkRule : TestRule {
    ...
    override fun apply(base: Statement, description: Description): Statement {
        return RuleChain
            ...
            .around(::applyBenchmarkRule)
            .apply(base, description)
    }

    private fun applyBenchmarkRule(base: Statement, description: Description) = evaluate {
        applied = true
...
internal fun evaluate(evaluate: () -> Unit) = object : Statement() {
