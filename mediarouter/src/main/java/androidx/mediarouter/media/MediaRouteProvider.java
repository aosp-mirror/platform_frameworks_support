...
public abstract class MediaRouteProvider {
    ...
    public abstract static class DynamicGroupRouteController extends RouteController {
        /**
         * Returns the ID of the dynamic group route. Note that the route may have not been
        ...
        /**
         * The title of the groupable routes section on the UX such as
        ...
        /**
         * The title of the transferable routes section on the UX such as
         * {@link androidx.mediarouter.app.MediaRouteCastDialog}, which is proposed by
         * {@link MediaRouteProvider}.
         * e.g. "Play on group."
         */
