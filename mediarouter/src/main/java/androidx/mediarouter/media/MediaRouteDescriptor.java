...
public final class MediaRouteDescriptor {
    ...
    static final String KEY_IS_DYNAMIC_ROUTE = "isDynamicRoute";
    ...
    /**
     * Returns if this route is a dynamic route.
     * <p>
     * {@link MediaRouteProvider} creates a dynamic route when
     * {@link MediaRouteProvider#onCreateDynamicRouteController(String)} is called.
     * It happens when a single route or a single static group is selected.
     * </p>
     * <p>
     * If a single device or a static group is selected, the associated dynamic route
     ...
     * The provider can treat this by not setting the media intent for the dynamic route
     * if it contains only one member.
     * </p>>
     * @return {@code true} if this route is a dynamic route.
     *
     * @hide TODO unhide this method and updateApi
     */
    @RestrictTo(LIBRARY_GROUP)
    public boolean isDynamicRoute() {
        return mBundle.getBoolean(KEY_IS_DYNAMIC_ROUTE, false);
    }
    ...
    public static final class Builder {
        ...
        /**
         * Sets whether the route is a dynamic route.
         * @see #isDynamicRoute()
         *
         * @hide TODO unhide this method and updateApi
         */
        @RestrictTo(LIBRARY_GROUP)
        public Builder setIsDynamicRoute(boolean isDynamic) {
            mBundle.putBoolean(KEY_IS_DYNAMIC_ROUTE, isDynamic);
            return this;
        }
        /**
