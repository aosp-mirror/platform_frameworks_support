...
class MediaRouteVolumeSlider extends AppCompatSeekBar {
    ...
    protected void drawableStateChanged() {
        ...
        mThumb.setColorFilter(mAccentColor, PorterDuff.Mode.SRC_IN);
        ...
        progressDrawable.setColorFilter(mAccentColor, PorterDuff.Mode.SRC_IN);
    ...
    /**
     * Sets accent color of the volume slider which fills both progress part of the prgressbar and
    ...
    public void setAccentColor(int accentColor) {
        ...
        if (Color.alpha(accentColor) != 0xFF) {
