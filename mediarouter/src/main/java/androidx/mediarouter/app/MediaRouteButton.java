...
public class MediaRouteButton extends View {
     ...
     * When true, the button is visible even if there is no routes to connect.
     * You may want to override {@link View#performClick()} to change behavior
     * when the button is clicked.
     * It doesn't overrides {@link View#setVisibility visibility} of the button.
     *
