...
public class MediaRouteCastDialog extends AppCompatDialog {
    ...
    static final float MIN_UNMUTED_VOLUME_RATIO = .1f;
    ...
    @SuppressWarnings("WeakerAccess") /* synthetic access */
    Map<String, Integer> mBeforeMuteVolumes;
    @SuppressWarnings("WeakerAccess") /* synthetic access */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBeforeMuteVolumes = new HashMap<>();
    ...
    private class VolumeChangeListener implements SeekBar.OnSeekBarChangeListener {
        ...
        public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
            if (fromUser) {
                ...
                if (progress == 0) {
                    mBeforeMuteVolumes.put(route.getId(), oldVolume);
                }
                ...
                // volume can be restored to that value when user unmutes it.
                if (progress == 0) {
                    mBeforeMuteVolumes.put(route.getId(), route.getVolume());
                }
                route.requestSetVolume(progress);
    ...
    private final class RecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        private class GroupVolumeViewHolder extends RecyclerView.ViewHolder
            ...
            public void updateVolume() {
                ...
                mMuteButton.setSelected(isMute);
            ...
            int getUnmutedVolume() {
                Integer beforeMuteVolume = mBeforeMuteVolumes.get(mRoute.getId());
                int minUnmutedVolume =
                        (int) Math.ceil(mRoute.getVolumeMax() * MIN_UNMUTED_VOLUME_RATIO);

                return (beforeMuteVolume == null)
                        ? minUnmutedVolume : Math.max(minUnmutedVolume, beforeMuteVolume);
            }
