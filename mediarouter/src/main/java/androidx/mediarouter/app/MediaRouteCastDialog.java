...
public class MediaRouteCastDialog extends AppCompatDialog {
    ...
    void update() {
        // Defer dialog updates when user is adjusting volume or selecting route, to prevent dialog
        // from being dismissed when MediaRouterCallback#onRouteUnselected is triggered in the
        // process of selecting route.
