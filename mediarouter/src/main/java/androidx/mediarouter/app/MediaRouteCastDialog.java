...
public class MediaRouteCastDialog extends AppCompatDialog {
    ...
    private void updateRouteView(MediaRouter.RouteInfo route) {
    ...
    private final class MediaRouterCallback extends MediaRouter.Callback {
        ...
        public void onRouteChanged(MediaRouter router, MediaRouter.RouteInfo route) {
            ...
            // been changed. So, update not only itself and but also all of its member routes.
            if (route instanceof MediaRouter.RouteGroup) {
                MediaRouter.RouteGroup routeGroup = (MediaRouter.RouteGroup) route;
                for (MediaRouter.RouteInfo memberRoute : routeGroup.getMemberRoutes()) {
