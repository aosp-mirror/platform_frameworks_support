...
public class MediaRouteCastDialog extends AppCompatDialog {
    ...
    @SuppressWarnings("WeakerAccess") /* synthetic access */
    Map<String, ViewHolderWithVolumeSlider> mViewHolderMap;
    @SuppressWarnings("WeakerAccess") /* synthetic access */
    ...
    MediaRouteVolumeSlider getVolumeSlider(@NonNull MediaRouter.RouteInfo route) {
        ViewHolderWithVolumeSlider viewHolder = mViewHolderMap.get(route.getId());
        return (viewHolder == null) ? null : viewHolder.getVolumeSlider();
    }
    ...
    private interface ViewHolderWithVolumeSlider {
    ...
    private final class RecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        private class GroupVolumeViewHolder extends RecyclerView.ViewHolder
                implements ViewHolderWithVolumeSlider {
