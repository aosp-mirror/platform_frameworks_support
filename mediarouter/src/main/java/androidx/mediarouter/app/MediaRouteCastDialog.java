...
public class MediaRouteCastDialog extends AppCompatDialog {
    ...
    private abstract class MediaRouteVolumeSliderHolder extends RecyclerView.ViewHolder {
        ...
        private final StateListDrawable mMuteButtonIcon;
        ...
        MediaRouteVolumeSliderHolder(View itemView) {
            ...
            mMuteButtonIcon = MediaRouterThemeHelper.getMuteButtonDrawableIcon(mContext);
        }
        ...
        void bindRouteVolumeSliderHolder(MediaRouter.RouteInfo route) {
            ...
            mMuteButton.setImageDrawable(mMuteButtonIcon);
        ...
        void toggleMute() {
            ...
            mMuteButton.setActivated(!wasMuted);
