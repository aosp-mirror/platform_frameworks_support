...
public class Sparklers {
    ...
    public static Spark loadSpark(Context context, LoadPolicy policy) throws SparkException {
        ...
        try {
            ...
            String sha1 = getSHA1(sig.toByteArray());
            if (policy.getReleaseSha1() == null || !policy.getReleaseSha1().equals(sha1)) {
                if (Build.TYPE.equals("user") || policy.getDebugSha1() == null
                        || !policy.getDebugSha1().equals(sha1)) {
                    throw new Exception("Incorrect signature");
                }
            }
            Log.d(TAG, "Signature: "+ sha1);
