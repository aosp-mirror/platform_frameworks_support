...
public final class LoadPolicy {
    ...
    private final String mReleaseSha256;
    private final String mDebugSha256;
    ...
    LoadPolicy(String library, List<String> disabled, String version, int mode,
            String minVersion, String sha256, String debugSha256) {
        mLibrary = library;
        mDisabled = disabled;
        mLocalVersion = version;
        mMode = mode;
        mMinVersion = minVersion;
        mReleaseSha256 = sha256 != null ? sha256.toUpperCase() : null;
        mDebugSha256 = debugSha256 != null ? debugSha256.toUpperCase() : null;
    }

    public String getReleaseSha256() {
        return mReleaseSha256;
    }

    public String getDebugSha256() {
        return mDebugSha256;
    }
    ...
    public static class Builder {
         ...
         */
        public Builder setReleaseSha256(String sha256) {
            mSha256 = sha256;
            return this;
        }
         ...
         */
        public Builder setDebugSha256(String sha256) {
            mDebugSha256 = sha256;
            return this;
        }
