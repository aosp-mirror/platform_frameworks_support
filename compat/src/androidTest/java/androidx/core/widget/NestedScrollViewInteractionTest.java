...
public class NestedScrollViewInteractionTest {
    ...
    public void uiFingerDown_parentHasNestedScrollingChildWithTypeTouch() {
        ...
        assertThat(mParentSpy.mHasNestedScrollingChild, is(true));
        assertThat(mParentSpy.mNestedScrollingType, is(ViewCompat.TYPE_TOUCH));
    }
    ...
    public void uiFingerUp_parentDoesNotHaveNestedScrollingChild() {
        ...
        assertThat(mParentSpy.mHasNestedScrollingChild, is(false));
    }
    ...
    public void uiFling_parentHasNestedScrollingChildWithTypeFling() {
        ...
        assertThat(mParentSpy.mHasNestedScrollingChild, is(true));
        assertThat(mParentSpy.mNestedScrollingType, is(ViewCompat.TYPE_NON_TOUCH));
    }
    ...
    public class NestedScrollingSpyView extends FrameLayout implements NestedScrollingChild3,
        ...
        public boolean mHasNestedScrollingChild;
        public int mNestedScrollingType;
        ...
        public boolean onStartNestedScroll(@NonNull View child, @NonNull View target, int axes,
                int type) {
            mHasNestedScrollingChild = true;
            mNestedScrollingType = type;
            return true;
        }
        ...
        public void onStopNestedScroll(@NonNull View target, int type) {
            mHasNestedScrollingChild = false;
        }
