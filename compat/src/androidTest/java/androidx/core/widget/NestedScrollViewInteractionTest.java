...
public class NestedScrollViewInteractionTest extends
    ...
    public void setup() {
        ...
        View child = new View(mActivityTestRule.getActivity());
        ...
        mParentSpy = Mockito.spy(new NestedScrollingSpyView(mActivityTestRule.getActivity()));
    ...
    public void uiFingerScroll_scrollsBeyondLimit_remainderPassedToParent() {
        int touchSlop = ViewConfiguration.get(mActivityTestRule.getActivity()).getScaledTouchSlop();
