...
@MediumTest
public class ViewParentCompatTest extends BaseInstrumentationTestCase<ViewCompatActivity> {

    private View mView;

    public ViewParentCompatTest() {
        super(ViewCompatActivity.class);
    }

    @Before
    public void setup() {
        mView = new View(mActivityTestRule.getActivity());
    }
