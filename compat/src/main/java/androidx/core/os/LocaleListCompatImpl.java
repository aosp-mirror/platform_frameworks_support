...
class LocaleListCompatImpl extends LocaleListCompat {
    static final LocaleListCompatImpl EMPTY = new LocaleListCompatImpl();
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof LocaleListCompatImpl)) {
            return false;
        }
        final Locale[] otherList = ((LocaleListCompatImpl) other).mList;
    ...
    LocaleListCompatImpl(@NonNull Locale... list) {
        if (list.length == 0) {
            mList = sEmptyList;
