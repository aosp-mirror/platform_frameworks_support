...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2 {
     ...
     * {@link #getChildRect(android.view.View, boolean, android.graphics.RectF)}, with translation
     * disabled.
     *
     ...
     * {@link #recordLastChildRect(android.view.View, android.graphics.RectF)}.
     *
    ...
    public static abstract class Behavior<V extends View> {
        ...
        /**
         * @deprecated You should now override
         * {@link #getInsetDodgeRect(android.support.design.widget.CoordinatorLayout, V, RectF)}.
         */
        @Deprecated
        ...
        public boolean getInsetDodgeRect(@NonNull CoordinatorLayout parent, @NonNull V child,
                @NonNull RectF rect) {
            return getInsetDodgeRect(parent, child, new Rect(
