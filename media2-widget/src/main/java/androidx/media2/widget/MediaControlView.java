...
public class MediaControlView extends ViewGroup {
    ...
    private static final long DISABLE_ANIMATION = -1;
    private static final long DEFAULT_ANIMATION_INTERVAL_MS = 2000;
    ...
    public MediaControlView(@NonNull Context context, @Nullable AttributeSet attrs,
        ...
        initControllerView();
        mAnimationIntervalMs = DEFAULT_ANIMATION_INTERVAL_MS;
    ...
    private final Runnable mShowAllBars = new Runnable() {
        ...
        public void run() {
            ...
            if (mController.isPlaying()) {
                postDelayedRunnable(mHideMainBars, mAnimationIntervalMs);
            }
        }
    };
    ...
    Runnable mHideMainBars = new Runnable() {
        ...
        public void run() {
            ...
            postDelayedRunnable(mHideProgressBar, mAnimationIntervalMs);
        }
    };
