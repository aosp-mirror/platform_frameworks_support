...
public class LinearLayoutManager extends RecyclerView.LayoutManager implements
     ...
     * #getLayoutDirection()}, {@link #getStackFromEnd()} and {@link #getReverseLayout()}.</p>
     *
     ...
     * {@link RecyclerView.State#hasTargetScrollPosition()} to find out if a scroll is going on, and
     * {@link RecyclerView.State#getTargetScrollPosition()} to find out to which item it is
     * scrolling.</p>
     *
     * <p><strong>Note:</strong>Laying out invisible elements generally comes with significant
     * performance cost. It's typically only desirable in places like smooth scrolling to an unknown
    ...
    private void updateLayoutState(int layoutDirection, int requiredSpace,
        ...
        mReusableIntPair[1] = 0;
        calculateExtraLayoutSpace(state, mReusableIntPair);
        mLayoutState.mExtraFillSpace = layoutToEnd ? mReusableIntPair[1] : mReusableIntPair[0];
        mLayoutState.mNoRecycleSpace = layoutToEnd ? mReusableIntPair[0] : mReusableIntPair[1];
        int scrollingOffset;
        if (layoutToEnd) {
