...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
    ...
    public final class Recycler {
        ...
        public void recycleView(@NonNull View view) {
            ...
            // started yet, the ItemAnimation on the view may not be cleared.
            // In b/720547, the View is removed by scroll pass while it's waiting in
            // the pendingMoving list of DefaultItemAnimator and DefaultItemAnimator later in
