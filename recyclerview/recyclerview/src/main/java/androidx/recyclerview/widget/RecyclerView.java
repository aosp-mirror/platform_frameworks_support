...
public class RecyclerView extends ViewGroup implements ScrollingView,
    ...
    public final class Recycler {
        ...
        ViewHolder tryGetViewHolderForPositionByDeadline(int position,
            ...
            if (holder == null) {
                ...
                if (holder == null) {
                    ...
                    itemDelegate.setAppAccessibilityDelegate(currentDelegate);
                    if (ALLOW_THREAD_GAP_WORK) {
        ...
        private void attachAccessibilityDelegateOnBind(ViewHolder holder) {
            if (isAccessibilityEnabled()) {
                ...
                AccessibilityDelegateCompat appDelegate =
                        itemDelegate.getAppAccessibilityDelegate();
                if (appDelegate != null) {
                    ViewCompat.setAccessibilityDelegate(holder.itemView, appDelegate);
                } else {
                    ViewCompat.setAccessibilityDelegate(holder.itemView, itemDelegate);
                }
            }
        }
        ...
        void addViewHolderToRecycledViewPool(@NonNull ViewHolder holder, boolean dispatchRecycled) {
            ...
            AccessibilityDelegateCompat appDelegate =
                    ViewCompat.getAccessibilityDelegate(holder.itemView);
            if (appDelegate != itemDelegate) {
                itemDelegate.setAppAccessibilityDelegate(appDelegate);
            }
            if (dispatchRecycled) {
