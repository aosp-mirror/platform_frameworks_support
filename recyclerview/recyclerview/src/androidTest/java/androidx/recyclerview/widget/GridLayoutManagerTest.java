...
public class GridLayoutManagerTest extends BaseGridLayoutManagerTest {
    ...
    public void computeVerticalScrollValues_isCorrect() throws Throwable {
        ...
        final int childWidth = MATCH_PARENT;
        final int childHeight = 100;
        final int rvHeight = childHeight * 4;
        final int rvWidth = MATCH_PARENT;
        ...
        assertEquals(0, mGlm.computeVerticalScrollOffset(recyclerView.mState));
        assertEquals(rvHeight, mGlm.computeVerticalScrollExtent(recyclerView.mState));
        assertEquals(childHeight * expectedNumberOfRows,
        ...
        assertEquals(childHeight * 7, mGlm.computeVerticalScrollOffset(recyclerView.mState));
        assertEquals(rvHeight, mGlm.computeVerticalScrollExtent(recyclerView.mState));
        assertEquals(childHeight * expectedNumberOfRows,
                mGlm.computeVerticalScrollRange(recyclerView.mState));
        ...
        assertEquals(childHeight * (expectedNumberOfRows - 4),
