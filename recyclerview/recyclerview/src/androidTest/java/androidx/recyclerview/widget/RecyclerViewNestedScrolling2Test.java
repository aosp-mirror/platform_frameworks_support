...
@LargeTest
public class RecyclerViewNestedScrolling2Test {
    ...
    public RecyclerViewNestedScrolling2Test() {
    ...
    public void uiFling_fullyParticipatesInNestedScrolling() throws Throwable {
        ...
        verify(mParent, atLeastOnce()).onNestedScroll(eq(mRecyclerView),  anyInt(), anyInt(),
                anyInt(),
                anyInt(), eq(ViewCompat.TYPE_NON_TOUCH));
    ...
    public static class NestedScrollingSpyView extends FrameLayout implements NestedScrollingChild2,
