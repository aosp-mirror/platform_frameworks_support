...
public class RecyclerViewNestedScrollingChildTest {
    ...
    public void uiFling_horizontal_parentHasNestedScrollingChildWithTypeFling() {
        ...
        SimpleGestureGeneratorKt.simulateFling(mRecyclerView, context, 500, 500, Direction.LEFT);
    ...
    public void uiDown_duringFling_stopsNestedScrolling() {
        ...
        int targetTimePassed = flingData.getTimeMillis();
        MotionEvent[] motionEvents = SimpleGestureGeneratorKt
                .generateFlingMotionEvents(flingData, 500, 500, Direction.DOWN);
        SimpleGestureGeneratorKt.dispatchMotionEventsToView(mRecyclerView, motionEvents);
