...
public class RecyclerViewNestedScrollingChildTest {
    ...
    public void uiFling_vertical_parentHasNestedScrollingChildWithTypeFling() {
        setup(true, 100, true);
        int[] targetFlingTimeDistance = NestedScrollViewTestUtils
                .getTargetFlingVelocityTimeAndDistance(InstrumentationRegistry.getContext());
        int targetTimePassed = targetFlingTimeDistance[1];
        int targetDistanceTraveled = targetFlingTimeDistance[2];
