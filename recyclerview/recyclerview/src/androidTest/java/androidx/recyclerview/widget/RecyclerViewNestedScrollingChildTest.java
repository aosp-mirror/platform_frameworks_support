...
public class RecyclerViewNestedScrollingChildTest {
    ...
    public void uiFling_vertical_parentHasNestedScrollingChildWithTypeFling() {
        ...
        SimpleGestureGeneratorKt
                .simulateFling(mRecyclerView, context, startTime, 500, 500, Direction.UP);
    ...
    public void uiFling_horizontal_parentHasNestedScrollingChildWithTypeFling() {
        ...
        SimpleGestureGeneratorKt
                .simulateFling(mRecyclerView, context, startTime, 500, 500, Direction.LEFT);
    ...
    public void uiFling_callsNestedFlingsCorrectly() {
        ...
        SimpleGestureGeneratorKt.simulateFling(mRecyclerView, context, 500, 500, Direction.UP);
    ...
    public void uiDown_duringFling_stopsNestedScrolling() {
        ...
        int targetTimePassed = flingData.getTime();
        List<MotionEventData> motionEventData = SimpleGestureGeneratorKt
                .generateFlingMotionEvents(flingData, 500, 500, Direction.DOWN);
        SimpleGestureGeneratorKt
                .dispatchMotionEventsToView(mRecyclerView, startTime, motionEventData);
        ...
        MotionEvent down = MotionEvent.obtain(
                0,
                startTime + targetTimePassed + 100, // Should be after fling events occurred.
