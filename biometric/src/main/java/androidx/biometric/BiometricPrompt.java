 ...
 * callback and executor early in the fragment/activity lifecycle (e.g. onCreate) allows the
 * ongoing authenticate session's callbacks to be received by the new fragment/activity.
 * Note that {@link BiometricPrompt#cancelAuthentication()} should not be called, and
