 ...
 * callback and executor early in the fragment/activity lifecycle (e.g. onCreate) allows the new
 * fragment/activity to receive callbacks on the new executor. Note that
