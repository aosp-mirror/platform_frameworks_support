 ...
 * BiometricPrompt every time the activity/fragment is created. This allows authentication to work
 * across configuration changes. The internal implementation of the library uses fragments, which
 * can be saved/restored. Instantiating the library with a new callback and executor early in the
 * fragment/activity lifecycle (e.g. onCreate) allows the new fragment/activity to receive callbacks
 * on the new executor.
 */
