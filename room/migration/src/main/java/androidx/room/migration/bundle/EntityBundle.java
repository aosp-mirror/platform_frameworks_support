...
public class EntityBundle implements SchemaEquality<EntityBundle> {
    ...
    final String mCreateSql;
    @SerializedName("fields")
    final List<FieldBundle> mFields;
    @SerializedName("primaryKey")
    final PrimaryKeyBundle mPrimaryKey;
    @SerializedName("indices")
    final List<IndexBundle> mIndices;
    @SerializedName("foreignKeys")
    final List<ForeignKeyBundle> mForeignKeys;
