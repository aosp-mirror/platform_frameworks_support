 ...
 * used in queries.
 * <p>
 * All fields in an FtsEntity are of <code>TEXT</code> affinity, expect the for the 'rowid' and
 * 'languageid' fields.
 * <p>
...
public @interface FtsEntity {
     ...
     * <p>
     * The default value is {@link #FTS4}. When the entity version is FTS4 then disk space
     * consumption can be reduced by setting this option to FTS3, see
     * <a href=https://www.sqlite.org/fts3.html#the_matchinfo_option>the matchinfo= option
     * documentation</a> for details.
     * <p>
     * This option is only available in {@link #FTS4}.
     *
     * @return The match info version, either {@link #FTS4} or {@link #FTS3}.
     */
