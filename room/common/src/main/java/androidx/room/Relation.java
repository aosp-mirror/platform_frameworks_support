...
public @interface Relation {
     ...
     * the {@code .} notation.
     * <p>
     * For instance, if you have an {@link Embedded}d field named {@code playlist} with a sub field
     ...
     * in {@link #entityColumn()}. In a many-to-many using {@link #associateBy()} then
     ...
     * <p>
     * In a one-to-one or one-to-many relation, this value will be matched against the value defined
     * in {@link #parentColumn()} ()}. In a many-to-many using {@link #associateBy()} then
