...
public @interface Delete {
     ...
     * <p>
     * When this is declared, the delete method parameters are interpreted as partial entities. The
     * POJO class that represents the entity must contain a subset of the fields of the target
     * entity. The fields value will be used to find matching entities to delete.
     * <p>
