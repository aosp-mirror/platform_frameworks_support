 ...
 * create a backing SQLite view, and it will be updated when the query in {@link DatabaseView} is
 * changed.
 * <p>
 * Room automatically handles View migrations, so you don't need to write migrations for views.
 *
 * @see Dao
 * @see Database
 * @see ColumnInfo
