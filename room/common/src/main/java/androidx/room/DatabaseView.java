 ...
 * {@link DatabaseView} similarly to an {@link Entity}, but you can not INSERT, DELETE or UPDATE
 * into a {@link DatabaseView}.
 * <p>
 * Similarly to an {@link Entity} you can use {@link ColumnInfo} and {@link Embedded} inside to
 * customize the data class.
 * <p>
 * Example:
 * <pre>
 * {@literal @}DatabaseView(
 *     "SELECT id, name, release_year FROM Song WHERE release_year >= 1990 AND release_year <= 1990")
