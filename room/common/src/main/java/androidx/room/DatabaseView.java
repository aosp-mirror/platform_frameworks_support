 ...
 *
 * The class will behave like normal POJOs when it is used in {@link Dao}. You can also use
 * {@link ColumnInfo} and {@link Embedded} inside.
 *
 * <p>
 * Example:
 * <pre>
 ...
 * </pre>
 *
 * Views have to be registered to a RoomDatabase by {@link Database#views}. Room will create the
 * backing database view.
 *
 * @see Dao
 * @see Database
 * @see ColumnInfo
