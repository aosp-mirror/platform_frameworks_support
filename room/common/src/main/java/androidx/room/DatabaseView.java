 ...
 * </pre>
 *
 * Views have to be registered to a RoomDatabase by {@link Database#views}. Room will automatically
 * create a backing database view, and it will be updated when the query in {@link DatabaseView} is
 * changed. Views don't need migration.
 *
 * @see Dao
 * @see Database
 * @see ColumnInfo
