...
class InsertMethodAdapter private constructor(private val insertionType: InsertionType) {
    companion object {
        ...
        @VisibleForTesting
        val VOID_SET by lazy { setOf(InsertionType.INSERT_VOID) }
        @VisibleForTesting
        val SINGLE_ITEM_SET by lazy {
            setOf(InsertionType.INSERT_VOID, InsertionType.INSERT_SINGLE_ID)
        }
        @VisibleForTesting
        val MULTIPLE_ITEM_SET by lazy {
            setOf(InsertionType.INSERT_VOID, InsertionType.INSERT_ID_ARRAY,
