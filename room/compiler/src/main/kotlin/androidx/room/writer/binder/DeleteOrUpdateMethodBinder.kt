...
/**
 * Connects the delete or update method, the database and the [DeleteOrUpdateAdapter].
 * <p>
 ...
 */
abstract class DeleteOrUpdateMethodBinder(val adapter: DeleteOrUpdateAdapter?) {
