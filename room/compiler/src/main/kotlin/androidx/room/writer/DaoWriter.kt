...
import androidx.room.vo.SelectQueryMethod
import androidx.room.vo.Entity
import androidx.room.vo.InsertionMethod
import androidx.room.vo.InsertUpdateDeleteQueryMethod
...
class DaoWriter(val dao: Dao, val processingEnv: ProcessingEnvironment)
    ...
    override fun createTypeSpecBuilder(): TypeSpec.Builder {
        ...
        val groupedPreparedQueries = dao.queryMethods
                .filterIsInstance<InsertUpdateDeleteQueryMethod>()
        ...
        builder.apply {
            ...
            dao.queryMethods.filterIsInstance<SelectQueryMethod>().forEach { method ->
    ...
    private fun createPreparedQueries(
        preparedQueries: List<InsertUpdateDeleteQueryMethod>
    ...
    private fun createPreparedQueryMethodBody(
        method: InsertUpdateDeleteQueryMethod,
    ...
    private fun createSelectMethod(method: SelectQueryMethod): MethodSpec {
    ...
    private fun createPreparedQueryMethod(method: InsertUpdateDeleteQueryMethod): MethodSpec {
        return overrideWithoutAnnotations(method.element, declaredDao).apply {
    ...
    private fun createPreparedQueryMethodBody(method: InsertUpdateDeleteQueryMethod): CodeBlock {
        val queryWriter = QueryWriter(method)
        val scope = CodeGenScope(this)
    ...
    private fun createQueryMethodBody(method: SelectQueryMethod): CodeBlock {
        val queryWriter = QueryWriter(method)
        val scope = CodeGenScope(this)
        val sqlVar = scope.getTmpVar("_sql")
