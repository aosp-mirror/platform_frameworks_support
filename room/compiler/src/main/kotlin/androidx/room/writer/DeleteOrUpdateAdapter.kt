 ...
 */
class DeleteOrUpdateAdapter private constructor(val context: Context) {
    companion object {
        fun create(
            context: Context,
            returnType: TypeMirror
        ): DeleteOrUpdateAdapter? {
            if (isDeleteOrUpdateValid(returnType.typeName())) {
                return DeleteOrUpdateAdapter(context)
            }
            return null
        }
