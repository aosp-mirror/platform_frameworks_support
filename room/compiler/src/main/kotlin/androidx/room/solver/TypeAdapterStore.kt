...
import androidx.room.writer.DeleteOrUpdateAdapter
import androidx.room.writer.InsertMethodAdapter
import androidx.room.writer.binder.DeleteOrUpdateMethodBinder
import androidx.room.writer.binder.InsertMethodBinder
import androidx.room.writer.binder.InstantDeleteOrUpdateMethodBinder
import androidx.room.writer.binder.InstantInsertMethodBinder
import androidx.room.writer.binderprovider.InstantDeleteOrUpdateMethodBinderProvider
import androidx.room.writer.binderprovider.InstantInsertMethodBinderProvider
...
class TypeAdapterStore private constructor(
    ...
    fun findDeleteOrUpdateAdapter(typeMirror: TypeMirror): DeleteOrUpdateAdapter? {
        return DeleteOrUpdateAdapter.create(context, typeMirror)
    }
    ...
    fun findInsertAdapter(
        ...
        return InsertMethodAdapter.create(context, typeMirror, params)
    }
