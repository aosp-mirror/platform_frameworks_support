...
/**
 * Validates and provides a MethodBinder for ListenableFuture.
 *
 * See [androidx.room.solver.shortcut.binder.GuavaListenableFutureInsertMethodBinder]
 */
class GuavaListenableFutureInsertMethodBinderProvider(
    ...
    override fun provide(
        ...
        val adapter = context.typeAdapterStore.findInsertAdapter(declared.typeArguments.first(), params)
        return GuavaListenableFutureInsertMethodBinder(context, declared, adapter, params)
    }
}
