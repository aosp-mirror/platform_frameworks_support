...
data class ParsedQuery(
    val original: String,
    val type: QueryType,
    val resultColumns: List<SectionInfo>,
     ...
     */
    private var _expanded: String? = null
    ...
    val resolved: String
        get() = _expanded ?: original

    val sections by lazy {
        val specialSections: List<SectionInfo> = (inputs + resultColumns).sortedBy { it.start }
