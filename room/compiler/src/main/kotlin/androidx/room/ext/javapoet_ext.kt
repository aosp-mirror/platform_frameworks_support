 ...
 * ```
 */
private val PACKAGE_NAME_MAP: Map<String, String> by lazy {
    RoomProcessor::class.java.classLoader.getResourceAsStream("dejetifier.config")?.reader()?.use {
        try {
            ...
            // Malformed config file, ignore it.
            null
        }
    } ?: emptyMap()
}
internal val SQLITE_PACKAGE = PACKAGE_NAME_MAP.getOrDefault("androidx.sqlite", "androidx.sqlite")
internal val ROOM_PACKAGE = PACKAGE_NAME_MAP.getOrDefault("androidx.room", "androidx.room")
internal val PAGING_PACKAGE = PACKAGE_NAME_MAP.getOrDefault("androidx.paging", "androidx.paging")
internal val COLLECTION_PACKAGE =
    PACKAGE_NAME_MAP.getOrDefault("androidx.collection", "androidx.collection")
