...
class RoomProcessor : BasicAnnotationProcessor() {
    ...
    /**
     * Annotation processor option to tell Gradle that Room is an aggregating annotation processor.
     */
    ...
    private var jdkVersionHasBugReported: Boolean = false
    ...
    private fun methodParametersVisibleInClassFiles(): Boolean {
        ...
        if (currentJavaVersion >= SimpleJavaVersion.VERSION_11_0_0) {
            ...
            //    3. AS 3.5.0-beta02 and higher use JDK 1.8.0_202-release-1483-b39-5509098 or
            //       higher, which have the cherry-picked JDK fix.
            // Therefore, if the JDK version is 1.8.0_202, we need to filter out those exist in
            // range #2.
            if (isEmbeddedJdk && (currentJavaVersion > SimpleJavaVersion.VERSION_1_8_0_202)) {
                return true
            } else if (isEmbeddedJdk &&
                    (currentJavaVersion == SimpleJavaVersion.VERSION_1_8_0_202)
            ) {
