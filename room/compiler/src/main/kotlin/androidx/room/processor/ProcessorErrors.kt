...
object ProcessorErrors {
    ...
    fun missingFtsContentField(columnName: String) = "External Content FTS Entity has declared " +
            "field with column name '$columnName' that was not found in the external content " +
            "entity."

    fun missingExternalContentEntity(ftsClassName: String, className: String) =
            "External Content FTS Entity '$ftsClassName' has a declared content entity " +
                    "'$className' that is not present in the same @Database. Maybe you forgot to " +
                    "add it to the entities section of the @Database?"
}
