...
object ProcessorErrors {
    ...
    fun cannotFindAsEntityField(entityName: String) = "Cannot find a column in the entity " +
            ...
            "the field then you can annotate with @Ignore."

    val TOO_MANY_PARAMETERS_IN_SHOTCUT = "@Insert, @Update or @Delete method that declares a " +
            "target entity can only have one parameter."
