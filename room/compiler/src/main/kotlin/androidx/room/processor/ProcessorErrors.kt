...
object ProcessorErrors {
    ...
    fun unsupportedFTS3Option(optionName: String) = "$optionName is not supported on FTS3"
    ...
    val INVALID_FTS_ENTITY_FIELD_AFFINITY = "@FtsEntity annotated class field must be of TEXT " +
            "affinity."
}
