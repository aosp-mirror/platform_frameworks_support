...
import androidx.room.vo.DatabaseItem
import androidx.room.vo.Field
import com.squareup.javapoet.TypeName
import javax.lang.model.element.Name
import javax.lang.model.element.TypeElement

interface DatabaseItemProcessor {
    fun process(): DatabaseItem
}

/**
 * A dummy implementation of [DatabaseItemProcessor] that just prints a processor error for use of
 * an invalid class as [DatabaseItem].
 */
class NonDatabaseItemProcessor(
    val context: Context,
    val element: TypeElement,
    private val referenceStack: LinkedHashSet<Name>
) : DatabaseItemProcessor {

    override fun process(): DatabaseItem {
...
fun databaseItemProcessor(
    ...
    return when {
        ...
        element.hasAnnotation(DatabaseView::class) ->
            ...
            NonDatabaseItemProcessor(context, element, referenceStack)
    }
}
