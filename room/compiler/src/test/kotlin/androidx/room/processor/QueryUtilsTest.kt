...
class QueryUtilsTest {
    ...
    fun joinSelf() {
        withEntities(
            ...
            assertThat(
                expanded,
                `is`(equalTo("SELECT `Employee`.`id`, `Employee`.`name`, `Employee`.`managerId`, " +
    ...
    fun specifyAlias() {
        withEntities(
            ...
            assertThat(expanded, `is`(equalTo("SELECT `a_`.`id` AS `a_id`, " +
    ...
    fun newlineInProjection() {
        withEntities(
            ...
            assertThat(expanded, `is`(equalTo("""
                SELECT `id`,
                firstName
                |
                ' '
            ...
            .processedWith(
                TestProcessor.builder()
                    ...
                    .nextRunHandler { invocation ->
                        ...
                        val expanded = QueryUtils.expandProjection(query, pojo, entities)
