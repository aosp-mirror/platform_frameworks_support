...
import androidx.room.processor.ProcessorErrors.junctionColumnWithoutForeignKey
...
class PojoProcessorTest {
    ...
    @Test
    fun relation_associateBy_warnMissingForeignKeyOnJunctionColumn() {
        val junctionEntity = """
            package foo.bar;
        ...
        singleRun(
            """
                ...
                junctionColumnWithoutForeignKey("foo.bar.UserFriendsXRef", "uid"))
    }
