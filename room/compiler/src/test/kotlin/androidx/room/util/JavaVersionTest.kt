...
class JavaVersionTest {
    ...
    @Test
    fun testParse() {
        assert(JavaVersion.parse("11.0.1+13-LTS") == JavaVersion(11, 0, null))
        assert(JavaVersion.parse("1.8.0_202-release-1483-b39-5396753") == JavaVersion(8, 0, 202))
        assert(
            JavaVersion.parse("1.8.0_181-google-v7-238857965-238857965")
                    == JavaVersion(8, 0, 181)
        )
        try {
