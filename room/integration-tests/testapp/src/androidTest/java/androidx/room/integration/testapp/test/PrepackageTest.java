...
public class PrepackageTest {
    ...
    public void createFromAsset() {
        ...
        ProductsDatabase database = Room.databaseBuilder(
                ...
                .createFromFile("databases/products_v1.db", false)
                .build();
    ...
    public void createFromAsset_badSchema() {
        ...
        ProductsDatabase database = Room.databaseBuilder(
                ...
                .createFromFile("databases/products_badSchema.db", false)
                .build();
    ...
    public void createFromAsset_notFound() {
        ...
        ProductsDatabase database = Room.databaseBuilder(
                ...
                .createFromFile("databases/products_notFound.db", false)
                .build();
    ...
    public void createFromAsset_versionZero() {
        ...
        ProductsDatabase database = Room.databaseBuilder(
                ...
                .createFromFile("databases/products_v0.db", false)
                .build();
    ...
    public void createFromAsset_versionZero_badSchema() {
        ...
        ProductsDatabase database = Room.databaseBuilder(
                ...
                .createFromFile("databases/products_v0_badSchema.db", false)
                .build();
    ...
    public void createFromAsset_badDatabaseFile() {
        ...
        ProductsDatabase database = Room.databaseBuilder(
                ...
                .createFromFile("databases/products_badFile.db", false)
                .build();
    ...
    public void createFromAsset_closeAndReOpen_upgrade() {
        ...
        ProductsDatabase_v2 database_v2 = Room.databaseBuilder(
                context, ProductsDatabase_v2.class, "products.db")
                .createFromFile("databases/products_v2.db", false)
    ...
    public void createFromFile() throws IOException {
        ...
        ProductsDatabase database = Room.databaseBuilder(
                ...
                .createFromFile(dataDbFile.getAbsolutePath(), true)
                .build();
    ...
    @Test
    public void openDataDirDB() throws IOException {
        Context context = ApplicationProvider.getApplicationContext();
        context.deleteDatabase("products_external.db");
