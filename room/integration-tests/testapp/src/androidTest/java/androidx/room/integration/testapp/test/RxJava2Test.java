...
public class RxJava2Test extends TestDatabaseTest {
    ...
    @Test
    public void withShadowTable_Flowable() throws InterruptedException {
        ...
        Mail mail0 = TestUtil.createMail(0, "subject0", "body0");
        ...
        Mail mail1 = TestUtil.createMail(1, "subject1", "body1");
