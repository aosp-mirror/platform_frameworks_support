...
public class DatabaseConfiguration {
     ...
     * @param migrationNotRequiredFrom The collection of schema versions from which migrations
     *                                 aren't required.
     * @param copyFrom If Room should copy a pre-packaged on initial create. If set to anything
     *                 other than COPY_FROM_NONE, then path to cpy from should be set into the
     *                 {@code copyFromPath} parameter.
