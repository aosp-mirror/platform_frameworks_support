...
public class CursorUtil {
    ...
    /**
     * Copies the given cursor into a in-memory cursor.
     * <p>
     ...
     */
    @NonNull
    public static Cursor copy(@NonNull Cursor c) {
        final MatrixCursor matrixCursor = new MatrixCursor(c.getColumnNames(), c.getCount());
        while (c.moveToNext()) {
