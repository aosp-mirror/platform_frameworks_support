...
/**
 * Utility class for in-process and multi-process key-based lock mechanism.
 * <p>
...
public class ProcessLock {
    ...
    /**
     * Creates a lock with {@code key} as name and using {@code lockDir} as the directory for the
     * lock files.
     *
     * @param key the key name of this lock.
     * @param lockDir the directory where the lock files will be located.
     */
    public ProcessLock(@NonNull String key, @NonNull File lockDir) {
        mCopyLockFile = new File(lockDir, key + ".lck");
