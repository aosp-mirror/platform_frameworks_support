...
public class TableInfo {
     ...
     */
    @IntDef(value = {CREATED_FROM_UNKNOWN, CREATED_FROM_COMPILER, CREATED_FROM_PRAGMA})
     ...
     */
    public static final int CREATED_FROM_COMPILER = 1;

    /**
     * Identifier for when the info is created by reading information from a PRAGMA,
     * such as table_info.
     */
    public static final int CREATED_FROM_PRAGMA = 2;
    ...
    public static class Column {
        ...
        public boolean equals(Object o) {
            ...
            if (mCreatedFrom == CREATED_FROM_COMPILER
                    && column.mCreatedFrom == CREATED_FROM_PRAGMA
                    && (defaultValue != null && !defaultValue.equals(column.defaultValue))) {
                return false;
            } else if (mCreatedFrom == CREATED_FROM_PRAGMA
                    && column.mCreatedFrom == CREATED_FROM_COMPILER
