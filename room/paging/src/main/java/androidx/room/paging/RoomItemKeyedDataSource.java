 ...
 * <p>
 * You can extend this class to implement your own ItemKeyedDataSource backed by Room queries, which
 * will invalidate itself as tables are modified. This is useful if you want to avoid the drawback
 * of the default LIMIT/OFFSET based PositionalDataSource type generated by Room.
 * <p>
 ...
 * <p>
 * The code below implements a paged query of the 'user' table, sorted by mId. It uses multiple
 * queries defined on the Dao to implement the DataSource load methods.
 *
 * <pre>
 *
 * {@literal @}Dao
 ...
 *
 *     // count methods below optional - only needed to count placeholders
 *
