...
/**
 * An implementation of {@link KeyedAppStatesReporter} that only allows a single instance to exist
 * at one time, avoiding repeated instantiations.
 */
public class SingletonKeyedAppStatesReporter implements KeyedAppStatesReporter {
