...
public abstract class KeyedAppState {
     ...
     * triggered by
     * a particular value (e.g. a managed configuration value), it should be included in the
     * message.
     */
    @Nullable
    ...
    public abstract static class KeyedAppStateBuilder {
        ...
        public abstract KeyedAppStateBuilder setKey(String key);
        ...
        public abstract KeyedAppStateBuilder setMessage(String message);

        /** Set {@link KeyedAppState#data()}. */
        public abstract KeyedAppStateBuilder setData(String data);
         ...
         * most
         * 1000 characters, and data length is at most 1000 characters.
         */
