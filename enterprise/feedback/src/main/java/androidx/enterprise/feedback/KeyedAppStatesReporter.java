 ...
 * mobility management).
 *
 * <p>Use {@link SingletonKeyedAppStatesReporter} in production.
 */
public abstract class KeyedAppStatesReporter {
     ...
     */
    abstract void setStates(@NonNull Collection<KeyedAppState> states);
     ...
     */
    abstract void setStatesImmediate(@NonNull Collection<KeyedAppState> states);
}
