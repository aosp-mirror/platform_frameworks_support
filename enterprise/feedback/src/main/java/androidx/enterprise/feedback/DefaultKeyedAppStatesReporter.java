 ...
 */
public class DefaultKeyedAppStatesReporter extends KeyedAppStatesReporter {
     ...
     */
    public DefaultKeyedAppStatesReporter(@NonNull Context context, @NonNull Executor executor) {
        this.mContext = context.getApplicationContext();
        this.mExecutor = executor;
    }

    public DefaultKeyedAppStatesReporter(@NonNull Context context) {
