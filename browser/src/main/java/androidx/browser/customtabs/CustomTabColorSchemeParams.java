...
public class CustomTabColorSchemeParams {
    ...
    private CustomTabColorSchemeParams(
     ...
     */
    @NonNull
    public CustomTabColorSchemeParams addDefaults(@NonNull CustomTabColorSchemeParams defaults) {
        return new CustomTabColorSchemeParams(
    ...
    public static class Builder {
        ...
        /**
         * Combines all the options that have been into {@link CustomTabColorSchemeParams}
         * object.
         */
        @NonNull
