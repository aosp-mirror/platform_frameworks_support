...
public abstract class BrowserServiceImageReadTask extends AsyncTask<Uri, Void, Bitmap> {
    private static final String TAG = "BrowserServiceIRT";
    private final ContentResolver mResolver;

    public BrowserServiceImageReadTask(@NonNull ContentResolver resolver) {
        super();
        mResolver = resolver;
    }

    @Override
    protected @Nullable Bitmap doInBackground(@NonNull Uri... params) {
        try {
    ...
    @Override
    protected final void onPostExecute(@Nullable Bitmap bitmap) {
     ...
     */
    protected abstract void onBitmapFileReady(@Nullable Bitmap bitmap);
}
