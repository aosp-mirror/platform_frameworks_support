 ...
 * client.
 *
 * Call {@link #generateUri} to save the image and {@link #readImage} to read it.
 */
public final class BrowserServiceFileProvider extends FileProvider {
    ...
    static Set<Uri> sFilesInSerialization = new HashSet<>();
    ...
    @GuardedBy("sLatchMapLock")
    @SuppressWarnings("WeakerAccess") /* synthetic access */
    static Map<Uri, CountDownLatch> sUriLatchMap = new HashMap<>();

    @SuppressWarnings("WeakerAccess") /* synthetic access */
    static Object sLatchMapLock = new Object();
    ...
    private static class FileCleanupTask extends AsyncTask<Void, Void, Void> {
        ...
        FileCleanupTask(WeakReference<Context> contextRef) {
            super();
    ...
    @UiThread
    @NonNull
    public static Uri generateUri(@NonNull Context context, @NonNull Bitmap bitmap,
    ...
    /**
     * Asynchronously loads a {@link Bitmap} from the uri generated by {@link #generateUri}.
     ...
     *         completed, or {@code null} if the Bitmap failed to read.
     */
    @NonNull
    public static ListenableFuture<Bitmap> readImage(@NonNull final ContentResolver resolver,
