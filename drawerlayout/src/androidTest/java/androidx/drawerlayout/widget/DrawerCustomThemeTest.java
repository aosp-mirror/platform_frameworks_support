...
public class DrawerCustomThemeTest {
    ...
    public void testCustomElevation() {
        ...
        DrawerLayout drawerLayout = (DrawerLayout) activity.findViewById(
                R.id.drawer_layout);
        final float expectedElevation = activity.getResources().getDimension(R.dimen.custom_drawer_elevation);
