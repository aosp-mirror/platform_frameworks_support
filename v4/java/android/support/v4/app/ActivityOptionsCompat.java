...
public class ActivityOptionsCompat {
    ...
    public static ActivityOptionsCompat makeCustomAnimation(Context context,
        ...
        if (Build.VERSION.SDK_INT >= 16) {
            return ActivityOptionsCompatJB.makeCustomAnimation(context, enterResId, exitResId);
        }
    ...
    public static ActivityOptionsCompat makeScaleUpAnimation(View source,
        ...
        if (Build.VERSION.SDK_INT >= 16) {
            return ActivityOptionsCompatJB.makeScaleUpAnimation(source, startX, startY,
    ...
    public static ActivityOptionsCompat makeThumbnailScaleUpAnimation(View source,
        ...
        if (Build.VERSION.SDK_INT >= 16) {
            return ActivityOptionsCompatJB.makeThumbnailScaleUpAnimation(source, thumbnail,
                    startX, startY);
        }
        return new ActivityOptionsCompat();
    }
