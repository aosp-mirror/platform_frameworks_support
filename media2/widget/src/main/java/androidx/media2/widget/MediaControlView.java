...
public class MediaControlView extends ViewGroup {
    ...
    public void setMediaController(@NonNull MediaController controller) {
        ...
        mPlayer = new CommonPlayer(controller, ContextCompat.getMainExecutor(getContext()),
                new Callback());
        ...
        mOverflowShowAnimator.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                findControlButton(SIZE_TYPE_FULL, R.id.ffwd).setVisibility(
                        mPlayer.canSeekForward() ? View.INVISIBLE : View.GONE);
            }
        });
    ...
    private void ensurePlayerIsNotNull() {
        if (mPlayer == null) {
    ...
    class Callback extends CommonPlayer.CommonCallback {
        private int mPrevState = SessionPlayer.PLAYER_STATE_IDLE;

        @Override
        public void onPlayerStateChanged(@NonNull CommonPlayer player, int state) {
            if (DEBUG) {
        ...
        @Override
        public void onSeekCompleted(@NonNull CommonPlayer player, long position) {
            if (DEBUG) {
        ...
        @Override
        public void onCurrentMediaItemChanged(@NonNull CommonPlayer player,
        ...
        @Override
        public void onPlaybackCompleted(@NonNull CommonPlayer player) {
            if (DEBUG) {
        ...
        @Override
        public void onAllowedCommandsChanged(@NonNull CommonPlayer player,
                @NonNull SessionCommandGroup commands) {
            updateAllowedCommands();
        }

        @Override
        public void onPlaybackSpeedChanged(@NonNull CommonPlayer player, float speed) {
        ...
        @Override
        @NonNull
        public SessionResult onCustomCommand(@NonNull CommonPlayer player,
