...
public class MediaControlView extends ViewGroup {
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        if (mSizeType == SIZE_TYPE_UNDEFINED && mPlayer != null) {
    ...
    class PlayerCallback extends PlayerWrapper.PlayerCallback {
        ...
        void onAttachCallback(@NonNull PlayerWrapper player) {
            ...
            if (item != null) {
                ...
                updatePlaybackSpeedList(player.getPlaybackSpeed());
        ...
        public void onAllowedCommandsChanged(@NonNull PlayerWrapper player,
            ...
            if (DEBUG) {
                Log.d(TAG, "onAllowedCommandsChanged()");
            }
        ...
        void onVideoSizeChanged(@NonNull PlayerWrapper player, @NonNull MediaItem item,
            ...
            if (DEBUG) {
                Log.d(TAG, "onVideoSizeChanged(): vide size: " + videoSize);
            }
