...
public class MediaControlView extends ViewGroup {
    ...
    public void setMediaController(@NonNull MediaController controller) {
        ...
        mPlayer = new WidgetPlayer(controller, ContextCompat.getMainExecutor(getContext()),
                new PlayerCallback());
    ...
    class PlayerCallback extends WidgetPlayer.WidgetCallback {
        @Override
        public void onPlayerStateChanged(@NonNull WidgetPlayer player, int state) {
            if (DEBUG) {
        ...
        @Override
        public void onSeekCompleted(@NonNull WidgetPlayer player, long position) {
            if (DEBUG) {
        ...
        @Override
        public void onCurrentMediaItemChanged(@NonNull WidgetPlayer player,
        ...
        @Override
        public void onPlaybackCompleted(@NonNull WidgetPlayer player) {
            if (DEBUG) {
        ...
        @Override
        public void onAllowedCommandsChanged(@NonNull WidgetPlayer player,
                @NonNull SessionCommandGroup commands) {
            updateAllowedCommands();
        }

        @Override
        public void onPlaybackSpeedChanged(@NonNull WidgetPlayer player, float speed) {
        ...
        @Override
        @NonNull
        public SessionResult onCustomCommand(@NonNull WidgetPlayer player,
