...
public class MediaPlayer extends SessionPlayer {
    ...
    @NonNull
    @Override
    public ListenableFuture<PlayerResult> selectTrackInternal(TrackInfoInternal info) {
    ...
    @NonNull
    @Override
    public ListenableFuture<PlayerResult> deselectTrackInternal(TrackInfoInternal info) {
