...
public abstract class SessionPlayer implements AutoCloseable {
    ...
    public List<TrackInfo> getTrackInfoInternal() {
        throw new IllegalStateException("getTrackInfoInternal is for internal use only.");
    };

    /**
     * TODO: Change this into selectTrackInternal(TrackInfo)
     * @hide
     */
    @RestrictTo(LIBRARY_GROUP)
    @NonNull
    public ListenableFuture<PlayerResult> selectTrackInternal(
        ...
        throw new IllegalStateException("selectTrackInternal is for internal use only.");
    }

    /**
     * TODO: Change this into deselectTrackInternal(TrackInfo)
     * @hide
     */
    @RestrictTo(LIBRARY_GROUP)
    @NonNull
    public ListenableFuture<PlayerResult> deselectTrackInternal(
            @NonNull TrackInfo trackInfo) {
        throw new IllegalStateException("deselectTrackInternal is for internal use only.");
    }
