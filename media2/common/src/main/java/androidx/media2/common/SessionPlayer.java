...
public abstract class SessionPlayer implements AutoCloseable {
    ...
    public abstract @NonNull List<TrackInfoInternal> getTrackInfoInternal();
     ...
     */
    @RestrictTo(LIBRARY_GROUP)
    public abstract @NonNull ListenableFuture<PlayerResult> selectTrackInternal(
     ...
     */
    @RestrictTo(LIBRARY_GROUP)
    public abstract @NonNull ListenableFuture<PlayerResult> deselectTrackInternal(
            @NonNull TrackInfoInternal trackInfo);
