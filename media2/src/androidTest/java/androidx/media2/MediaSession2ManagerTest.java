...
/**
 * Tests {@link MediaSession2ManagerTest}.
 */
@SdkSuppress(minSdkVersion = Build.VERSION_CODES.P)
@RunWith(AndroidJUnit4.class)
@SmallTest
public class MediaSession2ManagerTest extends MediaTestBase {
    ...
    public void testGetSessionServiceTokens() {
        ...
        MediaSession2Manager session2Manager = MediaSession2Manager.getSession2Manager(mContext);
        List<SessionToken2> serviceTokens = session2Manager.getSessionServiceTokens();
