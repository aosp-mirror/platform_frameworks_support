...
oneway interface IMediaController2 {
    ...
    //////////////////////////////////////////////////////////////////////////////////////////////
    // Command from session to controller
    //////////////////////////////////////////////////////////////////////////////////////////////
    void onSessionResult(int seq, in ParcelImpl sessionResult) = 24;
    void setCustomLayout(int seq, in List<ParcelImpl> commandButtonlist) = 14;
    void sendCustomCommand(int seq, in ParcelImpl command, in Bundle args) = 16;
