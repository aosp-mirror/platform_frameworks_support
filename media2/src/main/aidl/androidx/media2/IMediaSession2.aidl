...
oneway interface IMediaSession2 {
    ...
    void sendCustomCommand(IMediaController2 caller, int seq, in ParcelImpl sessionCommand2,
            in Bundle args) = 11;
    void prepareFromUri(IMediaController2 caller, int seq, in Uri uri, in Bundle extras) = 12;
    void prepareFromSearch(IMediaController2 caller, int seq, String query, in Bundle extras) = 13;
