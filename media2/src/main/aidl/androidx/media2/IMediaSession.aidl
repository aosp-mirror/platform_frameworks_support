...
oneway interface IMediaSession {
    ...
    void subscribeRoutesInfo(IMediaController caller, int seq) = 33;
    void unsubscribeRoutesInfo(IMediaController caller, int seq) = 34;
    void selectRoute(IMediaController caller, int seq, in Bundle route) = 35;
