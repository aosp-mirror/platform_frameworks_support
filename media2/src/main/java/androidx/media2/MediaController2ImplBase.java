...
import static androidx.media2.MediaController2.RESULT_CODE_PERMISSION_DENIED;
...
class MediaController2ImplBase implements MediaController2Impl {
    ...
    @FunctionalInterface
    private interface RemoteProcessCommand {
        void run(IMediaSession2 iSession2, int seq) throws RemoteException;
    }

    private ListenableFuture<CommandResult2> sendCommand(int commandCode,
            RemoteProcessCommand command) {
        final IMediaSession2 iSession2 = getSessionInterfaceIfAble(commandCode);
        if (iSession2 != null) {
            final CallSequenceManager.RemoteProcessFuture<CommandResult2> result =
                    mCallSequenceManager.createRemoteProcessFuture();
            try {
                command.run(iSession2, result.getSequenceNumber());
            } catch (RemoteException e) {
                Log.w(TAG, "Cannot connect to the service or the session is gone", e);
                result.set(new CommandResult2(RESULT_CODE_DISCONNECTED, null));
            }
            return result;
        } else {
            ...
            result.set(new CommandResult2(RESULT_CODE_PERMISSION_DENIED, null));
            return result;
        }
    }
    ...
    public ListenableFuture<CommandResult2> play() {
        return sendCommand(COMMAND_CODE_PLAYER_PLAY, new RemoteProcessCommand() {
            @Override
    ...
    public ListenableFuture<CommandResult2> pause() {
        return sendCommand(COMMAND_CODE_PLAYER_PAUSE, new RemoteProcessCommand() {
            @Override
            public void run(IMediaSession2 iSession2, int seq) throws RemoteException {
    ...
    public ListenableFuture<CommandResult2> prepare() {
        return sendCommand(COMMAND_CODE_PLAYER_PREPARE, new RemoteProcessCommand() {
            @Override
            public void run(IMediaSession2 iSession2, int seq) throws RemoteException {
    ...
    public ListenableFuture<CommandResult2> fastForward() {
        return sendCommand(COMMAND_CODE_SESSION_FAST_FORWARD, new RemoteProcessCommand() {
            @Override
            public void run(IMediaSession2 iSession2, int seq) throws RemoteException {
    ...
    public ListenableFuture<CommandResult2> rewind() {
        return sendCommand(COMMAND_CODE_SESSION_REWIND, new RemoteProcessCommand() {
            @Override
            public void run(IMediaSession2 iSession2, int seq) throws RemoteException {
    ...
    @Override
    public ListenableFuture<CommandResult2> seekTo(final long pos) {
        if (pos < 0) {
            throw new IllegalArgumentException("position shouldn't be negative");
        }
        return sendCommand(COMMAND_CODE_PLAYER_SEEK_TO, new RemoteProcessCommand() {
            @Override
            public void run(IMediaSession2 iSession2, int seq) throws RemoteException {
    ...
    @Override
    public ListenableFuture<CommandResult2> playFromMediaId(final @NonNull String mediaId,
            final @Nullable Bundle extras) {
        return sendCommand(COMMAND_CODE_SESSION_PLAY_FROM_MEDIA_ID, new RemoteProcessCommand() {
            @Override
            public void run(IMediaSession2 iSession2, int seq) throws RemoteException {
    ...
    @Override
    public ListenableFuture<CommandResult2> playFromSearch(final @NonNull String query,
            final @Nullable Bundle extras) {
        return sendCommand(COMMAND_CODE_SESSION_PLAY_FROM_SEARCH, new RemoteProcessCommand() {
            @Override
            public void run(IMediaSession2 iSession2, int seq) throws RemoteException {
    ...
    @Override
    public ListenableFuture<CommandResult2> playFromUri(final @NonNull Uri uri,
            final @NonNull Bundle extras) {
        return sendCommand(COMMAND_CODE_SESSION_PLAY_FROM_URI, new RemoteProcessCommand() {
            @Override
            public void run(IMediaSession2 iSession2, int seq) throws RemoteException {
    ...
    @Override
    public ListenableFuture<CommandResult2> prepareFromMediaId(final @NonNull String mediaId,
            final @Nullable Bundle extras) {
        return sendCommand(COMMAND_CODE_SESSION_PREPARE_FROM_MEDIA_ID, new RemoteProcessCommand() {
            @Override
            public void run(IMediaSession2 iSession2, int seq) throws RemoteException {
    ...
    @Override
    public ListenableFuture<CommandResult2> prepareFromSearch(final @NonNull String query,
            final @Nullable Bundle extras) {
        return sendCommand(COMMAND_CODE_SESSION_PREPARE_FROM_SEARCH, new RemoteProcessCommand() {
            @Override
            public void run(IMediaSession2 iSession2, int seq) throws RemoteException {
    ...
    @Override
    public ListenableFuture<CommandResult2> prepareFromUri(final @NonNull Uri uri,
            final @Nullable Bundle extras) {
        return sendCommand(COMMAND_CODE_SESSION_PREPARE_FROM_URI, new RemoteProcessCommand() {
            @Override
            public void run(IMediaSession2 iSession2, int seq) throws RemoteException {
    ...
    @Override
    public ListenableFuture<CommandResult2> setVolumeTo(final int value,
            final @VolumeFlags int flags) {
        return sendCommand(COMMAND_CODE_VOLUME_SET_VOLUME, new RemoteProcessCommand() {
            @Override
            public void run(IMediaSession2 iSession2, int seq) throws RemoteException {
    ...
    @Override
    public ListenableFuture<CommandResult2> adjustVolume(final @VolumeDirection int direction,
            final @VolumeFlags int flags) {
        return sendCommand(COMMAND_CODE_VOLUME_ADJUST_VOLUME, new RemoteProcessCommand() {
            @Override
            public void run(IMediaSession2 iSession2, int seq) throws RemoteException {
    ...
    @Override
    public ListenableFuture<CommandResult2> setPlaybackSpeed(final float speed) {
        return sendCommand(COMMAND_CODE_PLAYER_SET_SPEED, new RemoteProcessCommand() {
            @Override
            public void run(IMediaSession2 iSession2, int seq) throws RemoteException {
    ...
    @Override
    public ListenableFuture<CommandResult2> setRating(final @NonNull String mediaId,
            final @NonNull Rating2 rating) {
        return sendCommand(COMMAND_CODE_SESSION_SET_RATING, new RemoteProcessCommand() {
            @Override
            public void run(IMediaSession2 iSession2, int seq) throws RemoteException {
    ...
    @Override
    public ListenableFuture<CommandResult2> sendCustomCommand(
            final @NonNull SessionCommand2 command, final @Nullable Bundle args,
            final @Nullable ResultReceiver cb) {
        return sendCommand(COMMAND_CODE_PLAYER_PREPARE, new RemoteProcessCommand() {
            @Override
            public void run(IMediaSession2 iSession2, int seq) throws RemoteException {
    ...
    @Override
    public ListenableFuture<CommandResult2> setPlaylist(final @NonNull List<MediaItem2> list,
            final @Nullable MediaMetadata2 metadata) {
        return sendCommand(COMMAND_CODE_PLAYER_SET_PLAYLIST, new RemoteProcessCommand() {
            @Override
            public void run(IMediaSession2 iSession2, int seq) throws RemoteException {
    ...
    public ListenableFuture<CommandResult2> updatePlaylistMetadata(
            final @Nullable MediaMetadata2 metadata) {
        return sendCommand(COMMAND_CODE_PLAYER_UPDATE_LIST_METADATA, new RemoteProcessCommand() {
            @Override
            public void run(IMediaSession2 iSession2, int seq) throws RemoteException {
    ...
    @Override
    public ListenableFuture<CommandResult2> addPlaylistItem(final int index,
            final @NonNull MediaItem2 item) {
        return sendCommand(COMMAND_CODE_PLAYER_ADD_PLAYLIST_ITEM, new RemoteProcessCommand() {
            @Override
            public void run(IMediaSession2 iSession2, int seq) throws RemoteException {
    ...
    @Override
    public ListenableFuture<CommandResult2> removePlaylistItem(final @NonNull MediaItem2 item) {
        return sendCommand(COMMAND_CODE_PLAYER_REMOVE_PLAYLIST_ITEM, new RemoteProcessCommand() {
            @Override
            public void run(IMediaSession2 iSession2, int seq) throws RemoteException {
    ...
    @Override
    public ListenableFuture<CommandResult2> replacePlaylistItem(final int index,
                final @NonNull MediaItem2 item) {
        return sendCommand(COMMAND_CODE_PLAYER_REPLACE_PLAYLIST_ITEM, new RemoteProcessCommand() {
            @Override
            public void run(IMediaSession2 iSession2, int seq) throws RemoteException {
    ...
    @Override
    public ListenableFuture<CommandResult2> skipToPlaylistItem(final @NonNull MediaItem2 item) {
        return sendCommand(COMMAND_CODE_PLAYER_SKIP_TO_PLAYLIST_ITEM, new RemoteProcessCommand() {
            @Override
            public void run(IMediaSession2 iSession2, int seq) throws RemoteException {
    ...
    public ListenableFuture<CommandResult2> setRepeatMode(final int repeatMode) {
        return sendCommand(COMMAND_CODE_PLAYER_SET_REPEAT_MODE, new RemoteProcessCommand() {
            @Override
            public void run(IMediaSession2 iSession2, int seq) throws RemoteException {
    ...
    public ListenableFuture<CommandResult2> setShuffleMode(final int shuffleMode) {
        return sendCommand(COMMAND_CODE_PLAYER_SET_SHUFFLE_MODE, new RemoteProcessCommand() {
            @Override
            public void run(IMediaSession2 iSession2, int seq) throws RemoteException {
    ...
    public ListenableFuture<CommandResult2> subscribeRoutesInfo() {
        return sendCommand(COMMAND_CODE_SESSION_SUBSCRIBE_ROUTES_INFO, new RemoteProcessCommand() {
            @Override
            public void run(IMediaSession2 iSession2, int seq) throws RemoteException {
    ...
    @Override
    public ListenableFuture<CommandResult2> selectRoute(final @NonNull Bundle route) {
        return sendCommand(COMMAND_CODE_SESSION_SELECT_ROUTE, new RemoteProcessCommand() {
            @Override
            public void run(IMediaSession2 iSession2, int seq) throws RemoteException {
