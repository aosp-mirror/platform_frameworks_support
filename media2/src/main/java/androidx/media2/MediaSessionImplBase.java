...
class MediaSessionImplBase implements MediaSessionImpl {
    ...
    public void close() {
        synchronized (mLock) {
            ...
            dispatchRemoteControllerCallbackTask(new RemoteControllerTask() {
                @Override
    ...
    public void setAllowedCommands(@NonNull ControllerInfo controller,
        ...
        if (mSessionStub.getConnectedControllersManager().isConnected(controller)) {
            ...
            dispatchRemoteControllerCallbackTask(controller, new RemoteControllerTask() {
                @Override
                public void run(ControllerCb callback, int seq) throws RemoteException {
    ...
    void dispatchRemoteControllerCallbackTask(@NonNull RemoteControllerTask task) {
        ...
        for (int i = 0; i < controllers.size(); i++) {
            ...
            dispatchRemoteControllerCallbackTask(controller, task);
        }
    }
    ...
    private static class SessionPlayerCallback extends SessionPlayer.PlayerCallback {
        ...
        public void onCurrentMediaItemChanged(final SessionPlayer player, final MediaItem item) {
            ...
            session.dispatchRemoteControllerCallbackTask(new RemoteControllerTask() {
                @Override
                public void run(ControllerCb callback, int seq) throws RemoteException {
