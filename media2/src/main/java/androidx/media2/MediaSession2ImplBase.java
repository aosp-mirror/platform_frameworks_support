...
class MediaSession2ImplBase implements MediaSession2Impl {
    ...
    public ListenableFuture<CommandResult2> play() {
        return executeCommand(new CommandRunnable<ListenableFuture<CommandResult2>>() {
            @Override
            public ListenableFuture<CommandResult2> run(SessionPlayer2 player) throws Exception {
    ...
    @Override public @SessionPlayer2.PlayerState int getPlayerState() {
        return executeCommand(new CommandRunnable<Integer>() {
            @Override
    ...
    public long getCurrentPosition() {
        return executeCommand(new CommandRunnable<Long>() {
            @Override
    ...
    public float getPlaybackSpeed() {
        return executeCommand(new CommandRunnable<Float>() {
            @Override
    ...
    public List<MediaItem2> getPlaylist() {
        return executeCommand(new CommandRunnable<List<MediaItem2>>() {
            @Override
    ...
    public MediaMetadata2 getPlaylistMetadata() {
        return executeCommand(new CommandRunnable<MediaMetadata2>() {
            @Override
    ...
    public MediaItem2 getCurrentMediaItem() {
        return executeCommand(new CommandRunnable<MediaItem2>() {
            @Override
    ...
    @Override
    public ListenableFuture<CommandResult2> setRepeatMode(
    ...
    @Override
    public ListenableFuture<CommandResult2> setShuffleMode(
    ...
    private ListenableFuture<CommandResult2> executeCommand(
            @NonNull CommandRunnable<ListenableFuture<CommandResult2>> command) {
        SettableFuture<CommandResult2> result = SettableFuture.create();
        result.set(new CommandResult2(RESULT_CODE_INVALID_OPERATION, null));
        return executeCommand(command, result);
    }

    private <T> T executeCommand(@NonNull CommandRunnable<T> command, T fallbackResult) {
        final SessionPlayer2 player;
        synchronized (mLock) {
            player = mPlayer;
        }
    ...
    interface CommandRunnable<T> {
        T run(SessionPlayer2 player) throws Exception;
    }
