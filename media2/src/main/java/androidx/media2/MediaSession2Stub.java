...
class MediaSession2Stub extends IMediaSession2.Stub {
                ...
                if (accept) {
                    ...
                    final List<MediaItem2> playlist =
                            allowedCommands.hasCommand(
                                    SessionCommand2.COMMAND_CODE_PLAYER_GET_LIST)
    ...
    public void setPlaylist(final IMediaController2 caller, final List<ParcelImpl> playlist,
        ...
        onSessionCommand(caller, SessionCommand2.COMMAND_CODE_PLAYER_SET_LIST,
                new SessionRunnable() {
                    @Override
                    public void run(ControllerInfo controller) throws RemoteException {
                        if (playlist == null) {
    ...
    public void addPlaylistItem(IMediaController2 caller, final int index,
        ...
        onSessionCommand(caller, SessionCommand2.COMMAND_CODE_PLAYER_ADD_ITEM,
                new SessionRunnable() {
                    @Override
                    public void run(ControllerInfo controller) throws RemoteException {
    ...
    public void removePlaylistItem(IMediaController2 caller, final ParcelImpl mediaItem) {
        onSessionCommand(caller, SessionCommand2.COMMAND_CODE_PLAYER_REMOVE_ITEM,
                new SessionRunnable() {
                    @Override
                    public void run(ControllerInfo controller) throws RemoteException {
                        MediaItem2 item = ParcelUtils.fromParcelable(mediaItem);
    ...
    public void replacePlaylistItem(IMediaController2 caller, final int index,
            final ParcelImpl mediaItem) {
        onSessionCommand(caller, SessionCommand2.COMMAND_CODE_PLAYER_REPLACE_ITEM,
                new SessionRunnable() {
                    @Override
                    public void run(ControllerInfo controller) throws RemoteException {
                        MediaItem2 item = ParcelUtils.fromParcelable(mediaItem);
    ...
    public void skipToPreviousItem(IMediaController2 caller) {
        onSessionCommand(caller, SessionCommand2.COMMAND_CODE_PLAYER_SKIP_TO_PREV_ITEM,
                new SessionRunnable() {
                    @Override
                    public void run(ControllerInfo controller) throws RemoteException {
    ...
    public void skipToNextItem(IMediaController2 caller) {
        onSessionCommand(caller, SessionCommand2.COMMAND_CODE_PLAYER_SKIP_TO_NEXT_ITEM,
                new SessionRunnable() {
                    @Override
                    public void run(ControllerInfo controller) throws RemoteException {
