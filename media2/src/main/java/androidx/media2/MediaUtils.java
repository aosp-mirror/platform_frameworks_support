...
import static androidx.media2.MediaMetadata.METADATA_KEY_ALBUM;
import static androidx.media2.MediaMetadata.METADATA_KEY_ALBUM_ART;
import static androidx.media2.MediaMetadata.METADATA_KEY_ALBUM_ARTIST;
import static androidx.media2.MediaMetadata.METADATA_KEY_ALBUM_ART_URI;
import static androidx.media2.MediaMetadata.METADATA_KEY_ART;
import static androidx.media2.MediaMetadata.METADATA_KEY_ARTIST;
import static androidx.media2.MediaMetadata.METADATA_KEY_ART_URI;
import static androidx.media2.MediaMetadata.METADATA_KEY_AUTHOR;
import static androidx.media2.MediaMetadata.METADATA_KEY_BROWSABLE;
import static androidx.media2.MediaMetadata.METADATA_KEY_COMPILATION;
import static androidx.media2.MediaMetadata.METADATA_KEY_COMPOSER;
import static androidx.media2.MediaMetadata.METADATA_KEY_DATE;
import static androidx.media2.MediaMetadata.METADATA_KEY_DISC_NUMBER;
...
import static androidx.media2.MediaMetadata.METADATA_KEY_GENRE;
...
import static androidx.media2.MediaMetadata.METADATA_KEY_NUM_TRACKS;
...
import static androidx.media2.MediaMetadata.METADATA_KEY_TRACK_NUMBER;
import static androidx.media2.MediaMetadata.METADATA_KEY_USER_RATING;
import static androidx.media2.MediaMetadata.METADATA_KEY_WRITER;
import static androidx.media2.MediaMetadata.METADATA_KEY_YEAR;
...
public class MediaUtils {
    ...
    static {
        ...
        METADATA_COMPAT_KEY_TO_METADATA_KEY.put(MediaMetadataCompat.METADATA_KEY_ALBUM,
                METADATA_KEY_ALBUM);
        METADATA_COMPAT_KEY_TO_METADATA_KEY.put(MediaMetadataCompat.METADATA_KEY_ALBUM_ART,
                METADATA_KEY_ALBUM_ART);
        METADATA_COMPAT_KEY_TO_METADATA_KEY.put(MediaMetadataCompat.METADATA_KEY_ALBUM_ARTIST,
                METADATA_KEY_ALBUM_ARTIST);
        METADATA_COMPAT_KEY_TO_METADATA_KEY.put(MediaMetadataCompat.METADATA_KEY_ALBUM_ART_URI,
                METADATA_KEY_ALBUM_ART_URI);
        METADATA_COMPAT_KEY_TO_METADATA_KEY.put(MediaMetadataCompat.METADATA_KEY_ART,
                METADATA_KEY_ART);
        METADATA_COMPAT_KEY_TO_METADATA_KEY.put(MediaMetadataCompat.METADATA_KEY_ARTIST,
                METADATA_KEY_ARTIST);
        METADATA_COMPAT_KEY_TO_METADATA_KEY.put(MediaMetadataCompat.METADATA_KEY_ART_URI,
                METADATA_KEY_ART_URI);
        METADATA_COMPAT_KEY_TO_METADATA_KEY.put(MediaMetadataCompat.METADATA_KEY_AUTHOR,
                METADATA_KEY_AUTHOR);
        METADATA_COMPAT_KEY_TO_METADATA_KEY.put(MediaMetadataCompat.METADATA_KEY_BT_FOLDER_TYPE,
                METADATA_KEY_BROWSABLE);
        METADATA_COMPAT_KEY_TO_METADATA_KEY.put(MediaMetadataCompat.METADATA_KEY_COMPILATION,
                METADATA_KEY_COMPILATION);
        METADATA_COMPAT_KEY_TO_METADATA_KEY.put(MediaMetadataCompat.METADATA_KEY_COMPOSER,
                METADATA_KEY_COMPOSER);
        METADATA_COMPAT_KEY_TO_METADATA_KEY.put(MediaMetadataCompat.METADATA_KEY_DATE,
                METADATA_KEY_DATE);
        METADATA_COMPAT_KEY_TO_METADATA_KEY.put(MediaMetadataCompat.METADATA_KEY_DISC_NUMBER,
                METADATA_KEY_DISC_NUMBER);
        METADATA_COMPAT_KEY_TO_METADATA_KEY.put(
                MediaMetadataCompat.METADATA_KEY_DISPLAY_DESCRIPTION,
                METADATA_KEY_DISPLAY_DESCRIPTION);
        METADATA_COMPAT_KEY_TO_METADATA_KEY.put(MediaMetadataCompat.METADATA_KEY_DISPLAY_ICON,
                METADATA_KEY_DISPLAY_ICON);
        METADATA_COMPAT_KEY_TO_METADATA_KEY.put(MediaMetadataCompat.METADATA_KEY_DISPLAY_ICON_URI,
                METADATA_KEY_DISPLAY_ICON_URI);
        METADATA_COMPAT_KEY_TO_METADATA_KEY.put(MediaMetadataCompat.METADATA_KEY_DISPLAY_SUBTITLE,
                METADATA_KEY_DISPLAY_SUBTITLE);
        METADATA_COMPAT_KEY_TO_METADATA_KEY.put(MediaMetadataCompat.METADATA_KEY_DISPLAY_TITLE,
        ...
        METADATA_COMPAT_KEY_TO_METADATA_KEY.put(MediaMetadataCompat.METADATA_KEY_DURATION,
                METADATA_KEY_DURATION);
        METADATA_COMPAT_KEY_TO_METADATA_KEY.put(MediaMetadataCompat.METADATA_KEY_GENRE,
                METADATA_KEY_GENRE);
        METADATA_COMPAT_KEY_TO_METADATA_KEY.put(MediaMetadataCompat.METADATA_KEY_MEDIA_ID,
                METADATA_KEY_MEDIA_ID);
        METADATA_COMPAT_KEY_TO_METADATA_KEY.put(MediaMetadataCompat.METADATA_KEY_MEDIA_URI,
                METADATA_KEY_MEDIA_URI);
        METADATA_COMPAT_KEY_TO_METADATA_KEY.put(MediaMetadataCompat.METADATA_KEY_NUM_TRACKS,
                METADATA_KEY_NUM_TRACKS);
        METADATA_COMPAT_KEY_TO_METADATA_KEY.put(MediaMetadataCompat.METADATA_KEY_RATING,
                METADATA_KEY_RATING);
        METADATA_COMPAT_KEY_TO_METADATA_KEY.put(MediaMetadataCompat.METADATA_KEY_TITLE,
                METADATA_KEY_TITLE);
        METADATA_COMPAT_KEY_TO_METADATA_KEY.put(MediaMetadataCompat.METADATA_KEY_TRACK_NUMBER,
                METADATA_KEY_TRACK_NUMBER);
        METADATA_COMPAT_KEY_TO_METADATA_KEY.put(MediaMetadataCompat.METADATA_KEY_USER_RATING,
                METADATA_KEY_USER_RATING);
        METADATA_COMPAT_KEY_TO_METADATA_KEY.put(MediaMetadataCompat.METADATA_KEY_WRITER,
                METADATA_KEY_WRITER);
        METADATA_COMPAT_KEY_TO_METADATA_KEY.put(MediaMetadataCompat.METADATA_KEY_YEAR,
                METADATA_KEY_YEAR);
    ...
    public static MediaItem convertToMediaItem(MediaMetadataCompat metadataCompat) {
        ...
        MediaMetadata.Builder builder = new MediaMetadata.Builder(metadataCompat.getBundle())
        ...
        for (String key : metadataCompat.keySet()) {
            ...
            if (value instanceof CharSequence) {
                ...
                builder.putRating(key, convertToRating((RatingCompat) value));
    ...
    public static MediaMetadataCompat convertToMediaMetadataCompat(MediaMetadata metadata) {
        ...
        for (String key : metadata.keySet()) {
            ...
            } else if (!TextUtils.equals(key, METADATA_KEY_EXTRAS)) {
                // This may be the rating, but not sure. Try again with getRating().
                // Here's the reason. MediaMetdata uses
                // ParcelUtils#putVersionedParcelable(Bundle, String, VersionedParcelable) to put
                // Rating to the internal Bundle. So Bundle is expected for Rating type here.
                // However, it's internal implementation of putVersionedParcelable() and may be
                // changed anytime with no notice. So replies on the MediaMetdata#getRating() to
                // get the Rating object.
                Rating rating = metadata.getRating(key);
                if (rating != null) {
                    builder.putRating(compatKey, convertToRatingCompat(rating));
                }
            }
        }
