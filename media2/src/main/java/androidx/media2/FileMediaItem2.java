...
/**
 * Structure for {@link MediaItemDesc2} whose playback would use file.
 * <p>
 * Users should use {@link Builder} to create {@link FileMediaItem2}.
 *
 * @see MediaItemDesc2
 */
public class FileMediaItem2 extends MediaItemDesc2 {
    /**
    ...
    FileMediaItem2(FileMediaItem2.Builder builder) {
        super(builder);
        mFD = builder.mFD;
