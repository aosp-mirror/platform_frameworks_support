...
public abstract class SessionPlayer2 implements AutoCloseable {
     ...
     */
    public abstract @NonNull ListenableFuture<CommandResult2> skipToPreviousPlaylistItem();
     ...
     * @see PlayerCallback#onCurrentMediaItemChanged(SessionPlayer2, MediaItem2)
     */
    public abstract @NonNull ListenableFuture<CommandResult2> skipToNextPlaylistItem();
