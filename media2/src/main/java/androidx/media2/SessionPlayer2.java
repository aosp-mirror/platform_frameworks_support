...
public abstract class SessionPlayer2<T extends SessionPlayer2.PlaybackParams>
    ...
    public abstract @NonNull ListenableFuture<CommandResult2> setPlaybackParams(
    ...
    public abstract @NonNull ListenableFuture<CommandResult2> setPlaylist(List<MediaItemDesc2> list,
            MediaMetadata2 metadata);

    public abstract @NonNull ListenableFuture<CommandResult2> setPlayItemDesc(MediaItemDesc2 desc,
            MediaMetadata2 metadata);
    ...
    /**
     * Register {@link PlayerCallback} to listen changes in the underlying
    ...
    // e.g.) When PLAYING state, it may tell that 'pause' is possible but 'play' isn't possible
    // (or no op)
    ...
    public static abstract class PlayerCallback {
        ...
        public void onBufferingStateChanged(@NonNull SessionPlayer2 player,
                @Nullable MediaItemDesc2 desc, @BuffState int buffState) {
        }

        // TODO(jaewan): T extends PlaybackParams or PlaybackParams?
        public void onPlaybackParamsChanged(@NonNull SessionPlayer2 player,
                @Nullable PlaybackParams params) {
        }
        ...
        // TODO(jaewan): Uncomment this when ready
        //public void onAllowedCommandGroupChanged(@NonNull SessionPlayer2 player,
