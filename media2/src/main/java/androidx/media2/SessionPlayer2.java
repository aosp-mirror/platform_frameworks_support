...
public abstract class SessionPlayer2 implements AutoCloseable {
    ...
    public static final class PlayerResult {
        ...
        public PlayerResult(int resultCode, MediaItem2 item) {
         ...
         */
        // Note: resultCode is intentionally not annotated for subclass to return extra error codes.
        public PlayerResult(int resultCode, MediaItem2 item, long completionTime) {
         ...
         * <p>
         * Check the class documentation that has returned this {@link PlayerResult} to understand
