...
public abstract class SessionPlayer2 implements AutoCloseable {
     ...
     * {@link ListenableFuture} or callback for the completion.
     */
    public abstract @NonNull ListenableFuture<PlayerResult2> play();
     ...
     * {@link ListenableFuture} or callback for the completion.
     */
    public abstract @NonNull ListenableFuture<PlayerResult2> pause();
     ...
     * {@link ListenableFuture} or callback for the completion.
     */
    public abstract @NonNull ListenableFuture<PlayerResult2> prepare();
     ...
     */
    public abstract @NonNull ListenableFuture<PlayerResult2> seekTo(long position);
     ...
     */
    public abstract @NonNull ListenableFuture<PlayerResult2> setPlaybackSpeed(float playbackSpeed);
     ...
     */
    public abstract @NonNull ListenableFuture<PlayerResult2> setAudioAttributes(
     ...
     */
    public abstract @NonNull ListenableFuture<PlayerResult2> setPlaylist(
     ...
     */
    public abstract @NonNull ListenableFuture<PlayerResult2> setMediaItem(
     ...
     * @see PlayerCallback#onPlaylistChanged(SessionPlayer2, List, MediaMetadata2)
     */
    public abstract @NonNull ListenableFuture<PlayerResult2> addPlaylistItem(int index,
            @NonNull MediaItem2 item);
     ...
     * @see PlayerCallback#onPlaylistChanged(SessionPlayer2, List, MediaMetadata2)
     */
    public abstract @NonNull ListenableFuture<PlayerResult2> removePlaylistItem(
            @NonNull MediaItem2 item);
     ...
     * @see PlayerCallback#onPlaylistChanged(SessionPlayer2, List, MediaMetadata2)
     */
    public abstract @NonNull ListenableFuture<PlayerResult2> replacePlaylistItem(int index,
            @NonNull MediaItem2 item);
     ...
     */
    public abstract @NonNull ListenableFuture<PlayerResult2> skipToPreviousPlaylistItem();
     ...
     * @see PlayerCallback#onCurrentMediaItemChanged(SessionPlayer2, MediaItem2)
     */
    public abstract @NonNull ListenableFuture<PlayerResult2> skipToNextPlaylistItem();
     ...
     * @see PlayerCallback#onCurrentMediaItemChanged(SessionPlayer2, MediaItem2)
     */
    public abstract @NonNull ListenableFuture<PlayerResult2> skipToPlaylistItem(
            @NonNull MediaItem2 item);
     ...
     */
    public abstract @NonNull ListenableFuture<PlayerResult2> updatePlaylistMetadata(
     ...
     */
    public abstract @NonNull ListenableFuture<PlayerResult2> setRepeatMode(
     ...
     */
    public abstract @NonNull ListenableFuture<PlayerResult2> setShuffleMode(
    ...
    /**
     * Result class of the asynchrnous APIs.
     */
    public static final class PlayerResult2 {
        /**
        ...
        public PlayerResult2(int resultCode, MediaItem2 item) {
         ...
         */
        // Note: resultCode is intentionally not annotated for subclass to return extra error codes.
        public PlayerResult2(int resultCode, MediaItem2 item, long completionTime) {
         ...
         * <p>
         * Check the class documentation that has returned this {@link PlayerResult2} to understand
         * the meaning of the code value.
         *
         * @return result code
         */
