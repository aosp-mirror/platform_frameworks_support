...
public final class CommandResult2 {
    ...
    private final MediaItemDesc2 mDesc;

    public CommandResult2(int resultCode, long completionTime, MediaItemDesc2 desc) {
    ...
    /**
     * Gets the {@link MediaItemDesc2} for which the command was executed.
     *
     * @return media item desc
     */
    public final @Nullable MediaItemDesc2 getMediaItemDesc2() {
        return mDesc;
    }
}
