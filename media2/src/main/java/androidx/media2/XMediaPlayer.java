...
import static androidx.media2.SessionPlayer2.PlayerResult2.RESULT_CODE_BAD_VALUE;
import static androidx.media2.SessionPlayer2.PlayerResult2.RESULT_CODE_INVALID_STATE;
import static androidx.media2.SessionPlayer2.PlayerResult2.RESULT_CODE_IO_ERROR;
import static androidx.media2.SessionPlayer2.PlayerResult2.RESULT_CODE_PERMISSION_DENIED;
import static androidx.media2.SessionPlayer2.PlayerResult2.RESULT_CODE_SKIPPED;
import static androidx.media2.SessionPlayer2.PlayerResult2.RESULT_CODE_SUCCESS;
import static androidx.media2.SessionPlayer2.PlayerResult2.RESULT_CODE_UNKNOWN_ERROR;
...
public class XMediaPlayer extends SessionPlayer2 {
    ...
    static final class PendingCommand {
        ...
        @SuppressWarnings("WeakerAccess") /* synthetic access */
        final SettableFuture<PlayerResult2> mFuture;

        @SuppressWarnings("WeakerAccess") /* synthetic access */
        PendingCommand(int mCallType, SettableFuture<PlayerResult2> mFuture) {
    ...
    private void addPendingCommandLocked(
            int callType, final SettableFuture<PlayerResult2> future, final Object token) {
    ...
    public ListenableFuture<PlayerResult2> play() {
        ...
        if (mAudioFocusHandler.onPlayRequested()) {
            final SettableFuture<PlayerResult2> future = SettableFuture.create();
            synchronized (mPendingCommands) {
    ...
    public ListenableFuture<PlayerResult2> pause() {
        SettableFuture<PlayerResult2> future = SettableFuture.create();
        // TODO: Make commands be executed sequentially
    ...
    @Override
    public ListenableFuture<PlayerResult2> setAudioAttributes(AudioAttributesCompat attr) {
        SettableFuture<PlayerResult2> future = SettableFuture.create();
        synchronized (mPendingCommands) {
    ...
    @Override
    public ListenableFuture<PlayerResult2> setMediaItem(@NonNull MediaItem2 item) {
        if (item == null) {
    ...
    @Override
    public ListenableFuture<PlayerResult2> updatePlaylistMetadata(final MediaMetadata2 metadata) {
        synchronized (mPlaylistLock) {
            mPlaylistMetadata = metadata;
        }
        notifySessionPlayerCallback(new SessionPlayerCallbackNotifier() {
    ...
    @Override
    public ListenableFuture<PlayerResult2> setRepeatMode(final int repeatMode) {
    ...
    @Override
    public ListenableFuture<PlayerResult2> setShuffleMode(final int shuffleMode) {
     ...
     * {@link PlayerResult2} will be delivered when the command completes.
     */
    public ListenableFuture<PlayerResult2> setSurface(Surface surface) {
        SettableFuture<PlayerResult2> future = SettableFuture.create();
        synchronized (mPendingCommands) {
     ...
     * {@link PlayerResult2} will be delivered when the command completes.
     */
    public ListenableFuture<PlayerResult2> setPlayerVolume(float volume) {
        SettableFuture<PlayerResult2> future = SettableFuture.create();
        synchronized (mPendingCommands) {
     ...
     * {@link PlayerResult2} will be delivered when the command completes.
     */
    public ListenableFuture<PlayerResult2> setPlaybackParams(@NonNull PlaybackParams2 params) {
        SettableFuture<PlayerResult2> future = SettableFuture.create();
        synchronized (mPendingCommands) {
     ...
     * {@link PlayerResult2} will be delivered when the command completes.
     */
    public ListenableFuture<PlayerResult2> seekTo(long msec, @SeekMode int mode) {
        SettableFuture<PlayerResult2> future = SettableFuture.create();
     ...
     * {@link PlayerResult2} will be delivered when the command completes.
     */
    public ListenableFuture<PlayerResult2> setAudioSessionId(int sessionId) {
        SettableFuture<PlayerResult2> future = SettableFuture.create();
        synchronized (mPendingCommands) {
     ...
     * {@link PlayerResult2} will be delivered when the command completes.
     */
    public ListenableFuture<PlayerResult2> attachAuxEffect(int effectId) {
        SettableFuture<PlayerResult2> future = SettableFuture.create();
        synchronized (mPendingCommands) {
     ...
     * {@link PlayerResult2} will be delivered when the command completes.
     */
    public ListenableFuture<PlayerResult2> setAuxEffectSendLevel(float level) {
        SettableFuture<PlayerResult2> future = SettableFuture.create();
        synchronized (mPendingCommands) {
     ...
     * Selects a track.
     * <p>
     * If the player is in invalid state, {@link PlayerResult2#RESULT_CODE_INVALID_STATE} will be
     * reported with {@link PlayerResult2}.
     ...
     * {@link PlayerResult2} will be delivered when the command completes.
     */
    public ListenableFuture<PlayerResult2> selectTrack(int index) {
        SettableFuture<PlayerResult2> future = SettableFuture.create();
        synchronized (mPendingCommands) {
     ...
     * {@link PlayerResult2} will be delivered when the command completes.
     */
    public ListenableFuture<PlayerResult2> deselectTrack(int index) {
        SettableFuture<PlayerResult2> future = SettableFuture.create();
        synchronized (mPendingCommands) {
    ...
    private ListenableFuture<PlayerResult2> setPlayerMediaItemsInternal(
            @NonNull MediaItem2 curItem, @Nullable MediaItem2 nextItem) {
        boolean setMediaItemCalled;
        synchronized (mPlaylistLock) {
            setMediaItemCalled = mSetMediaItemCalled;
        }
        ListenableFuture<PlayerResult2> future = !setMediaItemCalled
    ...
    private ListenableFuture<PlayerResult2> setMediaItemInternal(MediaItem2 item) {
        SettableFuture<PlayerResult2> future = SettableFuture.create();
        synchronized (mPendingCommands) {
    ...
    private ListenableFuture<PlayerResult2> setNextMediaItemInternal(MediaItem2 item) {
        SettableFuture<PlayerResult2> future = SettableFuture.create();
        synchronized (mPendingCommands) {
    ...
    private ListenableFuture<PlayerResult2> skipToNextInternal() {
        SettableFuture<PlayerResult2> future = SettableFuture.create();
        synchronized (mPendingCommands) {
    ...
    private ListenableFuture<PlayerResult2> createFutureForResultCodeInternal(int resultCode) {
        SettableFuture<PlayerResult2> future = SettableFuture.create();
        synchronized (mPendingCommands) {
            if (mPendingCommands.size() > 0) {
                ...
                future.set(new PlayerResult2(resultCode, mPlayer.getCurrentMediaItem()));
            }
        }
        return future;
    }
    ...
    class Mp2Callback extends MediaPlayer2.EventCallback {
        ...
        public void onCallCompleted(
            ...
            expected.mFuture.set(new PlayerResult2(
            ...
            while (true) {
                ...
                command.mFuture.set(new PlayerResult2(
    ...
    static final class CombindedCommandResultFuture extends AbstractFuture<PlayerResult2> {
        final ListenableFuture<PlayerResult2>[] mFutures;
        AtomicInteger mSuccessCount = new AtomicInteger(0);

        public static CombindedCommandResultFuture create(Executor executor,
                ListenableFuture<PlayerResult2>... futures) {
        ...
        private CombindedCommandResultFuture(Executor executor,
            ...
            for (int i = 0; i < mFutures.length; ++i) {
                ...
                mFutures[i].addListener(new Runnable() {
                    ...
                    public void run() {
                        try {
                            PlayerResult2 result = mFutures[cur].get();
