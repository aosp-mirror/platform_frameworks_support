...
class MediaLibrarySessionImplBase extends MediaSession2ImplBase implements MediaLibrarySessionImpl {
    ...
    @Override
    void dispatchRemoteControllerNotifyTask(RemoteControllerNotifyTask runnable) {
        super.dispatchRemoteControllerNotifyTask(runnable);
        MediaLibraryService2LegacyStub legacyStub = getLegacyBrowserService();
        if (legacyStub != null) {
            dispatchRemoteControllerNotifyTask(legacyStub.getControllersForAll(), runnable);
        }
    }
