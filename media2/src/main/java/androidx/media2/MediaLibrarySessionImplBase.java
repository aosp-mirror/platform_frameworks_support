...
class MediaLibrarySessionImplBase extends MediaSession2ImplBase implements MediaLibrarySessionImpl {
    ...
    @Override
    void dispatchRemoteControllerTask(RemoteControllerTask runnable) {
        super.dispatchRemoteControllerTask(runnable);
        MediaLibraryService2LegacyStub legacyStub = getLegacyBrowserService();
        if (legacyStub != null) {
            dispatchRemoteControllerTask(legacyStub.getControllersForAll(), runnable);
        }
    }
