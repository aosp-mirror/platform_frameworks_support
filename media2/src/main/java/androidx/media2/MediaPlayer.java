...
public class MediaPlayer extends SessionPlayer {
     ...
     */
    private static class MediaItemList {
        ArrayList<MediaItem> mList = new ArrayList<>();

        private void add(int index, MediaItem item) {
            if (item instanceof FileMediaItem) {
        ...
        private boolean addAll(Collection<MediaItem> c) {
        ...
        private MediaItem remove(int index) {
        ...
        private MediaItem get(int index) {
            return mList.get(index);
        }

        private MediaItem set(int index, MediaItem item) {
            if (item instanceof FileMediaItem) {
                ((FileMediaItem) item).addParcelFileDescriptorClient(this);
            }
        ...
        private Collection<MediaItem> getCollection() {
            return mList;
        }
    }
}
