...
public class MediaPlayer extends SessionPlayer2 {
    ...
    abstract static class PendingFuture<V extends PlayerResult>
        ...
        static final int CALL_TYPE_INTERNAL = -1;
    ...
    @SuppressWarnings("WeakerAccess") /* synthetic access */
    List<ResolvableFuture<PlayerResult>> setPlayerMediaItemsInternal(
    ...
    @SuppressWarnings("WeakerAccess") /* synthetic access */
    ResolvableFuture<PlayerResult> createFutureForResultCodeInternal(int resultCode) {
        ResolvableFuture<PlayerResult> future = ResolvableFuture.create();
    ...
    @SuppressWarnings("WeakerAccess") /* synthetic access */
    List<ResolvableFuture<PlayerResult>> createFuturesForResultCodeInternal(
            int resultCode) {
        ArrayList<ResolvableFuture<PlayerResult>> futures = new ArrayList<>();
    ...
    private void executePendingFuturesIfNeeded() {
        synchronized (mPendingFutures) {
            ...
            while (it.hasNext()) {
                ...
                if (f.mCallType != MediaPlayer2.CALL_COMPLETED_SEEK_TO) {
                    break;
                }
                f.execute();
            }
