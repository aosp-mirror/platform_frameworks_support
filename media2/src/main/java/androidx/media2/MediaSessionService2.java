 ...
 * <p>
 * It's highly recommended for an app to use this if the app wants to keep media playback in the
 * background.
 * <p>
 * Here's the benefits of using {@link MediaSessionService2}.
 * <ul>
...
public abstract class MediaSessionService2 extends Service {
     ...
     *
     * @param sessionIdHint session id hint. Can be {@code null}
     * @return a new session
     * @see MediaSession2.Builder
     * @see #getSession()
     */
    public @NonNull abstract MediaSession2 onCreateSession(String sessionIdHint);
