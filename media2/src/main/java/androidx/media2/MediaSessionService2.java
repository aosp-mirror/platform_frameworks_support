...
public abstract class MediaSessionService2 extends Service {
     ...
     * <p>
     * This method will be called on the main thread, inside of {@link #onBind(Intent)}.
     *
    ...
    public IBinder onBind(Intent intent) {
        return mImpl.onBind(this, intent);
    }
    ...
    interface MediaSessionService2Impl {
        IBinder onBind(MediaSessionService2 service, Intent intent);
