...
class MediaControllerStub extends IMediaController.Stub {
    ...
    @Override
    public void onConnected(final ParcelImpl connectionResult) {
        ...
        try {
            ...
            List<MediaItem> itemList = MediaUtils.convertParcelImplListSliceToMediaItemList(
                    result.getPlaylistSlice());
    ...
    public void onDisconnected() {
        ...
        try {
            ...
            // Note: This is also used for rejection.
