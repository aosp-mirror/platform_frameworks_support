...
public class MediaController2 implements AutoCloseable {
     ...
     *
     * @param mediaId The id of the requested media. Should not be an empty string.
     ...
     *
     * @param mediaId The id of the media. Should not be an empty string.
     ...
     *
     * @param mediaId the descriptor of media item you want to play. Should not be an empty string.
     * @see MediaMetadata2#METADATA_KEY_MEDIA_ID
     */
     ...
     * @param mediaId the media ID of the new item. Should not be an empty string.
     * @see MediaMetadata2#METADATA_KEY_MEDIA_ID
     */
