...
public class MediaController2 implements AutoCloseable {
    ...
    /**
     * Requests that the player prefetches the media items for playback. In other words, other
    ...
    /**
     * Request that the player prefetches a media item with the media id for playback.
    ...
    /**
     * Request that the player prefetches a media item with the specific search query for playback.
     * In other words, other sessions can continue to play during the preparation of this session.
     * This method can be used to speed up the start of the playback.
     * Once the prefetch is done, the session will change its playback state to
     * {@link SessionPlayer2#PLAYER_STATE_PAUSED}. Afterwards, {@link #play} can be called to start
    ...
    /**
     * Request that the player prefetches a media item with the specific {@link Uri} for playback.
     * In other words, other sessions can continue to play during the preparation of this session.
     * This method can be used to speed up the start of the playback.
     * Once the prefetch is done, the session will change its playback state to
     * {@link SessionPlayer2#PLAYER_STATE_PAUSED}. Afterwards, {@link #play} can be called to start
    ...
    public static class ControllerResult extends RemoteResult2 {
        ...
        ControllerResult(@ResultCode int resultCode, @Nullable MediaItem2 item) {
