...
public class MediaSession2 implements AutoCloseable {
    ...
    public abstract static class SessionCallback {
         ...
         * <p>
         * During the prefetching, a session should not hold audio focus in order to allow
         * other sessions play seamlessly. The state of playback should be updated to
         * {@link SessionPlayer2#PLAYER_STATE_PAUSED} after the prefetching is done.
         * <p>
     ...
     */
    // Specify full name to avoid build error 'cannot find symbol'
    ...
    public static class SessionResult extends RemoteResult2 {
        ...
        public SessionResult(@ResultCode int resultCode, @Nullable Bundle customCommandResult) {
            this(resultCode, null, customCommandResult);
        }
        ...
        SessionResult(@ResultCode int resultCode, @Nullable MediaItem2 item,
