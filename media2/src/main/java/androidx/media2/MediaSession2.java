...
public class MediaSession2 implements MediaInterface2.SessionPlayer, AutoCloseable {
    ...
    /**
     * Resets the player connector to the initial state.
     * <p>
     * This calls {@link MediaPlayerConnector#reset()} which resets the player connector to the
     * uninitialized state, and detailed behaviors may differ depending on the player
     * implementation. Use this with caution.
     */
    @Override
    public void reset() {
        mImpl.reset();
