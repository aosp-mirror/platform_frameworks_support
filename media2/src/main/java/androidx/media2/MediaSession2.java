...
public class MediaSession2 implements AutoCloseable {
     ...
     *
     * @param errorCode error code among the result code
     * @param extras extras
     */
    public void notifyError(@ResultCode int errorCode, @Nullable Bundle extras) {
    ...
    public abstract static class SessionCallback {
         ...
         * </ul>
         * <p>
         * Return {@link #RESULT_CODE_NO_ERROR} to proceed the command. If something else is
         * returned, command wouldn't be sent and the controller would receive the code with it.
         *
         * @param session the session for this event
         * @param controller controller information.
         * @param command a command. This method will be called for every single command.
         * @return {@code RESULT_CODE_NO_ERROR} if you want to proceed incoming command.
         ...
         * <ol>
         * <li>{@link MediaController2#addPlaylistItem(int, MediaItem2)}</a>
         * <li>{@link MediaController2#replacePlaylistItem(int, MediaItem2)}</a>
         * <li>{@link MediaController2#setPlaylist(List, MediaMetadata2)}</a>
         * </ol>
         * Override this to translate incoming media items to be understood by your player.
         * <p>
         * For example, {link XMediaPlayer} currently only understands {@link FileMediaItem2},
         * {@link UriMediaItem2}, and {@link CallbackMediaItem2} while the media item from
         * the controller would be sanitized not to contain subclass information. In that case
         * you need to override this method to create a media item for player out of the media item
         * from the controller.
         * <p>
         ...
         * <p>
         * Default implementation simply returns the media item from the controller.
         *
         * @param session the session for this event
         * @param controller controller information
         ...
         */
        public @ResultCode int onCustomCommand(@NonNull MediaSession2 session,
    ...
    abstract static class ControllerCb {
        abstract void onCommandResult(int seq, CommandResult2 result) throws RemoteException;
        ...
        abstract void onSeekCompleted(long eventTimeMs, long positionMs, long position)
                throws RemoteException;
        abstract void onError(@ResultCode int errorCode, @Nullable Bundle extras)
                throws RemoteException;
