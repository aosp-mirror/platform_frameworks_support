...
/* package */ final class ExoPlayerWrapper {
    ...
    public void seekTo(long position, @MediaPlayer2.SeekMode int mode) {
        ...
        long startPosition = mMediaItemQueue.getCurrentMediaItem().getStartPosition();
        mPlayer.seekTo(position - startPosition);
    }

    public long getCurrentPosition() {
        long startPosition = mMediaItemQueue.getCurrentMediaItem().getStartPosition();
        return startPosition + mPlayer.getCurrentPosition();
    }
    ...
    public long getBufferedPosition() {
        long startPosition = mMediaItemQueue.getCurrentMediaItem().getStartPosition();
        return startPosition + mPlayer.getBufferedPosition();
    }
