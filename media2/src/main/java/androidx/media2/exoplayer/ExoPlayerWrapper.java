...
/* package */ final class ExoPlayerWrapper {
    ...
    public interface Listener {
        ...
        /** Called when the current media item changes (either via request or transition). */
        void onMediaItem2Changed(MediaItem2 mediaItem2);
