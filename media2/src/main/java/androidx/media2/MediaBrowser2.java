...
public class MediaBrowser2 extends MediaController2 {
     ...
     *
     * @param parentId parent id. Should not be an empty string.
     ...
     * of children.
     *
     * @param parentId parent id for getting the children. Should not be an empty string.
     ...
     * item.
     *
     * @param mediaId media id for specifying the item. Should not be an empty string.
     * @see BrowserResult#getMediaItems()
     */
