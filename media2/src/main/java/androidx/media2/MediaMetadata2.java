 ...
 * <p>
 * <a name="Browsable"></a>
 * <h3>{@link MediaMetadata2#METADATA_KEY_BROWSABLE_TYPE Browsable type}</h3>
 * <p>
 ...
 * successfuly run.
 * <p>
 * The {@link MediaLibrarySession} would require it for the the media items returned by the
 ...
 * to contain a media item which isn't playabale to only show the disable media item.
 * <p>
 * The {@link MediaLibrarySession} would require it for the the media items returned by the
 * {@link androidx.media2.MediaLibraryService2.MediaLibrarySession.MediaLibrarySessionCallback}.
 * <p>
...
public final class MediaMetadata2 implements VersionedParcelable {
     ...
     * </ul>
     * <p>
     * The values other than {@link #BROWSABLE_TYPE_NONE} means that it has children under the media
     * item.
     * <p>
     ...
     */
    public static final String METADATA_KEY_BROWSABLE_TYPE =
     ...
     * the media is playable. A value of 0 indicates it is not an advertisement.
    ...
    @StringDef({METADATA_KEY_DURATION, METADATA_KEY_YEAR, METADATA_KEY_TRACK_NUMBER,
            METADATA_KEY_NUM_TRACKS, METADATA_KEY_DISC_NUMBER, METADATA_KEY_BROWSABLE_TYPE,
    ...
    static {
        ...
        METADATA_KEYS_TYPE.put(METADATA_KEY_BROWSABLE_TYPE, METADATA_TYPE_LONG);
    ...
    public static final class Builder {
         ...
         * <li>{@link #METADATA_KEY_BROWSABLE_TYPE}</li>
