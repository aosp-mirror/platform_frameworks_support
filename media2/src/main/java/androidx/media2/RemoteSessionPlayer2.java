...
public abstract class RemoteSessionPlayer2 extends SessionPlayer2 {
     ...
     *                  volume down.
     */
    public abstract Future<CommandResult2> adjustPlayerVolume(int direction);
     ...
     * <p>
     * A value of {@code 0} indicates muting. See {@link #getMaxPlayerVolume()} for the volume range
     * supported by this player.
     *
     * @param volume a value between 0.0f and {@link #getMaxPlayerVolume()}.
     */
    public abstract Future<CommandResult2> setPlayerVolume(int volume);
     ...
     */
    public abstract int getPlayerVolume();

    /**
     * Gets the maximum volume that can be used in {@link #setPlayerVolume(int)}.
     *
     * @return the maximum volume. Shouldn't be negative.
     */
    public abstract int getMaxPlayerVolume();
     ...
     */
    public abstract @VolumeControlType int getPlayerVolumeControlType();
    ...
    public static class Callback extends SessionPlayer2.PlayerCallback {
         ...
         * @see #setPlayerVolume(int)
         */
        public void onPlayerVolumeChanged(@NonNull RemoteSessionPlayer2 player2, int volume) {
        }
    }
}
