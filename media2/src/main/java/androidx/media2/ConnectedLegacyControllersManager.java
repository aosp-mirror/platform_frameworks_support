...
class ConnectedLegacyControllersManager extends ConnectedControllersManager<RemoteUserInfo> {
    ...
    @Override
    public void addController(RemoteUserInfo key,
            ControllerInfo controller, SessionCommandGroup2 commands) {
        super.addController(key, controller, commands);
        mHandler.checkControllerDelayed(controller);
    }

    @Override
    public ControllerInfo getController(RemoteUserInfo key) {
