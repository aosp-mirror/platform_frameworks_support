 ...
 */
class ConnectedLegacyControllersManager extends ConnectedControllersManager<RemoteUserInfo> {
    ...
    @Override
    public void addController(RemoteUserInfo remoteUserInfo, ControllerInfo controller,
            SessionCommandGroup2 commands) {
        super.addController(remoteUserInfo, controller, commands);
        mHandler.checkControllerDelayed(controller);
    }

    @Override
    public ControllerInfo getController(RemoteUserInfo remoteUserInfo) {
        ControllerInfo controllerInfo = super.getController(remoteUserInfo);
