...
public class MediaController implements AutoCloseable {
     ...
     * with the type of the token.
     * <p>
     * Behaviors per token types
     * <ol>
     * <li><a href="#TypeSession">Connected to a {@link SessionToken#TYPE_SESSION} token</a></li>
     * <li><a href="#TypeSessionService">Connected to a {@link SessionToken#TYPE_SESSION_SERVICE} or
     * {@link SessionToken#TYPE_LIBRARY_SERVICE}</a></li>
     * </ol>
     * <a name="TypeSession"></a>
     * <h3>{@link SessionToken#TYPE_SESSION}</h3>
     ...
     *
     * <a name="TypeSessionService"></a>
     * <h3>{@link SessionToken#TYPE_SESSION_SERVICE} or {@link SessionToken#TYPE_LIBRARY_SERVICE}
     * </h3>
     ...
     * to the service while connected to wake up and keep the service process running.
     *
