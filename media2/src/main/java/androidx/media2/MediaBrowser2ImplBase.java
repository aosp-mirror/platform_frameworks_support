...
import static androidx.media2.BaseResult2.RESULT_CODE_PERMISSION_DENIED;
import static androidx.media2.BaseResult2.RESULT_CODE_SKIPPED;
import static androidx.media2.RemoteResult2.RESULT_CODE_DISCONNECTED;
...
class MediaBrowser2ImplBase extends MediaController2ImplBase implements
    ...
    private ListenableFuture<BrowserResult> sendCommand(int commandCode, SessionCommand command) {
