...
public class MediaSession implements AutoCloseable {
    ...
    public abstract static class SessionCallback {
        ...
        /**
         * Called when a controller called {@link MediaController#subscribeRoutesInfo()}
         * Session app should notify the routes information by calling
         * {@link MediaSession#notifyRoutesInfoChanged(ControllerInfo, List)}.
         *
         * @param session the session for this event
         * @param controller controller information
         * @see SessionCommand#COMMAND_CODE_SESSION_SUBSCRIBE_ROUTES_INFO
         * @hide
         */
        @RestrictTo(LIBRARY_GROUP)
        @ResultCode
        public int onSubscribeRoutesInfo(@NonNull MediaSession session,
                @NonNull ControllerInfo controller) {
            return RESULT_CODE_NOT_SUPPORTED;
        }

        /**
         * Called when a controller called {@link MediaController#unsubscribeRoutesInfo()}
         *
         * @param session the session for this event
         * @param controller controller information
         * @see SessionCommand#COMMAND_CODE_SESSION_UNSUBSCRIBE_ROUTES_INFO
         * @hide
         */
        @RestrictTo(LIBRARY_GROUP)
        @ResultCode
        public int onUnsubscribeRoutesInfo(@NonNull MediaSession session,
                @NonNull ControllerInfo controller) {
            return RESULT_CODE_NOT_SUPPORTED;
        }

        /**
         * Called when a controller called {@link MediaController#selectRoute(Bundle)}.
         * @param session the session for this event
         * @param controller controller information
         ...
         * @see SessionCommand#COMMAND_CODE_SESSION_SELECT_ROUTE
        ...
        @RestrictTo(LIBRARY_GROUP)
        @ResultCode
        public int onSelectRoute(@NonNull MediaSession session,
