...
class MediaController2Stub extends IMediaController2.Stub {
    ...
    @Override
    public void setCustomLayout(int seq, List<ParcelImpl> commandButtonList) {
        ...
        controller.onCustomLayoutChanged(seq, layout);
    }
    ...
    @Override
    public void sendCustomCommand(int seq, ParcelImpl commandParcel, Bundle args) {
        final MediaController2ImplBase controller;
        try {
            controller = getController();
        } catch (IllegalStateException e) {
