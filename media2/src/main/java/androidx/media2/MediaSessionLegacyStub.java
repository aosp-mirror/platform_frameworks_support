...
class MediaSessionLegacyStub extends MediaSessionCompat.Callback {
    ...
    public void onSkipToNext() {
        onSessionCommand(SessionCommand2.COMMAND_CODE_PLAYER_SKIP_TO_NEXT_ITEM,
                new SessionRunnable() {
                    @Override
                    public void run(ControllerInfo controller) throws RemoteException {
    ...
    public void onSkipToPrevious() {
        onSessionCommand(SessionCommand2.COMMAND_CODE_PLAYER_SKIP_TO_PREV_ITEM,
                new SessionRunnable() {
                    @Override
                    public void run(ControllerInfo controller) throws RemoteException {
    ...
    public void onAddQueueItem(final MediaDescriptionCompat description) {
        ...
        onSessionCommand(SessionCommand2.COMMAND_CODE_PLAYER_ADD_ITEM,
                new SessionRunnable() {
                    @Override
                    public void run(ControllerInfo controller) throws RemoteException {
    ...
    public void onRemoveQueueItem(final MediaDescriptionCompat description) {
        ...
        onSessionCommand(SessionCommand2.COMMAND_CODE_PLAYER_REMOVE_ITEM,
                new SessionRunnable() {
                    @Override
                    public void run(ControllerInfo controller) throws RemoteException {
