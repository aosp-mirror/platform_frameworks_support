...
class MediaSessionLegacyStub extends MediaSessionCompat.Callback {
    ...
    public void onPrepareFromMediaId(final String mediaId, final Bundle extras) {
        ...
        onSessionTask(SessionCommand2.COMMAND_CODE_SESSION_PREFETCH_FROM_MEDIA_ID,
                new SessionTask() {
                    @Override
                    public void run(ControllerInfo controller) throws RemoteException {
    ...
    public void onPrepareFromSearch(final String query, final Bundle extras) {
        ...
        onSessionTask(SessionCommand2.COMMAND_CODE_SESSION_PREFETCH_FROM_SEARCH,
                new SessionTask() {
                    @Override
                    public void run(ControllerInfo controller) throws RemoteException {
    ...
    public void onPrepareFromUri(final Uri uri, final Bundle extras) {
        ...
        onSessionTask(SessionCommand2.COMMAND_CODE_SESSION_PREFETCH_FROM_URI,
                new SessionTask() {
                    @Override
                    public void run(ControllerInfo controller) throws RemoteException {
    ...
    public void onPlayFromMediaId(final String mediaId, final Bundle extras) {
        ...
        onSessionTask(SessionCommand2.COMMAND_CODE_SESSION_PLAY_FROM_MEDIA_ID,
                new SessionTask() {
                    @Override
                    public void run(ControllerInfo controller) throws RemoteException {
    ...
    public void onPlayFromSearch(final String query, final Bundle extras) {
        ...
        onSessionTask(SessionCommand2.COMMAND_CODE_SESSION_PLAY_FROM_SEARCH,
                new SessionTask() {
                    @Override
                    public void run(ControllerInfo controller) throws RemoteException {
    ...
    public void onPlayFromUri(final Uri uri, final Bundle extras) {
        ...
        onSessionTask(SessionCommand2.COMMAND_CODE_SESSION_PLAY_FROM_URI,
                new SessionTask() {
                    @Override
                    public void run(ControllerInfo controller) throws RemoteException {
    ...
    public void onSkipToNext() {
        onSessionTask(SessionCommand2.COMMAND_CODE_PLAYER_SKIP_TO_NEXT_PLAYLIST_ITEM,
                new SessionTask() {
                    @Override
                    public void run(ControllerInfo controller) throws RemoteException {
    ...
    public void onSkipToPrevious() {
        onSessionTask(SessionCommand2.COMMAND_CODE_PLAYER_SKIP_TO_PREVIOUS_PLAYLIST_ITEM,
                new SessionTask() {
                    @Override
                    public void run(ControllerInfo controller) throws RemoteException {
    ...
    public void onSkipToQueueItem(final long id) {
        onSessionTask(SessionCommand2.COMMAND_CODE_PLAYER_SKIP_TO_PLAYLIST_ITEM,
                new SessionTask() {
                    @Override
                    public void run(ControllerInfo controller) throws RemoteException {
    ...
    public void onFastForward() {
        onSessionTask(SessionCommand2.COMMAND_CODE_SESSION_FAST_FORWARD,
                new SessionTask() {
                    @Override
                    public void run(ControllerInfo controller) throws RemoteException {
    ...
    public void onRewind() {
        onSessionTask(SessionCommand2.COMMAND_CODE_SESSION_REWIND,
                new SessionTask() {
                    @Override
                    public void run(ControllerInfo controller) throws RemoteException {
    ...
    public void onSetRating(final RatingCompat rating, Bundle extras) {
        ...
        // extras is ignored.
        onSessionTask(SessionCommand2.COMMAND_CODE_SESSION_SET_RATING,
                new SessionTask() {
                    @Override
                    public void run(ControllerInfo controller) throws RemoteException {
    ...
    public void onSetRepeatMode(final int repeatMode) {
        onSessionTask(SessionCommand2.COMMAND_CODE_PLAYER_SET_REPEAT_MODE,
                new SessionTask() {
                    @Override
                    public void run(ControllerInfo controller) throws RemoteException {
    ...
    public void onSetShuffleMode(final int shuffleMode) {
        onSessionTask(SessionCommand2.COMMAND_CODE_PLAYER_SET_SHUFFLE_MODE,
                new SessionTask() {
                    @Override
                    public void run(ControllerInfo controller) throws RemoteException {
    ...
    public void onAddQueueItem(final MediaDescriptionCompat description) {
        ...
        onSessionTask(SessionCommand2.COMMAND_CODE_PLAYER_ADD_PLAYLIST_ITEM,
                new SessionTask() {
                    @Override
                    public void run(ControllerInfo controller) throws RemoteException {
    ...
    public void onRemoveQueueItem(final MediaDescriptionCompat description) {
        ...
        onSessionTask(SessionCommand2.COMMAND_CODE_PLAYER_REMOVE_PLAYLIST_ITEM,
                new SessionTask() {
                    @Override
                    public void run(ControllerInfo controller) throws RemoteException {
    ...
    private void onSessionTask(@CommandCode final int commandCode,
            @NonNull final SessionTask task) {
        onSessionTaskInternal(null, commandCode, task);
    }

    private void onSessionTask(@NonNull final SessionCommand2 sessionCommand,
            @NonNull final SessionTask task) {
        onSessionTaskInternal(sessionCommand, COMMAND_CODE_CUSTOM, task);
    }

    private void onSessionTaskInternal(@Nullable final SessionCommand2 sessionCommand,
