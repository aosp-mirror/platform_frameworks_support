...
import static androidx.media2.MediaConstants.ARGUMENT_ROUTE_BUNDLE;
...
import static androidx.media2.SessionCommand.COMMAND_CODE_SESSION_SELECT_ROUTE;
import static androidx.media2.SessionCommand.COMMAND_CODE_SESSION_SUBSCRIBE_ROUTES_INFO;
import static androidx.media2.SessionCommand.COMMAND_CODE_SESSION_UNSUBSCRIBE_ROUTES_INFO;
    ...
    void onConnectedNotLocked() {
        ...
        synchronized (mLock) {
            ...
            commandsBuilder.addCommand(
                    new SessionCommand(SESSION_COMMAND_ON_CAPTIONING_ENABLED_CHANGED, null));
    ...
    private final class ControllerCompatCallback extends MediaControllerCompat.Callback {
            ...
            mCallbackExecutor.execute(new Runnable() {
                ...
                public void run() {
                    mCallback.onCustomCommand(mInstance,
                            new SessionCommand(SESSION_COMMAND_ON_EXTRA_CHANGED, null),
                            extras);
                }
            });
        }
        ...
        public void onCaptioningEnabledChanged(boolean enabled) {
            mCallbackExecutor.execute(new Runnable() {
                ...
                public void run() {
                    mCallback.onCustomCommand(mInstance,
                            new SessionCommand(SESSION_COMMAND_ON_CAPTIONING_ENABLED_CHANGED,
                                    null), null);
                }
            });
        }
