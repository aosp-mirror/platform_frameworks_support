...
public class FileMediaItem extends MediaItem {
    ...
    /**
     * Add a client in the client list so that ParcelFileDescriptor can be closed when the list
    ...
    /**
     * Remove a client from the client list. The ParcelFileDescriptor will be closed when the list
     * becomes empty.
     * @param client an object instance for identifying the client.
     * @hide
     */
