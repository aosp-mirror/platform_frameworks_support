 ...
 * <p>
 * This does not change the player state. For example, if this is called with the speed of 2.0f in
 * {@link MediaPlayer#PLAYER_STATE_PAUSED}, the player will just update internal property and stay
 * paused. Once the client calls {@link MediaPlayer#play()} afterwards, the player will start
