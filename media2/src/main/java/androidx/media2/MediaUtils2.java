...
import static androidx.media2.MediaMetadata2.METADATA_KEY_BROWSABLE_TYPE;
...
public class MediaUtils2 {
    ...
    public static MediaItem convertToMediaItem(MediaItem2 item2) {
        ...
        if (metadata == null) {
            ...
            boolean browsable = metadata.containsKey(METADATA_KEY_BROWSABLE_TYPE)
                    && metadata.getLong(METADATA_KEY_BROWSABLE_TYPE) != BROWSABLE_TYPE_NONE;
    ...
    private static MediaMetadata2 convertToMediaMetadata2(MediaDescriptionCompat descCompat,
        ...
        if (bundle != null && bundle.containsKey(EXTRA_BT_FOLDER_TYPE)) {
            metadata2Builder.putLong(METADATA_KEY_BROWSABLE_TYPE,
                    bundle.getLong(EXTRA_BT_FOLDER_TYPE));
        } else if (browsable) {
            metadata2Builder.putLong(METADATA_KEY_BROWSABLE_TYPE, BROWSABLE_TYPE_MIXED);
        }
