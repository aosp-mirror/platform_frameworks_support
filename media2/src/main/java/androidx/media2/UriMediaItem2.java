...
/**
 * Structure for {@link MediaItemDesc2} whose playback would use {@link Uri}.
 * <p>
 * Users should use {@link UriMediaItem2.Builder} to create {@link UriMediaItem2}.
 *
 * @see MediaItemDesc2
 * @hide
 */
// TODO(jaewan): Unhide
@RestrictTo(LIBRARY)
public class UriMediaItem2 extends MediaItemDesc2 {
    ...
    UriMediaItem2(UriMediaItem2.Builder builder) {
        super(builder);
        mUri = builder.mUri;
     ...
     */
    public static final class Builder extends MediaItemDesc2.Builder<UriMediaItem2.Builder> {
        @SuppressWarnings("WeakerAccess") /* synthetic access */
        Uri mUri;
        @SuppressWarnings("WeakerAccess") /* synthetic access */
        Map<String, String> mUriHeader;
