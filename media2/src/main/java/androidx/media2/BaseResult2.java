...
abstract class BaseResult2 {
    ...
    /**
     * Result code represents that the operation cannot be completed because of the valid state for
     * the operation.
     */
    ...
    /**
     * Result code represents that the operation is not supported nor implemented.
     */
    public static final int RESULT_CODE_NOT_SUPPORTED = -5;

    /**
     * Result code represents that the operation is skipped or canceled. For an example, a seek
     * operation can be skipped if it is followed by another seek operation.
     */
