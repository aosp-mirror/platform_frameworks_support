 ...
 * other states. Take a look at documentations of specific class that you're interested in.
 * <p>
 *
 ...
 * calls are ignored and would return {@link PlayerResult} with
...
public abstract class SessionPlayer implements AutoCloseable {
     ...
     * {@link PlayerResult} would be returned with {@link PlayerResult#RESULT_ERROR_INVALID_STATE}.
     */
     ...
     * it's ignored and {@link PlayerResult} would be returned with
     ...
     * would be returned with {@link PlayerResult#RESULT_ERROR_INVALID_STATE}.
     *
