...
public abstract class SessionPlayer implements AutoCloseable {
     ...
     *
     * @return the index of current media item. Can be {@link #ITEM_INDEX_INVALID} when current
     *         media item is null or is not in the playlist, and when the playlist hasn't been set.
     */
