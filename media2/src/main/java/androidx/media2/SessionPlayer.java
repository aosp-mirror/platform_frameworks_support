...
public abstract class SessionPlayer implements AutoCloseable {
     ...
     * is available.
     */
    public abstract @NonNull VideoSize getVideoSize();
    ...
    @VersionedParcelize
    public static class TrackInfo implements VersionedParcelable {
         ...
         */
        public @MediaPlayer.TrackInfo.MediaTrackType int getTrackType() {
            return mTrackType;
        }
