...
public abstract class SessionPlayer implements AutoCloseable {
     ...
     * media item when the command was completed. If it's not called in {@link #PLAYER_STATE_IDLE},
     ...
     * command was completed. If it's called in {@link #PLAYER_STATE_IDLE}, it is ignored and
     ...
     * playlist when the command was completed.
     *
     ...
     * <p>
     * On success, a {@link PlayerResult} should be returned with {@code item} sent.
     *
