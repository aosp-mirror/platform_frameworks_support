...
public abstract class MediaLibraryService2 extends MediaSessionService2 {
    ...
    public static final class MediaLibrarySession extends MediaSession2 {
        ...
        public static class MediaLibrarySessionCallback extends MediaSession2.SessionCallback {
            /**
             * Called to get the root information for browsing by a {@link MediaBrowser2}. Return
             * the root media item with a valid id here for the browser.
             * <p>
             * To allow browsing media information, return the {@link LibraryResult} with the valid
             * media item that contains the valid
             ...
             * <p>
             * For no children, return an empty list with the
             * {@link LibraryResult#RESULT_CODE_SUCCESS}.
             *
             * @param session the session for this event
             * @param controller controller
             ...
             * <p>
             * For no search result, return an empty list with the
             * {@link LibraryResult#RESULT_CODE_SUCCESS}.
             * <p>
     ...
     * <p>
     * The library params returned in the library session callback must XXXX.
     */
    @VersionedParcelize
    public static final class LibraryParams implements VersionedParcelable {
         ...
         * session is recommended to provide such media items. If it is, the library session
