...
public class MediaSessionServiceTest extends MediaSessionTestBase {
    ...
    public void testOnGetSessionIsCalled() throws InterruptedException {
        ...
        RemoteMediaController controller = createRemoteController(mToken, testHints, true);
    ...
    public void testOnGetSession_returnsDifferentSessions() {
        ...
        RemoteMediaController controller1 = createRemoteController(mToken, null, true);
        RemoteMediaController controller2 = createRemoteController(mToken, null, true);
    ...
    public void testGetSessions() throws InterruptedException {
        prepareLooper();
        RemoteMediaController controller = createRemoteController(mToken, null, true);
