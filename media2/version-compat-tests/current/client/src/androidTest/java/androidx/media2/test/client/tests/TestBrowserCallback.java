 ...
 */
public class TestBrowserCallback extends MediaBrowser.BrowserCallback
        implements TestControllerCallbackInterface {

    public final MediaController.ControllerCallback mCallbackProxy;
    public final CountDownLatch connectLatch = new CountDownLatch(1);
    public final CountDownLatch disconnectLatch = new CountDownLatch(1);
    @GuardedBy("this")
    private Runnable mOnCustomCommandRunnable;

    TestBrowserCallback(@Nullable MediaController.ControllerCallback callbackProxy) {
        mCallbackProxy = callbackProxy == null ? new MediaController.ControllerCallback() {} :
                callbackProxy;
    }
    ...
    public void onChildrenChanged(@NonNull MediaBrowser browser, @NonNull String parentId,
        ...
        ((MediaBrowser.BrowserCallback) mCallbackProxy).onChildrenChanged(
    ...
    public void onSearchResultChanged(@NonNull MediaBrowser browser, @NonNull String query,
            int itemCount, @Nullable MediaLibraryService.LibraryParams params) {
        ((MediaBrowser.BrowserCallback) mCallbackProxy).onSearchResultChanged(
