...
oneway interface IMediaSession {
    ...
    void selectTrack(IMediaController caller, int seq, in ParcelImpl trackInfo) = 40;
    void deselectTrack(IMediaController caller, int seq, in ParcelImpl trackInfo) = 41;
