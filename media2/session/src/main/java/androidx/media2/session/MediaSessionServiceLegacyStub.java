...
class MediaSessionServiceLegacyStub extends MediaBrowserServiceCompat {
    ...
    MediaSession.ControllerInfo createControllerInfo(RemoteUserInfo info) {
        return new MediaSession.ControllerInfo(info, mManager.isTrustedForMediaControl(info), null);
    }
