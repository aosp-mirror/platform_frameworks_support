...
public final class SessionCommand implements VersionedParcelable {
    ...
    @IntDef({COMMAND_CODE_CUSTOM,
            ...
            COMMAND_CODE_PLAYER_SELECT_TRACK_INFO,
            COMMAND_CODE_PLAYER_DESELECT_TRACK_INFO,
    ...
    public static final int COMMAND_CODE_PLAYER_SELECT_TRACK_INFO = 10019;
     ...
     */
    @RestrictTo(LIBRARY_GROUP)
    public static final int COMMAND_CODE_PLAYER_DESELECT_TRACK_INFO = 10020;

    static {
        VERSION_PLAYER_COMMANDS_MAP.put(COMMAND_VERSION_1,
                new Range(COMMAND_CODE_PLAYER_PLAY, COMMAND_CODE_PLAYER_DESELECT_TRACK_INFO));
    }
