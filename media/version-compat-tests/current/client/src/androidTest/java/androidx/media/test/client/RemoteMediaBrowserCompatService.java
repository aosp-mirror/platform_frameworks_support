 ...
 */
public class RemoteMediaBrowserCompatService extends Service {
    private static final String TAG = "RemoteMediaBrowserCompatService";
    ...
    private class RemoteMediaBrowserCompatStub extends IRemoteMediaBrowserCompat.Stub {
                ...
                mHandler.postAndSync(new Runnable() {
                    ...
                    public void run() {
                        MediaBrowserCompat browser = new MediaBrowserCompat(
                                RemoteMediaBrowserCompatService.this, componentName, callback,
        ...
        @Override
        public void runCustomTestCommands(String browserId, int command, Bundle args)
                throws RemoteException {
