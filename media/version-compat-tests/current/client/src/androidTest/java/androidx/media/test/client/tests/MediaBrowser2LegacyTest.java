...
import static androidx.media.test.lib.CommonConstants.MOCK_MEDIA_BROWSER_SERVICE_COMPAT;
...
public class MediaBrowser2LegacyTest extends MediaSession2TestBase {
    ...
    private MediaBrowser2 createBrowser(boolean waitForConnect, BrowserCallback callback) {
        SessionToken2 token = new SessionToken2(mContext, MOCK_MEDIA_BROWSER_SERVICE_COMPAT);
        try {
            return (MediaBrowser2) createController(token, waitForConnect, callback);
        } catch (InterruptedException e) {
            e.printStackTrace();
        }
        fail("failed to create MediaBrowser2 for connecting MockMediaBrowserServiceCompat");
        return null;
    }
...
//        MediaBrowser2 browser = createBrowser(false, new BrowserCallback() {
//            @Override
...
//     *    <li>{@link BrowserCallback#onChildrenChanged}</li>
//     * </ul>
...
//    }
    ...
    // TODO: Reduce the amount of this class.
