...
public final class MediaControllerCompat {
    ...
    static class MediaControllerImplApi21 implements MediaControllerImpl {
        ...
        public PlaybackStateCompat getPlaybackState() {
            ...
            Object stateObj = mControllerFwk.getPlaybackState();
            return stateObj != null ? PlaybackStateCompat.fromPlaybackState(stateObj) : null;
        }

        @Override
        public MediaMetadataCompat getMetadata() {
            Object metadataObj = mControllerFwk.getMetadata();
        ...
        @Override
        public PlaybackInfo getPlaybackInfo() {
            MediaController.PlaybackInfo volumeInfoObj = mControllerFwk.getPlaybackInfo();
