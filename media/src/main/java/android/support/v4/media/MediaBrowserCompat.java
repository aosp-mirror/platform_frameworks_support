...
public final class MediaBrowserCompat {
    ...
    public static class MediaItem implements Parcelable {
        ...
        public static MediaItem fromMediaItem(Object itemObj) {
            ...
            MediaBrowser.MediaItem item = (MediaBrowser.MediaItem) itemObj;
    ...
    public static class ConnectionCallback {
        final MediaBrowser.ConnectionCallback mConnectionCallbackObj;
        ConnectionCallbackInternal mConnectionCallbackInternal;

        public ConnectionCallback() {
            if (Build.VERSION.SDK_INT >= 21) {
                mConnectionCallbackObj = new ConnectionCallbackApi21();
            } else {
    ...
    public static abstract class SubscriptionCallback {
        final MediaBrowser.SubscriptionCallback mSubscriptionCallbackObj;
        ...
        public SubscriptionCallback() {
            mToken = new Binder();
            if (Build.VERSION.SDK_INT >= 26) {
                mSubscriptionCallbackObj = new SubscriptionCallbackApi26();
            } else if (Build.VERSION.SDK_INT >= 21) {
                mSubscriptionCallbackObj = new SubscriptionCallbackApi21();
            } else {
    ...
    public static abstract class ItemCallback {
        final MediaBrowser.ItemCallback mItemCallbackObj;

        public ItemCallback() {
            if (Build.VERSION.SDK_INT >= 23) {
                mItemCallbackObj = new ItemCallbackApi23();
            } else {
    ...
    static class MediaBrowserImplApi21 implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl,
        ...
        final Context mContext;
        protected final MediaBrowser mBrowserObj;
        ...
        MediaBrowserImplApi21(Context context, ComponentName serviceComponent,
            ...
            mBrowserObj = new MediaBrowser(context, serviceComponent,
        ...
        public void disconnect() {
            ...
            mBrowserObj.disconnect();
        }

        @Override
        public boolean isConnected() {
            return mBrowserObj.isConnected();
        }

        @Override
        public ComponentName getServiceComponent() {
            return mBrowserObj.getServiceComponent();
        }

        @NonNull
        @Override
        public String getRoot() {
            return mBrowserObj.getRoot();
        }

        @Nullable
        @Override
        public Bundle getExtras() {
            return mBrowserObj.getExtras();
        }
        ...
        public void subscribe(@NonNull final String parentId, final Bundle options,
            ...
            if (mServiceBinderWrapper == null) {
                ...
                mBrowserObj.subscribe(parentId, callback.mSubscriptionCallbackObj);
            } else {
                try {
        ...
        public void unsubscribe(@NonNull String parentId, SubscriptionCallback callback) {
            ...
            if (mServiceBinderWrapper == null) {
                if (callback == null) {
                    mBrowserObj.unsubscribe(parentId);
                } else {
                    final List<SubscriptionCallback> callbacks = sub.getCallbacks();
                    final List<Bundle> optionsList = sub.getOptionsList();
                    for (int i = callbacks.size() - 1; i >= 0; --i) {
        ...
        @Override
        public void onConnected() {
            Bundle extras = mBrowserObj.getExtras();
            if (extras == null) {
                return;
            }
            ...
            if (sessionToken != null) {
                mMediaSessionToken = MediaSessionCompat.Token.fromToken(
                        mBrowserObj.getSessionToken(), sessionToken);
            }
        }
    ...
    static class MediaBrowserImplApi23 extends MediaBrowserImplApi21 {
        ...
        public void getItem(@NonNull final String mediaId, @NonNull final ItemCallback cb) {
            if (mServiceBinderWrapper == null) {
                mBrowserObj.getItem(mediaId, cb.mItemCallbackObj);
            } else {
        ...
        public void subscribe(@NonNull String parentId, @Nullable Bundle options,
            ...
            if (mServiceBinderWrapper == null || mServiceVersion < SERVICE_VERSION_2) {
                if (options == null) {
                    ...
                    mBrowserObj.subscribe(parentId, options, callback.mSubscriptionCallbackObj);
                }
            } else {
        ...
        public void unsubscribe(@NonNull String parentId, SubscriptionCallback callback) {
            ...
            if (mServiceBinderWrapper == null || mServiceVersion < SERVICE_VERSION_2) {
                if (callback == null) {
                    ...
                    mBrowserObj.unsubscribe(parentId, callback.mSubscriptionCallbackObj);
                }
            } else {
