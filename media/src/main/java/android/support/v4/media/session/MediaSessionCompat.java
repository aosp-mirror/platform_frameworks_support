...
public class MediaSessionCompat {
    ...
    public abstract static class Callback {
        final MediaSession.Callback mCallbackObj;
        ...
        public Callback() {
            if (android.os.Build.VERSION.SDK_INT >= 24) {
                mCallbackObj = new MediaSessionCallbackApi24();
            } else if (android.os.Build.VERSION.SDK_INT >= 23) {
                mCallbackObj = new MediaSessionCallbackApi23();
            } else if (android.os.Build.VERSION.SDK_INT >= 21) {
                mCallbackObj = new MediaSessionCallbackApi21();
            } else {
                mCallbackObj = null;
            }
        }
        ...
        private class MediaSessionCallbackApi21 extends MediaSession.Callback {
            ...
            @Override
            public void onSetRating(Rating ratingObj) {
                setCurrentControllerInfo();
                Callback.this.onSetRating(RatingCompat.fromRating(ratingObj));
                clearCurrentControllerInfo();
            }

            public void onSetRating(Rating ratingObj, Bundle extras) {
        ...
        @RequiresApi(23)
        private class MediaSessionCallbackApi23 extends MediaSessionCallbackApi21 {

            MediaSessionCallbackApi23() {
            }
        ...
        @RequiresApi(24)
        private class MediaSessionCallbackApi24 extends MediaSessionCallbackApi23 {

            MediaSessionCallbackApi24() {
            }
    ...
    public static final class QueueItem implements Parcelable {
        ...
        public Object getQueueItem() {
            ...
            mItem = new MediaSession.QueueItem(
    ...
    static class MediaSessionImplApi21 implements MediaSessionImpl {
        final MediaSession mSessionObj;
        final Token mToken;
        final Object mLock = new Object();
        ...
        MediaSessionImplApi21(Context context, String tag, VersionedParcelable token2) {
            mSessionObj = new MediaSession(context, tag);
            mToken = new Token(mSessionObj.getSessionToken(), new ExtraSession(), token2);
            // For backward compatibility, these flags are always set.
        ...
        MediaSessionImplApi21(Object mediaSession) {
            ...
            mSessionObj = (MediaSession) mediaSession;
            mToken = new Token(mSessionObj.getSessionToken(), new ExtraSession());
            // For backward compatibility, these flags are always set.
            setFlags(FLAG_HANDLES_MEDIA_BUTTONS | FLAG_HANDLES_TRANSPORT_CONTROLS);
        }
        ...
        @Override
        public void setCallback(Callback callback, Handler handler) {
            mSessionObj.setCallback(callback == null ? null : callback.mCallbackObj, handler);
            if (callback != null) {
        ...
        public void setPlaybackToLocal(int stream) {
            ...
            mSessionObj.setPlaybackToLocal(bob.build());
        }

        @Override
        public void setPlaybackToRemote(VolumeProviderCompat volumeProvider) {
            mSessionObj.setPlaybackToRemote((VolumeProvider) volumeProvider.getVolumeProvider());
        }

        @Override
        public void setActive(boolean active) {
            mSessionObj.setActive(active);
        }

        @Override
        public boolean isActive() {
            return mSessionObj.isActive();
        }
        ...
        public void sendSessionEvent(String event, Bundle extras) {
            ...
            mSessionObj.sendSessionEvent(event, extras);
        }
        ...
        public void setMetadata(MediaMetadataCompat metadata) {
            mMetadata = metadata;
            mSessionObj.setMetadata(
                    metadata == null ? null : (MediaMetadata) metadata.getMediaMetadata());
        }

        @Override
        public void setSessionActivity(PendingIntent pi) {
            mSessionObj.setSessionActivity(pi);
        }

        @Override
        public void setMediaButtonReceiver(PendingIntent mbr) {
            mSessionObj.setMediaButtonReceiver(mbr);
        }
        ...
        public void setQueue(List<QueueItem> queue) {
            mQueue = queue;
            if (queue == null) {
                mSessionObj.setQueue(null);
                return;
            }
            ArrayList<MediaSession.QueueItem> queueItems = new ArrayList<>();
            for (QueueItem item : queue) {
                queueItems.add((MediaSession.QueueItem) item.getQueueItem());
            }
            mSessionObj.setQueue(queueItems);
        }

        @Override
        public void setQueueTitle(CharSequence title) {
            mSessionObj.setQueueTitle(title);
        }
        ...
        public void setRatingType(@RatingCompat.Style int type) {
            if (android.os.Build.VERSION.SDK_INT < 22) {
                ...
                mSessionObj.setRatingType(type);
            }
        }
        ...
        public String getCallingPackage() {
            if (android.os.Build.VERSION.SDK_INT < 24) {
                ...
                return getCallingPackageMediaSession(mSessionObj);
            }
        }
