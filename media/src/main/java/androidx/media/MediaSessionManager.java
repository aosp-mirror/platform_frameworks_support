...
public final class MediaSessionManager {
    ...
    public static final class RemoteUserInfo {
         ...
         * <p>
         * On P and before (API <= 28), two RemoteUserInfo objects are equal only if they are from
         * same package and from same process. If the PID is unknown, it will be ignored when
         * checking the equality. It cannot distinguish two different controllers/browsers in a
         * process.
         *
