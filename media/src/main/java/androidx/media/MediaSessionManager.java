...
public final class MediaSessionManager {
    ...
    public static final class RemoteUserInfo {
         ...
         * <li>One of the RemoteUserInfo's PID is {@link #UNKNOWN_PID} or PID are the same</li>
         * </ol>
         * Note that this cannot distinguish two different controllers/browsers in a process.
         *
