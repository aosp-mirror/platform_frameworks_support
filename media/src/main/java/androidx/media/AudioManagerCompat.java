...
public final class AudioManagerCompat {
    ...
    /**
     * Request audio focus. See the {@link AudioFocusRequestCompat} for information about the
     * options available to configureyour request, and notification of focus gain and loss.
     *
