...
/**
 * Transfer a large list of {@link Parcelable} objects across an IPC. Splits into
 * multiple transactions if needed.
 *
 * Note: Using this class makes synchronous binder calls, and also loses oneway property.
 *
 * @param <T> the type of elements in this parceled list. It should be a Parcelable class.
 * @hide
 */
...
public class MediaParceledListSlice<T extends Parcelable> implements Parcelable {
    ...
    MediaParceledListSlice(Parcel p) {
        ...
        while (i < itemCount) {
            ...
            final T parcelable = p.readParcelable(ParcelImpl.class.getClassLoader());
        ...
        while (i < itemCount) {
            ...
            while (i < itemCount && reply.readInt() != 0) {
                final T parcelable = reply.readParcelable(
    ...
    public void writeToParcel(@NonNull Parcel dest, int flags) {
        if (dest == null) {
            throw new NullPointerException("'dest' shouldn't be null");
        }
