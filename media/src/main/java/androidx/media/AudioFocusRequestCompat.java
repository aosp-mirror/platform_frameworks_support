...
public class AudioFocusRequestCompat {
    ...
    private final Object mPlatformAudioFocusRequest;
    ...
    private AudioFocusRequestCompat(
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            mPlatformAudioFocusRequest = null;
        }
    }
    ...
    /**
     * Returns whether the application that would use this {@code AudioFocusRequest} supports a
    ...
    /* package */ AudioFocusRequest getAudioFocusRequest() {
        return (AudioFocusRequest) mPlatformAudioFocusRequest;
    }
