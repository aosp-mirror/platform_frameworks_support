...
public class AudioFocusRequestCompat {
    ...
    /**
     * Gets whether the application that would use this {@code AudioFocusRequest} supports a focus
     * gain granted after a temporary request failure. This value is only applicable on {@link
     * android.os.Build.VERSION_CODES#O} and later.
     *
    ...
    public boolean equals(Object o) {
        ...
        return mFocusGain == that.mFocusGain
                ...
                && mAcceptsDelayedFocusGain == that.mAcceptsDelayedFocusGain
