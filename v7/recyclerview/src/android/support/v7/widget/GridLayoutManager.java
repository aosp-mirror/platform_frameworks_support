...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    /**
     * Borders for each span
     * For <b>i-th</b> item start is <b>i-1</b> and end is <b>i</b>.
     */
    int [] mCachedBorders;
    /**
    ...
    void layoutChunk(RecyclerView.Recycler recycler, RecyclerView.State state,
        ...
        for (int i = 0; i < count; i++) {
            ...
            final int spec = View.MeasureSpec.makeMeasureSpec(mCachedBorders[lp.mSpanIndex + lp.mSpanSize] - mCachedBorders[lp.mSpanIndex],
