 ...
 *
 * @param <B> The actual {@link ListenableWorkerBuilder} subtype being built.
 */
public class ListenableWorkerBuilder<B extends ListenableWorkerBuilder> {
    ...
    ListenableWorkerBuilder(@NonNull Context applicationContext, @NonNull String workerName) {
    ...
    B getThis() {
        // B = ListenableWorkerBuilder here. Java :(
        return (B) this;
    }
     ...
     * @return The current {@link ListenableWorkerBuilder}
     */
    @NonNull
    ...
    public ListenableWorker build() {
        ...
        WorkerParameters parameters =
                new WorkerParameters(
                        ...
                        taskExecutor.getSynchronousExecutor(),
                        taskExecutor,
                        getWorkerFactory()
                );
        ...
        if (worker == null) {
            throw new IllegalStateException("Could not create an instance of ListenableWorker");
        }
        return worker;
    }

    /**
     * Creates a new instance of a {@link ListenableWorkerBuilder} from a {@link WorkRequest}.
     *
     ...
     */
    @NonNull
    public static ListenableWorkerBuilder from(
        ...
        return new ListenableWorkerBuilder(context.getApplicationContext(), name)
