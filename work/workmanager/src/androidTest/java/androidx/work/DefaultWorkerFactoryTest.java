...
public class DefaultWorkerFactoryTest extends DatabaseTest {
    ...
    public void testCreateWorker_isCreated_withOnlyDefaultConstructor() {
        ...
        DefaultConstructorWorker worker = mDefaultWorkerFactory.createWorker(
                DefaultConstructorWorker.class,
                mContext,
    ...
    public void testCreateWorker_isCreated_withNewConstructor() {
        ...
        NewConstructorWorker worker = mDefaultWorkerFactory.createWorker(
                NewConstructorWorker.class,
                mContext,
                new WorkerParameters(
                        work.getId(),
                        Data.EMPTY,
