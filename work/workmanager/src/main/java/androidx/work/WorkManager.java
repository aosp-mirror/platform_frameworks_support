...
public abstract class WorkManager {
    ...
    /**
     * This method allows you to enqueue a uniquely-named {@link WorkContinuation}, where only
     * one continuation of OneTimeWorkRequests of a particular name can be active at a time.
     * For example, you may only want one sync operation to be active.  If there is one pending,
     * you can choose to let it run or replace it with your new work.
     *
     * The {@code uniqueWorkName} uniquely identifies this WorkContinuation.
     *
     ...
     *                     will be cancelled and the new work will run. {@code KEEP} will run th
