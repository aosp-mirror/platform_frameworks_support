...
public final class Configuration {
    ...
    private final @NonNull Executor mTaskExecutorDelegate;
    ...
    Configuration(@NonNull Configuration.Builder builder) {
        ...
        if (builder.mTaskExecutorDelegate == null) {
            // This executor is used for *both* reads and writes.
            // So this cannot be a single threaded executor. Writes will still be serialized
            // as this will be wrapped with an SerialExecutor.
            mTaskExecutorDelegate = createDefaultExecutor();
        } else {
            mTaskExecutorDelegate = builder.mTaskExecutorDelegate;
        }
     ...
     */
    @NonNull
    public Executor getTaskExecutorDelegate() {
        return mTaskExecutorDelegate;
    }
    ...
    public static final class Builder {
        ...
        Executor mTaskExecutorDelegate;
        ...
        /**
         * Specifies a custom {@link Executor} which will be used by WorkManager for all its
         * internal book-keeping.
         *
         * For best performance this {@link Executor} should be bounded and should *not* be a
         * single threaded executor.
         *
         * @param taskExecutorDelegate The {@link Executor} which will be used by WorkManager for
         *                             all its internal book-keeping
         * @return This {@link Builder} instance
         */
        public @NonNull Builder setTaskExecutorDelegate(@NonNull Executor taskExecutorDelegate) {
            mTaskExecutorDelegate = taskExecutorDelegate;
            return this;
        }
