 ...
 * such as doze mode.
 * <p>
 * You can control when the work executes in the period interval more exactly - by default, the work
 * will happen in the last five minutes of the interval (see
 * * {@link PeriodicWorkRequest.Builder#Builder(Class, Duration, Duration)} or one of its variants
 * for documentation on {@code flexInterval}s).
 * <p>
