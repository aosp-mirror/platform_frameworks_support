...
public final class Constraints {
    ...
    public static final class Builder {
        ...
        /**
         * Sets the delay that is allowed from the time a {@code ContentUri} change
        ...
        /**
         * Sets the maximum delay that is allowed from the first time a {@code ContentUri} change
         * is detected to the time when the {@link WorkRequest} is scheduled.
         *
         * @param duration The length of the delay in {@code timeUnit} units
         * @param timeUnit The units of time for {@code duration}
         * @return The current {@link Builder}
