...
/**
 * The engine for WorkManager task execution.  Public APIs will delegate to this class for all
 * business logic.
 *
 * @hide
 */
...
public class WorkManagerEngine {
    ...
    public void rescheduleEligibleWork() {
        ...
        // Using getters here so we can use from a mocked instance of WorkManagerEngine.
