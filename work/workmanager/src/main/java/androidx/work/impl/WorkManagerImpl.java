...
public class WorkManagerImpl extends WorkManager {
    ...
    private final LiveDataContainer mLiveDataContainer = new LiveDataContainer();
    ...
    public @NonNull LiveData<WorkInfo> getWorkInfoByIdLiveData(@NonNull UUID id) {
        ...
        LiveData<WorkInfo> dedupped = LiveDataUtils.dedupedMappedLiveDataFor(inputLiveData,
                ...
                mWorkTaskExecutor);
        return mLiveDataContainer.track(dedupped);
    }
    ...
    public @NonNull LiveData<List<WorkInfo>> getWorkInfosByTagLiveData(@NonNull String tag) {
        ...
        LiveData<List<WorkInfo>> dedupped = LiveDataUtils.dedupedMappedLiveDataFor(
                inputLiveData,
