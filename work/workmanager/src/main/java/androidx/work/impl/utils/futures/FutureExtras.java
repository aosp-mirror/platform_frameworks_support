...
public class FutureExtras {
    /**
     * A helper method to create an instance of {@link ListenableFuture} with a {@code value}.
     */
    public static <T> ListenableFuture<T> resolve(@NonNull T value) {
    ...
    /**
     * A helper method to create an instance of {@link ListenableFuture} with a given
     * {@code exception}.
     */
    public static <T> ListenableFuture<T> resolveWithException(@NonNull Throwable exception) {
        final SettableFuture<T> future = SettableFuture.create();
