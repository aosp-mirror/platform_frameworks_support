...
public interface WorkProgressDao {
    ...
    Data byWorkSpec(@NonNull String workSpecId);

    /**
     * @param workSpecIds The {@link List<String>} of workSpec ids
     * @return The {@link List<Data>} of progress data associated with the given workSpec ids.
     */
    @NonNull
    @Query("SELECT progress from WorkProgress WHERE work_spec_id IN (:workSpecIds)")
    List<Data> byWorkSpecs(@NonNull List<String> workSpecIds);
}
