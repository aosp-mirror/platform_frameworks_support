...
public class WorkerWrapper implements Runnable {
    ...
    private void onWorkFinished(@NonNull Result result) {
        try {
            mWorkDatabase.beginTransaction();
            if (!tryCheckForInterruptionAndNotify()) {
    ...
    static NonBlockingWorker workerFromWorkSpec(@NonNull Context context,
    ...
    public static NonBlockingWorker workerFromClassName(
