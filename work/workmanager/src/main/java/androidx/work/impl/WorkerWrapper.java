...
public class WorkerWrapper implements Runnable {
    ...
    private void resetPeriodicAndResolve() {
        ...
        try {
            ...
            // PeriodicWork might have been scheduled in the past. This will be reflected in
            // periodStartTime. When this happens, we need to move the nextPeriodStartTime to the
