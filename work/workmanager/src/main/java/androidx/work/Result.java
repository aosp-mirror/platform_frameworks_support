...
/**
 * The result of a {@link ListenableWorker}s computation.
 */
public abstract class Result {
    ...
    /**
     * Returns an instance of {@link Result} that can be used to indicate
     * that the work encountered a transient failure and should be retried with backoff specified
     * in {@link WorkRequest.Builder#setBackoffCriteria(BackoffPolicy, long, TimeUnit)}.
     *
     * @return An instance of {@link Result}
     */
    @NonNull
    ...
    /**
     * Returns an instance of {@link Result} that can be used to indicate
     * that the work completed with a permanent failure. Any work that depends
     * on this will also be marked as failed and will not be run. <b>If you need child
     * workers to run , you need to use {@link #success()} or {@link #success(Data)} </b>;
     ...
     * failure indicates a permanent stoppage of the chain of work.
     *
     * @param outputData An {@link Data} object that can be used to keep track of why the work
     *                   failed
     * @return An instance of {@link Result}
     */
    @NonNull
