...
abstract class CoroutineWorker(
    ...
    /**
     * The coroutine context on which [doWork] will run. By default, this is
     * [Dispatchers.Default].
     */
     ...
     * by [coroutineContext].
     *
     * @return The {@link Result} of the result of the background work; note that
     *         dependent work will not execute if you return [Result.failure()] or
     *         [Result.failure(Data)]
     */
