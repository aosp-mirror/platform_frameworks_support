...
public abstract class RxWorker extends ListenableWorker {
    private static final Executor INSTANT_EXECUTOR = new Executor() {
        @Override
     ...
     * <p>
     * The default implementation returns a scheduler that uses the Executor Pool which was provided
     * in {@link WorkManager}'s configuration (or the default one it creates).
     * <p>
     * You can override this method to change the scheduler used by RxWorker to start its
     * subscription. It always observers the result of the Single in WorkManager's internal thread.
     *
     ...
     */
    @MainThread
    abstract Single<Payload> createWork();
