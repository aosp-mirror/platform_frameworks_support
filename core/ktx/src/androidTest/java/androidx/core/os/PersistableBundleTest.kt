...
class PersistableBundleTest {
    ...
    @Test fun persistableBundleOfInvalid() {
        assertThrows<IllegalArgumentException> {
            persistableBundleOf("nope" to View(ApplicationProvider.getApplicationContext()))
        }.hasMessageThat().isEqualTo("Illegal value type android.view.View for key \"nope\"")

        assertThrows<IllegalArgumentException> {
            persistableBundleOf("nopes" to arrayOf(View(ApplicationProvider.getApplicationContext())))
