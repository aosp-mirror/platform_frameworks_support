...
import static androidx.core.graphics.ColorFilterCompat.createBlendModeColorFilterCompat;
...
public final class PaintCompat {
    ...
    public static boolean setBlendModeColorFilter(@NonNull Paint paint, @ColorInt int color,
        ...
        ColorFilter colorFilter = blendModeCompat != null
                ? createBlendModeColorFilterCompat(color, blendModeCompat) : null;
        paint.setColorFilter(colorFilter);
        // Return true if there is a compatible ColorFilter or if the provided BlendMode is null
        return colorFilter != null || blendModeCompat == null;
    }
