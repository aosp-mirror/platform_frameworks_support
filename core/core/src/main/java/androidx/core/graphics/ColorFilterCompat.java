...
public class ColorFilterCompat {
     ...
     *
     * Passing in null for the BlendModeCompat parameter will return null
     */
    public static @Nullable ColorFilter createBlendModeColorFilterCompat(int color,
        ...
        if (Build.VERSION.SDK_INT >= 29) {
            BlendMode blendMode = blendModeCompat != null
                    ? BlendModeUtils.obtainBlendModeFromCompat(blendModeCompat) : null;
            if (blendMode != null) {
