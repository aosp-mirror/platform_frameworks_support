...
public final class TraceCompatTest {
    ...
    public void beginAndEndSectionAsync() throws IOException {
        startTrace();
        TraceCompat.beginAsyncSection("beginAndEndSection", /*cookie=*/5099);
        TraceCompat.endAsyncSection("beginAndEndSection", /*cookie=*/5099);
        endTrace();

        assertTraceContains("tracing_mark_write:\\ S\\|.*\\|beginAndEndSection\\|5099");
        assertTraceContains("tracing_mark_write:\\ F\\|.*\\|beginAndEndSection\\|5099");
    }
    ...
    private void startTrace() throws IOException {
        ...
        writeDataToByteStream(automan.executeShellCommand(
