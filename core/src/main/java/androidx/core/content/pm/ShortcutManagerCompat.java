...
public class ShortcutManagerCompat {
     ...
     */
    private static Boolean sNeedToPersistShortcuts = null;
    ...
    public static boolean addDynamicShortcuts(@NonNull Context context,
        ...
        if (needToPersistShortcuts(context)) {
     ...
     */
    private static boolean needToPersistShortcuts(Context context) {
        if (Build.VERSION.SDK_INT < 23) {
            return false;
        }

        if (sNeedToPersistShortcuts == null) {
            ...
            sNeedToPersistShortcuts = needToPersist;
        }
        System.out.println("METT: needToPersistShortcuts=" + sNeedToPersistShortcuts);
        return sNeedToPersistShortcuts;
    }
}
