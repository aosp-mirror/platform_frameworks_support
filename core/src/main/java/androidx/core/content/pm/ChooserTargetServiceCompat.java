 ...
 */
// TODO: Choose a better name, since it is not a compatibility version for ChooserTargetService
public class ChooserTargetServiceCompat extends ChooserTargetService {

    @Override
    public List<ChooserTarget> onGetChooserTargets(ComponentName targetActivityName,
                                                   IntentFilter matchedFilter) {
        System.out.println("METT: onGetChooserTargets targetActivityName=" + targetActivityName.flattenToString()
        ...
        for (ShareTargetCompat target : targets) {
            ...
            for (ShortcutInfoCompat shortcut : shortcuts) {
                if (!shortcut.getCategories().contains(target.mCategory)) {
                    continue;
                }
                ...
                Person person = shortcut.getPerson();
                if (person != null) {
                    extras.putBundle("EXTRA_PERSON", person.toBundle());
                }
