...
public class ChooserTargetServiceCompat extends ChooserTargetService {
    ...
    public List<ChooserTarget> onGetChooserTargets(ComponentName targetActivityName,
        ...
        ShortcutInfoCompatSaver shortcutSaver = new ShortcutInfoCompatSaver(context, true);
        List<ShortcutInfoCompat> shortcuts = new ArrayList<>(shortcutSaver.loadFromXml().values());
    ...
    private Icon getIcon(ShortcutInfoCompat shortcut, ShortcutInfoCompatSaver shortcutSaver) {
        ...
        if (icon == null) {
            icon = shortcutSaver.loadShortcutIcon(shortcut.getId());
        }
        if (icon != null) {
            return icon.toIcon();
        }
