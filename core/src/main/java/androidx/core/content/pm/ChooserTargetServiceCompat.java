...
public class ChooserTargetServiceCompat extends ChooserTargetService {
    ...
    public List<ChooserTarget> onGetChooserTargets(ComponentName targetActivityName,
        ...
        System.out.println("METTT: onGetChooserTarget called");
        ...
        for (ShortcutInfo shortcut : shortcuts) {
            if (ShortcutInfoCompat.getLongLived(shortcut)) {
                ...
                System.out.println("METTT: adding share target, label:" + shortcut.getShortLabel() + " activity:" + shortcut.getActivity());

                targets.add(new ChooserTarget(
                        // The name of this target.
                        shortcut.getShortLabel(),
                        // The icon to represent this target.
                        null,//Icon.createWithResource(this, R.mipmap.logo_avatar),
