...
public class ViewCompat {
     ...
     *
     * @return The resourceId associated with the action, or -1 if the action could not be created
     * <p>
     * Compatibility:
     * <ul>
     *     <li>API &lt; 21: No-op</li>
    ...
    private static int getAvailableActionIdFromResources(View view) {
        ...
        for (int i = 0; i < sResourceIds.length && result == -1; i++) {
            int id = sResourceIds[i];
    ...
    public static <T extends AccessibilityViewCommand.CommandArguments> void
                replaceAccessibilityAction(@NonNull View view, @NonNull
