 ...
 * @param <T> The argument type passed in.
 */
public interface  AccessibilityViewCommand<T extends AccessibilityViewCommand.CommandArguments> {
    /**
     * Performs the action.
     *
     ...
     */
    boolean perform(@Nullable T arguments);
     ...
     */
    class MoveAtGranularityArguments extends CommandArguments {
     ...
     */
    class MoveHTMLArguments extends CommandArguments {
     ...
     */
    class SetSelectionArguments extends CommandArguments {
     ...
     */
    class SetTextArguments extends CommandArguments {
     ...
     */
    class ScrollToPositionArguments extends CommandArguments {
     ...
     * #ACTION_SET_PROGRESS}
     */
    class SetProgressArguments extends CommandArguments {
     ...
     * #ACTION_MOVE_WINDOW}
     */
    class MoveWindowArguments extends CommandArguments {
