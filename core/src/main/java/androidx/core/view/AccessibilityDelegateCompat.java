...
public class AccessibilityDelegateCompat {
    ...
    /**
     * This is a temporary workaround for TalkBack.
     * In frameworks we check to see if id & 0xFF000000 is non 0. This is a check to make sure the
     * generated id is a resource id. 0x7f is what app generated resourceids are.
     * And 0x01 are framework generated. 0x8F are ids generated by support library actions.
     * Lets just use 0x9F then.
     */
    private static final int sTemporaryClickableSpanAction = 0x9F000001;
    ...
    public boolean performAccessibilityAction(View host, int action, Bundle args) {
        ...
        if (!success && (action == R.id.accessibility_action_clickable_span
                || action == sTemporaryClickableSpanAction)) {
