...
public class Person {
     ...
     * can be created from a {@link Person} using {@link #toPersistableBundle()}.
     */
    @RequiresApi(21)
    @NonNull
    public static Person fromPersistableBundle(@NonNull PersistableBundle bundle) {
        // TODO: Add proper documentation for icon being skipped when building PersistableBundle.
        return new Builder()
     ...
     * bundle can be converted back by using {@link #fromPersistableBundle(PersistableBundle)}.
     */
    @RequiresApi(21)
    @NonNull
