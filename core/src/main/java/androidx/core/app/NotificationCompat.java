...
public class NotificationCompat {
    ...
    public static abstract class Style {
        ...
        /**
         * Automatically called when {@code NotificationCompatBuilder} is building the framework
         * {@code Notification} object. Compat styles should encode any additional information they
         * require that's not natively supported in the {@code extras} Bundle that's supplied.
         *
         * <p>Note: This will only run on SDK 16 and above.
         *
         * @hide
         */
        @RestrictTo(LIBRARY_GROUP_PREFIX)
        ...
        /**
         * Compat styles need to manually call this in order to decode extras from the native
         * framework {@code Notification} object back into the compat style.
         *
         * @hide
         */
        @RestrictTo(LIBRARY_GROUP_PREFIX)
        ...
        public void apply(NotificationBuilderWithBuilderAccessor builder) {
            ...
            if (Build.VERSION.SDK_INT >= 24) {
                ...
                for (MessagingStyle.Message compatMessage : mMessages) {
                    ...
                    // Use native message type for SDK 30 and above
//                    if (Build.VERSION.SDK_INT >= 30) {
//                        frameworkMessage.setMessageType(compatMessage.getMessageType());
//                    }
        ...
        public static final class Message {
            /** Used as the default message type denoting a plaintext message. */
            public static final int MESSAGE_TYPE_TEXT = 0;

            /**
             * Catchall message type for messages that don't fall into any other predefined
             * category.
             */
            public static final int MESSAGE_TYPE_OTHER = 1;

            /** Denotes that the message contains an image. */
            public static final int MESSAGE_TYPE_IMAGE = 2;

            /** Denotes that the message contains a video. */
            public static final int MESSAGE_TYPE_VIDEO = 3;

            /** Denotes that the message contains audio. */
            public static final int MESSAGE_TYPE_AUDIO = 4;

            /** Denotes that the message contains a sticker. */
            public static final int MESSAGE_TYPE_STICKER = 5;

            /**
             * Denotes that the message signals how long the sender will take to arrive to a
             * destination (ie. their estimated time of arrival).
             */
            public static final int MESSAGE_TYPE_ETA = 6;

            /** Denotes that the message points to an arbitrary location. */
            public static final int MESSAGE_TYPE_GENERIC_LOCATION = 7;

            /** Denotes that the message points to the sender's location. */
            public static final int MESSAGE_TYPE_SELF_LOCATION = 8;

            /** Denotes that the message is the sender's status. */
            public static final int MESSAGE_TYPE_STATUS = 9;

            /**
             * Denotes that the message is a service message generated by the app (as opposed to
             * being generated by a user). For example "x added y to the conversation".
             */
            public static final int MESSAGE_TYPE_SERVICE = 10;

            /** Denotes that the message is a link. */
            public static final int MESSAGE_TYPE_GENERIC_URI = 11;
            ...
            /**
             * Sets a contextual hint for what the message text or data represents.
             *
             * @return this object for method chaining
             */
            ...
            /**
             * A contextual hint for what this message's text or data represents.
             *
             * @return the message type set by the app, or {@link #MESSAGE_TYPE_TEXT} if none was
             *     provided.
             */
            @MessageType
            ...
            private Bundle toBundle() {
                ...
                bundle.putInt(KEY_MESSAGE_TYPE, mMessageType);
                return bundle;
            }
            ...
            static Message getMessageFromBundle(Bundle bundle) {
                try {
                    ...
                    message.setMessageType(bundle.getInt(KEY_MESSAGE_TYPE, MESSAGE_TYPE_TEXT));
                    return message;
                } catch (ClassCastException e) {
                    return null;
                }
            ...
            @IntDef({
                    ...
                    MESSAGE_TYPE_ETA,
                    MESSAGE_TYPE_GENERIC_LOCATION,
                    MESSAGE_TYPE_SELF_LOCATION,
                    MESSAGE_TYPE_STATUS,
                    MESSAGE_TYPE_SERVICE,
                    MESSAGE_TYPE_GENERIC_URI
            })
            @Retention(RetentionPolicy.SOURCE)
