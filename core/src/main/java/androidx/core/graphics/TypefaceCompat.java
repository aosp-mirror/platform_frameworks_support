...
public class TypefaceCompat {
    ...
    @Nullable
    @RestrictTo(LIBRARY_GROUP)
    private static Typeface getBestFontFromFamily(final Context context, final Resources resources,
    ...
    public static Typeface create(@NonNull final Context context, @Nullable final Typeface family,
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
            ...
            typefaceFromFamily = TypefaceCompat.getBestFontFromFamily(context, resources,
                    family, style);
