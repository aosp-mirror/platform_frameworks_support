...
public class ActivityCompatRecreateTestCase {
    ...
    public void testRecreate() throws Throwable {
        ...
        waitUntilState(mActivityTestRule, firstActivity, Lifecycle.State.RESUMED);
        ...
        waitUntilState(mActivityTestRule, firstActivity, Lifecycle.State.DESTROYED);
    ...
    public void testRecreateWhenStopped() throws Throwable {
        ...
        waitUntilState(mActivityTestRule, fgActivity, Lifecycle.State.RESUMED);
        waitUntilState(mActivityTestRule, firstActivity, Lifecycle.State.CREATED);
        ...
        fgActivity.finish();
        waitUntilState(mActivityTestRule, fgActivity, Lifecycle.State.DESTROYED);
        ...
        // Assert that the recreated Activity is resumed
        waitUntilState(mActivityTestRule, recreatedActivity, Lifecycle.State.RESUMED);
    }
}
