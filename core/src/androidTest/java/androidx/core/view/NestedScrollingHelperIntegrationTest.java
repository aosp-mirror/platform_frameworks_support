...
public class NestedScrollingHelperIntegrationTest {
    ...
    @Before
    public void setup() {
        mNestedScrollingImpl3 = new NestedScrollingImpl3(ApplicationProvider.getApplicationContext());
        mNestedScrollingImpl2 = new NestedScrollingImpl2(ApplicationProvider.getApplicationContext());
