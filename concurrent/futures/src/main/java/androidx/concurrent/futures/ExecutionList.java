...
import static androidx.concurrent.futures.AbstractResolvableFuture.checkNotNull;
 ...
 * during {@code Executor.execute} (e.g., a {@code RejectedExecutionException}
...
final class ExecutionList {
     ...
     * documentation.
     */
    public void add(@NonNull Runnable runnable, @NonNull Executor executor) {
