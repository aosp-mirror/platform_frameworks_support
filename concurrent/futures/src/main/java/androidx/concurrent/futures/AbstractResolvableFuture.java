 ...
 * common ways to create a {@code ListenableFuture} include instantiating a
 * {@link ResolvableFuture}, submitting a task to a {@code ListeningExecutorService}, and deriving a
 * {@code Future} from an existing one, typically using methods like
 * {@code Futures#transform(ListenableFuture, com.google.common.base.Function,
 * java.util.concurrent.Executor) Futures.transform} and {@code Futures#catching(ListenableFuture,
