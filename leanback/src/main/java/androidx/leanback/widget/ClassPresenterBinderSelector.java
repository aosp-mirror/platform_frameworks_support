...
public final class ClassPresenterBinderSelector<PresenterT extends Presenter,
    ...
    /**
     * Sets a PresenterBinder to be used for the given class.
    ...
    /**
     * Sets a PresenterBinder selector to be used for the given class.
     * @param cls The data model class to be rendered.
     * @param binderSelector The selector that finds the right PresenterBinder for a given class.
     * @return This ClassPresenterBinderSelector object.
     */
