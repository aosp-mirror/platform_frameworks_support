 ...
 */
public class ListRowBinder<
            ListRowPresenterT extends ListRowPresenter,
            ListRowVH extends ListRowPresenter.ViewHolder,
            ListRowT extends ListRow>
        extends RowBinder<ListRowPresenterT, ListRowVH, ListRowT> {

    @CallSuper
    @Override
    public void onBindViewHolder(@NonNull ListRowPresenterT presenter,
            @NonNull ListRowVH viewHolder, @NonNull ListRowT rowItem) {
        super.onBindViewHolder(presenter, viewHolder, rowItem);
