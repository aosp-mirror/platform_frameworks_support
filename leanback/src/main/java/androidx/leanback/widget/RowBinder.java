 ...
 */
public abstract class RowBinder<
            RowPresenterT extends RowPresenter,
            RowVH extends RowPresenter.ViewHolder,
            RowT extends Row>
        extends PresenterBinder<RowPresenterT, RowVH, RowT> {

    @CallSuper
    @Override
    public void onBindViewHolder(@NonNull RowPresenterT presenter, @NonNull RowVH viewHolder,
            @NonNull RowT item) {
