 ...
 *
 * @see ComponentActivity#addOnBackPressedHandler(LifecycleOwner, OnBackPressedHandler)
 * @see ComponentActivity#removeOnBackPressedHandler(OnBackPressedHandler)
 */
public interface OnBackPressedHandler {
     ...
     * further {@link OnBackPressedHandler} instances will be called if you return true.
     */
    @MainThread
