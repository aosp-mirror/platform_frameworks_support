...
public class ComponentActivity extends androidx.core.app.ComponentActivity implements
     ...
     */
    private final WeakHashMap<OnBackPressedCallback, Subscription>
            mOnBackPressedCallbackSubscriptions = new WeakHashMap<>();
    ...
    public void addOnBackPressedCallback(@NonNull OnBackPressedCallback onBackPressedCallback) {
        mOnBackPressedCallbackSubscriptions.put(onBackPressedCallback,
     ...
     * @deprecated Use {@link androidx.core.app.Subscription#cancel()} on the
     * {@link androidx.core.app.Subscription} returned by {@link #getOnBackPressedDispatcher() and
     * {@link OnBackPressedDispatcher#addCallback }}.
     */
    @SuppressWarnings("DeprecatedIsStillUsed") /* See mOnBackPressedCallbackSubscriptions */
    @Deprecated
    public void removeOnBackPressedCallback(@NonNull OnBackPressedCallback onBackPressedCallback) {
        Subscription subscription = mOnBackPressedCallbackSubscriptions.get(onBackPressedCallback);
