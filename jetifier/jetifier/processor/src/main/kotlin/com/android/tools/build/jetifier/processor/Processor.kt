...
class Processor private constructor(
     ...
     * - [XmlResourcesTransformer] for java native code and xml resource source files
    ...
    fun transform(input: Set<FileMapping>, copyUnmodifiedLibsAlso: Boolean = true): Set<File> {
        ...
        for (fileMapping in nonSingleFiles) {
            ...
            if (transformer != null) {
                println("Found the transformer!")
                // File is transformable, set relativePath to the output path.
