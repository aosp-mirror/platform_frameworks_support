...
class Processor private constructor(
    ...
    /**
     * Whether the last execution of [transform2] changed any library.
     */
    var noLibraryModified = true
        private set
    ...
    fun transform2(
        ...
        noLibraryModified = librariesToProcess.count { it.wasChanged } == 0
    ...
    fun transform(input: Set<FileMapping>, copyUnmodifiedLibsAlso: Boolean = true): Set<File> {
        return transform2(input = input, copyUnmodifiedLibsAlso = copyUnmodifiedLibsAlso)
    }
