...
class Processor private constructor(
    ...
    fun transform2(
        ...
        if (nonSingleFiles.isEmpty()) {
            ...
            return TransformationResult(filesCreated = emptySet(), numberOfLibsModified = 0)
        }
        ...
        if (copyUnmodifiedLibsAlso) {
            ...
            return TransformationResult(
                filesCreated = allLibraries.map { it.writeSelf() }.toSet(),
        ...
        return TransformationResult(
            filesCreated = inputLibraries.minus(originalFilesToRemove).plus(newGeneratedLibraries),
            numberOfLibsModified = numberOfLibsModified)
    }
