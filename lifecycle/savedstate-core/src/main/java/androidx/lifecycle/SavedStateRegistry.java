...
public class SavedStateRegistry implements SavedState {
    ...
    private SafeIterableMap<String, SaveStateCallback> mComponents = new SafeIterableMap<>();
    ...
    @MainThread
    @Override
    public void registerSaveStateCallback(@NonNull String key,
            @NonNull SaveStateCallback callback) {
        SaveStateCallback previousCallback = mComponents.putIfAbsent(key, callback);
    ...
    public void performSave(@NonNull Bundle outBundle) {
        ...
        for (Iterator<Map.Entry<String, SaveStateCallback>> it =
                mComponents.iteratorWithAdditions(); it.hasNext(); ) {
            Map.Entry<String, SaveStateCallback> entry = it.next();
