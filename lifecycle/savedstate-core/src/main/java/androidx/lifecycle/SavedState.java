...
public interface SavedState {
    /**
     * Consumes saved state previously supplied by {@link SavedState.SaveStateCallback} registered
     * via {@link #registerSaveStateCallback(String, SaveStateCallback)} with the given {@code key}.
     * <p>
     ...
     *
     * @param key a key with which {@link SavedState.SaveStateCallback} was previously registered.
    ...
    /**
     * Registers a {@link SaveStateCallback} by the given {@code key}. This callback will be called
     ...
     */
    @MainThread
    void registerSaveStateCallback(@NonNull String key, @NonNull SaveStateCallback callback);
