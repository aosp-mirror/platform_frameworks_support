...
val Lifecycle.scope: CoroutineScope
    get() {
        return (this.mInternalScope as? LifecycleCoroutineScope) ?: SCOPE_LOCK.withLock {
            (this.mInternalScope as? LifecycleCoroutineScope) ?: LifecycleCoroutineScope(
                this,
                Job() + Dispatchers.Main
            ).also {
                this.mInternalScope = it
            }
        }
    }
