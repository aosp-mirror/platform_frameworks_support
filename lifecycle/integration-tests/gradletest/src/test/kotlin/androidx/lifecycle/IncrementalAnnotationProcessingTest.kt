...
class IncrementalAnnotationProcessingTest {
    ...
    fun setup() {
        ...
        projectConnection = GradleConnector.newConnector().useDistribution(
            URI("https://services.gradle.org/distributions-snapshots/" +
                    "gradle-5.4-20190328132959+0000-all.zip"))
