...
interface LiveDataScope<T> {
     ...
     *
     * @param source The [LiveData] instance who values will be dispatched from current [LiveData].
     ...
     * was called last.
     *
     * Checking this value might be useful if you want to handle block cancelation gracefully and
