...
#
# Example usage: 'python3 development/update_studio_versions.py 3.4.0-beta03' where 3.4.0-beta03
# is the AGP version.
#### ####
...
def get_studio_version_string(agp_version):
    ...
    # No stability prefix, i.e agp_version is similar to '3.4.0', not '3.4.0-beta03'
    if len(split) == 1:
        return agp_version
...
USAGE_MESSAGE = """Usage: python3 development/update_studio_versions.py <agp_version>
Example usage: python3 development/update_studio_versions.py 3.4.0-beta03
...
Run \033[92m./studiow\033[0m and \033[92m./gradlew createArchive\033[0m to verify nothing broke!
"""

STUDIO_VERSIONS_TEMPLATE = """# WARNING: This file is automatically generated.
# To update, use 'python3 /development/update_studio_versions.py <agp_version>'
