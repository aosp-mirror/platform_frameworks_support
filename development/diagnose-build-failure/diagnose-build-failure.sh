...
echo
echoAndDo "$supportRoot/development/file-utils/diff-filterer.py --assume-no-side-effects $successState $tempDir/prev \"$scriptPath/impl/restore-state.sh . && cd $supportRoot && ./gradlew --no-daemon $gradleArgs\""
