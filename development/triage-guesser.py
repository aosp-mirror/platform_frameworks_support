...
class Triager(object):
  ...
  def parseIssues(self, lines):
    ...
    while len(fields) > 0:
      ...
      if len(middle) != 4:
        raise Exception("Parse error: wrong number of tabs in " + str(middle))
