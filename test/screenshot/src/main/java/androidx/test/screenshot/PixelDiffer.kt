...
import androidx.test.screenshot.proto.ScreenshotResultProto.ScreenshotResult.ComparisonStatistics
...
fun compareBitmaps(reference: Bitmap?, test: Bitmap): ScreenshotResult {
    ...
    result.setComparisonStatistics(ComparisonStatistics.newBuilder().apply {
