...
public class TestUtilsMatchers {
    ...
    /**
     * Returns a matcher that matches <code>SwitchCompat</code>s who's thumb drawable is flat-filled
     * with the specific color.
     */
    ...
    /**
     * Returns a matcher that matches <code>SwitchCompat</code>s who's track drawable is flat-filled
     * with the specific color.
     */
