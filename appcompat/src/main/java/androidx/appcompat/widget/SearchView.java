...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    static final PreQAutoCompleteTextViewReflector PRE_Q_HIDDEN_METHOD_INVOKER =
            (SDK_INT < Q) ? new PreQAutoCompleteTextViewReflector() : null;
    ...
    void forceSuggestionQuery() {
        if (SDK_INT >= Q) {
            ...
            PRE_Q_HIDDEN_METHOD_INVOKER.doBeforeTextChanged(mSearchSrcTextView);
            PRE_Q_HIDDEN_METHOD_INVOKER.doAfterTextChanged(mSearchSrcTextView);
        }
    }
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        void ensureImeVisible() {
            if (SDK_INT >= Q) {
                ...
                PRE_Q_HIDDEN_METHOD_INVOKER.ensureImeVisible(this);
            }
        }
    }
    ...
    private static class PreQAutoCompleteTextViewReflector {
        ...
        private static void preQCheck() {
            if (SDK_INT >= Q) {
                throw new UnsupportedClassVersionError(
                        "This function can only be used by pre-Q builds.");
            }
        }
    }
}
