...
public final class AppCompatDrawableManager {
    @RestrictTo(LIBRARY_GROUP)
    interface AppCompatDrawableManagerHooks {
        Drawable createDrawableFor(@NonNull AppCompatDrawableManager appCompatDrawableManager,
    ...
    public static synchronized AppCompatDrawableManager get() {
        if (INSTANCE == null) {
            ...
            INSTANCE.mHooks = new AppCompatDrawableManagerHooks() {
                /**
                ...
                @Override
                public Drawable createDrawableFor(@NonNull AppCompatDrawableManager appCompatDrawableManager,
                        @NonNull Context context, int resId) {
                    if (resId == R.drawable.abc_cab_background_top_material) {
                        return new LayerDrawable(new Drawable[]{
                                appCompatDrawableManager.getDrawable(context,
                                        R.drawable.abc_cab_background_internal_bg),
                                appCompatDrawableManager.getDrawable(context,
                                        R.drawable.abc_cab_background_top_mtrl_alpha)
                        });
                ...
                @Override
                public ColorStateList getTintList(@NonNull Context context, int resId) {
    ...
    private AppCompatDrawableManagerHooks mHooks;
    ...
    private Drawable tintDrawable(@NonNull Context context, @DrawableRes int resId,
        ...
        } else if (mHooks.tintDrawable(context, resId, drawable)) {
    ...
    boolean tintDrawableUsingColorFilter(@NonNull Context context,
            @DrawableRes final int resId, @NonNull Drawable drawable) {
        return mHooks.tintDrawableUsingColorFilter(context, resId, drawable);
    }
    ...
    PorterDuff.Mode getTintMode(final int resId) {
        return mHooks.getTintMode(resId);
    }
    ...
    synchronized ColorStateList getTintList(@NonNull Context context, @DrawableRes int resId) {
        ...
        if (tint == null) {
            // ...if the cache did not contain a color state list, try and create one
            tint = mHooks.getTintList(context, resId);
