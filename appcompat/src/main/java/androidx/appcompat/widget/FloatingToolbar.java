...
final class FloatingToolbar {
    ...
    FloatingToolbar(View view) {
        ...
        mPopup = new FloatingToolbarPopup(context, mRootView, mDismissRunnable, new RtlHelper() {
            @Override
     ...
     * toolbar.
     */
    public FloatingToolbar setMenu(SupportMenu menu) {
    ...
    private static final class FloatingToolbarPopup {
        ...
        FloatingToolbarPopup(
                Context context, View parent, Runnable dismissRunnable, RtlHelper rtlHelper) {
