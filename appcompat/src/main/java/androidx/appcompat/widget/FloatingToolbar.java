...
final class FloatingToolbar {
    ...
    static final int MENU_ID_ASSIST = FloatingToolbarConstants.MENU_ID_ASSIST;
    ...
    private final Comparator<SupportMenuItem> mMenuItemComparator =
            new Comparator<SupportMenuItem>() {
                ...
                public int compare(SupportMenuItem menuItem1, SupportMenuItem menuItem2) {
                    ...
                    if (menuItem1.getItemId() == MENU_ID_ASSIST) {
                        return menuItem2.getItemId() == MENU_ID_ASSIST ? 0 : -1;
                    }
                    if (menuItem2.getItemId() == MENU_ID_ASSIST) {
                        return 1;
                    }
    ...
    FloatingToolbar(View view) {
        ...
        mPopup = new FloatingToolbarPopup(context, mRootView, mDismissRunnable);
    }
     ...
     */
    private List<SupportMenuItem> getVisibleAndEnabledMenuItems(Menu menu) {
    ...
    private static final class FloatingToolbarPopup {
         ...
         *      from.
         */
        FloatingToolbarPopup(Context context, View parent, Runnable dismissRunnable) {
        ...
        List<SupportMenuItem> layoutMainPanelItems(
            ...
            final LinkedList<SupportMenuItem> remainingMenuItems = new LinkedList<>();
            ...
            for (SupportMenuItem menuItem : menuItems) {
                if (menuItem.getItemId() != MENU_ID_ASSIST
            ...
            while (!remainingMenuItems.isEmpty()) {
                final SupportMenuItem menuItem = remainingMenuItems.peek();
                ...
                final boolean showIcon = isFirstItem && menuItem.getItemId() == MENU_ID_ASSIST;
        ...
        ViewGroup createMainPanel() {
            ...
            mainPanel.setTag(FloatingToolbarConstants.MAIN_PANEL_TAG);
            return mainPanel;
        }
        ...
        OverflowPanel createOverflowPanel() {
            ...
            overflowPanel.setTag(FloatingToolbarConstants.OVERFLOW_PANEL_TAG);
        ...
        private static final class OverflowPanelViewHelper {
            ...
            private boolean shouldShowIcon(SupportMenuItem menuItem) {
                if (menuItem != null) {
                    return menuItem.getGroupId() == MENU_ID_ASSIST;
                }
                return false;
            }
        }
    ...
    static ViewGroup createContentContainer(Context context) {
        ...
        contentContainer.setTag(FloatingToolbarConstants.FLOATING_TOOLBAR_TAG);
     ...
     */
    static Context applyDefaultTheme(Context originalContext) {
