...
public class X509CertificateSigningTest {
    ...
    @Test
    public void testSigning() throws IdentityCredentialException {
        ...
        try {
            ...
            X509Certificate cert = Util.signPublicKeyWithPrivateKey(keyToSignAlias, keyToSignWithAlias);
            assertNotNull(cert);
            Log.d(TAG, "Cert:\n--\n" + cert.toString() + "\n--\n");
            ...
            assertArrayEquals(keyToSignKeyPair.getPublic().getEncoded(), cert.getPublicKey().getEncoded());
