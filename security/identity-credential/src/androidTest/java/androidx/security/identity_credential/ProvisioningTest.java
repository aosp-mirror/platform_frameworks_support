...
public class ProvisioningTest {
    ...
    @Test
    public void deleteCredential() throws IdentityCredentialException {
        Context appContext = InstrumentationRegistry.getTargetContext();
        IdentityCredentialStore store = IdentityCredentialStore.getInstance(appContext);

        store.deleteCredentialByName("test");
        assertFalse(store.deleteCredentialByName("test"));
        createCredential(store, "test");
        assertTrue(store.deleteCredentialByName("test"));
        assertFalse(store.deleteCredentialByName("test"));
    }
