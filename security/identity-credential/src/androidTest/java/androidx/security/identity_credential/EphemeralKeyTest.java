...
public class EphemeralKeyTest {
    ...
    class TestReader {
        ...
        byte[] decryptMessageFromHolder(byte[] messageCiphertext) throws IdentityCredentialException {
    ...
    public void createEphemeralKey() throws IdentityCredentialException {
        ...
        Collection<X509Certificate> certChain = ProvisioningTest.createCredential(store, credentialName);
        ...
        TestReader reader = new TestReader(IdentityCredentialStore.CIPHERSUITE_ECDHE_HKDF_ECDSA_WITH_AES_128_GCM_SHA256,
        ...
        for (int n = 0; n < 5; n++) {
            ...
            byte[] decryptedMessageToHolder = credential.decryptMessageFromReader(encryptedMessageToHolder);
            ...
            byte[] decryptedMessageToReader = reader.decryptMessageFromHolder(encryptedMessageToReader);
