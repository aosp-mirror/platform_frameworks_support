...
/*
 * This is based on https://github.com/google/tink/blob/master/java/src/test/java/com/google/crypto/tink/subtle/HkdfTest.java
...
public class HkdfTest {
    ...
    static private byte[] randBytes(int numBytes) {
