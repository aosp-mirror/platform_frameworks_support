...
public abstract class WritableIdentityCredential {
    /**
     * <p>Generates and returns an X.509 certificate chain for the CredentialKey which identifies this
     ...
     *            A collection of {@link EntryNamespace} specifying the data to be provisioned,
