 ...
 *
 * <p>TODO: mention various backends, e.g. software emulation vs. calling into credstore/IC HAL if on R.</p>
 *
 ...
 * <p>TODO:</p>
 * <ul>
 *     <li>Implement user auth (Using a Keystore key per ACP)</li>
 *
 *     <li>Add |proofOfDeletion| return value to deleteCredentialByName().</li>
 *
 *     <li>Sort out exceptions, in particular specify in Javadoc the circumstances
 *     under which an exception is thrown.</li>
 *
 *     <li>We might be leaking Keystore keys because we lack atomicity in deletion of
 *     Keystore keys and persisting CBOR. Therefore, have a way to enumerate created
 *     credentials (by virtue of CBOR files all living in the same directory), the keystore
 *     keys they use, and use this to delete all unused Keystore keys.</li>
 * </ul>
 */
public class IdentityCredentialStore {
    ...
    public static IdentityCredentialStore getInstance(Context context)  {
        // TODO: Have a IdentityCredentialStore per Context?
    ...
    public WritableIdentityCredential createCredential(@NonNull String credentialName,
        ...
        return new SoftwareWritableIdentityCredential(mContext, credentialName, docType, cipherSuite);
    }
     ...
     *
     * <p>TODO: also return a proofOfDeletion akin to proofOfProvisioning, to prove that the data was
     * deleted from the secure area.</p>
     *
     * @param credentialName the name of the credential to delete.
     *
     * @return {@code false} if the credential was not found, {@code true} if the credential was found and deleted.
     *
     * @throws IdentityCredentialException if an error occurred.
     */
    public boolean deleteCredentialByName(@NonNull String credentialName) throws IdentityCredentialException {
        /* TODO: Also support CredstoreWritableIdentityCredential and check both
         * CredstoreIdentityCredential and SoftwareIdentityCredential in that order.
         */
