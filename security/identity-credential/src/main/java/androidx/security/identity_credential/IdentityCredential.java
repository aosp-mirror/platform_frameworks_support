...
public abstract class IdentityCredential {
     ...
     *
     * <p>The {@code requestMessage} parameter must contain CBOR data conforming to the following
     * CDDL schema:</p>
     *
     * <pre>
     *   ItemsRequest = {
     ...
     *
     * @param requestMessage         Must contain CBOR data conforming to the schema mentioned
     *                               above.
     * @param entriesToNotRequest    A collection of {@link RequestNamespace} objects
     *                               specifying all the data elements to not request,
