...
public class SecureConfig {
    ...
    public static class Builder {
        ...
        String mSymmetricCipherTransformation;
        boolean mSymmetricSensitiveDataProtection;
        boolean mSymmetricRequireUserAuth = true;
        int mSymmetricRequireUserValiditySeconds = -1;
    ...
    public static SecureConfig getDefault() {
        ...
        builder.mSignatureAlgorithm = "ECDSA";
    ...
    public static SecureConfig getNiapConfig(
        ...
        builder.mSignatureAlgorithm = "SHA512withRSA/PSS"; // verify this with the NIAP spec
    ...
    public boolean isAsymmetricRequireUserAuthEnabled() {
        return mAsymmetricRequireUserAuth;
    }
    ...
    public boolean isSymmetricRequireUserAuthEnabled() {
        return mSymmetricRequireUserAuth;
    }
