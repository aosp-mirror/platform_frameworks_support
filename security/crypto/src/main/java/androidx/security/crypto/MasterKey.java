...
public class MasterKey {
    ...
    public static MasterKey getOrCreate(
        ...
        builder.mKeyAlias = MASTER_KEY_ALIAS;
        builder.mMasterKeyEncryptionScheme = masterKeyEncryptionScheme;
        builder.mDeviceUnlockedRequired = true;
        builder.mUserAuthRequiredSeconds = -1;
