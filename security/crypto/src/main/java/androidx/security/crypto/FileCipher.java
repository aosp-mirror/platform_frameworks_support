...
public class FileCipher {
    ...
    class EncryptedFileOutputStream extends FileOutputStream {
        ...
        public void write(@NonNull byte[] b) {
            ...
            secureCipher.encryptSensitiveDataAsymmetric(getAsymKeyPairAlias(),
                    secretKey.getEncoded(), new SecureCipher.SecureAsymmetricEncryptionListener() {
        ...
        void decrypt(final SecureContextCompat.EncryptedFileInputStreamListener listener)
            ...
            if (this.mDecryptedData == null) {
                try {
                    ...
                    secureCipher.decryptEncodedData(encodedData, new SecureCipher.SecureDecryptionListener() {
