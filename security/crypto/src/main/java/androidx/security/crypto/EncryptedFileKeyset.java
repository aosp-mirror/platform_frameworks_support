...
public class EncryptedFileKeyset {
     ...
     */
    @NonNull
    public static EncryptedFileKeyset getDefault(
            @NonNull Context context,
            @NonNull MasterKey masterKey,
            @NonNull FileEncryptionScheme fileEncryptionScheme) {
        Builder builder = new Builder();
        builder.mFileName = FILE_NAME;
        builder.mFileKeysetAlias = KEYSET_ALIAS;
        builder.mFileEncryptionScheme = fileEncryptionScheme;
