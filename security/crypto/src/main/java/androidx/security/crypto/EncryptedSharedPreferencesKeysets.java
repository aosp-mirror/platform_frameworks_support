...
import static androidx.security.crypto.EncryptedSharedPreferences.KEY_FILE_NAME;
import static androidx.security.crypto.EncryptedSharedPreferences.KEY_KEYSET_ALIAS;
import static androidx.security.crypto.EncryptedSharedPreferences.VALUE_FILE_NAME;
import static androidx.security.crypto.EncryptedSharedPreferences.VALUE_KEYSET_ALIAS;
...
public class EncryptedSharedPreferencesKeysets {
    ...
    EncryptedSharedPreferences.KeyEncryptionScheme mKeyEncryptionScheme;
    EncryptedSharedPreferences.ValueEncryptionScheme mValueEncryptionScheme;
    Context mContext;
     ...
     */
    @NonNull
    public EncryptedSharedPreferences.KeyEncryptionScheme getKeyEncryptionScheme() {
     ...
     */
    @NonNull
    public EncryptedSharedPreferences.ValueEncryptionScheme getValueEncryptionScheme() {
    ...
    public static EncryptedSharedPreferencesKeysets getOrCreate(
            ...
            @NonNull EncryptedSharedPreferences.KeyEncryptionScheme keyEncryptionScheme,
            @NonNull EncryptedSharedPreferences.ValueEncryptionScheme valueEncryptionScheme) {
    ...
    public static class Builder {
        ...
        public Builder(@NonNull Context context,
                @NonNull MasterKey masterKey,
                @NonNull EncryptedSharedPreferences.KeyEncryptionScheme keyEncryptionScheme,
                @NonNull EncryptedSharedPreferences.ValueEncryptionScheme
         ...
         */
        @NonNull
        public Builder setKeyEncryptionScheme(@NonNull EncryptedSharedPreferences
        ...
        public Builder setValueEncryptionScheme(
                @NonNull EncryptedSharedPreferences
