...
public final class EncryptedSharedPreferences implements SharedPreferences {
    ...
    EncryptedSharedPreferences(@NonNull String name,
        ...
        this(name, masterKey, context, keyEncryptionScheme, valueEncryptionScheme,
    ...
    public static SharedPreferences create(@NonNull String fileName,
            ...
            @NonNull ValueEncryptionScheme valueEncryptionScheme)
            throws GeneralSecurityException, IOException {
        return new EncryptedSharedPreferences(fileName, masterKey,
