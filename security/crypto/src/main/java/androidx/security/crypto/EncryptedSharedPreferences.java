...
public final class EncryptedSharedPreferences implements SharedPreferences {
     ...
     * @throws GeneralSecurityException when there is an issue encrypting data
    ...
    private static final class Editor implements SharedPreferences.Editor {
        ...
        private final TinkCipher mTinkCipher;
        private final Context mContext;

        Editor(EncryptedSharedPreferences encryptedSharedPreferences,
                SharedPreferences.Editor editor, TinkCipher cipher, Context context) {
    ...
    @NonNull
    public Editor edit() {
        return new Editor(this, mSharedPreferences.edit(), mTinkCipher,
                mContext);
    }
