...
public class SecureCipher {
    ...
    public static SecureCipher getDefault() {
        return new SecureCipher(SecureConfig.getNiapConfig());
    }
    ...
    public static SecureCipher getDefault(
        ...
        return new SecureCipher(SecureConfig.getNiapConfig(biometricKeyAuthCallback));
    }
    ...
    public void decryptEncodedData(@NonNull byte[] encodedCipherText,
        ...
        switch (encodingType) {
            ...
            case SYMMETRIC:
                ...
                iv = new byte[ivLength];
                byteBuffer.get(iv);
                keyAliasLength = byteBuffer.getInt();
                keyAliasBytes = new byte[keyAliasLength];
                byteBuffer.get(keyAliasBytes);
                keyAlias = new String(keyAliasBytes);
                cipherText = new byte[byteBuffer.remaining()];
                byteBuffer.get(cipherText);
