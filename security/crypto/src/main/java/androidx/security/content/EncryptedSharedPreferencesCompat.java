...
public class EncryptedSharedPreferencesCompat implements SharedPreferences,
    ...
    public EncryptedSharedPreferencesCompat(@NonNull String name, int mode,
    ...
    private Pair<String, String> decryptKey(String encryptedKey) {
        ...
        String type = null;
        try {
            byte[] clearText = mTinkCipher.decryptAead(mContext, Base64.decode(encryptedKey),
                    new byte[0],
                    true);
