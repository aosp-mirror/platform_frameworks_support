...
public class SecureSharedPreferencesCompat implements SharedPreferences, SharedPreferences.Editor {
    ...
    public SharedPreferences.Editor putString(String key, @Nullable String value) {
        putEncryptedObject(key, String.class.getName(), value.getBytes(UTF_8));
        return this;
    }
    ...
    public SharedPreferences.Editor putStringSet(String key, @Nullable Set<String> values) {
        ...
        putEncryptedObject(key, Set.class.getName(), buffer.array());
        return this;
    }
    ...
    public SharedPreferences.Editor putInt(String key, int value) {
        ...
        buffer.putInt(value);
        putEncryptedObject(key, Integer.class.getName(), buffer.array());
        return this;
    }
    ...
    public SharedPreferences.Editor putLong(String key, long value) {
        ...
        putEncryptedObject(key, Long.class.getName(), buffer.array());
        return this;
    }
    ...
    public SharedPreferences.Editor putFloat(String key, float value) {
        ...
        putEncryptedObject(key, Float.class.getName(), buffer.array());
        return this;
    }
    ...
    public SharedPreferences.Editor putBoolean(String key, boolean value) {
        ...
        putEncryptedObject(key, Boolean.class.getName(), buffer.array());
        return this;
    }
