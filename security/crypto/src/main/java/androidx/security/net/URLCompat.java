...
public class URLCompat {
    ...
    public URLCompat(@NonNull String spec, @NonNull String clientCertAlias)
     ...
     */
    public boolean isValid(@NonNull String hostname, @NonNull SSLSocket socket) {
        try {
     ...
     * <p>
     * Example Code:
     * URL mUrl = new URL("https://" + urlText);
