...
class ValidatableSSLSocketFactory extends SSLSocketFactory {
    ...
    private URLCompat mSecureURL;
    private Socket mSocket;
    private SecureConfig mSecureConfig;

    ValidatableSSLSocketFactory(URLCompat secureURL, SSLSocketFactory sslSocketFactory,
    ...
    ValidatableSSLSocketFactory(URLCompat secureURL) {
        this(secureURL, (SSLSocketFactory) SSLSocketFactory.getDefault(),
                SecureConfig.getStrongConfig());
    }

    ValidatableSSLSocketFactory(URLCompat secureURL,
            Map<String, InputStream> trustedCAs, SecureConfig secureConfig) {
    ...
    private static SSLSocketFactory createUserTrustSSLSocketFactory(Map<String, InputStream>
            trustAnchors, SecureConfig secureConfig, URLCompat secureURL) {
        try {
