 ...
 *
 * Default:
 * RevocableURLConfig.getOrCreate() provides basic Certificate revocation checking via OCSP.
 *
 * Enterprise:
 * RevocableURLConfig.getOrCreate(), only allows for secure SSL ciphers which use encryption and
