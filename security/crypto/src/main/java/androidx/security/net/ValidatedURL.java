 ...
 *
 * For OCSP to work properly, on Android 9.0+, the network_security_config.xml must be created and
 * configured to allow plain text connections to the OCSP sites.
 *
...
public class ValidatedURL {
     ...
     * boolean valid = mUrl.ensureValid(conn);
     * </p>
     *
