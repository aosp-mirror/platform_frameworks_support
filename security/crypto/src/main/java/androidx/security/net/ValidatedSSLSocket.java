...
class ValidatedSSLSocket extends SSLSocket {
    ...
    private ValidatedSSLSocket(Socket sslSocket, ValidatedUrl validatedUrl) {
    ...
    static SSLSocket create(Socket sslSocket,
        ...
        ValidatedSSLSocket validatedSSLSocket = new ValidatedSSLSocket(sslSocket, validatedUrl);
    ...
    public void startHandshake() throws IOException {
        ...
        mValidatedUrl.ensureValid(Arrays.asList(
                mSslSocket.getSession().getPeerCertificates()), mSslSocket);
    }
