...
public class EncryptionConfig {
    ...
    public static final String SHARED_PREF_VALUE_KEYSET = "aead_keys";
    public static final String SHARED_PREF_KEY_KEYSET = "daead_keys";
    public static final String ENCRYPTED_FILE_KEYSET = "streaming_aead_keys";
