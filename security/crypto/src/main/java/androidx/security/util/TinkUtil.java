...
public class TinkUtil {
    ...
    public static AsyncAead getOrCreateMasterKey(final SecureConfig secureConfig)
        ...
        AsyncAead masterKey = new AsyncAead() {
            ...
            // TODO could Tink support this? Maybe create an AsyncAead interface?
            // TODO Will check and see if I can inline the async operation.
            @Override
            public void decrypt(byte[] ciphertext, byte[] associatedData,
                ...
                if (secureConfig.getSymmetricRequireUserAuthEnabled()) {
                    ...
                    secureConfig.getBiometricKeyAuthCallback().authenticateKey(cipher,
                    ...
                    // TODO discuss, we need to make this method to be void and call a
                    //  listener back.
                    // Add key authentication here
                    cipher.updateAAD(aad);
            ...
            public byte[] decrypt(byte[] ciphertext, byte[] associatedData)
                ...
                Cipher cipher = Cipher.getInstance("AES/GCM/NoPadding");
                cipher.init(Cipher.DECRYPT_MODE, key, params);
                // TODO discuss, we need to make this method to be void and call a listener back.
                // Add key authentication here
                cipher.updateAAD(aad);
