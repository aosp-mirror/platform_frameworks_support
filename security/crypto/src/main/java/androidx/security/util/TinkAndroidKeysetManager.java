...
public final class TinkAndroidKeysetManager {
    ...
    private final TinkMasterKeyGenerator.AsyncAead mMasterKey;
    ...
    public static final class Builder {
        ...
        TinkMasterKeyGenerator.AsyncAead mMasterKey = null;
         ...
         */
        public Builder withMasterKey(TinkMasterKeyGenerator.AsyncAead val) {
            mMasterKey = val;
            return this;
        }
