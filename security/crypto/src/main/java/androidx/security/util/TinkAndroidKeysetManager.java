...
public final class TinkAndroidKeysetManager {
    ...
    private TinkAndroidKeysetManager(Builder builder) throws GeneralSecurityException, IOException {
    ...
    public static final class Builder {
        private KeysetReader mReader = null;
        private KeysetWriter mWriter = null;
        private TinkUtil.AsyncAead mMasterKey = null;
        private boolean mUseKeystore = true;
        private KeyTemplate mKeyTemplate = null;
