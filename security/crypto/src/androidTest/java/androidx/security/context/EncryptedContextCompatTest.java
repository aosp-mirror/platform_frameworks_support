...
public class EncryptedContextCompatTest {
    ...
    public void setup() throws Exception {
        ...
        // Turn off device unlocked required for testing.
        mEncryptionConfig.setSymmetricSensitiveDataProtection(false);

        SharedPreferences sharedPreferences = mContext.getSharedPreferences(
                EncryptionConfig.ENCRYPTED_FILE_KEYSET, Context.MODE_PRIVATE);
        sharedPreferences.edit().clear().commit();

        // Delete overwrite previous master key
    ...
    public void testWriteReadEncryptedFile() throws Exception {
        ...
        OutputStream outputStream = encryptedContextCompat.openEncryptedFileOutput(fileName,
