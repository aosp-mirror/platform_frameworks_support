...
public class EncryptedSharedPreferencesCompatTest {
    ...
    public void testWriteSharedPrefs() throws Exception {
        ...
        SharedPreferences sharedPreferences = EncryptedSharedPreferencesCompat
                .getEncryptedSharedPreferences(PREFS_FILE, Context.MODE_PRIVATE,
                        mMasterKey, mContext,
                        EncryptedSharedPreferencesCompat.KeyEncryptionScheme.AES256_SIV,
                        EncryptedSharedPreferencesCompat.ValueEncryptionScheme.AES256_GCM);
