...
open class CreateLibraryBuildInfoFileTask : DefaultTask() {
    ...
    private fun writeJsonToFile(info: LibraryBuildInfoFile) {
        ...
        println("I was given the following file path $outputFile")
    ...
    private fun resolveAndCollectDependencies(): LibraryBuildInfoFile {
        ...
        val releaseCheckboxes = ArrayList<LibraryBuildInfoFile.ReleaseCheckbox>()
        libraryBuildInfoFile.releaseCheckboxes = releaseCheckboxes
