...
fun Project.getMetalavaConfiguration(): Configuration {
    val name = "metalava"
    val existing = configurations.findByName(name)
    if (existing != null) {
        return existing
    }
...
object MetalavaRunner {

    fun runWithArgs(project: Project, configuration: Configuration, args: List<String>) {
        project.javaexec {
    ...
    fun generateApi(
        ...
        runWithArgs(project, metalavaConfiguration, args)
