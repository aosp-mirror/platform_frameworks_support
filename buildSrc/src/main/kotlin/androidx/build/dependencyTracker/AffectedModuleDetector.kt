 ...
 *
 * Whenn a file in a module is changed, all modules that depend on it are considered as changed.
 */
private class AffectedModuleDetectorImpl constructor(
    ...
    private fun findLocallyAffectedProjects(): Set<Project> {
        ...
        // wear presubmit always expects the APK so always include wear for now.
