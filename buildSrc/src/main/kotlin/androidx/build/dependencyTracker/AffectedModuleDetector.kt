...
abstract class AffectedModuleDetector {
    ...
    companion object {
        ...
        private const val ONLY_DEPENDANTS_ARG = "androidx.onlyDependant"
        ...
        fun configure(gradle: Gradle, rootProject: Project) {
            ...
            val onlyDependant = rootProject.hasProperty(ONLY_DEPENDANTS_ARG)
...
internal class AffectedModuleDetectorImpl constructor(
    ...
    private val onlyDependant: Boolean = false,
     ...
     *
     * With param onlyDependant, finds only modules dependant on directly affected modules
     *
    ...
    private fun findLocallyAffectedProjects(): Set<Project> {
        ...
        return when {
            onlyDependant -> expandToDependants(containingProjects) - containingProjects
                .filterNotNull()
            onlyDirectlyAffected -> (containingProjects + alwaysBuild).filterNotNull().toSet()
            else -> expandToDependants(containingProjects) + alwaysBuild
        }
    }
