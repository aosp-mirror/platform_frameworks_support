...
class DependencyTracker(
    ...
    fun debugForBuildServer(
        ...
        logger?.info("changes based on build props change sha: ${gitClient.findChangedFilesSince(buildShas.buildSha)}")
        logger?.info("changes based on build props change sha pre: ${gitClient.findChangedFilesSince("${buildShas.buildSha}^")}")
