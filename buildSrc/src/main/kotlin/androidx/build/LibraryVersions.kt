...
object LibraryVersions {
    ...
    val LIFECYCLE = Version("2.2.0-alpha01")
    val LIFECYCLES_SAVEDSTATE = Version("1.0.0-alpha01")
    val LOADER = Version("1.1.0-beta02")
    val MEDIA = Version("1.1.0-beta01")
    val MEDIA2_COMMON = Version("1.0.0-beta01")
    val MEDIA2_PLAYER = Version("1.0.0-beta01")
    val MEDIA2_SESSION = Version("1.0.0-beta01")
    val MEDIA2_EXOPLAYER = Version("1.0.0-beta01")
