...
<<<<<<< HEAD   (fead5b Merge "Merge empty history for sparse-5693105-L2230000033775)
...
=======
    ...
    val FRAGMENT = Version("1.1.0-rc02")
    val FUTURES = Version("1.0.0-beta02")
>>>>>>> BRANCH (badb02 Merge "Merge cherrypicks of [1014802, 1014803] into sparse-5)
