...
object LibraryVersions {
    val ACTIVITY = Version("1.0.0-alpha09")
    ...
    val ARCH_RUNTIME = Version("2.1.0-beta02")
    ...
    val CAMERA = Version("1.0.0-alpha02")
    ...
    val FRAGMENT = Version("1.1.0-alpha09")
    ...
    val PREFERENCE = Version("1.1.0-alpha06")
