...
object LibraryVersions {
    ...
    val BENCHMARK = Version("1.0.0-alpha02")
    val BIOMETRIC = Version("1.0.0-alpha05")
    val BROWSER = Version("1.2.0-alpha02")
    ...
    val NAVIGATION = Version("2.1.0-alpha05")
    ...
    val RECYCLERVIEW = Version("1.1.0-beta00")
    ...
    val WORKMANAGER = Version("2.1.0-alpha02")
}
