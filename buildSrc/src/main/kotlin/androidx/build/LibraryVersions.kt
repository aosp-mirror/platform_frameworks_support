...
object LibraryVersions {
    val ACTIVITY = Version("1.0.0-alpha03")
    ...
    val CORE_KTX = Version("1.1.0-alpha02")
    ...
    val FRAGMENT = Version("1.1.0-alpha03")
