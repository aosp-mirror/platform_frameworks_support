...
object LibraryVersions {
    val ACTIVITY = Version("1.0.0-alpha08")
...
=======
    ...
    val APPCOMPAT = Version("1.1.0-alpha06")
...
>>>>>>> BRANCH (ff4d74 Merge "Update javadoc about theme ID in FragmentScenario" in)
    ...
    val FRAGMENT = Version("1.1.0-alpha08")
    ...
    val MEDIA = Version("1.1.0-beta02")
    val MEDIA2_COMMON = Version("1.0.0-beta02")
    val MEDIA2_PLAYER = Version("1.0.0-beta02")
    val MEDIA2_SESSION = Version("1.0.0-beta02")
    val MEDIA2_EXOPLAYER = Version("1.0.0-beta02")
    val MEDIA2_WIDGET = Version("1.0.0-alpha07")
<<<<<<< HEAD   (d26d2b Merge "Merge cherrypicks of [955355] into androidx-master-re)
    val MEDIAROUTER = Version("1.1.0-beta01")
    val NAVIGATION = Version("2.1.0-alpha03")
=======
    val MEDIAROUTER = Version("1.1.0-beta02")
    val NAVIGATION = Version("2.1.0-alpha04")
>>>>>>> BRANCH (ff4d74 Merge "Update javadoc about theme ID in FragmentScenario" in)
...
<<<<<<< HEAD   (d26d2b Merge "Merge cherrypicks of [955355] into androidx-master-re)
    val ROOM = Version("2.1.0-beta01")
    val SAVEDSTATE = Version("1.0.0-beta01")
    val SECURITY = Version("1.0.0-alpha01")
=======
    val ROOM = Version("2.1.0-beta02")
