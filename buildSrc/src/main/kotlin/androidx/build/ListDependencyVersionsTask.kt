...
open class ListProjectDependencyVersionsTask : DefaultTask() {
    ...
    init {
        ...
        description = "Creates a json file of the dependency graph in " +
                "/host/gradle/frameworks/support/build/dependencyGraph/AndroidXDependencyGraph.json"
    }
...
open class DependencyGraphFileTask : DefaultTask() {
    init {
        group = "Help"
        description = "Creates a json file of the dependency graph in" +
                "out/host/gradle/frameworks/support/dependencyGraph/AndroidXDependencyGraph.json"
    }
