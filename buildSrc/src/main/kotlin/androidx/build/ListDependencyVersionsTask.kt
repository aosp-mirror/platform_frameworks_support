...
open class ListProjectDependencyVersionsTask : DefaultTask() {
    ...
    private fun writeJsonToFile(artifact: Artifact) {
        ...
        val depGraphFile = File(getProjectDependencyGraphFileName())
    ...
    private fun collectDependencies(artifact: Artifact): MutableSet<String> {
    ...
    fun dumpDependencies() {
        // val dependencySet: MutableSet<String> = mutableSetOf()
        val artifact = Artifact(project.name.toString(),
            project.group.toString(),
            project.version.toString())
        val dependencySet: MutableSet<String> = collectDependencies(artifact)
