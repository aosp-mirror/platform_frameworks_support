...
abstract class ReportLibraryMetrics : DefaultTask() {
    ...
    private fun getAarSize(): Long {
        val debugVariants = AndroidXPlugin.getDebugVariants(project)
        val aarFiles = debugVariants.flatMap {
            it.packageLibraryProvider.get()
