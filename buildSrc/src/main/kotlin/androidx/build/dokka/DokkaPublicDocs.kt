...
object DokkaPublicDocs {
    ...
    fun registerPrebuiltForProject(project: Project, extension: SupportLibraryExtension) {
        ...
        if (strategy is Prebuilts) {
            ...
            //val sourceDir = File(unzipTask.destinationDir, "androidx")
            val sourceDir = unzipTask.destinationDir
            System.out.println("DokkaPublicDocs using source dir of " + sourceDir)
            docsTask.sourceDirs += listOf(sourceDir)
