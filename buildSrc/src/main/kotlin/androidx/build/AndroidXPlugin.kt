...
class AndroidXPlugin : Plugin<Project> {
    ...
    private fun verifyJava7Targetting(libraryVersion: String, javaVersion: JavaVersion) {
    ...
    private fun LibraryExtension.configureAndroidLibraryOptions(
        ...
        project.afterEvaluate {
            verifyJava7Targetting(project.version as String, compileOptions.sourceCompatibility)
        }
