...
class AndroidXPlugin : Plugin<Project> {
    ...
    private fun Project.configureRootProject() {
        ...
        tasks.register(BUILD_ON_SERVER_TASK) { buildOnServerTask ->
            ...
            buildOnServerTask.dependsOn(project.tasks.named("partiallyDejetifyArchive"))
            buildOnServerTask.dependsOn(project.tasks.named(
                ...
                project.afterEvaluate {
                    if (project.path == ":docs-runner") {
                        buildOnServerTask.dependsOn(
                            project.tasks.named(DokkaPublicDocs.ARCHIVE_TASK_NAME))
                        buildOnServerTask.dependsOn(
                            project.tasks.named(DokkaSourceDocs.ARCHIVE_TASK_NAME))
                    } else {
