...
val RELEASE_RULE = docsRules("public", false) {
    ...
    prebuilts(LibraryGroups.ASYNCLAYOUTINFLATER, "1.1.0-alpha01")
    prebuilts(LibraryGroups.BIOMETRIC, "biometric", "1.0.0-alpha04")
    prebuilts(LibraryGroups.BROWSER, "1.1.0-alpha01")
    ...
    prebuilts(LibraryGroups.CARDVIEW, "1.1.0-alpha01")
    prebuilts(LibraryGroups.COLLECTION, "1.1.0-alpha03")
    prebuilts(LibraryGroups.CONCURRENT, "1.0.0-alpha03")
    prebuilts(LibraryGroups.CONTENTPAGER, "1.1.0-alpha01")
    prebuilts(LibraryGroups.COORDINATORLAYOUT, "1.1.0-alpha02")
    prebuilts(LibraryGroups.CORE, "core", "1.1.0-alpha05")
    prebuilts(LibraryGroups.CORE, "core-ktx", "1.1.0-alpha05")
    prebuilts(LibraryGroups.CURSORADAPTER, "1.1.0-alpha01")
    prebuilts(LibraryGroups.CUSTOMVIEW, "1.1.0-alpha01")
    prebuilts(LibraryGroups.DOCUMENTFILE, "1.1.0-alpha01")
    prebuilts(LibraryGroups.DRAWERLAYOUT, "1.1.0-alpha01")
    prebuilts(LibraryGroups.DYNAMICANIMATION, "dynamicanimation-ktx", "1.0.0-alpha02")
    prebuilts(LibraryGroups.DYNAMICANIMATION, "1.0.0-alpha02")
    prebuilts(LibraryGroups.EMOJI, "1.1.0-alpha01")
    ...
    prebuilts(LibraryGroups.GRIDLAYOUT, "1.1.0-alpha01")
    prebuilts(LibraryGroups.HEIFWRITER, "1.1.0-alpha01")
    prebuilts(LibraryGroups.INTERPOLATOR, "1.1.0-alpha01")
    prebuilts(LibraryGroups.LEANBACK, "1.1.0-alpha02")
    prebuilts(LibraryGroups.LEGACY, "1.1.0-alpha01")
    prebuilts(LibraryGroups.LOADER, "1.1.0-beta01")
    prebuilts(LibraryGroups.LOCALBROADCASTMANAGER, "1.1.0-alpha02")
    ...
    prebuilts(LibraryGroups.PALETTE, "1.1.0-alpha01")
    prebuilts(LibraryGroups.PERCENTLAYOUT, "1.1.0-alpha01")
    ...
    prebuilts(LibraryGroups.RECOMMENDATION, "1.1.0-alpha01")
    prebuilts(LibraryGroups.RECYCLERVIEW, "recyclerview", "1.1.0-alpha03")
    prebuilts(LibraryGroups.RECYCLERVIEW, "recyclerview-selection", "1.1.0-alpha03")
    prebuilts(LibraryGroups.REMOTECALLBACK, "1.0.0-alpha02")
    prebuilts(LibraryGroups.SAVEDSTATE, "1.0.0-alpha01")
...
//    prebuilts(LibraryGroups.SLICE, "slice-test", "1.0.0")
    ...
    prebuilts(LibraryGroups.SLIDINGPANELAYOUT, "1.1.0-alpha01")
    ...
    prebuilts(LibraryGroups.VECTORDRAWABLE, "1.1.0-alpha02")
    prebuilts(LibraryGroups.VECTORDRAWABLE, "vectordrawable-animated", "1.1.0-alpha02")
    prebuilts(LibraryGroups.VERSIONEDPARCELABLE, "1.1.0-alpha02")
    prebuilts(LibraryGroups.VIEWPAGER, "1.1.0-alpha01")
    ...
    prebuilts(LibraryGroups.PAGING, "2.2.0-alpha01")
