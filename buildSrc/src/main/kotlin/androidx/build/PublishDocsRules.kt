...
val RELEASE_RULE = docsRules("public", false) {
    ...
    prebuilts(LibraryGroups.MEDIA2, "session", "1.0.0-alpha04")
    prebuilts(LibraryGroups.MEDIA2, "player", "1.0.0-alpha04")
    prebuilts(LibraryGroups.MEDIA2, "common", "1.0.0-alpha04")
