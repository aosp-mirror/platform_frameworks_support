...
val RELEASE_RULE = docsRules("public", false) {
    ...
    ignore(LibraryGroups.ENTERPRISE.group, "enterprise-feedback-testing")
    prebuilts(LibraryGroups.ENTERPRISE, "1.0.0-alpha02")
    prebuilts(LibraryGroups.EXIFINTERFACE, "1.1.0-alpha01")
    prebuilts(LibraryGroups.FRAGMENT, "1.1.0-alpha09")
    ...
    prebuilts(LibraryGroups.NAVIGATION, "2.1.0-alpha04")
...
//    prebuilts(LibraryGroups.SLICE.group, "slice-test", "1.0.0")
    ...
    prebuilts(LibraryGroups.WORKMANAGER, "2.1.0-alpha02")
    default(Ignore)
}
