...
/**
 * Constructs a fling data from a [Context].
 */
fun generateFlingData(context: Context): FlingData {
    ...
    val targetVelocitySeconds = (maximumVelocity + minimumVelocity) / 2
...
fun View.simulateFling(
    ...
    dispatchTouchEvents(downTime,
            generateFlingData(context).generateFlingMotionEvents(originX, originY, direction))
}
