...
/**
 * Use this Rule in conjunction with a [HackyActivityScenarioRule] to launch one Activity per
 * test class.
 *
 * Example usage:
 * ```
 ...
 *         @get:ClassRule
 *         @JvmStatic
 *         val activityRule = HackyActivityScenarioRule(TestActivity::class.java)
 *     }
 *
 *     @get:Rule
 ...
 * ```
 */
class ActivityScenarioResetRule<A : Activity>(
