...
@SmallTest
public class SwipeRefreshLayoutNestedScrollingParent2Test extends
    ...
    public SwipeRefreshLayoutNestedScrollingParent2Test() {
        super(TestContentViewActivity.class);
    }

    @Before
    public void instantiateMembers() {
        mSwipeRefreshLayout = new SwipeRefreshLayout(mActivityTestRule.getActivity());
    ...
    public void onStopNestedScroll_parentOnStopNestedScrollCalledWithCorrectParams()
        ...
        mActivityTestRule.runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                mSwipeRefreshLayout.onStopNestedScroll(mChild, ViewCompat.TYPE_NON_TOUCH);
    ...
    public void onStopNestedScroll_v1_parentOnStopNestedScrollCalledWithTypeTouch()
        ...
        mActivityTestRule.runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                mSwipeRefreshLayout.onStopNestedScroll(mChild);
    ...
    public void onNestedScroll_nsvScrolls() throws Throwable {
        ...
        mActivityTestRule.runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                mSwipeRefreshLayout.onNestedScroll(mChild, 0, 0, 0, 50, ViewCompat.TYPE_NON_TOUCH);

                assertThat(mSwipeRefreshLayout.getScrollY(), is(50));
            }
        });
    }

    @Test
    public void onNestedScroll_canOnlyScrollPartWay_nsvScrollsPartWay() throws Throwable {
        ...
        mActivityTestRule.runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                assertThat(mSwipeRefreshLayout.getScrollY(), is(25));
            }
        });
    }
    ...
    public void onNestedScroll_negativeScroll_nsvScrollsNegative() throws Throwable {
        ...
        mActivityTestRule.runOnUiThread(new Runnable() {
            @Override
            public void run() {
                mSwipeRefreshLayout.scrollTo(0, 50);

                mSwipeRefreshLayout.onNestedScroll(mChild, 0, 0, 0, -50, ViewCompat.TYPE_NON_TOUCH);

                assertThat(mSwipeRefreshLayout.getScrollY(), is(0));
            }
        });
    }
    ...
    public void onNestedScroll_nsvCanOnlyConsumePartOfScroll_correctScrollDistancesPastToParent()
        ...
        mActivityTestRule.runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                mSwipeRefreshLayout.onNestedScrollAccepted(mChild, mChild,
                        ViewCompat.SCROLL_AXIS_VERTICAL, ViewCompat.TYPE_NON_TOUCH);
                mSwipeRefreshLayout.onNestedScroll(mChild, 0, 0, 0, 75, ViewCompat.TYPE_NON_TOUCH);
    ...
    public void onNestedScroll_v1_parentOnNestedScrollCalledWithTypeTouch()
        ...
        mActivityTestRule.runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                mSwipeRefreshLayout.onNestedScroll(mChild, 0, 0, 0, 50);
    ...
    public void onNestedPreScroll_v1_parentOnNestedPreScrollCalledWithTypeTouch() throws Throwable {
        ...
        mActivityTestRule.runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                mSwipeRefreshLayout.onNestedPreScroll(mChild, 1, 2, consumed);
    ...
    private void setupNestedScrollViewWithParentAndChild(int nestedScrollViewHeight,
        ...
        mSwipeRefreshLayout.setMinimumHeight(nestedScrollViewHeight);
