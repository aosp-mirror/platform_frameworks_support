...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent3,
    ...
    public void onNestedScroll(@NonNull View target, int dxConsumed, int dyConsumed,
        ...
        int newDyUnconsumed = dyUnconsumed += consumedByParents;
        ...
        if (newDyUnconsumed == 0) {
            ...
            newDyUnconsumed = dyUnconsumed + mParentOffsetInWindow[1];
        }

        // Not sure why we have to make sure the child can't scroll up... but seems dangerous to
        // remove.
        if (newDyUnconsumed < 0 && !canChildScrollUp()) {
            mTotalUnconsumed += Math.abs(newDyUnconsumed);
            moveSpinner(mTotalUnconsumed);
            consumed[1] += newDyUnconsumed;
        }
    }
