...
import static androidx.animation.AnimatorSetTests.AnimEvent.EventType.END;
import static androidx.animation.AnimatorSetTests.AnimEvent.EventType.START;
...
public class AnimatorSetTests {
    ...
    public void setup() {
        ...
        anim1 = ValueAnimator.ofFloat(0f, 100f);
        anim2 = ValueAnimator.ofInt(100, 200);
    }
    ...
    @ClassRule
    public static TestAnimationHandler sTestAnimationHandler = new TestAnimationHandler();
    ...
    public void testPlaySequentially() throws Throwable {
        ...
        verifyPlayOrder(mAnimatorSet, new Animator[] {anim1, anim2}, PlayOrder.SEQUENTIAL);

        AnimatorSet set = new AnimatorSet();
        set.playSequentially(anim1, anim2);
        verifyPlayOrder(set, new Animator[] {anim1, anim2}, PlayOrder.SEQUENTIAL);
    }
    ...
    public void testPlayTogether() {
        ...
        verifyPlayOrder(mAnimatorSet, new Animator[] {anim1, anim2}, PlayOrder.TOGETHER);

        AnimatorSet set = new AnimatorSet();
        set.playTogether(anim1, anim2);
        verifyPlayOrder(set, new Animator[] {anim1, anim2}, PlayOrder.TOGETHER);
    }
    ...
    public void testPlayBeforeAfter() {
        ...
        verifyPlayOrder(set, new Animator[] {anim3, anim1, anim2}, PlayOrder.SEQUENTIAL);
    }
    ...
    public void testListenerCallbackOnEmptySet() throws Throwable {
        ...
        ArrayList<AnimEvent> animEvents = registerAnimatorsForEvents(new Animator[] {emptySet, set});
        set.start();
    ...
    public void testDuration() {
        ...
        Animator[] animatorArray = {anim1, anim2};
