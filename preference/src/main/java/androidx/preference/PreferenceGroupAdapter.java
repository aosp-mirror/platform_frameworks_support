...
public class PreferenceGroupAdapter extends RecyclerView.Adapter<PreferenceViewHolder>
    ...
    /**
     * List of unique {@link Preference}s and their subclasses' names and layouts, used to cache
     * item view types for {@link RecyclerView}.
     */
    private List<PreferenceResourceDescriptor> mPreferenceLayoutResources;
    ...
    public PreferenceGroupAdapter(PreferenceGroup preferenceGroup) {
        ...
        mPreferenceLayoutResources = new ArrayList<>();
    ...
    private void flattenPreferenceGroup(List<Preference> preferences, PreferenceGroup group) {
        ...
        for (int i = 0; i < groupSize; i++) {
            ...
            final PreferenceResourceDescriptor layout = new PreferenceResourceDescriptor(
                    preference);
            if (!mPreferenceLayoutResources.contains(layout)) {
                mPreferenceLayoutResources.add(layout);
            }
    ...
    public int getItemViewType(int position) {
        ...
        PreferenceResourceDescriptor layout = new PreferenceResourceDescriptor(preference);

        int viewType = mPreferenceLayoutResources.indexOf(layout);
        if (viewType != -1) {
            return viewType;
        } else {
            viewType = mPreferenceLayoutResources.size();
            mPreferenceLayoutResources.add(layout);
            return viewType;
        }
    }
    ...
    public PreferenceViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        final PreferenceResourceDescriptor layout = mPreferenceLayoutResources.get(viewType);
        ...
        final View view = inflater.inflate(layout.mLayoutResId, parent, false);
        ...
        if (widgetFrame != null) {
            if (layout.mWidgetLayoutResId != 0) {
                inflater.inflate(layout.mWidgetLayoutResId, widgetFrame);
            } else {
