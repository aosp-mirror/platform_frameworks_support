...
/**
 * The basic building block that represents an individual setting. This class provides the data
 * that will be displayed to the user and has a reference to the {@link SharedPreferences} or
 * {@link PreferenceDataStore} instance that persists the preference values.
 *
