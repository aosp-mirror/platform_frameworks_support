...
public class PreferenceManager {
    ...
    /**
     * The {@link SharedPreferences} name that will be used for all {@link Preference}s managed
     * by this instance.
     */
    private String mSharedPreferencesName;
    /**
     * The {@link SharedPreferences} mode that will be used for all {@link Preference}s managed
     * by this instance.
     */
     ...
     * {@link Preference} item's {@code android:defaultValue} attribute. This should be called by
     * the application's main activity.
     *
     * @param context   The context of the shared preferences
     * @param resId     The resource ID of the preference XML file
     * @param readAgain Whether to re-read the default values. If false, this method sets the
     ...
     *                  <p class="note"> Note: this will NOT reset preferences back to their
    ...
    /**
     * Similar to {@link #setDefaultValues(Context, int, boolean)} but allows the client to
     ...
     *                              as {@link Context#MODE_PRIVATE} or {@link Context#MODE_PRIVATE}.
     * @param resId                 The resource ID of the preference XML file
     ...
     *                              {@link #KEY_HAS_SET_DEFAULT_VALUES} in the default value
     *                              shared preferences file is false). To attempt to set the
     *                              default values again bypassing this check, set {@code
     *                              readAgain} to true.
     *                              <p class="note"> Note: this will NOT reset preferences back
    ...
    /**
     * Sets the name of the {@link SharedPreferences} file that preferences managed by this will
     * use.
     *
    ...
    /**
     * Returns the current mode of the {@link SharedPreferences} file that preferences managed by
     * this will use.
     *
    ...
    /**
     * Sets the mode of the {@link SharedPreferences} file that preferences managed by this will
     * use.
     *
    ...
    /**
     * Explicitly set the storage location used internally by this class to be device-protected
     * storage.
     *
     * <p>On devices with direct boot, data stored in this location is encrypted with a key tied
     * to the physical device, and it can be accessed immediately after the device has booted
     * successfully, both <em>before and after</em> the user has authenticated with their
     * credentials (such as a lock pattern or PIN).
     *
     * <p>Because device-protected data is available without user authentication, you should
     * carefully limit the data you store using this Context. For example, storing sensitive
     * authentication tokens or passwords in the device-protected area is strongly discouraged.
     *
     * <p>Prior to API 24 this method has no effect, since device-protected storage is not
     * available.
     *
    ...
    /**
     * Indicates if the storage location used internally by this class is backed by
    ...
    /**
     * Sets a {@link PreferenceDataStore} to be used by all preferences associated with this
     * manager that don't have a custom {@link PreferenceDataStore} assigned via
    ...
    /**
     * Whether it is the client's responsibility to commit on the {@link #getEditor()}. This will
     * return false in cases where the writes should be batched, for example when inflating
