...
public class DefaultSummaryProviderTest {
    ...
    public void listPreference_noValueSet_summaryDisplaysNotSet() {
        ListPreference listPreference = createListPreferenceForTesting();
    ...
    public void dropDownPreference_noValueSet_summaryDisplaysNotSet() {
        DropDownPreference dropDownPreference = createDropDownPreferenceForTesting();
    ...
    public void editTextPreference_noValueSet_summaryDisplaysNotSet() {
        EditTextPreference editTextPreference = createEditTextPreferenceForTesting();
    ...
    private ListPreference createListPreferenceForTesting() {
    ...
    private DropDownPreference createDropDownPreferenceForTesting() {
    ...
    private EditTextPreference createEditTextPreferenceForTesting() {
