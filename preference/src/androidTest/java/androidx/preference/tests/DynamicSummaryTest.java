...
public class DynamicSummaryTest {
    ...
    public void noValueSaved_summaryDisplaysNotSet() {
        mListPreference.useDefaultSummaryFormatter();
        mDropDownPreference.useDefaultSummaryFormatter();
        mEditTextPreference.useDefaultSummaryFormatter();
    ...
    public void dynamicSummaryNotSet_summaryNotSetOrUpdated() {
        ...
        assertNull(mListPreference.getSummaryFormatter());
        assertNull(mDropDownPreference.getSummaryFormatter());
        assertNull(mEditTextPreference.getSummaryFormatter());
    ...
    public void dynamicSummaryDisabled_summaryNotSetOrUpdated() {
        mListPreference.setSummaryFormatter(null);
        mDropDownPreference.setSummaryFormatter(null);
        mEditTextPreference.setSummaryFormatter(null);
