...
class PathKeyframes implements Keyframes<PointF> {
    ...
    private abstract static class SimpleKeyframes<T> implements Keyframes<T> {
        private final ArrayList<Keyframe<T>> EMPTY_KEYFRAMES = new ArrayList<>();
        @Override
    ...
    abstract static class IntKeyframesBase extends SimpleKeyframes<Integer> implements IntKeyframes {
        @Override
        public Class<?> getType() {
