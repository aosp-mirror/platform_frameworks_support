 ...
 * in parallel.
 */
public class PropertyValuesHolder<T, V> implements Cloneable {
     ...
     * functions and in deriving the type of androidx.animation.TypeEvaluator.
     */
    Class mValueType;
     ...
     */
    private PropertyValuesHolder(Property<Object, V> property) {
        mProperty = property;
        if (property != null) {
     ...
     */
    public static PropertyValuesHolder<Integer, Integer> ofInt(String propertyName, int... values) {
     ...
     * @return PropertyValuesHolder The constructed PropertyValuesHolder object.
     */
    public static PropertyValuesHolder<Integer, Integer> ofInt(Property<?, Integer> property, int... values) {
        return new IntPropertyValuesHolder((Property<Object, Integer>) property, values);
    }
     ...
     */
    public static PropertyValuesHolder<?, int[]> ofMultiInt(String propertyName, int[][] values) {
        if (values.length < 2) {
     ...
     */
    public static PropertyValuesHolder<?, int[]> ofMultiInt(String propertyName, Path path) {
        Keyframes<PointF> keyframes = KeyframeSet.ofPath(path);
     ...
     */
    @SafeVarargs
    public static <T> PropertyValuesHolder<T, int[]> ofMultiInt(String propertyName,
    ...
    @SafeVarargs
    public static <T> PropertyValuesHolder<T, int[]> ofMultiInt(String propertyName,
            TypeConverter<T, int[]> converter, TypeEvaluator<T> evaluator, Keyframe<T>... values) {
        KeyframeSet<T> keyframeSet = KeyframeSet.ofKeyframe(values);
     ...
     * @return PropertyValuesHolder The constructed PropertyValuesHolder object.
     */
    public static PropertyValuesHolder<Float, Float> ofFloat(String propertyName, float... values) {
     ...
     * @return PropertyValuesHolder The constructed PropertyValuesHolder object.
     */
    public static PropertyValuesHolder<Float, Float> ofFloat(Property<?, Float> property, float... values) {
        return new FloatPropertyValuesHolder((Property<Object, Float>) property, values);
    }
     ...
     */
    public static PropertyValuesHolder<?, float[]> ofMultiFloat(String propertyName, float[][] values) {
        if (values.length < 2) {
            throw new IllegalArgumentException("At least 2 values must be supplied");
        }
        int numParameters = 0;
     ...
     * @see ObjectAnimator#ofPropertyValuesHolder(Object, PropertyValuesHolder...)
     */
    public static PropertyValuesHolder<?, float[]> ofMultiFloat(String propertyName, Path path) {
     ...
     */
    @SafeVarargs
    public static <P> PropertyValuesHolder<?, float[]> ofMultiFloat(String propertyName,
            TypeConverter<P, float[]> converter, TypeEvaluator<P> evaluator, P... values) {
    ...
    @SafeVarargs
    public static <P> PropertyValuesHolder<?, float[]> ofMultiFloat(String propertyName,
            TypeConverter<P, float[]> converter, TypeEvaluator<P> evaluator, Keyframe<P>... values) {
     ...
     * @return PropertyValuesHolder The constructed PropertyValuesHolder object.
     */
    public static <V> PropertyValuesHolder<?, V> ofObject(String propertyName,
            TypeConverter<PointF, V> converter, Path path) {
        PropertyValuesHolder<?, V> pvh = new PropertyValuesHolder<>(propertyName);
     ...
     */
    @SafeVarargs
    // TODO: how can we make the property more
    public static <V> PropertyValuesHolder ofObject(Property<?, V> property,
            TypeEvaluator<V> evaluator, V... values) {
        PropertyValuesHolder<?, V> pvh = new PropertyValuesHolder<V, ?>((Property<Object, V>) property);
        pvh.setObjectValues(values);
        pvh.setEvaluator(evaluator);
        return pvh;
    }
     ...
     * @param evaluator A androidx.animation.TypeEvaluator that will be called on each animation
     *                 frame to provide the necessary interpolation between the Object values to
     ...
     */
    @SafeVarargs
    public static <P, V> PropertyValuesHolder<P, V> ofObject(Property<?, V> property,
            TypeConverter<P, V> converter, TypeEvaluator<P> evaluator, P... values) {
        PropertyValuesHolder<P, V> pvh = new PropertyValuesHolder<P, V>((Property<Object, V>) property);
        pvh.setConverter(converter);
        pvh.setObjectValues(values);
        pvh.setEvaluator(evaluator);
        return pvh;
     ...
     * @return PropertyValuesHolder The constructed PropertyValuesHolder object.
     */
    public static <V> PropertyValuesHolder<PointF, V> ofObject(Property<?, V> property,
            TypeConverter<PointF, V> converter, Path path) {
        PropertyValuesHolder<PointF, V> pvh = new PropertyValuesHolder<>((Property<Object, V>) property);
        pvh.mKeyframes = KeyframeSet.ofPath(path);
        pvh.mValueType = PointF.class;
        pvh.setConverter(converter);
        return pvh;
     ...
     * @param values The set of values to animate between.
     */
    public static <T> PropertyValuesHolder<T, ?> ofKeyframe(Property property, Keyframe<T>... values) {
        KeyframeSet<T> keyframeSet = KeyframeSet.ofKeyframe(values);
        return ofKeyframes(property, keyframeSet);
    }

    static <T> PropertyValuesHolder<T, ?> ofKeyframes(String propertyName, Keyframes<T> keyframes) {
        if (keyframes instanceof Keyframes.IntKeyframes) {
            return (PropertyValuesHolder<T, ?>) new IntPropertyValuesHolder(propertyName, (Keyframes.IntKeyframes) keyframes);
        } else if (keyframes instanceof Keyframes.FloatKeyframes) {
            return (PropertyValuesHolder<T, ?>) new FloatPropertyValuesHolder(propertyName,
                    (Keyframes.FloatKeyframes) keyframes);
        } else {
            PropertyValuesHolder<T, ?> pvh = new PropertyValuesHolder<>(propertyName);
    ...
    static <T> PropertyValuesHolder<T, ?> ofKeyframes(Property property, Keyframes keyframes) {
        if (keyframes instanceof Keyframes.IntKeyframes) {
            return (PropertyValuesHolder<T, ?>) new IntPropertyValuesHolder((Property<Object, Integer>) property, (Keyframes.IntKeyframes) keyframes);
        } else if (keyframes instanceof Keyframes.FloatKeyframes) {
            return (PropertyValuesHolder<T, ?>) new FloatPropertyValuesHolder((Property<Object, Float>) property, (Keyframes.FloatKeyframes) keyframes);
        } else {
            PropertyValuesHolder<T, ?> pvh = new PropertyValuesHolder(property);
            pvh.mKeyframes = keyframes;
            pvh.mValueType = keyframes.getType();
            return pvh;
        }
    ...
    void setupSetterAndGetter(Object target) {
        if (mProperty != null) {
            ...
            try {
                ...
                List<Keyframe<T>> keyframes = mKeyframes.getKeyframes();
        ...
        if (mProperty == null) {
            ...
            for (int i = 0; i < keyframeCount; i++) {
                ...
                if (!kf.hasValue() || kf.valueWasSetOnStart()) {
                    ...
                    try {
                        Object value = convertBack((V) mGetter.invoke(target));
                        kf.setValue(value);
                        kf.setValueWasSetOnStart(true);
    ...
    private V convertBack(V value) {
        if (mConverter != null) {
            ...
            value = (V) ((BidirectionalTypeConverter) mConverter).convertBack(value);
        }
        return value;
    }
    ...
    public PropertyValuesHolder clone() {
        try {
            PropertyValuesHolder<T, V> newPVH = (PropertyValuesHolder<T, V>) super.clone();
    ...
    void setAnimatedValue(Object target) {
        if (mProperty != null) {
            mProperty.set(target, (V) getAnimatedValue());
        }
        if (mSetter != null) {
            try {
    ...
    static class IntPropertyValuesHolder extends PropertyValuesHolder<Integer, Integer> {

        private IntProperty<Object> mIntProperty;
        ...
        IntPropertyValuesHolder(Property<Object, Integer> property, Keyframes.IntKeyframes keyframes) {
            super(property);
            mValueType = int.class;
            mKeyframes = keyframes;
            mIntKeyframes = keyframes;
        ...
        IntPropertyValuesHolder(Property<Object, Integer> property, int... values) {
            super(property);
            setIntValues(values);
            if (property instanceof  IntProperty) {
                mIntProperty = (IntProperty) mProperty;
        ...
        @Override
        public void setProperty(Property<Object, Integer> property) {
            if (property instanceof IntProperty) {
    ...
    static class FloatPropertyValuesHolder extends PropertyValuesHolder<Float, Float> {

        private FloatProperty<Object> mFloatProperty;
        ...
        FloatPropertyValuesHolder(Property<Object, Float> property, Keyframes.FloatKeyframes keyframes) {
            super(property);
            mValueType = float.class;
            mKeyframes = keyframes;
            mFloatKeyframes = keyframes;
        ...
        FloatPropertyValuesHolder(Property<Object, Float> property, float... values) {
            super(property);
            setFloatValues(values);
            if (property instanceof  FloatProperty) {
                mFloatProperty = (FloatProperty) mProperty;
        ...
        @Override
        public void setProperty(Property<Object, Float> property) {
            if (property instanceof FloatProperty) {
    ...
    static class MultiFloatValuesHolder<T> extends PropertyValuesHolder<T, float[]> {

        MultiFloatValuesHolder(String propertyName, TypeConverter<T, float[]> converter,
        ...
        MultiFloatValuesHolder(String propertyName, TypeConverter<T, float[]> converter,
                               TypeEvaluator<T> evaluator,  Keyframes<T> keyframes) {
            super(propertyName);
            setConverter(converter);
            mKeyframes = keyframes;
            setEvaluator(evaluator);
    ...
    static class MultiIntValuesHolder<T> extends PropertyValuesHolder<T, int[]> {

        MultiIntValuesHolder(String propertyName, TypeConverter<T, int[]> converter,
                TypeEvaluator<T> evaluator, T... values) {
            super(propertyName);
            setConverter(converter);
            setObjectValues(values);
