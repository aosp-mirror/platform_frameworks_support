 ...
 *
 * <p>ValueAnimator also supports the use of a combination of {@link PropertyValuesHolder}
...
public class ValueAnimator extends Animator implements AnimationHandler.AnimationFrameCallback {
    ...
    /**
     * Developer defined name for animation. This name will show up in the systrace.
     */
    private String mAnimTraceName = null;
     ...
     * factory method also takes a androidx.animation.TypeEvaluator object that the ValueAnimator will use
     * to perform that interpolation.
     *
     * @param evaluator A androidx.animation.TypeEvaluator that will be called on each animation frame to
     ...
     * of those objects.</p>
     *
     * <p>There should be a androidx.animation.TypeEvaluator set on the ValueAnimator that knows how to interpolate
     ...
     * playing from that point. {@link androidx.animation.Animator.AnimatorListener} events are not
     ...
     * during a call to
     * {@link androidx.animation.Animator.AnimatorUpdateListener#onAnimationUpdate(Animator)}, which
    ...
    public void resume() {
        ...
        if (mPaused && !mResumed) {
            mResumed = true;
            if (mPauseTime > 0) {
                // TODO: check whether this needs to be moved to after super.resume() call.
                addAnimationCallback();
            }
        }
        super.resume();
     ...
     */
    // TODO: should this be in base class instead?
    public String getNameForTrace() {
        return mAnimTraceName == null ? "animator" : mAnimTraceName;
    }

    /**
     * Sets a name for the animation to show up in the systrace. This makes a particular animation
     * identifiable in the systrace.
     *
     * @param animationName A name for the animation to make the instance identifiable in systrace
     */
    public void setNameForTrace(String animationName) {
        mAnimTraceName = animationName;
    }
