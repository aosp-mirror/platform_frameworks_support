    ...
    public int getIntValue(float fraction) {
        if (fraction <= 0f) {
            ...
            return mEvaluator == null ?
                    ...
                    ((Integer)mEvaluator.evaluate(intervalFraction, prevValue, nextValue)).
                            intValue();
        } else if (fraction >= 1f) {
            ...
            return mEvaluator == null ?
                    prevValue + (int)(intervalFraction * (nextValue - prevValue)) :
                    ((Integer)mEvaluator.evaluate(intervalFraction, prevValue, nextValue)).intValue();
        }
        ...
        // shouldn't get here
        return ((Integer)mKeyframes.get(mNumKeyframes - 1).getValue()).intValue();
    }
