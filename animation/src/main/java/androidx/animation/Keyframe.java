...
public abstract class Keyframe<T> implements Cloneable {
     ...
     * this keyframe.
     */
    public static IntKeyframe ofInt(float fraction, int value) {
     ...
     * with no initial value must be used as part of an {@link androidx.animation.ObjectAnimator}).
     ...
     * of time elapsed of the overall animation duration.
     */
    public static IntKeyframe ofInt(float fraction) {
     ...
     * this keyframe.
     */
    public static FloatKeyframe ofFloat(float fraction, float value) {
     ...
     * of time elapsed of the overall animation duration.
     */
    public static FloatKeyframe ofFloat(float fraction) {
     ...
     * this keyframe.
     */
    public static <T> Keyframe<T> ofObject(float fraction, T value) {
     ...
     * of time elapsed of the overall animation duration.
     */
    public static <T> ObjectKeyframe<T> ofObject(float fraction) {
    ...
    static class ObjectKeyframe<T> extends Keyframe<T> {
        ...
        public ObjectKeyframe<T> clone() {
            ObjectKeyframe<T> kfClone = new ObjectKeyframe<>(getFraction(), hasValue() ? mValue : null);
