 ...
 *
 * @param <T> type T, which can be converted from and to type V
 * @param <V> type V, which can be converted from and to type T
...
public abstract class BidirectionalTypeConverter<T, V> extends TypeConverter<T, V> {
    ...
    private static class InvertedConverter<From, To> extends BidirectionalTypeConverter<From, To> {
        ...
        InvertedConverter(BidirectionalTypeConverter<To, From> converter) {
