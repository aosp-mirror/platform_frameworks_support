...
public class AnimatorInflater {
                ...
                case XmlPullParser.START_TAG:
                    ...
                    if ("item".equals(parser.getName())) {
                        ...
                        for (int i = 0; i < attributeCount; i++) {
                            ...
                            //TODO: This attr is added in later API, check whether this works
                            if (attrName == android.R.attr.animation) {
    ...
    private static class PathDataEvaluator implements TypeEvaluator<PathParser.PathDataNode[]> {
        ...
        @Override
        public PathParser.PathDataNode[] evaluate(float fraction, PathParser.PathDataNode[] startPathData,
                PathParser.PathDataNode[] endPathData) {
            if (mPathData == null) {
                mPathData = new PathParser.PathDataNode[startPathData.length];
            }
            if (!PathParser.interpolatePathDataNodes(mPathData, startPathData, endPathData, fraction)) {
    ...
    private static void parseAnimatorFromTypeArray(ValueAnimator anim,
        ...
        int valueType = arrayAnimator.getInt(AndroidResources.STYLEABLE_ANIMATOR_VALUE_TYPE, VALUE_TYPE_UNDEFINED);
     ...
     * @param valueType True if the value type is float.
     * @param pixelSize The relative pixel size, used to calculate the
     *                  maximum error for path animations.
     */
    private static void setupObjectAnimator(ValueAnimator anim, TypedArray arrayObjectAnimator,
        ...
        String pathData = arrayObjectAnimator.getString(AndroidResources.STYLEABLE_PROPERTY_ANIMATOR_PATH_DATA);
        ...
        if (pathData != null) {
            String propertyXName =
                    arrayObjectAnimator.getString(AndroidResources.STYLEABLE_PROPERTY_ANIMATOR_PROPERTY_X_NAME);
            String propertyYName =
                    arrayObjectAnimator.getString(AndroidResources.STYLEABLE_PROPERTY_ANIMATOR_PROPERTY_Y_NAME);
            ...
            String propertyName =
                    arrayObjectAnimator.getString(AndroidResources.STYLEABLE_PROPERTY_ANIMATOR_PROPERTY_NAME);
    ...
    private static Animator createAnimatorFromXml(Resources res, Theme theme, XmlPullParser parser,
        ...
        while (((type = parser.next()) != XmlPullParser.END_TAG || parser.getDepth() > depth)
            ...
            if (name.equals("objectAnimator")) {
                ...
                TypedArray a;
                if (theme != null) {
                    a = theme.obtainStyledAttributes(attrs, AndroidResources.STYLEABLE_ANIMATOR_SET, 0, 0);
                } else {
    ...
    private static PropertyValuesHolder[] loadValues(Resources res, Theme theme,
        ...
        while ((type = parser.getEventType()) != XmlPullParser.END_TAG &&
            ...
            if (name.equals("propertyValuesHolder")) {
                TypedArray a;
                if (theme != null) {
                    a = theme.obtainStyledAttributes(attrs, AndroidResources.STYLEABLE_PROPERTY_VALUES_HOLDER, 0, 0);
                } else {
                    a = res.obtainAttributes(attrs, AndroidResources.STYLEABLE_PROPERTY_VALUES_HOLDER);
                }
                String propertyName = a.getString(AndroidResources.STYLEABLE_PROPERTY_VALUES_HOLDER_PROPERTY_NAME);
                int valueType = a.getInt(AndroidResources.STYLEABLE_PROPERTY_VALUES_HOLDER_VALUE_TYPE,
    ...
    private static Keyframe loadKeyframe(Resources res, Theme theme, AttributeSet attrs,
        ...
        if (resID > 0) {
            final TimeInterpolator interpolator = AnimationUtils.loadInterpolator(res, theme, resID);
