...
public class AnimatorInflater {
     ...
     */
    static Animator loadAnimator(Context context, int id) throws NotFoundException {
     ...
     * @throws android.content.res.Resources.NotFoundException when the animation cannot be loaded
     */
    static Animator loadAnimator(Resources resources, Theme theme, int id)
    ...
    private static Keyframe createNewKeyframe(Keyframe sampleKeyframe, float fraction) {
        return sampleKeyframe.getType() == float.class
                ? Keyframe.ofFloat(fraction) : (sampleKeyframe.getType() == int.class)
                ? Keyframe.ofInt(fraction) : Keyframe.ofObject(fraction);
    }
