...
public final class ObjectAnimator extends ValueAnimator {
     ...
     */
    @NonNull
    public static <T> ObjectAnimator ofInt(@NonNull T target, @Nullable Property<T, Integer> xProperty,
            @Nullable Property<T, Integer> yProperty, @NonNull Path path) {
        PathKeyframes keyframes = KeyframeSet.ofPath(path);
     ...
     */
    @NonNull
    public static ObjectAnimator ofMultiInt(@NonNull Object target, @NonNull String propertyName, @NonNull int[][] values) {
     ...
     */
    @NonNull
    public static ObjectAnimator ofArgb(@NonNull Object target, @NonNull String propertyName, @NonNull int... values) {
     ...
     */
    @NonNull
    public static <T> ObjectAnimator ofArgb(@NonNull T target, @NonNull Property<T, Integer> property,
            @NonNull int... values) {
     ...
     */
    @NonNull
    public static ObjectAnimator ofFloat(@NonNull Object target, @NonNull String propertyName, @NonNull float... values) {
        ObjectAnimator anim = new ObjectAnimator(target, propertyName);
     ...
     */
    @NonNull
    public static <T> ObjectAnimator ofFloat(@NonNull T target, @NonNull Property<T, Float> property,
     ...
     */
    @NonNull
    public static <T> ObjectAnimator ofFloat(@NonNull T target, @Nullable Property<T, Float> xProperty,
            @Nullable Property<T, Float> yProperty, @NonNull Path path) {
        PathKeyframes keyframes = KeyframeSet.ofPath(path);
        PropertyValuesHolder x = PropertyValuesHolder.ofKeyframes(xProperty,
                keyframes.createXFloatKeyframes());
        PropertyValuesHolder y = PropertyValuesHolder.ofKeyframes(yProperty,
     ...
     */
    @NonNull
    public static ObjectAnimator ofMultiFloat(@NonNull Object target, @NonNull String propertyName, @NonNull float[][] values) {
    ...
    @SafeVarargs
    @NonNull
    public static <T> ObjectAnimator ofMultiFloat(@NonNull Object target, @NonNull String propertyName,
            @NonNull TypeConverter<T, float[]> converter, @NonNull TypeEvaluator<T> evaluator, @NonNull T... values) {
    ...
    @NonNull
    @SafeVarargs
    public static <T, V> ObjectAnimator ofObject(@NonNull T target, @NonNull Property<T, V> property,
