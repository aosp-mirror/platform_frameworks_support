...
class SimpleTypeInterpreter {
    static SimpleTypeDescriptor predefinedInstance(String typename) throws XsdParserException {
        switch (typename) {
            case "string":
            case "token":
    ...
    static SimpleTypeDescriptor parse(XmlSchema schema, XsdTypeReferrer typeRef) throws XsdParserException {
