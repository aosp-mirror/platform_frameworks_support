...
class SchemaDescriptor {
    ...
    void registerClass(ClassDescriptor descriptor) throws XsdParserException {
    ...
    void registerRootElement(VariableDescriptor element) throws XsdParserException {
    ...
    Map<String, ClassDescriptor> getClassDescriptorMap() {
        return classDescriptorMap;
    }

    Map<String, VariableDescriptor> getRootElementMap() {
        return rootElementMap;
    }

    ClassDescriptor getClass(String name) throws XsdParserException {
        if (!classDescriptorMap.containsKey(name)) {
            throw new XsdParserException(String.format("class does not exist : %s", name));
        }
        return classDescriptorMap.get(name);
    }

    void printXmlParser(String packageName, PrintWriter out) {
