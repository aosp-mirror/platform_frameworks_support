...
class ClassDescriptor {
    ...
    void setBase(ClassDescriptor base) throws XsdParserException {
    ...
    void setValueType(TypeDescriptor valueType) throws XsdParserException {
        addNameSet("value");
        this.valueType = valueType;
    }

    void registerElement(VariableDescriptor element) throws XsdParserException {
        addNameSet(element.getName());
        elements.add(element);
    }

    void registerAttribute(VariableDescriptor attribute) throws XsdParserException {
        addNameSet(attribute.getName());
        attributes.add(attribute);
    }

    void registerInnerClass(ClassDescriptor innerClass) throws XsdParserException {
    ...
    void print(String packageName, PrintWriter out) {
