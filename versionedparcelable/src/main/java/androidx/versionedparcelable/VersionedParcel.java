...
public abstract class VersionedParcel {
    ...
    protected final SimpleArrayMap<String, Method> mReadCache;
    protected final SimpleArrayMap<String, Method> mWriteCache;
    protected final SimpleArrayMap<String, Class<?>> mParcelizerCache;

    public VersionedParcel(SimpleArrayMap<String, Method> readCache,
