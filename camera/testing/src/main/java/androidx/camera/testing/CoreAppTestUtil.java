...
public final class CoreAppTestUtil {
     ...
     *
     */
    public static void assumeCompatibleDevice(@Nullable String message) {
        // TODO(b/134894604) This will be removed once the issue is fixed.
        if (Build.VERSION.SDK_INT == Build.VERSION_CODES.LOLLIPOP
                && Build.MODEL.contains("Nexus 5")) {
            throw new AssumptionViolatedException("Known issue, b/134894604: " + message);
        }

        if (message != null) {
            // There is something wrong, and ignore the test and note.
            throw new AssumptionViolatedException("Ignore test, API: " + Build.VERSION.SDK_INT
                    + ", Model: " + Build.MODEL + ", "
                    + message);
        }
