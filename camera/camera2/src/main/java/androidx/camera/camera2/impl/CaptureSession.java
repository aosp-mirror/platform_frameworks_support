...
final class CaptureSession {
        ...
        synchronized (mStateLock) {
            switch (mState) {
                ...
                case INITIALIZED:
                    ...
                    // TODO: Remove this workaround after CheckedSurfaceTexture removed.
                    ...
                    CameraEventCallbacks eventCallbacks = new Camera2Config(
                            sessionConfig.getCameraOption()).getCameraEventCallback(
            ...
            switch (mState) {
                ...
                case OPENED:
                    ...
                    if (mSessionConfig != null) {
                        CameraEventCallbacks eventCallbacks = new Camera2Config(
                                mSessionConfig.getCameraOption()).getCameraEventCallback(
                                CameraEventCallbacks.createEmptyCallback());
    ...
    private List<CaptureConfig> setupConfiguredSurface(List<CaptureConfig> list) {
