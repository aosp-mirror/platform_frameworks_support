...
public final class CameraCaptureSessionCompat {
     ...
     * except that it uses {@link Executor} as an argument instead of {@link android.os.Handler}.
     *
     ...
     */
    public static int captureSingleRequest(@NonNull CameraCaptureSession captureSession,
    ...
    interface CameraCaptureSessionCompatImpl {
        int captureSingleRequest(@NonNull CameraCaptureSession captureSession,
                @NonNull CaptureRequest request,
                @NonNull /* @CallbackExecutor */ Executor executor,
                @NonNull CameraCaptureSession.CaptureCallback listener)
                throws CameraAccessException;
