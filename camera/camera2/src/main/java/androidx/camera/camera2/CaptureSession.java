...
final class CaptureSession {
        ...
        synchronized (mStateLock) {
            switch (mState) {
                ...
                case INITIALIZED:
                    ...
                    List<CaptureConfig> presetList = SessionEventCallbacks.createComboCallback(
            ...
            switch (mState) {
                ...
                case OPENED:
                    ...
                    if (mSessionConfig != null) {
                        List<CaptureConfig> configList = SessionEventCallbacks.createComboCallback(
                                mSessionConfig.getSessionEventCallback()).onDisableSession();
                        if (!configList.isEmpty()) {
                            issueCaptureRequests(configList);
                        }
                    }
    ...
    void issueRepeatingCaptureRequests() {
        ...
        try {
            ...
            List<CaptureConfig> repeatingRequestList = SessionEventCallbacks.createComboCallback(
            ...
            synchronized (mStateLock) {
                switch (mState) {
                    ...
                    case OPENING:
                        ...
                        if (mSessionConfig != null) {
                            List<CaptureConfig> list = SessionEventCallbacks.createComboCallback(
