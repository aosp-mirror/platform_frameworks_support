...
final class SupportedSurfaceCombination {
    ...
    private boolean hasMatchingAspectRatio(Size resolution, Rational aspectRatio) {
        ...
        if (aspectRatio == null) {
            ...
            double scale = resolution.getWidth() / (double) aspectRatio.getNumerator();
            int scaleHeight = (int) (aspectRatio.getDenominator() * scale);
            ...
            isMatch = resolution.getHeight() == ceilAlignedHeight
                    || resolution.getHeight() == floorAlignedHeight;
        }
        return isMatch;
    }
