...
final class Camera implements BaseCamera {
    ...
    /**
     * Checks if there's valid repeating surface and attaches all to {@link CaptureConfig.Builder}.
     *
     * @param captureConfigBuilder the configuration builder to attach repeating surfaces
     * @return True if repeating surfaces has been successfully attached, otherwise false.
     */
