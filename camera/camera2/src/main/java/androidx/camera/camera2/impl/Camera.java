...
final class Camera implements BaseCamera {
    ...
    void doAddOnlineUseCase() {
        List<UseCase> useCasesToAdd = mUseCaseAggregator.popPendingOnline();
    ...
    void doRemoveOnlineUseCase() {
        List<UseCase> useCasesToRemove = mUseCaseAggregator.popPendingOffline();
        if (DEBUG) {
    ...
    class UseCaseAggregator {
        ...
        synchronized List<UseCase> popPendingOnline() {
        ...
        synchronized List<UseCase> popPendingOffline() {
