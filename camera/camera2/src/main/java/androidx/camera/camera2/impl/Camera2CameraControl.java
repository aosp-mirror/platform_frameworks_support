...
public final class Camera2CameraControl implements CameraControl {
    ...
    public Camera2CameraControl(ControlUpdateListener controlUpdateListener,
            @NonNull Executor executor, @NonNull ScheduledExecutorService scheduler) {
        this(controlUpdateListener, executor, scheduler, DEFAULT_FOCUS_TIMEOUT_MS);
    }
    ...
    public void focus(
            final Rect focus,
            final Rect metering,
            @Nullable final Executor userListenerExecutor,
    ...
    void focusInternal(
        ...
        final Executor listenerExecutor =
                (userListenerExecutor == null) ? CameraXExecutors.mainThreadExecutor()
                        : userListenerExecutor;
        if (listener != null) {
