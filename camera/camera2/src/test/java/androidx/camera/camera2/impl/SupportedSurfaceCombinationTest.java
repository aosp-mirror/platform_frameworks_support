...
public final class SupportedSurfaceCombinationTest {
    ...
    public void checkTargetAspectRatioForPreviewInLegacyDevice() {
        ...
        Rational resultAspectRatio = supportedSurfaceCombination.checkPreviewAspectRatio(preview);
        ...
        if (Build.VERSION.SDK_INT == 21) {
            // Check targetAspectRatio and maxJpegAspectRatio, which is the ratio of maximum size
