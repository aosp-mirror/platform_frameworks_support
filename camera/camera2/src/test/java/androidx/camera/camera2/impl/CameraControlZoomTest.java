...
public class CameraControlZoomTest {
    ...
    public void setUp() {
        ...
        mCamera2CameraControl = new Camera2CameraControl(mCameraManager,
                CAMERAID_0,
                mControlUpdateListener, executorService, executorService);

        mCameraControl = mCamera2CameraControl.getPublicCameraControl();

        Camera2CameraControl camera2CameraControl01 = new Camera2CameraControl(mCameraManager,
                CAMERAID_1,
                mControlUpdateListener, executorService, executorService);
        mCameraControl01 = camera2CameraControl01.getPublicCameraControl();
    ...
    public void setZoomAs1_CropRegionIsSensorRect() throws InterruptedException {
        ...
        assertThat(repeatingConfig.getCaptureRequestOption(CaptureRequest.SCALER_CROP_REGION, null))
                .isEqualTo(mCamera2CameraControl.getSensorRect());
