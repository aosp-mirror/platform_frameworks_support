...
public final class ProcessingImageReaderTest {
    ...
    public void testClearCaptureResult_nextCaptureBundleCanWork()
        ...
        // To set the second capture bundle immediately after clearCaptureResult().
        // The second capture bundle should work fine.
        ...
        // To verify the second capture bundle result should work fine.
        Map<Integer, Long> resultMap = new HashMap<>();
