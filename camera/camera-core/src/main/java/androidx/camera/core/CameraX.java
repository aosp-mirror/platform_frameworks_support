...
public final class CameraX {
    ...
    /**
     * Gets the default lens facing if the provided {@link LensFacing} is not existent or
     * {@code null}.
     *
     * @param preferredLensFacing the lens facing of the camera
    ...
    @RestrictTo(Scope.LIBRARY_GROUP)
    @Nullable
    public static LensFacing getDefaultLensFacing(@Nullable LensFacing preferredLensFacing)
            throws CameraInfoUnavailableException {
        List<LensFacing> lensFacingList;
        if (preferredLensFacing == LensFacing.FRONT) {
