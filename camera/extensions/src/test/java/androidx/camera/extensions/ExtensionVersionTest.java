...
public class ExtensionVersionTest {
    ...
    public void testVendorReturnValidVersion() {
        ...
        assertTrue(ExtensionVersion.getInstance().isExtensionVersionSupported());
        assertEquals(ExtensionVersion.getInstance().getRuntimeVersion(), Version.parse(testString));
    }
    ...
    public void testVendorReturnGreaterMajor() {
        ...
        assertFalse(ExtensionVersion.getInstance().isExtensionVersionSupported());
        assertNull(ExtensionVersion.getInstance().getRuntimeVersion());
    }
    ...
    /**
     * A Shadow of {@link ExtenderVersioningImpl} which return a test version for testing.
     */
    @Implements(
            value = ExtenderVersioningImpl.class,
            minSdk = 21
    )
