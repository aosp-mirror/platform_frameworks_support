...
public final class ImageCaptureExtenderTest {
    ...
    public void receiveErrorCode_whenOnlyEnableImageCaptureExtender() throws InterruptedException {
        ...
        FakeImageCaptureExtender fakeImageCaptureExtender = FakeImageCaptureExtender.create(
                imageCaptureConfigBuilder);
        fakeImageCaptureExtender.enableExtension();
        fakeImageCaptureExtender.setExtenderErrorListener(new ExtenderErrorListener() {
            @Override
        ...
        PreviewConfig.Builder previewConfigBuilder = new PreviewConfig.Builder().setLensFacing(
                LensFacing.BACK);
        FakePreviewExtender fakePreviewExtender = FakePreviewExtender.create(previewConfigBuilder);
