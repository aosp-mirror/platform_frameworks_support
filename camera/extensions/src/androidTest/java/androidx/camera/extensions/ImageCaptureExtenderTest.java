...
import static androidx.camera.extensions.ExtensionsErrorListener.ExtensionsErrorCode.IMAGE_CAPTURE_EXTENSION_REQUIRED;
import static androidx.camera.extensions.ExtensionsErrorListener.ExtensionsErrorCode.PREVIEW_EXTENSION_REQUIRED;
...
public final class ImageCaptureExtenderTest {
    ...
    public void receiveErrorCode_whenOnlyEnableImageCaptureExtender() throws InterruptedException {
        ...
        ExtensionsManager.setExtensionsErrorListener(new ExtensionsErrorListener() {
            ...
            public void onError(ExtensionsErrorCode errorCode) {
                if (errorCode == PREVIEW_EXTENSION_REQUIRED) {
    ...
    public void receiveErrorCode_whenOnlyEnablePreviewExtender() throws InterruptedException {
        ...
        ExtensionsManager.setExtensionsErrorListener(new ExtensionsErrorListener() {
            @Override
            public void onError(ExtensionsErrorCode errorCode) {
                if (errorCode == IMAGE_CAPTURE_EXTENSION_REQUIRED) {
                    isErrorCodeReceived[0] = true;
                }
            }
        });
    ...
    public void notReceiveErrorCode_whenEnableBothImageCapturePreviewExtenders()
        ...
        ExtensionsManager.setExtensionsErrorListener(new ExtensionsErrorListener() {
            ...
            public void onError(ExtensionsErrorCode errorCode) {
                if (errorCode == PREVIEW_EXTENSION_REQUIRED
                        || errorCode == IMAGE_CAPTURE_EXTENSION_REQUIRED) {
                    isErrorCodeReceived[0] = true;
                }
            }
        });
