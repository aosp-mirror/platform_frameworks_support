...
public class ExtensionTest {
    ...
    @Test
    public void testBokehExtender_frontCam() throws InterruptedException {
    ...
    @Test
    public void testBokehExtender_backCam() throws InterruptedException {
    ...
    @Test
    public void testHdrExtender_frontCam() throws InterruptedException {
        assumeTrue(getAvailableCameraLensFacing().contains(CameraX.LensFacing.FRONT));
    ...
    @Test
    public void testHdrExtender_backCam() throws InterruptedException {
        assumeTrue(getAvailableCameraLensFacing().contains(CameraX.LensFacing.BACK));
        assumeTrue(ExtensionsManager.isExtensionAvailable(ExtensionsManager.EffectMode.HDR,
                CameraX.LensFacing.BACK));
    ...
    @Test
    public void testBeautyExtender_frontCam() throws InterruptedException {
        assumeTrue(getAvailableCameraLensFacing().contains(CameraX.LensFacing.FRONT));
    ...
    @Test
    public void testBeautyExtender_backCam() throws InterruptedException {
        assumeTrue(getAvailableCameraLensFacing().contains(CameraX.LensFacing.BACK));
        assumeTrue(ExtensionsManager.isExtensionAvailable(ExtensionsManager.EffectMode.BEAUTY,
                CameraX.LensFacing.BACK));
    ...
    @Test
    public void testNightExtender_frontCam() throws InterruptedException {
        assumeTrue(getAvailableCameraLensFacing().contains(CameraX.LensFacing.FRONT));
    ...
    @Test
    public void testNightExtender_backCam() throws InterruptedException {
        assumeTrue(getAvailableCameraLensFacing().contains(CameraX.LensFacing.BACK));
        assumeTrue(ExtensionsManager.isExtensionAvailable(ExtensionsManager.EffectMode.NIGHT,
                CameraX.LensFacing.BACK));
    ...
    @Test
    public void testAutoExtender_frontCam() throws InterruptedException {
        assumeTrue(getAvailableCameraLensFacing().contains(CameraX.LensFacing.FRONT));
    ...
    @Test
    public void testAutoExtender_backCam() throws InterruptedException {
        assumeTrue(getAvailableCameraLensFacing().contains(CameraX.LensFacing.BACK));
        assumeTrue(ExtensionsManager.isExtensionAvailable(ExtensionsManager.EffectMode.AUTO,
                CameraX.LensFacing.BACK));
