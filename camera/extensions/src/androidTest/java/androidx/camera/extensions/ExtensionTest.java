...
public class ExtensionTest {
    ...
    public void cleanUp() throws InterruptedException {
        if (mLatch != null) {
            if (mPreview != null && CameraX.isBound(mPreview)) {
                CameraX.unbind(mPreview);
            }
            if (mImageCapture != null && CameraX.isBound(mImageCapture)) {
    ...
    public void testCanBindToLifeCycleAndTakePicture() {
        ...
        CameraX.bindToLifecycle(mLifecycleOwner, mPreview, mImageCapture);

        // To set the update listener and Preview will change to active state.
        mPreview.setOnPreviewOutputUpdateListener(mockOnPreviewOutputUpdateListener);

        mImageCapture.takePicture(mockOnImageCapturedListener);
