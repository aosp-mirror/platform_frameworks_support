...
public class PreviewExtenderTest {
    ...
    public void getCaptureStagesTest_shouldSetToRepeatingRequest() throws InterruptedException {
        ...
        CaptureStageImpl mockCaptureStageImpl = new FakeCaptureStageImpl();

        final CountDownLatch latch = new CountDownLatch(1);
        final AtomicReference<TotalCaptureResult> totalCaptureResult = new AtomicReference<>();
        ...
        List<Pair<CaptureRequest.Key, Object>> parameters = mockCaptureStageImpl.getParameters();
        for (Pair<CaptureRequest.Key, Object> parameter : parameters) {
            assertThat(totalCaptureResult.get().getRequest().get(
