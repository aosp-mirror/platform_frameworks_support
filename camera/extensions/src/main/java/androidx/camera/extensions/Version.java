...
abstract class Version implements Comparable<Version> {
     ...
     * @param another The preference the to check if it have the same major and minor version to
     *                this one.
     * @return true if the major and minor version is the same to the <var>another</var>.
     */
