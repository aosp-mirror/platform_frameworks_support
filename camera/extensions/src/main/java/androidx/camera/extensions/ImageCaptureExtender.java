...
abstract class ImageCaptureExtender {
    ...
    public void enableExtension() {
        ...
        mBuilder.getMutableConfig().insertOption(OPTION_IMAGE_CAPTURE_EXTENDER_TYPE,
                ImageCaptureExtender.class.toString() + mEffectMode);
    }

    static void checkPreviewEnabled(EffectMode effectMode) {
        ...
        if (extensionsErrorListener != null) {
            ...
            String dependenceExtenderType = PreviewExtender.class.toString() + effectMode;
            ...
            for (UseCase useCase : activeUseCases) {
                ...
                if (dependenceExtenderType.equals(previewExtenderType)) {
    ...
    static class ImageCaptureAdapter extends CameraEventCallback implements UseCase.EventListener,
        ...
        public CaptureConfig onPresetSession() {
            if (mActive.get()) {
                checkPreviewEnabled(mEffectMode);
