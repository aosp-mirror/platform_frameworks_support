...
/**
 * The implementation of {@link EffectEnabler} for applying effect config.
 */
final class AdaptingEffectEnabler implements EffectEnabler {
    ...
    public void applyEffectConfig(@NonNull ImageCaptureConfig.Builder builder,
        ...
        ImageCaptureExtender.removeEffectConfigs(builder);
    ...
    public void applyEffectConfig(@NonNull PreviewConfig.Builder builder,
        ...
        PreviewExtender.removeEffectConfigs(builder);
