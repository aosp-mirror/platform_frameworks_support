...
final class AdaptingEffectHelper implements EffectHelper {
     ...
     */
    @Override
    public void applyEffectConfig(ImageCaptureConfig.Builder builder,
     ...
     */
    @Override
    public void applyEffectConfig(PreviewConfig.Builder builder, LifecycleOwner lifecycleOwner) {
