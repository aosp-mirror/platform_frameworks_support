 ...
 */
public final class ImageCaptureExtensionsCameraIdFilter implements CameraIdFilter {
    ImageCaptureExtenderImpl mImageCaptureExtenderImpl;

    ImageCaptureExtensionsCameraIdFilter(ImageCaptureExtenderImpl imageCaptureExtenderImpl) {
    ...
    public Set<String> filter(Set<String> cameraIdSet) {
        ...
        for (String cameraId : cameraIdSet) {
            if (mImageCaptureExtenderImpl.isExtensionAvailable(cameraId,
