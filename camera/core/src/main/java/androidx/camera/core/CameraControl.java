...
public interface CameraControl {
     ...
     */
    void submitCaptureRequest(List<CaptureConfig> captureConfigs);
    ...
    CameraControl DEFAULT_EMPTY_INSTANCE = new CameraControl() {
        ...
        @Override
        public void submitCaptureRequest(List<CaptureConfig> captureConfigs) {
        }
    };
    ...
    interface ControlUpdateListener {
        ...
        void onCameraControlCaptureRequest(List<CaptureConfig> captureConfigs);
    }
}
