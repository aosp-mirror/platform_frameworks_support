...
public interface ImageOutputConfig {
    ...
    /**
     * Option: camerax.core.imageOutput.targetAspectRatioMode
     *
     * @hide
     */
    @RestrictTo(Scope.LIBRARY_GROUP)
    Option<AspectRatioMode> OPTION_TARGET_ASPECT_RATIO_MODE =
            Option.create("camerax.core.imageOutput.targetAspectRatioMode", AspectRatioMode.class);
     ...
     */
    @Nullable
    AspectRatioMode getTargetAspectRatioMode(@Nullable AspectRatioMode valueIfMissing);
     ...
     * @throws IllegalArgumentException if the option does not exist in this configuration.
     */
    AspectRatioMode getTargetAspectRatioMode();
    ...
    interface Builder<B> {
         ...
         *
         * <p>TValid values for the relative aspect ratio mode are:
         ...
         * @return The current Builder.
         */
        B setTargetAspectRatioMode(AspectRatioMode aspectRatioMode);
