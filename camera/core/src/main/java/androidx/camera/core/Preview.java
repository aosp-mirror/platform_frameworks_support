...
public class Preview extends UseCase {
    ...
    private SessionConfig.Builder createFrom(final PreviewConfig config, Size resolution) {
        ...
        if (captureProcessor != null) {
            ...
            mSurfaceTextureHolder = new ProcessingSurfaceTextureHolder(processingSurfaceTexture,
                    this, resolution);
            mDeferrableSurface = processingSurfaceTexture;
            ...
            mDeferrableSurface = checkedSurfaceTexture;
        }
