...
public interface BaseCamera extends UseCase.StateChangeListener,
        InternalCameraControl.ControlUpdateListener {
    /**
    ...
    /** Returns the global InternalCameraControl attached to this camera. */
    InternalCameraControl getInternalCameraControl();
