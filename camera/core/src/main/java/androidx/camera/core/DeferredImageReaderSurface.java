...
final class DeferredImageReaderSurface extends DeferrableSurface {
    ...
    @NonNull
    ImageReaderCreator mImageReaderCreator;
    ...
    @UiThread
    void releaseImageReader(ImageReaderProxy imageReader) {

        if (imageReader != null) {
            // add to release list
            mImageReaderToReleaseList.add(imageReader);
        }
    }
