...
public final class PreviewConfig
    ...
    /**
     * Retrieves the aspect ratio mode of the target intending to use images from this
     * configuration.
     *
     * <p>Valid values for the relative aspect ratio mode are: {@link AspectRatioMode#RATIO_4_3},
     * {@link AspectRatioMode#RATIO_16_9}.
     *
     * @param valueIfMissing The value to return if this configuration option has not been set.
     * @return The stored value or <code>valueIfMissing</code> if the value does not exist in this
     * configuration.
    ...
    @Nullable
    @Override
    public AspectRatioMode getTargetAspectRatioMode(@Nullable AspectRatioMode valueIfMissing) {
        return retrieveOption(OPTION_TARGET_ASPECT_RATIO_MODE, valueIfMissing);
    }
     ...
     */
    @Override
    public AspectRatioMode getTargetAspectRatioMode() {
        return retrieveOption(OPTION_TARGET_ASPECT_RATIO_MODE);
    }
    ...
    public static final class Builder
        ...
        public PreviewConfig build() {
            ...
            if (getMutableConfig().retrieveOption(OPTION_TARGET_ASPECT_RATIO_MODE, null) != null
        ...
        /**
         * Sets the aspect ratio mode of the intended target for images from this configuration.
         *
         * <p>Valid values for the relative aspect ratio mode are:
         * {@link AspectRatioMode#RATIO_4_3}, {@link AspectRatioMode#RATIO_16_9}.
         *
         * <p>It is not allowed to set both target aspect ratio mode and target resolution on the
         * same use case.
         *
         * <p>The target aspect ratio is used as a hint when determining the resulting output aspect
         * ratio which may differ from the request, possibly due to device constraints.
         ...
         * {@link androidx.camera.core.Preview.PreviewOutput}.
         *
         * @param aspectRatioMode A {@link AspectRatioMode} representing the ratio of the
         *                        target's width and height.
         * @return The current Builder.
         */
        @Override
        public Builder setTargetAspectRatioMode(AspectRatioMode aspectRatioMode) {
            getMutableConfig().insertOption(OPTION_TARGET_ASPECT_RATIO_MODE, aspectRatioMode);
            return this;
        }
