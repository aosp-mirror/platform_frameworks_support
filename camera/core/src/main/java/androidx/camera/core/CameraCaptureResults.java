...
public class CameraCaptureResults {
    /**
    ...
    public static CameraCaptureResult retrieveCameraCaptureResult(ImageInfo imageInfo) {
        CameraCaptureResultImageInfo info = (CameraCaptureResultImageInfo.class).cast(imageInfo);
        if (info != null) {
            return info.getCameraCaptureResult();
        } else {
            return null;
        }
    }
