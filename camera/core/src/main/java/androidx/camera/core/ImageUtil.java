...
final class ImageUtil {
    ...
    public static byte[] cropByteArray(byte[] data, Rect cropRect) throws CodecFailedException {
        ...
        try {
            ...
            throw new CodecFailedException("Decode byte array failed with illegal argument." + e,
                    CodecFailedException.FailedType.DECODE_FAILED);
        } catch (IOException e) {
        ...
        if (!success) {
            throw new CodecFailedException("Encode bitmap failed.",
                    CodecFailedException.FailedType.ENCODE_FAILED);
        }
        bitmap.recycle();
    ...
    public static final class CodecFailedException extends Exception {
        ...
        private FailedType mFailedType;

        CodecFailedException(String message) {
            super(message);
            mFailedType = FailedType.UNKNOWN_FAILED;
        }

        CodecFailedException(String message, FailedType failedType) {
            super(message);
