...
public final class ImageCaptureConfig
    ...
    /**
     * Returns the value of the bypass suggested resolution flag.
     * @param valueIfMissing The value to return if this configuration option has not been set.
     * @hide
     */
    @RestrictTo(Scope.LIBRARY_GROUP)
    public boolean getBypassSuggestedResolution(boolean valueIfMissing) {
        return retrieveOption(OPTION_BYPASS_SUGGESTED_RESOLUTION, valueIfMissing);
    }
     ...
     */
    @RestrictTo(Scope.LIBRARY_GROUP)
    public boolean getBypassSuggestedResolution() {
        return retrieveOption(OPTION_BYPASS_SUGGESTED_RESOLUTION);
    }
