...
public interface SessionEventConfig {
     ...
     */
    @RestrictTo(RestrictTo.Scope.LIBRARY_GROUP)
    Config.Option<CaptureRequestInfo> OPTION_CORE_CAPTURE_REQUTEST_INFO =
    ...
    @RestrictTo(RestrictTo.Scope.LIBRARY_GROUP)
    @Nullable
    CaptureRequestInfo getCaptureRequestInfoProvider(
    ...
    interface Builder<B> {
         ...
         */
        @RestrictTo(RestrictTo.Scope.LIBRARY_GROUP)
        B setCaptureRequestInfoProvider(CaptureRequestInfo captureRequestInfo);
    }
}
