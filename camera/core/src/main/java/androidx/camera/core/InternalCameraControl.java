...
/**
 * The InternalCameraControl Interface.
 *
 * <p>InternalCameraControl is used for global camera operations like zoom, focus, flash and
 * triggering
 * AF/AE.
 *
 * @hide
...
public interface InternalCameraControl {

    /**
     * Exposes the public version of CameraControl
     */
    CameraControl getPublicCameraControl();
    ...
    InternalCameraControl DEFAULT_EMPTY_INSTANCE = new InternalCameraControl() {
        @Override
    ...
    /** Listener called when InternalCameraControl need to notify event. */
    interface ControlUpdateListener {

        /** Called when InternalCameraControl has updated session configuration. */
        void onCameraControlUpdateSessionConfig(SessionConfig sessionConfig);

        /** Called when InternalCameraControl need to send capture requests. */
