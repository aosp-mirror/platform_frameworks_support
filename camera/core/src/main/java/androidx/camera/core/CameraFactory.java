...
public interface CameraFactory {
    ...
    /** Check if the camera with specified lens facing exists. */
    boolean hasCameraIdForLensFacing(@NonNull CameraX.LensFacing lensFacing)
            throws CameraInfoUnavailableException;

    /** Get lens facing camera id filter. */
    @NonNull
