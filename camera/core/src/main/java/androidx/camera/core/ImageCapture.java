...
public class ImageCapture extends UseCase {
    ...
    protected void onDetachFromCamera(@NonNull String cameraId) {
        ...
        while ((request = mImageCaptureRequests.poll()) != null) {
            ...
            request.callbackError(UseCaseError.USE_CASE_DETACHED, message,
                    new RequestFailedException(message));
        }
    }
    ...
    public enum UseCaseError {
        ...
        FILE_IO_ERROR,
        /**
         * An error occurred while use case is attempting to operate camera but not attached to
         * camera.
         */
        USE_CASE_DETACHED
    }
