...
public class ImageCapture extends UseCase {
    ...
    private CheckedImageReader mDeferrableSurface;
    /**
    ...
    // session.
    private final CheckedImageReader.OnImageReaderRefreshListener mImageReaderRefreshListener =
            new CheckedImageReader.OnImageReaderRefreshListener() {
                @Override
                public Surface onImageReaderRefresh(Size resolution) {
                    Log.i(TAG, "Recreate ImageReader via OnImageReaderRefreshListener.");
                    if (mImageReader != null) {
                        mImageReader.close();
                        mImageReader = null;
                    }
    ...
    protected Map<String, Size> onSuggestedResolutionUpdated(
        ...
        mDeferrableSurface = new CheckedImageReader(mImageReaderRefreshListener, resolution);
