...
final class HandlerScheduledExecutorService extends AbstractExecutorService implements
    ...
    public <V> ScheduledFuture<V> schedule(Callable<V> callable, long delay, TimeUnit unit) {
        ...
        return new ImmediateFailedScheduledFuture<>(createPostFailedException());
    }
    ...
    private static final class ImmediateFailedScheduledFuture<V> implements ScheduledFuture<V> {

        private final Throwable mThrowable;

        ImmediateFailedScheduledFuture(@NonNull Throwable throwable) {
