...
public class DeferredImageReaderSurfaceTest {
    ...
    private ImageReaderProxy setupImageReader(Size resolution) {
    ...
    public void recreateImageReaderWhenRefresh() {
        ...
        assertThat(mDeferredImageReaderSurface.mImageReaderToReleaseList.size())
                .isEqualTo(2);
        assertThat(mDeferredImageReaderSurface.getAttachedCount()).isEqualTo(3);
        assertThat(mDeferredImageReaderSurface.getImageReader()).isNotNull();

    }


    @Test
    public void releaseImageReaderListWhenFreeUnusedSurfaces() {
        ...
        mDeferredImageReaderSurface.freeUnusedSurfaces();
    ...
    @Test
    public void releaseImageReaderWhenRelease() {

        mDeferredImageReaderSurface.refresh();
        mDeferredImageReaderSurface.notifySurfaceAttached();

        // ImageReader and Release list are all empty.
        mDeferredImageReaderSurface.release();

        mDeferredImageReaderSurface.notifySurfaceDetached();
        mDeferredImageReaderSurface.notifySurfaceDetached();

        assertThat(mDeferredImageReaderSurface.getAttachedCount()).isEqualTo(0);
