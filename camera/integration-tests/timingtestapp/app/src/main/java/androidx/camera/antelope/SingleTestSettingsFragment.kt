...
class SingleTestSettingsFragment(
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        val cameraPref =
            (preferenceManager.findPreference(
                getString(R.string.settings_single_test_camera_key)) as ListPreference)
    ...
    fun toggleNumTests() {
        val typePref =
            (preferenceManager.findPreference(
                getString(R.string.settings_single_test_type_key)) as ListPreference)
        val numberPref = (preferenceManager
            .findPreference(getString(R.string.settings_numtests_key)) as ListPreference)
        when (typePref.value) {
    ...
    fun togglePreviewBuffer() {
        val typePref =
            (preferenceManager.findPreference(getString(R.string.settings_single_test_type_key))
                as ListPreference)
        val previewPref =
            (preferenceManager
                .findPreference(getString(R.string.settings_previewbuffer_key)) as ListPreference)
        when (typePref.value) {
            "INIT" -> {
