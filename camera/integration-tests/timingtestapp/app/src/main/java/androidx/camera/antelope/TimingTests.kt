...
import androidx.camera.antelope.MainActivity.Companion.cameraParams
import androidx.camera.antelope.MainActivity.Companion.logd
import androidx.camera.antelope.cameracontrollers.camera1OpenCamera
import androidx.camera.antelope.cameracontrollers.camera2OpenCamera
import androidx.camera.antelope.cameracontrollers.cameraXOpenCamera
import androidx.camera.antelope.cameracontrollers.cameraXTakePicture
import androidx.camera.antelope.cameracontrollers.closeAllCameras
import androidx.camera.antelope.cameracontrollers.closePreviewAndCamera
import androidx.camera.antelope.cameracontrollers.initializeStillCapture
