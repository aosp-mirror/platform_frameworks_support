...
class AntelopeInstrumentedTests {
    ...
    fun test09MultiCaptureCamera1Test() {
        ...
        // There is a bug in sailfish 8.0.0 that crashes the camera with this Camera 1 test, skip it
        assumeFalse(Build.VERSION.SDK_INT == Build.VERSION_CODES.O &&
                Build.BOARD.equals("sailfish"))
