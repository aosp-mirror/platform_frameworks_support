...
class AntelopeInstrumentedTests {
    ...
    fun test03SingleCaptureTest() {
        ...
        onView(withId(R.id.button_single)).check(matches(isDisplayed())).perform(click())
    ...
    fun test06AbortTest() {
        ...
        try {
            ...
            Unit // Having aborted the camera test, a PerformException is expected here
        }
    ...
    fun test11MultipleCaptureTest() {
        ...
        onView(withId(R.id.button_multi)).check(matches(isDisplayed())).perform(click())
        onView(withId(R.id.button_start))
            .inRoot(isDialog()).check(matches(isDisplayed())).perform(click())
