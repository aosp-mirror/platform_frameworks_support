...
public class CameraExtensionsActivity extends AppCompatActivity
    ...
    void createAndBindUseCases() {
        ...
        boolean isImageCaptureCreated = mImageCapture != null;
        boolean isPreviewCreated = mPreview != null;
        ...
        if (!isImageCaptureCreated) {
            createImageCapture();

            if (mImageCapture != null) {
                CameraX.bindToLifecycle(this, mImageCapture);
            }
        }
