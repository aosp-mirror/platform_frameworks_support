...
public class CaptureCharacteristicsImpls {
    ...
    static class VendorCaptureCharacteristicsImpl implements CaptureCharacteristicsImpl {
         ...
         *
         * <p>&lt;List&lt;Pair&lt;Integer, Size[]&gt;&gt;&gt;
         * {@link CameraCharacteristics.Key#SCALER_STREAM_CONFIGURATION_MAP} Gets supported
         * resolutions when specific effect mode is enabled. The first object in Pair&lt;Integer,
         * Size[]&gt; is the supported {@link ImageFormat}. The second object is the supported
         * resolutions for that {@link ImageFormat}.
         *
         * <p>&lt;{@link Float}&gt;
         * {@link CameraCharacteristics.Key#SCALER_AVAILABLE_MAX_DIGITAL_ZOOM} Gets supported
         * maximum zoom level when specific effect mode is enabled.
         *
         * <p>&lt;float[]&gt; {@link CameraCharacteristics.Key#LENS_INFO_AVAILABLE_APERTURES} Gets
         * supported aperture values when specific effect mode is enabled.
         *
