 ...
 * an access prior that will result in IllegalArgumentException.
 */
@MainThread
    ...
    override val value: VM
        get() {
            ...
            if (viewModel == null) {
                ...
                viewModel = ViewModelProvider(fragment, resolvedFactory).get(cls.java)
                cached = viewModel
            }
            return viewModel
        }
 ...
 * [Fragment.onAttach()], an access prior that will result in IllegalArgumentException.
 */
@MainThread
    ...
    override val value: VM
        get() {
            ...
            if (viewModel == null) {
                ...
                val resolvedFactory = factory ?: AndroidViewModelFactory.getInstance(application)
                viewModel = ViewModelProvider(activity, resolvedFactory).get(cls.java)
                cached = viewModel
            }
            return viewModel
        }
