...
public abstract class FragmentStatePagerAdapter extends PagerAdapter {
     ...
     * {@link FragmentStatePagerAdapter(FragmentManager, Behavior int)} and passing in
     ...
     * @deprecated use {@link FragmentStatePagerAdapter(FragmentManager, Behavior int)} with
