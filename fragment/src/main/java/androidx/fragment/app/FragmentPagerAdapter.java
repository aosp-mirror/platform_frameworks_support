...
public abstract class FragmentPagerAdapter extends PagerAdapter {
    ...
    /**
     * Indicates that the {@link Fragment#setUserVisibleHint(boolean)} callback will be called when
     * the current fragment changes.
     *
     * @deprecated use {@link #RESUME_ONLY_CURRENT_FRAGMENT} instead.
