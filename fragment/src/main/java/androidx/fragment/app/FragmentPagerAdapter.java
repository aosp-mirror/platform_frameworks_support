...
public abstract class FragmentPagerAdapter extends PagerAdapter {
    ...
    @IntDef({BEHAVIOR_USE_SET_USER_VISIBLE_HINT, BEHAVIOR_RESUME_ONLY_CURRENT_FRAGMENT})
     ...
     */
    @Deprecated
    public static final int BEHAVIOR_USE_SET_USER_VISIBLE_HINT = 0;
     ...
     * passing in {@link #BEHAVIOR_USE_SET_USER_VISIBLE_HINT}.
     *
    ...
    public FragmentPagerAdapter(@NonNull FragmentManager fm) {
        this(fm, BEHAVIOR_USE_SET_USER_VISIBLE_HINT);
    }
     ...
     * {@link Lifecycle.State#STARTED}. If {@link #BEHAVIOR_USE_SET_USER_VISIBLE_HINT} is passed,
     * all fragments are in the {@link Lifecycle.State#RESUMED} state and there will be callbacks to
