...
public abstract class FragmentPagerAdapter extends PagerAdapter {
     ...
     * This is the equivalent of calling {@link FragmentPagerAdapter(FragmentManager, Behavior int)}
     * and passing in {@link #USE_SET_USER_VISIBLE_HINT}.
     *
     * <p>Fragments will have {@link Fragment#setUserVisibleHint(boolean)} called whenever the
     * current Fragment changes.</p>
     *
     * @param fm fragment manager that will interact with this adapter
     * @deprecated use {@link FragmentPagerAdapter(FragmentManager, Behavior int)} with
