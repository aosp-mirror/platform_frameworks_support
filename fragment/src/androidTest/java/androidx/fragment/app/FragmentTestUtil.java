...
public class FragmentTestUtil {
    ...
    public static FragmentLifecycleTest mFragmentLifecycleTest = new FragmentLifecycleTest();
    ...
    public static FragmentController startupFragmentController(Parcelable savedState,
            ViewModelStore viewModelStore, ActivityTestRule<EmptyFragmentTestActivity> rule) {
        final FragmentController fc = FragmentController.createController(
                new HostCallbacks(rule.getActivity(), viewModelStore));
        fc.attachHost(null);
    ...
    public static FragmentController restartFragmentController(FragmentController fc,
            ViewModelStore viewModelStore, ActivityTestRule<EmptyFragmentTestActivity> rule) {
