...
class FragmentLifecycleTest {
    ...
    class ChildFragmentManagerFragment : StrictFragment() {
        private lateinit var mSavedChildFragmentManager: FragmentManager
        private lateinit var mChildFragment: ChildFragmentManagerChildFragment
        ...
        override fun onAttach(context: Context) {
            ...
            mSavedChildFragmentManager = childFragmentManager
        }
        ...
        override fun onCreateView(
            ...
            assertWithMessage("child FragmentManagers not the same instance")
                .that(childFragmentManager).isSameAs(mSavedChildFragmentManager)
            var child = mSavedChildFragmentManager
                .findFragmentByTag("tag") as ChildFragmentManagerChildFragment?
            if (child == null) {
                child = ChildFragmentManagerChildFragment("foo")
                mSavedChildFragmentManager.beginTransaction().add(child, "tag").commitNow()
