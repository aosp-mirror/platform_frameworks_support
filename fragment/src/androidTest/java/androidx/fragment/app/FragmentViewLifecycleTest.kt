...
class FragmentViewLifecycleTest {
    ...
    fun testFragmentViewLifecycleDetach() {
        ...
        assertWithMessage("LiveData should have active observers when RESUMED")
            .that(fragment.mLiveData.hasActiveObservers()).isTrue()
        ...
        assertWithMessage("LiveData should not have active observers after detach()")
            .that(fragment.mLiveData.hasActiveObservers()).isFalse()
        try {
            fragment.viewLifecycleOwner
    ...
    class ObserveInOnCreateViewFragment : Fragment() {
        ...
        private val mOnCreateViewObserver = Observer<Boolean> { }
        ...
        override fun onCreateView(
            ...
            mLiveData.observe(viewLifecycleOwner, mOnCreateViewObserver)
            assertWithMessage("LiveData should have observers after onCreateView observe")
                .that(mLiveData.hasObservers()).isTrue()
            // Return null - oops!
            return null
        }
    }
    ...
    class ObservingFragment : StrictViewFragment() {
        val mLiveData = MutableLiveData<Boolean>()
        private val mOnCreateViewObserver = Observer<Boolean> { }
        private val mOnViewCreatedObserver = Observer<Boolean> { }
        private val mOnViewStateRestoredObserver = Observer<Boolean> { }
        ...
        override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
            ...
            mLiveData.observe(viewLifecycleOwner, mOnViewCreatedObserver)
        ...
        override fun onViewStateRestored(savedInstanceState: Bundle?) {
            ...
            mLiveData.observe(viewLifecycleOwner, mOnViewStateRestoredObserver)
