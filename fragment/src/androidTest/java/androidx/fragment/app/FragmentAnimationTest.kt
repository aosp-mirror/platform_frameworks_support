...
class FragmentAnimationTest {
    ...
    fun addAnimators() {
        ...
        // One fragment with a createdView
    ...
    // When an animation is running on a Fragment's View, the createdView shouldn't be
    ...
    // When a createdView is animated out, is parent should be null after the animation completes
    @Test
    ...
    private fun waitForAnimationReady() {
        ...
        // Add a createdView to the hierarchy
        activityRule.runOnUiThread {
        ...
        // Remove the createdView that we just added
        activityRule.runOnUiThread {
            val content = activity.findViewById<ViewGroup>(R.id.fragmentContainer)
    ...
    class AnimationListenerFragment : StrictViewFragment() {
        ...
        override fun onCreateView(
            ...
            if (forceRunOnHwLayer) {
                // Set any background color on the TextView, so createdView.hasOverlappingRendering() will
                ...
                anim.setAnimationListener(object : Animation.AnimationListener {
                    ...
                    override fun onAnimationEnd(animation: Animation) {
                        if (enter) {
                            ...
                            exitEndCount++
                            // When exiting, the createdView is detached after onAnimationEnd,
