...
/**
 * FragmentLayout is a customized Layout designed specifically for Fragments. It extends
 ...
 *
 * <p>Layout animations and transitions are disabled for FragmentLayout. Animations should be done
 * through {@link FragmentTransaction#setCustomAnimations(int, int, int, int)}. If
...
public class FragmentLayout extends FrameLayout {
    ...
    public FragmentLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
     ...
     *
     * <p>View animations and transitions are disabled for FragmentLayout. Use
    ...
    public void setLayoutTransition(LayoutTransition transition) {
        throw new UnsupportedOperationException(
                "FragmentLayout does not support Layout Transitions.");
    }
}
