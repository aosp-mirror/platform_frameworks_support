...
class FragmentContainerViewTest {
    ...
    @Test
    fun exitAnimationFirst() {
        val activity = activityRule.activity
        val container = TestContainerView(activity.applicationContext).apply {
            id = 1
        }
        val fragmentContainerView =
            activity.findViewById<FragmentContainerView>(R.id.fragment_container_view)
        fragmentContainerView.addView(container)
    ...
    class TestContainerView(context: Context) : FragmentContainerView(context) {
