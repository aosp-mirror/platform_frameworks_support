...
class FragmentScenarioTest {
    ...
    fun launchFragmentWithFragmentFactory() {
        val factory = object : FragmentFactory() {
            override fun instantiate(
                ...
                return if (NoDefaultConstructorFragment::class.java.name != className) {
        ...
        with(launchFragment<NoDefaultConstructorFragment>(/*fragmentArgs=*/null, factory)) {
            onFragment { fragment ->
                assertThat(fragment.state).isEqualTo(State.RESUMED)
    ...
    fun launchInContainerFragmentWithFragmentFactory() {
        ...
        with(
            launchFragmentInContainer<NoDefaultConstructorFragment>(/*fragmentArgs=*/null, factory)
        ) {
            onFragment { fragment ->
                assertThat(fragment.state).isEqualTo(State.RESUMED)
                assertThat(fragment.constructorArg).isEqualTo("my constructor arg")
