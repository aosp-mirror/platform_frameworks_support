...
public final class FragmentScenario<F extends Fragment> {
    ...
    private FragmentScenario(
            Class<F> fragmentClass, ActivityScenario<EmptyFragmentActivity> activityScenario) {
     ...
     */
    public static <F extends Fragment> FragmentScenario<F> launch(Class<F> fragmentClass) {
    ...
    private static <F extends Fragment> FragmentScenario<F> internalLaunch(
            final Class<F> fragmentClass, final @Nullable Bundle fragmentArgs,
     ...
     * <p>This method cannot be called from the main thread.
     */
    public FragmentScenario<F> moveToState(State newState) {
    ...
    public interface FragmentAction<F extends Fragment> {
         ...
         *
         * @param fragment a Fragment instrumented by the FragmentScenario. It never be null.
         */
     ...
     * <p>This method cannot be called from the main thread.
     */
    public FragmentScenario<F> onFragment(final FragmentAction<F> action) {
        mActivityScenario.onActivity(
                new ActivityScenario.ActivityAction<EmptyFragmentActivity>() {
                    @Override
                    public void perform(EmptyFragmentActivity activity) {
