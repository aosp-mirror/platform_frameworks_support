...
final class HintConstants {
     ...
     *
     * <p>Consider using <code>{@value #AUTOFILL_HINT_PERSON_NAME}</code> to be more specific
     *
     * <p>See {@link android.view.View#setAutofillHints(String...)} for more info about autofill
     * hints.
     */
     ...
     *
     * <p>Consider using <code>{@value #AUTOFILL_HINT_PHONE_NUMBER}</code> to be more specific
     *
     * <p>See {@link android.view.View#setAutofillHints(String...)} for more info about autofill
     * hints.
     */
    ...
    /**
     * Hint indicating that this view can be autofilled with an phone number country code.
     *
     * <p>Can be used with either {@link android.view.View#setAutofillHints(String[])} or <a
     * href="#attr_android:autofillHint">{@code android:autofillHint}</a> (in which case the value
     ...
     * hints.
     */
    public static final String AUTOFILL_HINT_BIRTH_DATE = "birthDate";
